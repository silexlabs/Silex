...
- **Desktop app (coming soon)** — work offline, no account needed, AI-ready with built-in features

## Getting Started

To run Silex locally for development or self-hosting:

1.  **Clone the repo:** `git clone https://github.com/silexlabs/Silex.git`
