...
shortcut:[[goog.events.KeyCodes.V,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"CSS styles editor",id:"view.open.cssEditor",className:"menu-item-view-open-cssEditor",globalKey:goog.events.KeyCodes.D,shortcut:[[goog.events.KeyCodes.D,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"D",mnemonic:goog.events.KeyCodes.D,accelerator:"d"},{label:"Open file browser",id:"view.open.fileExplorer",
className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",globalKey:goog.events.KeyCodes.T,shortcut:[[goog.events.KeyCodes.T,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"T",mnemonic:goog.events.KeyCodes.T,accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",globalKey:goog.events.KeyCodes.I,shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+
"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",globalKey:goog.events.KeyCodes.C,shortcut:[[goog.events.KeyCodes.C,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"C",mnemonic:goog.events.KeyCodes.C,accelerator:"c"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html",globalKey:goog.events.KeyCodes.H,shortcut:[[goog.events.KeyCodes.H,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],
tooltip:altKeyDisplay+"H",mnemonic:goog.events.KeyCodes.H,accelerator:"h"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},
{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",
...
silex.controller.ControllerBase.prototype.openFile=function(c,d){this.tracker.trackAction("controller-events","request","file.open",0);this.view.fileExplorer.openDialog(goog.bind(function(e){this.model.file.open(e,goog.bind(function(d){console.log(e,silex.utils.Url.getBaseUrl(e));d=silex.utils.Url.relative2absolute(d,silex.utils.Url.getBaseUrl(e));this.model.file.setHtml(d);this.fileOperationSuccess(this.model.head.getTitle()+" opened.",!0);silex.utils.RetroCompat.process(this.model.body.bodyElement,
this.model.head.headElement);this.tracker.trackAction("controller-events","success","file.open",1);c&&c()},this),goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to open this file. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)},this))},this),{mimetype:"text/html"},function(c){this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)})};
silex.controller.ControllerBase.prototype.doSave=function(c,d,e){var f=silex.utils.Url.getBaseUrl(c),h=this.model.file.getHtml(),h=silex.utils.Url.absolute2Relative(h,f);this.model.file.saveAs(c,h,goog.bind(function(){this.tracker.trackAction("controller-events","success","file.save",1);this.fileOperationSuccess("File is saved.",!1);d&&d()},this),goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to save the file. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events",
"error","file.save",-1);e&&e(c)},this))};silex.controller.ControllerBase.prototype.save=function(c,d,e){console.log(this.model.file.getUrl());this.tracker.trackAction("controller-events","request","file.save",0);c?this.doSave(c,d,e):this.view.fileExplorer.saveAsDialog(goog.bind(function(c){this.doSave(c,d,e)},this),{mimetype:"text/html"})};
...
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(d=e.indexOf(">",f),d=c.substring(d+1,h));-1<k&&-1<l&&e.indexOf(">",k);c=c.substring(k,l+7);silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);this.bodyElement.innerHTML=c;e=c.indexOf('"');h=c.indexOf('"',e+1);e=c.substring(e+1,h);h=silex.utils.Url.relative2absolute(e,
this.getUrl());console.log(c,e);this.bodyElement.setAttribute("style",h);silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);this.headElement.innerHTML=d};
silex.model.File.prototype.getHtml=function(){silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);var c=this.bodyElement.innerHTML;silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);var d=this.bodyElement.getAttribute("style")||"",e;e="<html>"+("<head>"+this.headElement.innerHTML+"</head>");e+='<body style="'+d+'">'+c+"</body>";return e+="</html>"};silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
...
silex.model.File.prototype.open=function(c,d,e){silex.service.CloudStorage.getInstance().load(c,goog.bind(function(e){this.close();this.setUrl(c);d&&d(e)},this),e)};silex.model.File.prototype.close=function(){this.url=null};silex.model.File.prototype.getUrl=function(){return this.url};silex.model.File.prototype.setUrl=function(c){this.url=c};
silex.model.File.prototype.publish=function(c,d,e){this.cleanup(goog.bind(function(f,h,k){silex.service.SilexTasks.getInstance().publish(c,f,h,k,d,e)},this),goog.bind(function(c){console.error("publish cleanup error",c);e&&e(c)},this))};
silex.model.File.prototype.cleanup=function(c,d){var e=goog.dom.getOuterHtml(this.bodyElement);e.replace("<div","<body");e.replace(/<\/div$/,"</body");var f=this.headElement.innerHTML,h=[],k=[];if(this.getUrl()){var l=silex.utils.Url.getBaseUrl(this.getUrl()),e=e.replace(/<img[^"]*src="?([^" ]*)"/g,function(c,d,e){e=silex.utils.Url.getAbsolutePath(d,l);var f=silex.utils.Url.getRelativePath(e,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="assets/"+e.substr(e.lastIndexOf("/")+
1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,h)}),e=e.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(c,d,e){return this.filterBgImage(l,k,c,d,e)},this)),f=f.replace(/href="?([^" ]*)"/g,function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,l);var h=silex.utils.Url.getRelativePath(e,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="css/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,
destPath:f,srcPath:h}),c.replace(d,f))}),f=f.replace(/src="?([^"]*)"/g,function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,l);var h=silex.utils.Url.getRelativePath(e,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="js/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),m=goog.dom.createElement("div");m.innerHTML=e;e=goog.dom.createElement("div");e.innerHTML=
f;$('meta[name="publicationPath"]',e).remove();f=goog.dom.getElementsByClass("editable-style",m);goog.array.forEach(f,function(c){var d=c.getAttribute("data-silex-href");d&&(c.setAttribute("href",d),c.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,c),goog.dom.removeNode(c))},this);var f=goog.dom.getElementsByClass("editable-style",m),n=0;goog.array.forEach(f,function(c){var d=
"silex-"+c.getAttribute(silex.model.Element.TYPE_ATTR);goog.dom.classes.add(c,d);d="element-"+n++;goog.dom.classes.add(c,d);var e=c.getAttribute("style");h.push({classNames:["."+d],styles:e});goog.dom.classes.remove(c,"editable-style");c.removeAttribute("data-silex-type");c.removeAttribute("style")},this);var p="";goog.array.forEach(h,function(c){var d="";goog.array.forEach(c.classNames,function(c){""!=d&&(d+=", ");d+=c},this);d+="{\n\t"+silex.utils.Style.styleToString(c.styles)+"\n}";p+="\n"+d},
this);p.replace("; ",";\n\t");e="<html>"+('<head><link href="css/styles.css" rel="stylesheet">'+e.innerHTML+"</head>");e+="<body>"+m.innerHTML+"</body>";e+="</html>";c(e,p,k)}else d&&d({message:"The file must be saved before I can clean it up for you."})};
...
f=new silex.view.Menu(e,c,d),h=goog.dom.getElementByClass("silex-stage"),k=new silex.view.Stage(h,c,d),l=goog.dom.getElementByClass("silex-page-tool"),m=new silex.view.PageTool(l,c,d),n=goog.dom.getElementByClass("silex-html-editor"),p=new silex.view.HTMLEditor(n,c,d),q=goog.dom.getElementByClass("silex-css-editor"),s=new silex.view.CssEditor(q,c,d),t=goog.dom.getElementByClass("silex-texteditor"),u=new silex.view.TextEditor(t,c,d),v=goog.dom.getElementByClass("silex-fileexplorer"),y=new silex.view.FileExplorer(v,
c,d),w=goog.dom.getElementByClass("silex-settings-dialog"),z=new silex.view.SettingsDialog(w,c,d),x=goog.dom.getElementByClass("silex-property-tool"),A=new silex.view.PropertyTool(x,c,d),B=goog.dom.getElementByClass("silex-workspace"),e=new silex.view.Workspace(B,e,h,l,x,n,q,t,v,w),c=new silex.types.Model(new silex.model.File(c,d),new silex.model.Head(c,d),new silex.model.Body(c,d),new silex.model.Element(c,d)),f=new silex.types.View(e,f,k,m,A,p,s,u,y,z),k=new silex.types.Controller(new silex.controller.MenuController(c,
f),new silex.controller.StageController(c,f),new silex.controller.PageToolController(c,f),new silex.controller.PropertyToolController(c,f),new silex.controller.SettingsDialogController(c,f),new silex.controller.HtmlEditorController(c,f),new silex.controller.CssEditorController(c,f),new silex.controller.TextEditorController(c,f));k.menuController.menuCallback("file.new");silex.Config.debug.debugMode&&silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(c,f,k)};
