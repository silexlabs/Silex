...
silex.controller.ControllerBase.prototype.browseAndAddImage=function(){this.tracker.trackAction("controller-events","request","insert.image",0);this.view.fileExplorer.openDialog(goog.bind(function(c){var d=this.addElement(silex.model.Element.TYPE_IMAGE);this.model.element.setImageUrl(d,c,goog.bind(function(c,d){goog.style.setStyle(c,{width:d.naturalWidth+"px",height:d.naturalHeight+"px"});this.tracker.trackAction("controller-events","success","insert.image",1)},this),goog.bind(function(c,d){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+
d);this.removeElement(c);this.tracker.trackAction("controller-events","error","insert.image",1)},this))},this),{mimetype:"image/*"},goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","insert.image",-1)},this));this.view.workspace.invalidate()};
...
silex.controller.ControllerBase.prototype.editElement=function(c){c||(c=this.view.stage.getSelection()[0]);switch(this.model.element.getType(c)){case silex.model.Element.TYPE_TEXT:this.view.textEditor.openEditor(this.model.element.getInnerHtml(c));break;case silex.model.Element.TYPE_HTML:this.view.htmlEditor.openEditor(this.model.element.getInnerHtml(c));break;case silex.model.Element.TYPE_IMAGE:this.view.fileExplorer.openDialog(goog.bind(function(d){this.model.element.setImageUrl(c,d)},this),{mimetype:"image/*"},
goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""))},this)),this.view.workspace.invalidate()}};silex.controller.ControllerBase.prototype.openPage=function(c){silex.utils.PageablePlugin.setCurrentPage(c);this.view.pageTool.redraw()};
...
$(c).find("[aria-disabled]").removeAttr("aria-disabled"),$(c).find(".ui-resizable-handle").remove())};silex.utils.EditablePlugin.setEditableHtml=function(c,d,e){silex.utils.EditablePlugin.setEditable(c,!1,e);c.innerHTML=d;silex.utils.EditablePlugin.setEditable(c,!0,e)};silex.utils.EditablePlugin.getEditableHtml=function(c,d){silex.utils.EditablePlugin.setEditable(c,!1,d);var e=c.cloneNode(!0);silex.utils.EditablePlugin.setEditable(c,!0,d);return e.innerHTML};silex.view.Stage=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initEvents()};goog.inherits(silex.view.Stage,silex.view.ViewBase);
...
silex.controller.PropertyToolController.prototype.propertyToolCallback=function(c,d,e){switch(c){case "editHTML":this.editElement();break;case "editText":this.editElement();break;case "selectBgImage":this.view.fileExplorer.openDialog(goog.bind(function(d){var e=this.view.stage.getSelection()[0];this.model.element.setBgImage(e,d);this.view.propertyTool.redraw();this.tracker.trackAction("controller-events","success",c,1)},this),{mimetype:"image/*"},goog.bind(function(d){silex.utils.Notification.notifyError("Error: I could not load the image. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "selectImage":this.editElement();break;case "styleChanged":this.styleChanged(d,e);break;case "classNameChanged":this.setClassName(d);break;case "propertyChanged":this.propertyChanged(d,e);break;case "addToPage":silex.utils.PageablePlugin.addToPage(this.view.stage.getSelection()[0],d);break;case "removeFromPage":silex.utils.PageablePlugin.removeFromPage(this.view.stage.getSelection()[0],
d);break;case "addLink":silex.utils.PageablePlugin.setLink(this.view.stage.getSelection()[0],d);break;case "removeLink":silex.utils.PageablePlugin.setLink(this.view.stage.getSelection()[0])}};silex.controller.MenuController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.menu.onStatus=goog.bind(this.menuCallback,this)};goog.inherits(silex.controller.MenuController,silex.controller.ControllerBase);
...
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(f=e.indexOf(">",f),d=c.substring(f+1,h));-1<k&&-1<l&&(f=e.indexOf(">",k),c.substring(f+1,l));c=c.substring(k,l+7);silex.utils.EditablePlugin.setEditableHtml(this.bodyElement,c);this.headElement.innerHTML=d};
silex.model.File.prototype.getHtml=function(){var c=this.bodyElement.getAttribute("style")||"",d=silex.utils.EditablePlugin.getEditableHtml(this.bodyElement),e;e="<html>"+("<head>"+this.headElement.innerHTML+"</head>");e+='<body style="'+c+'">'+d+"</body>";return e+="</html>"};silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
