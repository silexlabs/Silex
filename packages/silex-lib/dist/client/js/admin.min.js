...
silex.view.propertiesTool.PagePane.prototype.onLinkChanged=function(){if("none"===this.linkDropdown.value)this.component.removeLink();else if("custom"===this.linkDropdown.value){var c=this.linkInputTextField.getCleanContents();0===c.indexOf("#")&&(c="");""===c&&(c="http://www.silex.me/");this.component.setLink(c)}else this.component.setLink("#"+this.linkDropdown.value);this.pageChanged();this.redraw()};
silex.view.propertiesTool.PagePane.prototype.onLinkTextChanged=function(){this.component.setLink(this.linkInputTextField.getCleanContents());this.pageChanged()};
...
c.substr(1):(this.linkInputTextField.setHtml(!1,c),this.linkDropdown.value="custom"):this.linkDropdown.value="none";c=goog.dom.getElementByClass("link-input-text",this.element);"custom"===this.linkDropdown.value?goog.style.setStyle(c,"display","inherit"):goog.style.setStyle(c,"display","none");this.isRedraw=!1}};silex.view.propertiesTool.PagePane.prototype.checkPage=function(c,d){d.isChecked()?c.addComponent(this.component):c.removeComponent(this.component);this.pageChanged();this.redraw()};
