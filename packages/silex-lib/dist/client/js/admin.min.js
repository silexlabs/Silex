...
!1},!1,this);goog.events.listen(this.element,"resize",function(c){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1},!1,this);goog.events.listen(this.element,"newContainer",function(c){console.log("newContainer");if(this.onStatus)this.onStatus("newContainer")},!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(c){if(this.onStatus)this.onStatus("edit")},!1,this);var c=new goog.events.MouseWheelHandler(this.element);goog.events.listen(c,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,
...
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "selectImage":this.editElement();break;case "styleChanged":this.styleChanged(d,e);break;case "classNameChanged":this.setClassName(d);break;case "propertyChanged":console.error("not implemented");break;case "addToPage":silex.utils.PageablePlugin.addToPage(this.view.stage.getSelection()[0],d);break;case "removeFromPage":silex.utils.PageablePlugin.removeFromPage(this.view.stage.getSelection()[0],
...
silex.view.pane.PaneBase.prototype.editText=function(){if(this.onStatus)this.onStatus("editText")};silex.view.pane.PaneBase.prototype.styleChanged=function(c,d){if(this.onStatus)this.onStatus("styleChanged",c,d)};silex.view.pane.PaneBase.prototype.propertyChanged=function(){if(this.onStatus)this.onStatus("propertyChanged")};silex.view.pane.PaneBase.prototype.redraw=function(){};silex.view.pane.PaneBase.prototype.getBaseUrl=function(){return this.baseUrl};
silex.view.pane.PaneBase.prototype.setBaseUrl=function(c){this.baseUrl=c;this.redraw()};silex.view.pane.PropertyPane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.PropertyPane,silex.view.pane.PaneBase);
...
silex.view.pane.BgPane.prototype.setColorPaletteVisibility=function(c){c?this.getColorPaletteVisibility()||(goog.style.setStyle(this.hsvPalette.getElement(),"visibility",null),goog.style.setStyle(this.hsvPalette.getElement(),"position",null)):this.getColorPaletteVisibility()&&(goog.style.setStyle(this.hsvPalette.getElement(),"visibility","hidden"),goog.style.setStyle(this.hsvPalette.getElement(),"position","absolute"))};silex.view.pane.StylePane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.StylePane,silex.view.pane.PaneBase);silex.view.pane.StylePane.prototype.buildUi=function(){this.cssClassesInput=goog.dom.getElementByClass("style-css-classes-input");goog.events.listen(this.cssClassesInput,"change",this.onInputChanged,!1,this)};
silex.view.pane.StylePane.prototype.redraw=function(){silex.view.pane.StylePane.superClass_.redraw.call(this);var c=this.getSelection()[0];c&&(this.cssClassesInput.value=silex.utils.Style.getClassName(c))};silex.view.pane.StylePane.prototype.onInputChanged=function(c){if(this.onStatus)this.onStatus("classNameChanged",this.cssClassesInput.value)};silex.view.pane.GeneralStylePane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.GeneralStylePane,silex.view.pane.PaneBase);silex.view.pane.GeneralStylePane.prototype.buildUi=function(){this.opacityInput=goog.dom.getElementByClass("opacity-input");goog.events.listen(this.opacityInput,"change",this.onInputChanged,!1,this)};
...
this.element),this.bodyElement,this.headElement);this.propertyPane.onStatus=c;this.pagePane=new silex.view.pane.PagePane(goog.dom.getElementByClass("page-editor",this.element),this.bodyElement,this.headElement);this.pagePane.onStatus=c;this.generalStylePane=new silex.view.pane.GeneralStylePane(goog.dom.getElementByClass("general-editor",this.element),this.bodyElement,this.headElement);this.generalStylePane.onStatus=c;this.stylePane=new silex.view.pane.StylePane(goog.dom.getElementByClass("general-editor",
