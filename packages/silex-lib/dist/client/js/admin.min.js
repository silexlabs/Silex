...
accelerator:"s"},{label:"Save As...",id:"file.saveas",className:"menu-item-file-saveas",globalKey:goog.events.KeyCodes.S,shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META+goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT]],tooltip:ctrlKeyDisplay+"\u21e7S"},null,{label:"Publish",id:"file.publish",className:"menu-item-file-publish",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"P",
mnemonic:goog.events.KeyCodes.P,accelerator:"p"},{label:"Settings...",id:"file.publish.settings",className:"menu-item-file-publish-settings"},null,{label:"Close File",id:"file.close",className:"menu-item-file-close",globalKey:goog.events.KeyCodes.W,shortcut:[[goog.events.KeyCodes.W,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"w",mnemonic:goog.events.KeyCodes.W,accelerator:"w"}],[{label:"Delete selection",id:"edit.delete.selection",className:"menu-item-edit-delete-selection",
...
silex.view.Menu.prototype.getWebsiteName=function(){return goog.dom.getElementByClass("website-name").innerHTML};silex.controller={};silex.controller.ControllerBase=function(c,d){this.model=c;this.view=d;this.tracker=silex.service.Tracker.getInstance()};silex.controller.ControllerBase.prototype.removeElement=function(c){c||(c=this.view.stage.getSelection()[0]);this.model.element.removeElement(c);this.view.propertyTool.refresh()};
silex.controller.ControllerBase.prototype.addElement=function(c){c=this.model.element.createElement(c,this.bodyElement);var d=silex.utils.JQueryPageable.getCurrentPage(this.bodyElement);silex.utils.JQueryPageable.addToPage(c,d);this.checkElementVisibility(c);this.model.element.setSelected(c);this.view.propertyTool.refresh();return c};
silex.controller.ControllerBase.prototype.editElement=function(c){c||(c=this.view.stage.getSelection()[0]);switch(this.model.element.getType(c)){case silex.model.Component.SUBTYPE_TEXT:this.view.textEditor.openEditor(this.model.Element.getInnerHtml(c));break;case silex.model.Component.SUBTYPE_HTML:this.view.htmlEditor.openEditor(this.model.Element.getInnerHtml(c));break;case silex.model.Component.SUBTYPE_IMAGE:this.view.fileExplorer.openDialog(goog.bind(function(c){this.view.propertyTool.setImage(c)},
this),["image/*","text/plain"],goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""))},this)),this.app.workspace.invalidate()}};silex.controller.ControllerBase.prototype.openPage=function(c){silex.utils.JQueryPageable.setCurrentPage(this.bodyElement,c);this.view.pageTool.refresh()};
silex.controller.ControllerBase.prototype.renamePage=function(c){c||(c=silex.utils.JQueryPageable.getCurrentPage(this.bodyElement));this.getUserInputPageName(page.displayName,goog.bind(function(d,e){e&&(silex.utils.JQueryPageable.renamePage(this.bodyElement,c,d,e),this.openPage(silex.utils.JQueryPageable.getPageByName(this.bodyElement,d)))},this))};
silex.controller.ControllerBase.prototype.removePage=function(c){c||(c=silex.utils.JQueryPageable.getCurrentPage(this.bodyElement));silex.utils.Notification.confirm('I am about to delete the page "'+c.displayName+'", are you sure?',function(d){d&&(silex.utils.JQueryPageable.removePage(c),this.view.pageTool.refresh(),this.view.propertyTool.refresh())})};
silex.controller.ControllerBase.prototype.getUserInputPageName=function(c,d){silex.utils.Notification.prompt("Enter a name for your page!",function(c,f){if(c&&f&&0<f.length){var h=f;f=f.replace(/\ /g,"-").replace(/\./g,"-").replace(/'/g,"-").replace(/"/g,"-").toLowerCase();var k=silex.model.Page.getPages(),l=null;goog.array.forEach(k,function(c){c.name===f&&(l=c)});l?l.open():d(f,h)}d(null)},c)};
silex.controller.ControllerBase.prototype.checkElementVisibility=function(c){if(null!==silex.utils.JQueryEditable.getParentPage(c)){var d=silex.view.JQueryPageable.getPages(this.rootPageable);for(idx in d)silex.view.JQueryPageable.removeFromPage(c,d[idx]);this.view.propertyTool.redraw()}};
silex.controller.ControllerBase.prototype.createPage=function(c,d){this.getUserInputPageName("Your new page name",goog.bind(function(e,f){if(e){var h=silex.utils.JQueryPageable.createPage(this.bodyElement,e,f);this.openPage(h);this.tracker.trackAction("controller-events","success",event.type,0);c&&c()}else this.tracker.trackAction("controller-events","cancel",event.type,0),d&&d()},this))};
silex.controller.ControllerBase.prototype.view=function(){this.model.file.getUrl()?window.open(this.model.file.getUrl()):silex.utils.Notification.confirm("Save your file before preview?",goog.bind(function(c){c&&this.save(null,goog.bind(function(){window.open(this.model.file.getUrl())},this))},this))};
...
silex.controller.ControllerBase.prototype.save=function(c,d,e){c?this.app.file.save(c,goog.bind(function(){this.fileOperationSuccess("File is saved.",!1);d&&d()},this),goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to save the file. <br /><br />"+(c.message||""));e&&e(c);this.tracker.trackAction("controller-events","error",event.type,-1)},this)):this.fileExplorer.saveAsDialog(goog.bind(function(c){this.app.file.saveAs(c,goog.bind(function(){this.fileOperationSuccess("File is saved.",
...
silex.controller.MenuController.prototype.menuCallback=function(c){this.tracker.trackAction("controller-events","request",c,0);switch(c){case "title.changed":this.promptTitle();break;case "file.new":this.model.file.newFile();break;case "file.saveas":this.save();break;case "file.publish.settings":this.view.settingsDialog.openDialog();this.view.workspace.invalidate();break;case "file.publish":this.publish();break;case "file.save":this.save(this.model.file.getUrl());break;case "file.open":this.openFile();
break;case "file.close":this.model.file.newFile();break;case "view.file":this.model.file.view();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "view.open.fileExplorer":this.model.fileExplorer.openDialog();this.view.workspace.invalidate();
break;case "view.open.editor":this.editComponent();break;case "insert.page":this.createPage();break;case "insert.text":this.addElement(silex.model.Element.TYPE_TEXT);break;case "insert.html":this.addElement(silex.model.Element.TYPE_IMAGE);break;case "insert.image":this.model.fileExplorer.openDialog(goog.bind(function(d){var e=this.addElement(silex.model.Element.TYPE_IMAGE);this.model.element.setImageUrl(e,d,goog.bind(function(d){this.view.workspace.invalidate();this.tracker.trackAction("controller-events",
...
silex.view.FileExplorer.prototype.openDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d.url)},10,this)).start()};this.filePicker.pick(goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");if(f&&!1===silex.Helper.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+1);silex.utils.Notification.confirm("The file name "+
...
silex.view.FileExplorer.prototype.saveAsDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d.url)},10,this)).start()};this.filePicker.exportFile("http://google.com/",d,goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");if(f&&!1===silex.Helper.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+
...
silex.model.Head.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};silex.model.Head.prototype.getTitle=function(){var c=this.stage.headElement.getElementsByTagName("title");return c&&0<c.length?c[0].innerHTML:null};
silex.model.Head.prototype.setTitle=function(c){var d=this.stage.headElement.getElementsByTagName("title");d&&0<d.length?d[0].innerHTML=c:(d=goog.dom.createElement("title"),d.innerHTML=c,this.stage.headElement.appendChild(d));this.menu.setWebsiteName(c)};silex.view.pane={};silex.view.pane.PaneBase=function(c,d,e){silex.view.ViewBase.call(this,c,e,d)};goog.inherits(silex.view.pane.PaneBase,silex.view.ViewBase);silex.view.pane.PaneBase.prototype.selectBgImage=function(){if(this.onStatus)this.onStatus("selectBgImage")};silex.view.pane.PaneBase.prototype.selectImage=function(){if(this.onStatus)this.onStatus("selectImage")};silex.view.pane.PaneBase.prototype.editHTML=function(){if(this.onStatus)this.onStatus("editHTML")};
...
silex.view.pane.PropertyPane.prototype.redraw=function(){silex.view.pane.PropertyPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){var d=c.getAttribute(silex.model.Element.TYPE_ATTR),e=null;d===silex.model.Element.SUBTYPE_IMAGE&&(e=this.baseUrl?silex.utils.Style.getRelativePath(c.getAttribute("src"),this.baseUrl):this.component.getImageSrc());var f=goog.dom.getElementByClass("edition-container",this.element);if(this.element){var h=goog.dom.getElementByClass("edition-template",
this.element).innerHTML;silex.utils.Dom.resolveTemplate(f,h,{htmlEditor:d===silex.model.Element.SUBTYPE_HTML,textEditor:d===silex.model.Element.SUBTYPE_TEXT,imageUrl:e});if(e=goog.dom.getElementByClass("html-editor-button",f))h=new goog.ui.CustomButton,h.decorate(e),goog.events.listen(e,goog.events.EventType.CLICK,this.editHTML,!1);if(e=goog.dom.getElementByClass("text-editor-button",f))h=new goog.ui.CustomButton,h.decorate(e),goog.events.listen(e,goog.events.EventType.CLICK,this.editText,!1);if(d===
silex.model.Element.SUBTYPE_IMAGE){if(e=goog.dom.getElementByClass("image-url-button",f))h=new goog.ui.CustomButton,h.decorate(e),goog.events.listen(e,goog.events.EventType.CLICK,this.selectImage,!1);var k=goog.dom.getElementByClass("image-url-input",f);k&&goog.events.listen(k,"change",function(){this.component&&!this.isRedraw&&d===silex.model.Element.SUBTYPE_IMAGE&&this.setImage(k.value)},!1,this)}goog.dom.classes.has(c,"editable-style")?(this.leftInput.value=void 0!==c.style.left?c.style.left.substr(0,
c.style.left.indexOf("px")):"",this.widthInput.value=void 0!==c.style.width?c.style.width.substr(0,c.style.width.indexOf("px")):"",this.bottomInput.value=void 0!==c.style.bottom?c.style.bottom.substr(0,c.style.bottom.indexOf("px")):"",this.topInput.value=void 0!==c.style.top?c.style.top.substr(0,c.style.top.indexOf("px")):"",this.heightInput.value=void 0!==c.style.height?c.style.height.substr(0,c.style.height.indexOf("px")):"",this.rightInput.value=void 0!==c.style.right?c.style.right.substr(0,c.style.right.indexOf("px")):
"",this.zIndexInput.value=void 0!==c.style.zIndex?c.style.zIndex:""):(this.leftInput.value="",this.widthInput.value="",this.bottomInput.value="",this.topInput.value="",this.heightInput.value="",this.rightInput.value="",this.zIndexInput.value="")}else f&&(f.innerHTML="");this.isRedraw=!1}};goog.editor={};goog.editor.defines={};goog.editor.defines.USE_CONTENTEDITABLE_IN_FIREFOX_3=!1;goog.userAgent.product.determineVersion_=function(){if(goog.userAgent.product.FIREFOX)return goog.userAgent.product.getFirstRegExpGroup_(/Firefox\/([0-9.]+)/);if(goog.userAgent.product.IE||goog.userAgent.product.OPERA)return goog.userAgent.VERSION;if(goog.userAgent.product.CHROME)return goog.userAgent.product.getFirstRegExpGroup_(/Chrome\/([0-9.]+)/);if(goog.userAgent.product.SAFARI)return goog.userAgent.product.getFirstRegExpGroup_(/Version\/([0-9.]+)/);if(goog.userAgent.product.IPHONE||goog.userAgent.product.IPAD){var c=
...
silex.view.pane.PagePane.prototype.onLinkChanged=function(){if("none"===this.linkDropdown.value)this.component.removeLink(),this.redraw();else if("custom"===this.linkDropdown.value){this.linkInputTextField.setValue("");var c=goog.dom.getElementByClass("link-input-text",this.element);goog.style.setStyle(c,"display","inherit")}else this.component.setLink("#"+this.linkDropdown.value),this.redraw();this.pageChanged()};
silex.view.pane.PagePane.prototype.onLinkTextChanged=function(){console.log("xxx");this.component.setLink(this.linkInputTextField.getValue());this.pageChanged()};
silex.view.pane.PagePane.prototype.redraw=function(){silex.view.pane.PagePane.superClass_.redraw.call(this);if(this.getSelection()[0]){goog.array.forEach(this.pageCheckboxes,function(c){if(this.component){var e=c.page.name;c.checkbox.setEnabled(!0);c.checkbox.setChecked(goog.dom.classes.has(this.component.element,e))}else c.checkbox.setChecked(!1),c.checkbox.setEnabled(!1)},this);var c=this.component.getLink();c?0===c.indexOf("#")&&silex.model.Page.getPageByName(c.substr(1))?this.linkDropdown.value=
c.substr(1):(this.linkInputTextField.setValue(c),this.linkDropdown.value="custom"):(this.linkDropdown.value="none",this.linkInputTextField.setValue(""));c=goog.dom.getElementByClass("link-input-text",this.element);"custom"===this.linkDropdown.value?goog.style.setStyle(c,"display","inherit"):goog.style.setStyle(c,"display","none");this.isRedraw=!1}};
silex.view.pane.PagePane.prototype.checkPage=function(c,d){d.isChecked()?c.addComponent(this.component):c.removeComponent(this.component);this.pageChanged();this.redraw()};silex.view.pane.PagePane.prototype.unCheckAll=function(){goog.array.forEach(this.pages,function(c){c.removeComponent(this.component)},this);this.pageChanged();this.redraw()};silex.utils.Style={};silex.utils.Style.styleToString=function(c){var d="";goog.object.forEach(c,function(c,f,h){c&&(d+=goog.string.toSelectorCase(f)+": "+c+"; ")});return d};silex.utils.Style.stringToStyle=function(c){return goog.style.parseStyleAttribute(c)};
...
!1),this.getFieldObject().dispatchSelectionChangeEvent()),c.preventDefault(),!0)};silex.view.TextEditor=function(c,d,e){silex.view.ViewBase.call(this,c,e,d);this.initUI();this.closeEditor();c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};goog.inherits(silex.view.TextEditor,silex.view.ViewBase);
...
silex.model.Body.prototype.filterBgImage=function(c,d,e,f,h){c=silex.utils.Url.getAbsolutePath(h,c);e=silex.utils.Url.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(e)||(e=e.replace("../","/"));f="assets/"+c.substr(c.lastIndexOf("/")+1);h="url('../"+f+"')";d.push({url:c,destPath:f,srcPath:e});return h};silex.App=function(){silex.service.Tracker.getInstance().trackAction("app-events","start",null,2);"silex"===window.location.href.slice(-5)&&(window.location.href+="/");window.location.hash="";if(!silex.Config.debug.debugMode||silex.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure you want to leave me?"};var c=goog.dom.getElementByClass("silex-stage-body"),d=goog.dom.createElement("div"),e=goog.dom.getElementByClass("silex-menu"),f=new silex.view.Menu(e),h=goog.dom.getElementByClass("silex-stage"),
k=new silex.view.Stage(h,c,d),l=goog.dom.getElementByClass("silex-pagetool"),m=new silex.view.PageTool(l,c,d),n=goog.dom.getElementByClass("silex-htmleditor"),p=new silex.view.HTMLEditor(n,c,d),q=goog.dom.getElementByClass("silex-texteditor"),s=new silex.view.TextEditor(q,c,d),t=goog.dom.getElementByClass("silex-fileexplorer"),u=new silex.view.FileExplorer(t,c,d),v=goog.dom.getElementByClass("silex-settings-dialog"),x=new silex.view.SettingsDialog(v,c,d),w=goog.dom.getElementByClass("silex-propertyTool"),
y=new silex.view.PropertyTool(w,c,d),z=goog.dom.getElementByClass("silex-workspace"),e=new silex.view.Workspace(z,e,h,l,w,n,q,t,v),c=new silex.types.Model(new silex.model.File(c,d),new silex.model.Head(d),new silex.model.Body(c),new silex.model.Element),f=new silex.types.View(e,f,k,m,y,p,s,u,x);new silex.types.Controller(new silex.controller.MenuController(c,f),new silex.controller.StageController(c,f),new silex.controller.PageToolController(c,f),new silex.controller.PropertyToolController(c,f),new silex.controller.SettingsDialogController(c,
f),new silex.controller.HtmlEditorController(c,f),new silex.controller.TextEditorController(c,f));c.file.newFile(function(){silex.Config.debug.debugMode&&silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(this)})};goog.exportSymbol("silex.App",silex.App);
