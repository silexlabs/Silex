...
$("[href]",c).each(function(){var c=this.getAttribute("href");0===c.indexOf("#")&&0!==c.indexOf("#!")&&this.setAttribute("href",c.substr(2))});$("[data-silex-type]",c).each(function(){$(this).addClass(this.getAttribute("data-silex-type")+"-element")});$("[src]",d).each(function(){var c=this.getAttribute("src");this.setAttribute("src",c.replace("http://static.silex.me/2.0","http://static.silex.me/2.1"))});$("[href]",d).each(function(){var c=this.getAttribute("href");this.setAttribute("href",c.replace("http://static.silex.me/2.0",
"http://static.silex.me/2.1"))})};silex.utils.Notification=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Notification.ERROR_ICON="assets/notifications/error.png";silex.utils.Notification.SUCCESS_ICON="assets/notifications/success.png";silex.utils.Notification.INFO_ICON="assets/notifications/info.png";silex.utils.Notification.useNative=function(){return window.webkitNotifications&&0===window.webkitNotifications.checkPermission()};
...
silex.controller.ControllerBase.prototype.openFile=function(c,d){this.tracker.trackAction("controller-events","request","file.open",0);this.view.fileExplorer.openDialog(goog.bind(function(e){this.model.file.open(e,goog.bind(function(d){this.model.file.setHtml(d);this.fileOperationSuccess(this.model.head.getTitle()+" opened.",!0);silex.utils.RetroCompat.process(this.model.body.bodyElement,this.model.head.headElement);this.tracker.trackAction("controller-events","success","file.open",1);c&&c()},this),
...
silex.controller.ControllerBase.prototype.fileOperationSuccess=function(c,d){if(d){var e=silex.utils.PageablePlugin.getPages();silex.utils.PageablePlugin.setCurrentPage(e[0]);this.view.pageTool.redraw();this.view.propertyTool.redraw();this.view.menu.redraw();this.refreshFonts()}c&&silex.utils.Notification.notifySuccess(c);this.model.head.updateBrowserStyle()};
...
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(d=e.indexOf(">",f),d=c.substring(d+1,h));-1<k&&-1<l&&e.indexOf(">",k);c=c.substring(k,l+7);this.getUrl()&&(e=silex.utils.Url.getBaseUrl(this.getUrl()),console.log("setHtml",this.getUrl(),e),c=silex.utils.Url.relative2absolute(c,e));silex.utils.EditablePlugin.setEditable(this.bodyElement,
!1);this.bodyElement.innerHTML=c;e=c.indexOf('"');h=c.indexOf('"',e+1);c=c.substring(e+1,h);this.bodyElement.setAttribute("style",c);silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);this.headElement.innerHTML=d};
...
silex.model.File.prototype.filterBgImage=function(c,d,e,f,h){0===h.indexOf("'")&&(h=h.substr(1));h.lastIndexOf("'")===h.length-1&&(h=h.substr(0,h.length-1));var k=silex.utils.Url.getAbsolutePath(h,c),l=silex.utils.Url.getRelativePath(k,silex.utils.Url.getBaseUrl());console.log(arguments,l,k);silex.utils.Url.isAbsoluteUrl(l)||(l=l.replace("../","/"));var m="assets/"+k.substr(k.lastIndexOf("/")+1),n="url('../"+m+"')";d.push({url:k,destPath:m,srcPath:l});return n};silex.App=function(){silex.service.Tracker.getInstance().trackAction("app-events","start",null,2);"silex"===window.location.href.slice(-5)&&(window.location.href+="/");window.location.hash="";if(!silex.Config.debug.debugMode||silex.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure you want to leave me?"};var c=goog.dom.getElementByClass("silex-stage-body");silex.utils.PageablePlugin.setBodyElement(c);var d=goog.dom.createElement("div"),e=goog.dom.getElementByClass("silex-menu"),
