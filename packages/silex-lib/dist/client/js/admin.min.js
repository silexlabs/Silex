...
silex.controller.ControllerBase.prototype.openFile=function(c,d){this.tracker.trackAction("controller-events","request","file.open",0);this.view.fileExplorer.openDialog(goog.bind(function(e){this.model.file.open(e,goog.bind(function(d){d=silex.utils.Url.relative2absolute(d,silex.utils.Url.getBaseUrl(e));this.model.file.setHtml(d);this.fileOperationSuccess(this.model.head.getTitle()+" opened.",!0);silex.utils.RetroCompat.process(this.model.body.bodyElement,this.model.head.headElement);this.tracker.trackAction("controller-events",
"success","file.open",1);c&&c()},this),goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to open this file. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)},this))},this),{mimetype:"text/html"},function(c){this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)})};
...
"error","file.save",-1);e&&e(c)},this))};silex.controller.ControllerBase.prototype.save=function(c,d,e){this.tracker.trackAction("controller-events","request","file.save",0);c?this.doSave(c,d,e):this.view.fileExplorer.saveAsDialog(goog.bind(function(c){this.doSave(c,d,e)},this),{mimetype:"text/html"})};
