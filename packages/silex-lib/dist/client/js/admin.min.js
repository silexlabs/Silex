...
shortcut:[[goog.events.KeyCodes.DELETE],[goog.events.KeyCodes.BACKSPACE]],tooltip:"suppr",mnemonic:goog.events.KeyCodes.R,accelerator:"r"},null,{label:"Edit selection",id:"view.open.editor",className:"menu-item-view-open-textEditor",tooltip:"\u21b5"},{label:"Edit CSS styles",id:"view.open.cssEditor",className:"menu-item-view-open-cssEditor"},null,{label:"Rename page",id:"edit.rename.page",className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],
[{label:"View in new window",id:"view.file",className:"menu-item-view-file",globalKey:goog.events.KeyCodes.V,shortcut:[[goog.events.KeyCodes.V,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",globalKey:goog.events.KeyCodes.T,shortcut:[[goog.events.KeyCodes.T,
goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"T",mnemonic:goog.events.KeyCodes.T,accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",globalKey:goog.events.KeyCodes.I,shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",globalKey:goog.events.KeyCodes.C,shortcut:[[goog.events.KeyCodes.C,
goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"C",mnemonic:goog.events.KeyCodes.C,accelerator:"c"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html",globalKey:goog.events.KeyCodes.H,shortcut:[[goog.events.KeyCodes.H,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"H",mnemonic:goog.events.KeyCodes.H,accelerator:"h"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,
goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,
{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",className:"menu-item-help-forkMe"}]]};
...
silex.model.Element.prototype.createElement=function(c){var d,e={height:"100px",width:"100px",top:100+this.bodyElement.scrollTop+"px",left:100+this.bodyElement.scrollLeft+"px",position:"absolute"};switch(c){case silex.model.Element.TYPE_CONTAINER:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);e.backgroundColor="white";break;case silex.model.Element.TYPE_TEXT:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,
silex.model.Element.TYPE_TEXT);var f=goog.dom.createElement("div");f.innerHTML="<p>New text box</p>";goog.style.setStyle(f,"width","100%");goog.style.setStyle(f,"height","100%");goog.dom.appendChild(d,f);goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);e.backgroundColor="white";break;case silex.model.Element.TYPE_HTML:d=goog.dom.createElement("div");d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME;d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);
f=goog.dom.createElement("div");f.innerHTML="<p>New HTML box</p>";goog.style.setStyle(f,"width","100%");goog.style.setStyle(f,"height","100%");goog.dom.appendChild(d,f);goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);e.backgroundColor="white";break;case silex.model.Element.TYPE_IMAGE:d=goog.dom.createElement("div"),d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE)}goog.dom.classes.add(d,silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);
...
silex.view.TextEditor.prototype.openEditor=function(c){this.textField.setHtml(!1,c);this.textField.focusAndPlaceCursorAtStart();c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","inherit");this.redraw()};
...
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(f=e.indexOf(">",f),d=c.substring(f+1,h));-1<k&&-1<l&&(f=e.indexOf(">",k),c.substring(f+1,l));c=c.substring(k,l+7);silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);this.bodyElement.innerHTML=c;silex.utils.EditablePlugin.setEditable(this.bodyElement,
!0);this.headElement.innerHTML=d};silex.model.File.prototype.getHtml=function(){silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);var c=this.bodyElement.innerHTML;silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);var d=this.bodyElement.getAttribute("style")||"",e;e="<html>"+("<head>"+this.headElement.innerHTML+"</head>");e+='<body style="'+d+'">'+c+"</body>";return e+="</html>"};
