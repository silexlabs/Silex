...
silex.model.Element.prototype.setImageUrl=function(c,d,e,f){if(c.getAttribute(silex.model.Element.TYPE_ATTR)===silex.model.Element.TYPE_IMAGE)if(this.getContentNode(c)){var h=new goog.net.ImageLoader;goog.events.listenOnce(h,goog.net.EventType.SUCCESS,function(d){goog.style.setStyle(c,{width:d.target.naturalWidth,height:d.target.naturalHeight});goog.style.setStyle(d.target,"width","100%");goog.style.setStyle(d.target,"height","100%");c.setContentNode(d.target);e&&e(c)});goog.events.listenOnce(h,goog.net.EventType.ERROR,
function(d){console.error("An error occured while loading the image.",c);f&&f(c,"An error occured while loading the image.")});h.addImage(d,d);h.start()}else console.error("The image could not be retrieved from the element.",c),f&&f(c,"The image could not be retrieved from the element.");else console.error("The element is not an image.",c),f&&f(c,"The element is not an image.")};silex.model.Element.prototype.removeElement=function(c){goog.dom.removeNode(c)};
silex.model.Element.prototype.createElement=function(c,d){var e;switch(c){case silex.model.Element.TYPE_CONTAINER:e=goog.dom.createElement("div");e.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);break;case silex.model.Element.TYPE_TEXT:e=goog.dom.createElement("div");e.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_TEXT);e.innerHTML="New text box";break;case silex.model.Element.TYPE_HTML:e=goog.dom.createElement("div");e.className=silex.utils.JQueryEditable.EDITABLE_CLASS_NAME;
e.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);var f=goog.dom.createElement("div");goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);f.innerHTML="<p>New HTML box</p>";goog.style.setStyle(f,"width","100%");goog.style.setStyle(f,"height","100%");goog.dom.appendChild(e,f);break;case silex.model.Element.TYPE_IMAGE:e=goog.dom.createElement("div"),e.className=silex.utils.JQueryEditable.EDITABLE_CLASS_NAME,e.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE),
f=goog.dom.createElement("img"),goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME),goog.style.setStyle(f,"width","100%"),goog.style.setStyle(f,"height","100%"),goog.dom.appendChild(e,f),f.setAttribute("src",silex.model.Element.LOADING_IMAGE)}goog.dom.classes.add(e,silex.utils.JQueryEditable.EDITABLE_CLASS_NAME);silex.utils.JQueryEditable.setEditable(e,!0);goog.style.setStyle(e,{height:"100px",width:"100px",backgroundColor:"rgba(255, 255, 255, 1)"});d&&goog.dom.appendChild(d,e);
return e};silex.model.Element.prototype.setSelected=function(c,d){d?(this.resetSelection(),goog.dom.classes.add(c,silex.model.Element.SELECTED_CLASS_NAME)):goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)};silex.model.Element.prototype.resetSelection=function(){var c=goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement);goog.array.forEach(c,function(c){goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)},this)};
silex.model.Element.prototype.getSelected=function(c){return goog.dom.classes.has(c,silex.model.Element.SELECTED_CLASS_NAME)};silex.view={};silex.view.ViewBase=function(c,d,e){this.element=c;this.bodyElement=d;this.headElement=e};silex.view.ViewBase.prototype.getSelection=function(){return goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement)};silex.view.Menu=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.buildMenu(c)};goog.inherits(silex.view.Menu,silex.view.ViewBase);silex.view.Menu.prototype.redraw=function(){var c=null;$('meta[name="title"]',this.headElement).each(function(){c=this.getAttribute("content")});this.setWebsiteName(c)};
...
silex.utils.JQueryPageable.setCurrentPage=function(c,d){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");$(c).pageable({currentPage:d})};
silex.utils.JQueryPageable.getDisplayName=function(c,d){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");var e="";$('a[data-silex-type="page"]',c).each(function(){this.getAttribute("id")===d&&(e=this.getAttribute("data-silex-name"))});return e};
silex.utils.JQueryPageable.removePage=function(c,d){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");$('a[data-silex-type="page"]',c).each(function(){this.getAttribute("id")===d&&$(this).remove()});$('*[data-silex-href="#!'+d+'"]').each(function(){this.removeAttribute("data-silex-href")});$("."+d).each(function(){$(this).removeClass(d);0>=silex.utils.JQueryPageable.getPagesForElement(this).length&&$(this).removeClass(silex.utils.JQueryPageable.PAGE_CLASS)})};
silex.utils.JQueryPageable.createPage=function(c,d,e){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");var f=goog.dom.createElement("a");f.setAttribute("id",d);f.setAttribute("data-silex-name",e);f.setAttribute("data-silex-type","page");f.innerHTML=e;goog.dom.appendChild(c,f)};
silex.utils.JQueryPageable.renamePage=function(c,d,e,f){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");$('a[data-silex-type="page"]',c).each(function(){this.getAttribute("id")===d&&(this.setAttribute("id",e),this.setAttribute("data-silex-name",f))});$('*[data-silex-href="#!'+d+'"]').each(function(){this.setAttribute("data-silex-href","#!"+e)});$("."+d).each(function(){$(this).removeClass(d);$(this).addClass(e)})};
silex.utils.JQueryPageable.setLink=function(c,d){url?c.setAttribute(silex.utils.JQueryPageable.LINK_ATTR,"#!"+d):c.removeAttribute(silex.utils.JQueryPageable.LINK_ATTR)};silex.utils.JQueryPageable.getLink=function(c){(c=c.getAttribute("data-silex-href"))&&0===c.indexOf("#!")&&(c=c.substring(2));return c};silex.utils.JQueryPageable.addToPage=function(c,d){goog.dom.classes.add(c,d);goog.dom.classes.add(c,silex.utils.JQueryPageable.PAGE_CLASS)};
silex.utils.JQueryPageable.removeFromPage=function(c,d){goog.dom.classes.remove(c,d);0<!silex.utils.JQueryPageable.getPagesForElement(c).length&&goog.dom.classes.remove(c,silex.utils.JQueryPageable.PAGE_CLASS)};silex.utils.JQueryPageable.getPagesForElement=function(c,d){if(!silex.utils.JQueryPageable.getPageable(c))throw Error("Operation failed, root pageable element is required.");var e=[],f=silex.view.JQueryPageable.getPages(c);for(idx in f){var h=f[idx];goog.dom.classes.has(d,h)&&e.push(h)}};silex.utils.Notification=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Notification.ERROR_ICON="assets/notifications/error.png";silex.utils.Notification.SUCCESS_ICON="assets/notifications/success.png";silex.utils.Notification.INFO_ICON="assets/notifications/info.png";silex.utils.Notification.useNative=function(){return window.webkitNotifications&&0===window.webkitNotifications.checkPermission()};
...
silex.utils.Notification.notifySuccess=function(c){console.info(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.SUCCESS_ICON);alertify.success(c)};silex.utils.Notification.notifyError=function(c){console.error(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.ERROR_ICON);alertify.error(c)};silex.utils.Notification.notifyInfo=function(c){console.info(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.INFO_ICON);alertify.log(c)};silex.controller={};silex.controller.ControllerBase=function(c,d){this.model=c;this.view=d;this.tracker=silex.service.Tracker.getInstance()};silex.controller.ControllerBase.prototype.removeElement=function(c){c||(c=this.view.stage.getSelection()[0]);this.model.element.removeElement(c);this.view.propertyTool.redraw()};
silex.controller.ControllerBase.prototype.addElement=function(c){c=this.model.element.createElement(c,this.model.body.bodyElement);var d=silex.utils.JQueryPageable.getCurrentPageName(this.model.body.bodyElement);silex.utils.JQueryPageable.addToPage(c,d);this.checkElementVisibility(c);this.model.element.setSelected(c);this.view.propertyTool.redraw();return c};
silex.controller.ControllerBase.prototype.editElement=function(c){c||(c=this.view.stage.getSelection()[0]);switch(this.model.element.getType(c)){case silex.model.Element.SUBTYPE_TEXT:this.view.textEditor.openEditor(this.model.Element.getInnerHtml(c));break;case silex.model.Element.SUBTYPE_HTML:this.view.htmlEditor.openEditor(this.model.Element.getInnerHtml(c));break;case silex.model.Element.SUBTYPE_IMAGE:this.view.fileExplorer.openDialog(goog.bind(function(c){this.view.propertyTool.setImage(c)},this),
["image/*","text/plain"],goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""))},this)),this.view.workspace.invalidate()}};silex.controller.ControllerBase.prototype.openPage=function(c){silex.utils.JQueryPageable.setCurrentPage(this.model.body.bodyElement,c);this.view.pageTool.refresh()};
silex.controller.ControllerBase.prototype.renamePage=function(c){console.log(arguments);c||(c=silex.utils.JQueryPageable.getCurrentPageName(this.model.body.bodyElement));this.getUserInputPageName(silex.utils.JQueryPageable.getDisplayName(this.model.body.bodyElement,c),goog.bind(function(d,e){e&&(silex.utils.JQueryPageable.renamePage(this.model.body.bodyElement,c,d,e),this.openPage(d))},this))};
silex.controller.ControllerBase.prototype.removePage=function(c){c||(c=silex.utils.JQueryPageable.getCurrentPage(this.model.body.bodyElement));silex.utils.Notification.confirm('I am about to delete the page "'+silex.utils.JQueryPageable.getDisplayName(c)+'", are you sure?',function(d){d&&(silex.utils.JQueryPageable.removePage(c),this.view.pageTool.refresh(),this.view.propertyTool.redraw())})};
silex.controller.ControllerBase.prototype.getUserInputPageName=function(c,d){silex.utils.Notification.prompt("Enter a name for your page!",function(c,f){if(c&&f&&0<f.length){var h=f;f=f.replace(/\ /g,"-").replace(/\./g,"-").replace(/'/g,"-").replace(/"/g,"-").toLowerCase();var k=silex.utils.JQueryPageable.getPages(),l=!1;goog.array.forEach(k,function(c){c===f&&(l=!0)});l?silex.utils.JQueryPageable.openPage(f):d(f,h)}d(null)},c)};
silex.controller.ControllerBase.prototype.checkElementVisibility=function(c){if(null!==silex.utils.JQueryPageable.getParentPage(c)){var d=silex.utils.JQueryPageable.getPagesForElement(this.rootPageable);for(idx in d)silex.utils.JQueryPageable.removeFromPage(c,d[idx]);this.view.propertyTool.redraw()}};
...
silex.controller.ControllerBase.prototype.fileOperationSuccess=function(c,d){d&&(this.view.pageTool.redraw(),this.view.propertyTool.redraw(),this.view.menu.redraw(),this.refreshFonts(),this.pageTool.setSelectedIndex(0),silex.utils.RetroCompat.process(this.model.body.bodyElement,this.model.head.headElement));silex.utils.Notification.notifySuccess(c);this.tracker.trackAction("controller-events","success",event.type,1)};
silex.controller.ControllerBase.prototype.publish=function(){this.model.head.getPublicationPath()?this.model.file.publish(goog.bind(function(c){c&&!1==c.success?(console.error("Error: I did not manage to publish the file. (1)"),silex.utils.Notification.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+(c.message||c.code||"")),this.tracker.trackAction("controller-events","error",event.type,-1)):
(silex.utils.Notification.notifySuccess("I am about to publish your site. This may take several minutes."),this.tracker.trackAction("controller-events","success",event.type,1))},this),goog.bind(function(c){console.error("Error: I did not manage to publish the file. (2)",c);silex.utils.Notification.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+c);this.tracker.trackAction("controller-events",
...
silex.utils.JQueryEditable.getFirstEditableParent=function(c){for(var d=c;d&&d.getAttribute&&!$(d).hasClass("editable-style");)d=d.parentNode;if(d&&d.getAttribute&&$(d).hasClass("editable-style"))return d;console.log("this element has no editable parent",c);return c};silex.utils.JQueryEditable.setDropableOnly=function(c,d){d?$(this.bodyElement).editable({isContainer:!0,isResizable:!1,isDroppable:!0,isDraggable:!1}):silex.utils.JQueryEditable.setEditable(c,!1)};
silex.utils.JQueryEditable.setEditable=function(c,d){d?($('.editable-style[data-silex-type="container"]',c).editable({isContainer:!0}),$('.editable-style[data-silex-type="element"]',c).editable(),$(c).editable()):($(".editable-style",c).editable("destroy"),$(c).editable("destroy"),$(c).find(".silex-selected").removeClass("silex-selected"),$(c).find(".ui-resizable").removeClass("ui-resizable"),$(c).find(".ui-draggable").removeClass("ui-draggable"),$(c).find(".ui-droppable").removeClass("ui-droppable"),
$(c).find("[aria-disabled]").removeAttr("aria-disabled"),$(c).find(".ui-resizable-handle").remove())};silex.utils.JQueryEditable.setEditableHtml=function(c,d,e){silex.utils.JQueryEditable.setEditable(c,!1);if(e){if(e=goog.dom.getFirstElementChild(c))e.innerHTML=d}else c.innerHTML=d;silex.utils.JQueryEditable.setEditable(c,!0)};
silex.utils.JQueryEditable.getEditableHtml=function(c,d){silex.utils.JQueryEditable.setEditable(c,!1);var e=c.cloneNode(!0);silex.utils.JQueryEditable.setEditable(c,!0);var f="";if(d){if(e=goog.dom.getFirstElementChild(e))f=e.innerHTML}else f=e.innerHTML;return f};silex.view.Stage=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initEvents();silex.utils.JQueryEditable.setDropableOnly(d,!0);silex.utils.JQueryPageable.setPageable(d,!0)};goog.inherits(silex.view.Stage,silex.view.ViewBase);
silex.view.Stage.prototype.initEvents=function(){goog.events.listen(this.element,"mousedown",function(c){if(this.onStatus)this.onStatus("select",c.target);this.isDragging=!0},!1,this);goog.events.listen(document.body,"mouseup",function(c){if(this.isDragging){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1}},!1,this);goog.events.listen(this.element,"dragstop",function(c){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1},!1,this);goog.events.listen(this.element,
"resize",function(c){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1},!1,this);goog.events.listen(this.element,"newContainer",function(c){if(this.onStatus)this.onStatus("newContainer")},!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(c){if(this.onStatus)this.onStatus("edit")},!1,this);var c=new goog.events.MouseWheelHandler(this.element);goog.events.listen(c,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,function(c){0>c.deltaX&&0>=this.element.scrollLeft&&
c.preventDefault()},!1,this)};silex.view.Stage.prototype.getSelection=function(){return goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement)};silex.view.Stage.prototype.getNeededFonts=function(){var c=[];this.getStageElement().innerHTML.replace(/<font[^"]*face="?([^"]*)"/g,function(d,e,f){c[e]=!0;return d});return c};silex.controller.SettingsDialogController=function(c,d){silex.controller.ControllerBase.call(this,c,d);this.view.settingsDialog.onStatus=goog.bind(this.settingsDialogCallback,this)};goog.inherits(silex.controller.SettingsDialogController,silex.controller.ControllerBase);
silex.controller.SettingsDialogController.prototype.settingsDialogCallback=function(c,d){switch(c){case "browsePublishPath":this.view.fileExplorer.openDialog(goog.bind(function(d){d=d.substring(d.indexOf("/api/v1.0/"),d.lastIndexOf("/"));d=d.replace("/exec/get","/exec/put");this.app.file.setPublicationPath(d);this.tracker.trackAction("controller-events","success",c,1)},this),null,goog.bind(function(d){silex.utils.Notification.notifyError("Error: I could not select the publish path. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));break;case "change":this.app.file.setPublicationPath(d)}};silex.controller.PageToolController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.pageTool.onStatus=goog.bind(this.pageToolCallback,this)};goog.inherits(silex.controller.PageToolController,silex.controller.ControllerBase);
silex.controller.PageToolController.prototype.pageToolCallback=function(c,d){this.tracker.trackAction("controller-events","request",c,0);switch(c){case "changed":this.openPage(d);break;case "delete":this.removePage(d);break;case "rename":this.renamePage(d);break;case "addToPage":silex.utils.JQueryPageable.addToPage(this.view.stage.getSelection()[0],d);break;case "removeFromPage":silex.utils.JQueryPageable.removeFromPage(this.view.stage.getSelection()[0],d);break;case "addLink":silex.utils.JQueryPageable.setLink(this.view.stage.getSelection()[0],
d);break;case "removeLink":silex.utils.JQueryPageable.setLink(this.view.stage.getSelection()[0])}};silex.controller.StageController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.stage.onStatus=goog.bind(this.stageCallback,this)};goog.inherits(silex.controller.StageController,silex.controller.ControllerBase);
silex.controller.StageController.prototype.stageCallback=function(c,d){switch(c){case "select":this.model.element.setSelected(d,!0);this.view.propertyTool.redraw();break;case "change":this.view.propertyTool.redraw();break;case "newContainer":var e=this.view.stage.getSelection()[0];this.checkPageVisibility(e);break;case "edit":this.editElement()}};silex.controller.PropertyToolController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.propertyTool.onStatus=goog.bind(this.propertyToolCallback,this)};goog.inherits(silex.controller.PropertyToolController,silex.controller.ControllerBase);
...
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "selectImage":this.editElement();break;case "styleChanged":var f=this.view.stage.getSelection()[0];f&&d?(this.model.element.setStyle(f,d,e),this.view.propertyTool.redraw()):console.error("can not set style ",d," on element ",f);break;case "propertyChanged":console.error("not implemented")}};silex.controller.MenuController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.menu.onStatus=goog.bind(this.menuCallback,this)};goog.inherits(silex.controller.MenuController,silex.controller.ControllerBase);
silex.controller.MenuController.prototype.menuCallback=function(c){this.tracker.trackAction("controller-events","request",c,0);switch(c){case "title.changed":this.promptTitle();break;case "file.new":this.model.file.newFile();break;case "file.saveas":this.save();break;case "file.rename":this.promptTitle();break;case "file.publish.settings":this.view.settingsDialog.openDialog();this.view.workspace.invalidate();break;case "file.publish":this.publish();break;case "file.save":this.save(this.model.file.getUrl());
break;case "file.open":this.openFile();break;case "file.close":this.model.file.newFile();break;case "view.file":this.preview();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "view.open.fileExplorer":this.model.fileExplorer.openDialog();
this.view.workspace.invalidate();break;case "view.open.editor":this.editComponent();break;case "insert.page":this.createPage();break;case "insert.text":this.addElement(silex.model.Element.TYPE_TEXT);break;case "insert.html":this.addElement(silex.model.Element.TYPE_IMAGE);break;case "insert.image":this.model.fileExplorer.openDialog(goog.bind(function(d){var e=this.addElement(silex.model.Element.TYPE_IMAGE);this.model.element.setImageUrl(e,d,goog.bind(function(d){this.view.workspace.invalidate();this.tracker.trackAction("controller-events",
"success",c,1)}),goog.bind(function(d,e){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+e);this.removeElement(d);this.tracker.trackAction("controller-events","error",c,1)}))},this),["image/*","text/plain"],goog.bind(function(d){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "insert.container":this.addElement(silex.model.Element.TYPE_CONTAINER);
...
silex.view.Stage.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',headElement).each(function(){c=this.getAttribute("content")});return c};silex.view.SettingsDialog.prototype.redraw=function(){goog.dom.getElementByClass("input-publication-path").value=this.getPublicationPath()};
...
silex.view.FileExplorer.prototype.openDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d.url)},10,this)).start()};this.filePicker.pick(goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");if(f&&!1===silex.utils.Url.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+1);
silex.utils.Notification.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c.url):h({message:"Wrong file type."})})}else k(c.url)},this),h);this.openEditor()};
silex.view.FileExplorer.prototype.saveAsDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d.url)},10,this)).start()};console.log("call exportFile",Array.isArray(d),d);this.filePicker.exportFile("http://google.com/",d,goog.bind(function(c){console.log("ok",c);this.closeEditor();c.url=c.url.replace("https://","http://");
if(f&&!1===silex.utils.Url.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+1);silex.utils.Notification.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};
...
silex.view.FileExplorer.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};silex.model.Body=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.Body,silex.model.ModelBase);silex.model.Head=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.Head,silex.model.ModelBase);
silex.model.Head.prototype.refreshFontList=function(){var c=goog.dom.getElementsByTagNameAndClass("link");goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});var d=this.headElement,c=goog.dom.getElementsByTagNameAndClass("link",null,d);goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});c=goog.dom.getElementsByTagNameAndClass("link",null,d);goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&
c.parentNode.removeChild(c)});c=goog.dom.getElementsByTagNameAndClass("font",null,d);goog.array.forEach(c,function(c){null!==c.getAttribute("face")&&(neededFonts[c.getAttribute("face")]=!0)});var e=silex.Config.fonts,c=function(c){for(var d in e)if(e[d].value===c)return e[d];return null},f;for(f in neededFonts){var h=c(f);if(h&&void 0!==h.href){var k=goog.dom.createElement("link");k.setAttribute("href",h.href);k.setAttribute("rel","stylesheet");k.setAttribute("type","text/css");d.appendChild(k);k=
goog.dom.createElement("link");k.setAttribute("href",h.href);k.setAttribute("rel","stylesheet");k.setAttribute("type","text/css");document.head.appendChild(k)}}};silex.model.Head.prototype.setPublicationPath=function(c){var d=!1;$('meta[name="publicationPath"]',this.headElement).each(function(){c&&""!==c?this.setAttribute("content",c):$(this).remove();d=!0});if(!d&&c&&""!==c){var e=goog.dom.createElement("meta");e.name="publicationPath";e.content=c;goog.dom.appendChild(this.headElement,e)}};
silex.model.Head.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};silex.model.Head.prototype.getTitle=function(){var c=null;$('meta[name="title"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};
silex.model.Head.prototype.setTitle=function(c){var d=!1;$('meta[name="title"]',this.headElement).each(function(){this.setAttribute("content",c);d=!0});if(!d){var e=goog.dom.createElement("meta");e.name="title";e.content=c;goog.dom.appendChild(this.headElement,e)}};silex.utils.Dom=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Dom.renderList=function(c,d){var e="";for(itemIdx in d){var f=c;for(key in d[itemIdx])f=f.replace("{{"+key+"}}",d[itemIdx][key]);e+=f}return e};silex.view.pane={};silex.view.pane.PaneBase=function(c,d,e){silex.view.ViewBase.call(this,c,d,e)};goog.inherits(silex.view.pane.PaneBase,silex.view.ViewBase);silex.view.pane.PaneBase.prototype.selectBgImage=function(){if(this.onStatus)this.onStatus("selectBgImage")};silex.view.pane.PaneBase.prototype.selectImage=function(){if(this.onStatus)this.onStatus("selectImage")};silex.view.pane.PaneBase.prototype.editHTML=function(){if(this.onStatus)this.onStatus("editHTML")};
silex.view.pane.PaneBase.prototype.editText=function(){if(this.onStatus)this.onStatus("editText")};silex.view.pane.PaneBase.prototype.styleChanged=function(c,d){if(this.onStatus)this.onStatus("styleChanged",c,d);this.redraw()};silex.view.pane.PaneBase.prototype.propertyChanged=function(){if(this.onStatus)this.onStatus("propertyChanged")};silex.view.pane.PaneBase.prototype.redraw=function(){};silex.view.pane.PaneBase.prototype.getBaseUrl=function(){return this.baseUrl};
...
silex.view.pane.PropertyPane.prototype.buildUi=function(){this.leftInput=goog.dom.getElementByClass("left-input");goog.events.listen(this.leftInput,"change",this.onPositionChanged,!1,this);this.widthInput=goog.dom.getElementByClass("width-input");goog.events.listen(this.widthInput,"change",this.onPositionChanged,!1,this);this.bottomInput=goog.dom.getElementByClass("bottom-input");goog.events.listen(this.bottomInput,"change",this.onPositionChanged,!1,this);this.topInput=goog.dom.getElementByClass("top-input");
goog.events.listen(this.topInput,"change",this.onPositionChanged,!1,this);this.heightInput=goog.dom.getElementByClass("height-input");goog.events.listen(this.heightInput,"change",this.onPositionChanged,!1,this);this.rightInput=goog.dom.getElementByClass("right-input");goog.events.listen(this.rightInput,"change",this.onPositionChanged,!1,this);this.zIndexInput=goog.dom.getElementByClass("z-index-input");goog.events.listen(this.zIndexInput,"change",this.onPositionChanged,!1,this)};
silex.view.pane.PropertyPane.prototype.onPositionChanged=function(){this.getSelection()[0]&&(this.leftInput.value&&""!==this.leftInput.value?this.styleChanged("left",this.leftInput.value+"px"):this.styleChanged("left"),this.widthInput.value&&""!==this.widthInput.value?this.styleChanged("width",tthis.widthInput.value+"px"):this.styleChanged("width"),this.bottomInput.value&&""!==this.bottomInput.value?this.styleChanged("bottom",ththis.bottomInput.value+"px"):this.styleChanged("bottom"),this.topInput.value&&
""!==this.topInput.value?this.styleChanged("top",this.topInput.value+"px"):this.styleChanged("top"),this.heightInput.value&&""!==this.heightInput.value?this.styleChanged("height",ththis.heightInput.value+"px"):this.styleChanged("height"),this.rightInput.value&&""!==this.rightInput.value?this.styleChanged("right",tthis.rightInput.value+"px"):this.styleChanged("right"),this.zIndexInput.value&&""!==this.zIndexInput.value?this.styleChanged("zIndex",ththis.zIndexInput.value+"px"):this.styleChanged("zIndex"))};
silex.view.pane.PropertyPane.prototype.redraw=function(){silex.view.pane.PropertyPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){var d=c.getAttribute(silex.model.Element.TYPE_ATTR),e="";d===silex.model.Element.TYPE_IMAGE&&(e=this.baseUrl?silex.utils.Style.getRelativePath(c.getAttribute("src"),this.baseUrl):this.component.getImageSrc());var f=goog.dom.getElementByClass("edition-container",this.element);if(this.element){var h=goog.dom.getElementByClass("edition-template",this.element).innerHTML;
f.innerHTML=silex.utils.Dom.renderList(h,[{htmlEditor:d===silex.model.Element.TYPE_HTML?"inherit":"none",textEditor:d===silex.model.Element.TYPE_TEXT?"inherit":"none",imageEditor:d===silex.model.Element.TYPE_IMAGE?"inherit":"none",imageUrl:e}]);if(e=goog.dom.getElementByClass("html-editor-button",f))h=new goog.ui.CustomButton,h.decorate(e),goog.events.listen(e,goog.events.EventType.CLICK,this.editHTML,!1);if(e=goog.dom.getElementByClass("text-editor-button",f))h=new goog.ui.CustomButton,h.decorate(e),
goog.events.listen(e,goog.events.EventType.CLICK,this.editText,!1);if(d===silex.model.Element.TYPE_IMAGE){if(e=goog.dom.getElementByClass("image-url-button",f))h=new goog.ui.CustomButton,h.decorate(e),goog.events.listen(e,goog.events.EventType.CLICK,this.selectImage,!1);var k=goog.dom.getElementByClass("image-url-input",f);k&&goog.events.listen(k,"change",function(){this.component&&!this.isRedraw&&d===silex.model.Element.TYPE_IMAGE&&this.setImage(k.value)},!1,this)}goog.dom.classes.has(c,"editable-style")?
(this.leftInput.value=void 0!==c.style.left?c.style.left.substr(0,c.style.left.indexOf("px")):"",this.widthInput.value=void 0!==c.style.width?c.style.width.substr(0,c.style.width.indexOf("px")):"",this.bottomInput.value=void 0!==c.style.bottom?c.style.bottom.substr(0,c.style.bottom.indexOf("px")):"",this.topInput.value=void 0!==c.style.top?c.style.top.substr(0,c.style.top.indexOf("px")):"",this.heightInput.value=void 0!==c.style.height?c.style.height.substr(0,c.style.height.indexOf("px")):"",this.rightInput.value=
void 0!==c.style.right?c.style.right.substr(0,c.style.right.indexOf("px")):"",this.zIndexInput.value=void 0!==c.style.zIndex?c.style.zIndex:""):(this.leftInput.value="",this.widthInput.value="",this.bottomInput.value="",this.topInput.value="",this.heightInput.value="",this.rightInput.value="",this.zIndexInput.value="")}else f&&(f.innerHTML="");this.isRedraw=!1}};goog.editor={};goog.editor.defines={};goog.editor.defines.USE_CONTENTEDITABLE_IN_FIREFOX_3=!1;goog.userAgent.product.determineVersion_=function(){if(goog.userAgent.product.FIREFOX)return goog.userAgent.product.getFirstRegExpGroup_(/Firefox\/([0-9.]+)/);if(goog.userAgent.product.IE||goog.userAgent.product.OPERA)return goog.userAgent.VERSION;if(goog.userAgent.product.CHROME)return goog.userAgent.product.getFirstRegExpGroup_(/Chrome\/([0-9.]+)/);if(goog.userAgent.product.SAFARI)return goog.userAgent.product.getFirstRegExpGroup_(/Version\/([0-9.]+)/);if(goog.userAgent.product.IPHONE||goog.userAgent.product.IPAD){var c=
...
this.bgColorPicker.render(goog.dom.getElementByClass("border-color-button",this.element));this.hsvPalette.setColorRgbaHex("#000000FF");this.setColorPaletteVisibility(!1);this.noBorderButton=goog.dom.getElementByClass("enable-border-color-button",this.element);this.borderPlacementCheckBoxes=[];var c=goog.dom.getElementsByTagNameAndClass("span",null,goog.dom.getElementByClass("border-placement-container",this.element)),d,e=c.length;for(d=0;d<e;d++){var f=goog.ui.decorate(c[d]);this.borderPlacementCheckBoxes.push(f);
goog.events.listen(f,goog.ui.Component.EventType.CHANGE,this.onBorderChanged,!1,this)}this.cornerRadiusInput=goog.dom.getElementByClass("corner-radius-input",this.element);this.cornerPlacementCheckBoxes=[];c=goog.dom.getElementsByTagNameAndClass("span",null,goog.dom.getElementByClass("corner-placement-container",this.element));e=c.length;for(d=0;d<e;d++)f=goog.ui.decorate(c[d]),this.cornerPlacementCheckBoxes.push(f),goog.events.listen(f,goog.ui.Component.EventType.CHANGE,this.onBorderChanged,!1,this);
goog.events.listen(this.borderWidthInput,"change",this.onBorderChanged,!1,this);goog.events.listen(this.borderStyleComboBox,goog.ui.Component.EventType.CHANGE,this.onBorderChanged,!1,this);goog.events.listen(this.hsvPalette,goog.ui.Component.EventType.ACTION,this.onBorderChanged,!1,this);goog.events.listen(this.bgColorPicker,goog.ui.Component.EventType.ACTION,this.toggleColorPaletteVisibility,!1,this);goog.events.listen(this.noBorderButton,goog.events.EventType.CLICK,this.onResetBorder,!1,this);goog.events.listen(this.cornerRadiusInput,
"change",this.onBorderChanged,!1,this)};
silex.view.pane.BorderPane.prototype.redraw=function(){silex.view.pane.BorderPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){if(c.style.borderWidth){var d=c.style.borderWidth.split(" "),e=d[0];this.borderWidthInput.value=e.substr(0,e.indexOf("px"));for(var f=this.borderPlacementCheckBoxes.length,e=0;e<f;e++){var h=this.borderPlacementCheckBoxes[e];d.length>e&&"0"!==d[e]?h.setChecked(!0):h.setChecked(!1)}d=c.style.borderColor;void 0===d||"transparent"===d||""===d?(this.bgColorPicker.setEnabled(!1),
this.setColorPaletteVisibility(!1)):(d=silex.Helper.rgbaToHex(d),this.bgColorPicker.setEnabled(!0),this.bgColorPicker.setValue(d.substring(0,7)),this.hsvPalette.setColorRgbaHex(d))}else for(this.borderWidthInput.value="",f=this.borderPlacementCheckBoxes.length,e=0;e<f;e++)h=this.borderPlacementCheckBoxes[e],h.setChecked(!0);c.style.borderStyle?this.borderStyleComboBox.setValue(c.style.borderStyle):this.borderStyleComboBox.setSelectedIndex(0);if(c.style.borderRadius)for(d=c.style.borderRadius.split(" "),
e=d[0],this.cornerRadiusInput.value=e.substr(0,e.indexOf("px")),f=this.cornerPlacementCheckBoxes.length,e=0;e<f;e++)h=this.cornerPlacementCheckBoxes[e],d.length>e&&"0"!==d[e]?h.setChecked(!0):h.setChecked(!1);else for(this.cornerRadiusInput.value="",f=this.cornerPlacementCheckBoxes.length,e=0;e<f;e++)h=this.cornerPlacementCheckBoxes[e],h.setChecked(!0);this.isRedraw=!1}};
silex.view.pane.BorderPane.prototype.onBorderChanged=function(){if(this.borderWidthInput.value&&""!==this.borderWidthInput.value){var c="",d,e=this.borderPlacementCheckBoxes.length;for(d=0;d<e;d++)var f=this.borderPlacementCheckBoxes[d],c=f.getChecked()?c+(this.borderWidthInput.value+"px "):c+"0 ";this.styleChanged("borderWidth",c);this.styleChanged("borderStyle",this.borderStyleComboBox.getSelectedItem().getValue());c=this.hsvPalette.getColorRgbaHex();d=silex.Helper.hexToRgba(c);this.styleChanged("borderColor",
d);this.bgColorPicker.setValue(c.substring(0,7))}else this.styleChanged("borderWidth","none"),this.styleChanged("borderStyle","none");if(this.cornerRadiusInput.value&&""!==this.cornerRadiusInput.value){c="";e=this.cornerPlacementCheckBoxes.length;for(d=0;d<e;d++)f=this.cornerPlacementCheckBoxes[d],c=f.getChecked()?c+(this.cornerRadiusInput.value+"px "):c+"0 ";this.styleChanged("borderRadius",c)}else this.styleChanged("borderRadius","none")};
silex.view.pane.BorderPane.prototype.onResetBorder=function(){this.borderWidthInput.value="";this.onBorderChanged()};silex.view.pane.BorderPane.prototype.toggleColorPaletteVisibility=function(){this.setColorPaletteVisibility(!this.getColorPaletteVisibility())};silex.view.pane.BorderPane.prototype.getColorPaletteVisibility=function(){return"hidden"!==goog.style.getStyle(this.hsvPalette.getElement(),"visibility")};
...
silex.view.pane.PagePane.prototype.setPages=function(c){this.pages=c;var d=[];goog.array.forEach(c,function(c){d.push({name:c,displayName:silex.utils.JQueryPageable.getDisplayName(this.bodyElement,c)})},this);this.pageCheckboxes&&goog.array.forEach(this.pageCheckboxes,function(c){c.checkbox.dispose()});var e=d.concat([{name:"none",displayName:"None"},{name:"custom",displayName:"External link"}]),f=goog.dom.getElementByClass("link-combo-box",this.element);c=goog.dom.getElementByClass("link-template",this.element).innerHTML;
f.innerHTML=silex.utils.Dom.renderList(c,e);e=goog.dom.getElementByClass("pages-container",this.element);c=goog.dom.getElementByClass("pages-selector-template",this.element).innerHTML;e.innerHTML=silex.utils.Dom.renderList(c,d);this.pageCheckboxes=[];c=goog.dom.getElementByClass("pages-container",this.element);c=goog.dom.getElementsByClass("page-container",c);var h=0;goog.array.forEach(c,function(c){var d=goog.dom.getElementByClass("page-check",c);c=goog.dom.getElementByClass("page-label",c);var e=
new goog.ui.Checkbox,f=this.pages[h++];e.render(d);e.setLabel(c);this.pageCheckboxes.push({checkbox:e,pageName:f});goog.events.listen(e,goog.ui.Component.EventType.CHANGE,function(c){this.checkPage(pageName,e)},!1,this)},this);c=goog.dom.getElementByClass("show-on-all-pages-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(c){this.unCheckAll()},!1,this)};
...
silex.view.pane.PagePane.prototype.redraw=function(){silex.view.pane.PagePane.superClass_.redraw.call(this);this.setPages(silex.utils.JQueryPageable.getPages(this.bodyElement));var c=this.getSelection()[0];if(c){var d=silex.utils.JQueryPageable.getLink(c);goog.array.forEach(this.pageCheckboxes,function(c){c.checkbox.setEnabled(!0);c.checkbox.setChecked(d===c.pageName)},this);d?0===d.indexOf("#")&&silex.model.Page.getPageByName(d.substr(1))?this.linkDropdown.value=d.substr(1):(this.linkInputTextField.setValue(d),
this.linkDropdown.value="custom"):(this.linkDropdown.value="none",this.linkInputTextField.setValue(""));c=goog.dom.getElementByClass("link-input-text",this.element);"custom"===this.linkDropdown.value?goog.style.setStyle(c,"display","inherit"):goog.style.setStyle(c,"display","none");this.isRedraw=!1}};silex.view.pane.PagePane.prototype.checkPage=function(c,d){if(d.isChecked())this.onStatus("addToPage",c);else this.onStatus("removeFromPage",c)};
silex.view.pane.PagePane.prototype.unCheckAll=function(){goog.array.forEach(this.pages,function(c){page.removeComponent(this.component)},this);this.pageChanged();this.redraw()};silex.utils.Style={};silex.utils.Style.styleToString=function(c){var d="";goog.object.forEach(c,function(c,f,h){c&&(d+=goog.string.toSelectorCase(f)+": "+c+"; ")});return d};silex.utils.Style.stringToStyle=function(c){return goog.style.parseStyleAttribute(c)};
...
silex.view.pane.BgPane.prototype.buildUi=function(){var c=goog.dom.getElementByClass("color-bg-palette",this.element);this.hsvPalette=new goog.ui.HsvaPalette(null,null,null,"goog-hsva-palette-sm");this.hsvPalette.render(c);goog.events.listen(this.hsvPalette,goog.ui.Component.EventType.ACTION,this.onColorChanged,!1,this);this.bgColorPicker=new goog.ui.ColorButton;this.bgColorPicker.setTooltip("Click to select color");this.bgColorPicker.render(goog.dom.getElementByClass("color-bg-button"));goog.events.listen(this.bgColorPicker,
goog.ui.Component.EventType.ACTION,this.onBgColorButton,!1,this);this.hsvPalette.setColorRgbaHex("#FFFFFFFF");this.setColorPaletteVisibility(!1);this.transparentBgCheckbox=new goog.ui.Checkbox;this.transparentBgCheckbox.decorate(goog.dom.getElementByClass("enable-color-bg-button"),this.element);goog.events.listen(this.transparentBgCheckbox,goog.ui.Component.EventType.CHANGE,this.onTransparentChanged,!1,this);c=goog.dom.getElementByClass("bg-image-button");this.bgSelectBgImage=new goog.ui.CustomButton;
this.bgSelectBgImage.decorate(c);this.bgSelectBgImage.setTooltip("Click to select a file");goog.events.listen(c,goog.events.EventType.CLICK,this.onSelectImageButton,!1,this);c=goog.dom.getElementByClass("clear-bg-image-button");this.bgClearBgImage=new goog.ui.CustomButton;this.bgClearBgImage.setTooltip("Click to select a file");this.bgClearBgImage.decorate(c);goog.events.listen(c,goog.events.EventType.CLICK,this.onClearImageButton,!1,this);this.attachementComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-attachement-combo-box"));
this.vPositionComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-position-v-combo-box"));this.hPositionComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-position-h-combo-box"));this.repeatComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-repeat-combo-box"));goog.events.listen(this.attachementComboBox,goog.ui.Component.EventType.CHANGE,function(c){this.styleChanged("backgroundAttachment",c.target.getSelectedItem().getId())},!1,this);goog.events.listen(this.vPositionComboBox,goog.ui.Component.EventType.CHANGE,
function(c){c=this.hPositionComboBox.getSelectedItem().getId();var e=this.vPositionComboBox.getSelectedItem().getId();this.styleChanged("backgroundPosition",e+" "+c)},!1,this);goog.events.listen(this.hPositionComboBox,goog.ui.Component.EventType.CHANGE,function(c){c=this.hPositionComboBox.getSelectedItem().getId();var e=this.vPositionComboBox.getSelectedItem().getId();this.styleChanged("backgroundPosition",e+" "+c)},!1,this);goog.events.listen(this.repeatComboBox,goog.ui.Component.EventType.CHANGE,
function(c){this.styleChanged("backgroundRepeat",c.target.getSelectedItem().getId())},!1,this)};
...
silex.view.pane.GeneralStylePane.prototype.redraw=function(){silex.view.pane.GeneralStylePane.superClass_.redraw.call(this);var c=this.getSelection()[0];c&&(this.opacityInput.value=c.style.opacity?c.style.opacity:"")};silex.view.pane.GeneralStylePane.prototype.onInputChanged=function(c){this.opacityInput.value&&""!==this.opacityInput.value?this.styleChanged("opacity",this.opacityInput.value):this.styleChanged("opacity")};silex.view.PropertyTool=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.buildTabs();this.buildPanes()};goog.inherits(silex.view.PropertyTool,silex.view.ViewBase);silex.view.PropertyTool.TAB_TITLE_NORMAL="Normal";silex.view.PropertyTool.TAB_TITLE_HOVER="Hover";silex.view.PropertyTool.TAB_TITLE_PRESSED="Pressed";
silex.view.PropertyTool.prototype.buildTabs=function(){var c=goog.dom.getElementByClass("tab-bar-container",this.element),d=new goog.ui.TabBar;d.decorate(c);goog.events.listen(d,goog.ui.Component.EventType.ACTION,function(c){d.getSelectedTab().getCaption();if(this.onStatus)this.onStatus("contextChanged");this.setComponent(this.component)},!1,this)};
...
silex.view.PageTool.prototype.initEvents=function(c){goog.events.listen(this.element,goog.events.EventType.CLICK,function(c){goog.dom.classes.has(c.target,"delete")?this.removePageAtIndex(this.getCellIndex(c.target.parentNode)):goog.dom.classes.has(c.target,"label")?this.renamePageAtIndex(this.getCellIndex(c.target.parentNode)):this.setSelectedIndex(this.getCellIndex(c.target),!0)},!1,this)};
silex.view.PageTool.prototype.redraw=function(){var c=silex.view.JQueryPageable.getPages(),d=goog.dom.getElementByClass("page-tool-container",this.element),e=goog.dom.getElementByClass("page-tool-template",this.element).innerHTML;d.innerHTML=silex.utils.Dom.resolveTemplate(e,c)};silex.view.PageTool.prototype.removePageAtIndex=function(c){if(this.onStatus)this.onStatus("delete",this.pages[c]);this.redraw()};
silex.view.PageTool.prototype.renamePageAtIndex=function(c){if(this.onStatus)this.onStatus("rename",this.pages[c]);this.redraw()};silex.view.PageTool.prototype.setSelectedIndex=function(c,d){var e=goog.dom.getElementsByClass("page-container",this.element);goog.array.forEach(e,function(d){var e=this.getCellIndex(d);c===e?goog.dom.classes.add(d,"ui-selected"):goog.dom.classes.remove(d,"ui-selected")},this);if(d&&this.onStatus)this.onStatus("changed",page)};
silex.view.PageTool.prototype.getCellIndex=function(c){for(var d=goog.dom.getElementsByClass("page-container",this.element),e=0;e<d.length&&d[e]!=c;)e++;e>=d.length&&(e=-1,console.error("Page not found for element ",c));return e};goog.ui.ToolbarSeparatorRenderer=function(){goog.ui.MenuSeparatorRenderer.call(this)};goog.inherits(goog.ui.ToolbarSeparatorRenderer,goog.ui.MenuSeparatorRenderer);goog.addSingletonGetter(goog.ui.ToolbarSeparatorRenderer);goog.ui.ToolbarSeparatorRenderer.CSS_CLASS="goog-toolbar-separator";goog.ui.ToolbarSeparatorRenderer.prototype.createDom=function(c){return c.getDomHelper().createDom("div",this.getCssClass()+" "+goog.ui.INLINE_BLOCK_CLASSNAME,"\u00a0")};
...
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.publishSettingsElement,d,e));goog.dom.classes.has(document.body,"loading-pending")&&goog.dom.classes.remove(document.body,"loading-pending")};silex.model.File=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.File,silex.model.ModelBase);silex.model.File.CREATION_TEMPLATE="creation-template.html";
silex.model.File.prototype.setHtml=function(c){for(var d=silex.model.Page.getPages();0<d.length;)d[0].detach();var e,d=c.toLowerCase(),f=d.indexOf("<head>");-1===f&&(f=d.indexOf("<head "));var h=d.indexOf("</head>"),k=d.indexOf("<body>");-1===k&&(k=d.indexOf("<body "));var l=d.indexOf("</body>");-1<f&&-1<h&&(f=d.indexOf(">",f),e=c.substring(f+1,h));-1<k&&-1<l&&(f=d.indexOf(">",k),c.substring(f+1,l));c=c.substring(k,l+1);d=c.indexOf('"');h=c.indexOf('"',d+1);d=c.substring(d+1,h);d=this.bodyElement.relative2absolute(this.bodyStyle,
this.getUrl());this.bodyElement.innerHTML=c;this.bodyElement.setAttribute("style",d);this.headElement.innerHTML=e};silex.model.File.prototype.getHtml=function(){var c=this.bodyElement.getAttribute("style"),d;d="<html>"+("<head>"+this.headElement.innerHTML+"</head>");d+='<body style="'+c+'">'+this.bodyElement.innerHTML+"</body>";return d+="</html>"};silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
...
silex.model.File.prototype.open=function(c,d,e){this.fileExplorer.openDialog(goog.bind(function(c){silex.service.CloudStorage.getInstance().load(c,goog.bind(function(e){this.close();this.setUrl(c);d&&d(e)},this),e)},this),["text/html","text/plain"],e)};silex.model.File.prototype.close=function(){this.url=null};silex.model.File.prototype.getUrl=function(){return this.url};silex.model.File.prototype.setUrl=function(c){this.url=c};
silex.model.File.prototype.publish=function(c){this.cleanup(goog.bind(function(d,e,f){silex.service.SilexTasks.getInstance().publish(c,d,e,f,cbk,opt_errCbk)},this),goog.bind(function(c){console.error("publish cleanup error",c);opt_errCbk&&opt_errCbk(c)},this))};
silex.model.Body.prototype.cleanup=function(c,d){var e=goog.dom.getOuterHtml(this.bodyElement),f=this.headElement.innerHTML,h=[],k=[];if(this.getUrl()){var l=silex.utils.Url.getBaseUrl(this.getUrl()),e=e.replace(/<img[^"]*src="?([^" ]*)"/g,function(c,d,e){e=silex.utils.Url.getAbsolutePath(d,l);var f=silex.utils.Url.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="assets/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,
h)}),e=e.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(c,d,e){return this.filterBgImage(l,k,c,d,e)},this)),f=f.replace(/href="?([^" ]*)"/g,function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,l);var h=silex.utils.Url.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="css/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),f=f.replace(/src="?([^"]*)"/g,
function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,l);var h=silex.utils.Url.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="js/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),m=goog.dom.createElement("div");m.innerHTML=e;e=goog.dom.createElement("div");e.innerHTML=f;$('meta[name="publicationPath"]',e).remove();f=goog.dom.getElementsByClass("editable-style",
m);goog.array.forEach(f,function(c){c=new silex.model.Component(c);var d=c.element.getAttribute("data-silex-href");d&&(c.element.setAttribute("href",d),c.element.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c.element),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,c.element),goog.dom.removeNode(c.element),c.element=d)},this);var f=goog.dom.getElementsByClass("editable-style",m),n=0;goog.array.forEach(f,function(c){c=new silex.model.Component(c);
c.addClass("silex-"+c.type);var d="component-"+n++;c.addClass(d);var e=c.getCss(silex.model.Component.CONTEXT_NORMAL);h.push({classNames:["."+d],styles:e});c.hasStyle(silex.model.Component.CONTEXT_HOVER)&&(e=c.getCss(silex.model.Component.CONTEXT_HOVER),h.push({classNames:["."+d+":hover"],styles:e}));c.hasStyle(silex.model.Component.CONTEXT_PRESSED)&&(e=c.getCss(silex.model.Component.CONTEXT_PRESSED),h.push({classNames:["."+d+":pressed"],styles:e}));c.removeClass("editable-style");c.element.removeAttribute("data-silex-type");
c.element.removeAttribute("data-silex-sub-type");c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_NORMAL);c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_HOVER);c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_PRESSED);c.element.removeAttribute("style")},this);f=this.stage.getBodyStyle();f=f.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(c,d,e){return this.filterBgImage(l,k,c,d,e)},this));h.push({classNames:["body"],styles:silex.Helper.stringToStyle(f)});
var p="";goog.array.forEach(h,function(c){var d="";goog.array.forEach(c.classNames,function(c){""!=d&&(d+=", ");d+=c},this);d+="{\n\t"+silex.Helper.styleToString(c.styles)+"\n}";p+="\n"+d},this);p.replace("; ",";\n\t");e="<html>"+('<head><link href="css/styles.css" rel="stylesheet">'+e.innerHTML+"</head>");e+="<body>"+m.innerHTML+"</body>";e+="</html>";c(e,p,k)}else d&&d({message:"The file must be saved before I can clean it up for you."})};
silex.model.Body.prototype.filterBgImage=function(c,d,e,f,h){c=silex.utils.Url.getAbsolutePath(h,c);e=silex.utils.Url.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(e)||(e=e.replace("../","/"));f="assets/"+c.substr(c.lastIndexOf("/")+1);h="url('../"+f+"')";d.push({url:c,destPath:f,srcPath:e});return h};silex.App=function(){silex.service.Tracker.getInstance().trackAction("app-events","start",null,2);"silex"===window.location.href.slice(-5)&&(window.location.href+="/");window.location.hash="";if(!silex.Config.debug.debugMode||silex.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure you want to leave me?"};var c=goog.dom.getElementByClass("silex-stage-body"),d=goog.dom.createElement("div"),e=goog.dom.getElementByClass("silex-menu"),f=new silex.view.Menu(e,c,d),h=goog.dom.getElementByClass("silex-stage"),
k=new silex.view.Stage(h,c,d),l=goog.dom.getElementByClass("silex-page-tool"),m=new silex.view.PageTool(l,c,d),n=goog.dom.getElementByClass("silex-htmleditor"),p=new silex.view.HTMLEditor(n,c,d),q=goog.dom.getElementByClass("silex-texteditor"),s=new silex.view.TextEditor(q,c,d),t=goog.dom.getElementByClass("silex-fileexplorer"),w=new silex.view.FileExplorer(t,c,d),x=goog.dom.getElementByClass("silex-settings-dialog"),z=new silex.view.SettingsDialog(x,c,d),y=goog.dom.getElementByClass("silex-property-tool"),
A=new silex.view.PropertyTool(y,c,d),B=goog.dom.getElementByClass("silex-workspace"),e=new silex.view.Workspace(B,e,h,l,y,n,q,t,x),u=new silex.types.Model(new silex.model.File(c,d),new silex.model.Head(c,d),new silex.model.Body(c,d),new silex.model.Element(c,d)),v=new silex.types.View(e,f,k,m,A,p,s,w,z),C=new silex.types.Controller(new silex.controller.MenuController(u,v),new silex.controller.StageController(u,v),new silex.controller.PageToolController(u,v),new silex.controller.PropertyToolController(u,
v),new silex.controller.SettingsDialogController(u,v),new silex.controller.HtmlEditorController(u,v),new silex.controller.TextEditorController(u,v));u.file.newFile(function(){silex.Config.debug.debugMode&&silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(u,v,C)})};goog.exportSymbol("silex.App",silex.App);
