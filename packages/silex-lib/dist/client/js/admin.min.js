...
silex.model.Element.prototype.createElement=function(c){var d;switch(c){case silex.model.Element.TYPE_CONTAINER:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);break;case silex.model.Element.TYPE_TEXT:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_TEXT);var e=goog.dom.createElement("div");e.innerHTML="<p>New text box</p>";goog.style.setStyle(e,"width","100%");goog.style.setStyle(e,
"height","100%");goog.dom.appendChild(d,e);goog.dom.classes.add(e,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);break;case silex.model.Element.TYPE_HTML:d=goog.dom.createElement("div");d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME;d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);e=goog.dom.createElement("div");e.innerHTML="<p>New HTML box</p>";goog.style.setStyle(e,"width","100%");goog.style.setStyle(e,"height","100%");goog.dom.appendChild(d,e);goog.dom.classes.add(e,
silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);break;case silex.model.Element.TYPE_IMAGE:d=goog.dom.createElement("div"),d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE)}goog.dom.classes.add(d,silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);silex.utils.EditablePlugin.setEditable(d,!0);e=goog.dom.getElementByClass("background",this.bodyElement);e||(e=this.bodyElement);goog.style.setStyle(d,{height:"100px",width:"100px",
top:100+this.bodyElement.scrollTop+"px",left:100+this.bodyElement.scrollLeft+"px",backgroundColor:"rgba(255, 255, 255, 1)",position:"absolute"});goog.dom.classes.add(d,c+"-element");goog.dom.appendChild(e,d);return d};silex.model.Element.prototype.setSelected=function(c,d){d?(this.resetSelection(),goog.dom.classes.add(c,silex.model.Element.SELECTED_CLASS_NAME)):goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)};
