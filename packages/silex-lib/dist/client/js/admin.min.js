...
goog.inherits=function(c,d){function e(){}e.prototype=d.prototype;c.superClass_=d.prototype;c.prototype=new e;c.prototype.constructor=c;c.base=function(c,e,k){var l=Array.prototype.slice.call(arguments,2);return d.prototype[e].apply(c,l)}};
...
h);if(c[d]===f)return c.constructor.prototype[d].apply(c,h);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(c){c.call(goog.global)};var silex={utils:{}};silex.utils.RetroCompat=function(){throw"this is a static class and it canot be instanciated";};
silex.utils.RetroCompat.process=function(c,d){$("[data-style-normal]",c).each(function(){this.setAttribute("style",this.getAttribute("data-style-normal"));this.removeAttribute("data-style-normal")});$("[data-style-hover]",c).each(function(){this.removeAttribute("data-style-hover")});$("[data-style-pressed]",c).each(function(){this.removeAttribute("data-style-pressed")});$("[data-silex-sub-type]",c).each(function(){this.setAttribute("data-silex-type",this.getAttribute("data-silex-sub-type"));this.removeAttribute("data-silex-sub-type")});
$('meta[name="page"]',d).each(function(){var d=this.getAttribute("content");console.log("meta page",d);$(c).append('<a id="'+d+'" data-silex-type="page">'+d+"</a>");$(this).remove()});$("[href]",c).each(function(){var c=this.getAttribute("href");0===c.indexOf("#")&&0!==c.indexOf("#!")&&this.setAttribute("href",c.substr(2))});$("[data-silex-type]",c).each(function(){$(this).addClass(this.getAttribute("data-silex-type")+"-element")});$("[src]",d).each(function(){var c=this.getAttribute("src");this.setAttribute("src",
c.replace("http://static.silex.me/2.0","http://static.silex.me/2.1"))});$("[href]",d).each(function(){var c=this.getAttribute("href");this.setAttribute("href",c.replace("http://static.silex.me/2.0","http://static.silex.me/2.1"))})};silex.utils.Notification=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Notification.ERROR_ICON="assets/notifications/error.png";silex.utils.Notification.SUCCESS_ICON="assets/notifications/success.png";silex.utils.Notification.INFO_ICON="assets/notifications/info.png";silex.utils.Notification.useNative=function(){return window.webkitNotifications&&0===window.webkitNotifications.checkPermission()};
silex.utils.Notification.activateNative=function(){window.webkitNotifications?(console.log("Native notifications are supported!"),silex.utils.Notification.useNative()?console.log("Native notifications are active!"):window.webkitNotifications.requestPermission()):console.log("Notifications are not supported for this Browser/OS version yet.")};
silex.utils.Notification.nativeNotification=function(c,d){silex.utils.Notification.useNative()?window.webkitNotifications.createNotification(d,"Silex speaking...",c).show():silex.utils.Notification.activateNative()};silex.utils.Notification.alert=alertify.alert;silex.utils.Notification.prompt=alertify.prompt;silex.utils.Notification.confirm=alertify.confirm;
silex.utils.Notification.notifySuccess=function(c){console.info(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.SUCCESS_ICON);alertify.success(c)};silex.utils.Notification.notifyError=function(c){console.error(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.ERROR_ICON);alertify.error(c)};silex.utils.Notification.notifyInfo=function(c){console.info(c);silex.utils.Notification.nativeNotification(c,silex.utils.Notification.INFO_ICON);alertify.log(c)};silex.utils.PageablePlugin=function(){throw"this is a static class and it canot be instanciated";};silex.utils.PageablePlugin.getBodyElement=function(){return silex.utils.PageablePlugin.bodyElement};silex.utils.PageablePlugin.setBodyElement=function(c){silex.utils.PageablePlugin.bodyElement=c};silex.utils.PageablePlugin.LINK_ATTR="data-silex-href";silex.utils.PageablePlugin.PAGEABLE_ROOT_CLASS_NAME="pageable-root-class";silex.utils.PageablePlugin.PAGE_CLASS_NAME="silex-page";
silex.utils.PageablePlugin.getParentPage=function(c){for(c=c.parentNode;c&&!goog.dom.classes.has(c,silex.utils.PageablePlugin.PAGE_CLASS_NAME);)c=c.parentNode;return c};silex.utils.PageablePlugin.getPageable=function(c){return c&&$(c).hasClass(silex.utils.PageablePlugin.PAGEABLE_ROOT_CLASS_NAME)};
silex.utils.PageablePlugin.setPageable=function(c,d){if(d){$(c).addClass(silex.utils.PageablePlugin.PAGEABLE_ROOT_CLASS_NAME);var e=silex.utils.PageablePlugin.getPages();$(c).pageable({currentPage:e[0],useDeeplink:!1})}else $(c).pageable("destroy"),$(c).removeClass(silex.utils.PageablePlugin.PAGEABLE_ROOT_CLASS_NAME)};
silex.utils.PageablePlugin.getPages=function(){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");var c=[];$('a[data-silex-type="page"]',silex.utils.PageablePlugin.bodyElement).each(function(){c.push(this.getAttribute("id"))});return c};
silex.utils.PageablePlugin.getCurrentPageName=function(){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");return $(silex.utils.PageablePlugin.bodyElement).pageable("option","currentPage")};silex.utils.PageablePlugin.setCurrentPage=function(c){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");$(silex.utils.PageablePlugin.bodyElement).pageable({currentPage:c})};
silex.utils.PageablePlugin.getDisplayName=function(c){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");var d="";$('a[data-silex-type="page"]',silex.utils.PageablePlugin.bodyElement).each(function(){this.getAttribute("id")===c&&(d=this.innerHTML)});return d};
silex.utils.PageablePlugin.removePage=function(c){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");$('a[data-silex-type="page"]',silex.utils.PageablePlugin.bodyElement).each(function(){this.getAttribute("id")===c&&$(this).remove()});$('*[data-silex-href="#!'+c+'"]').each(function(){this.removeAttribute("data-silex-href")});$("."+c).each(function(){$(this).removeClass(c);0>=silex.utils.PageablePlugin.getPagesForElement(this).length&&
$(this).removeClass(silex.utils.PageablePlugin.PAGE_CLASS_NAME)})};silex.utils.PageablePlugin.createPage=function(c,d){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");var e=goog.dom.createElement("a");e.setAttribute("id",c);e.setAttribute("data-silex-type","page");e.innerHTML=d;goog.dom.appendChild(silex.utils.PageablePlugin.bodyElement,e);goog.dom.classes.add(e,"page-element")};
silex.utils.PageablePlugin.renamePage=function(c,d,e){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");$('a[data-silex-type="page"]',silex.utils.PageablePlugin.bodyElement).each(function(){this.getAttribute("id")===c&&(this.setAttribute("id",d),this.innerHTML=e)});$('*[data-silex-href="#!'+c+'"]').each(function(){this.setAttribute("data-silex-href","#!"+d)});$("."+c).each(function(){$(this).removeClass(c);
$(this).addClass(d)})};silex.utils.PageablePlugin.setLink=function(c,d){d?c.setAttribute(silex.utils.PageablePlugin.LINK_ATTR,d):c.removeAttribute(silex.utils.PageablePlugin.LINK_ATTR)};silex.utils.PageablePlugin.getLink=function(c){return c.getAttribute("data-silex-href")};silex.utils.PageablePlugin.addToPage=function(c,d){goog.dom.classes.add(c,d);goog.dom.classes.add(c,silex.utils.PageablePlugin.PAGE_CLASS_NAME)};
silex.utils.PageablePlugin.removeFromPage=function(c,d){goog.dom.classes.remove(c,d);0<!silex.utils.PageablePlugin.getPagesForElement(c).length&&goog.dom.classes.remove(c,silex.utils.PageablePlugin.PAGE_CLASS_NAME)};
silex.utils.PageablePlugin.getPagesForElement=function(c){if(!silex.utils.PageablePlugin.getPageable(silex.utils.PageablePlugin.bodyElement))throw Error("Operation failed, root pageable element is required.");var d=[],e=silex.utils.PageablePlugin.getPages();for(idx in e){var f=e[idx];goog.dom.classes.has(c,f)&&d.push(f)}return d};silex.utils.PageablePlugin.isInPage=function(c,d){d||(d=silex.utils.PageablePlugin.getCurrentPageName());return goog.dom.classes.has(c,d)};silex.controller={};silex.controller.ControllerBase=function(c,d){this.model=c;this.view=d;this.tracker=silex.service.Tracker.getInstance()};silex.controller.ControllerBase.prototype.removeElement=function(c){c||(c=this.view.stage.getSelection()[0]);this.model.element.removeElement(c);this.view.propertyTool.redraw()};
silex.controller.ControllerBase.prototype.browseBgImage=function(){this.tracker.trackAction("controller-events","request","selectBgImage",0);this.view.fileExplorer.openDialog(goog.bind(function(c){var d=this.view.stage.getSelection()[0],e=silex.utils.Url.getBaseUrl();c=silex.utils.Url.getAbsolutePath(c,e);this.model.element.setBgImage(d,c);this.view.propertyTool.redraw();this.tracker.trackAction("controller-events","success","selectBgImage",1)},this),{mimetype:"image/*"},goog.bind(function(c){silex.utils.Notification.notifyError("Error: I could not load the image. <br /><br />"+
(c.message||""));this.tracker.trackAction("controller-events","error",type,-1)},this));this.view.workspace.invalidate()};
silex.controller.ControllerBase.prototype.browseAndAddImage=function(){this.tracker.trackAction("controller-events","request","insert.image",0);this.view.fileExplorer.openDialog(goog.bind(function(c){var d=silex.utils.Url.getBaseUrl();c=silex.utils.Url.getAbsolutePath(c,d);d=this.addElement(silex.model.Element.TYPE_IMAGE);this.model.element.setImageUrl(d,c,goog.bind(function(c,d){goog.style.setStyle(c,{width:d.naturalWidth+"px",height:d.naturalHeight+"px"});this.tracker.trackAction("controller-events",
"success","insert.image",1)},this),goog.bind(function(c,d){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+d);this.removeElement(c);this.tracker.trackAction("controller-events","error","insert.image",1)},this))},this),{mimetype:"image/*"},goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","insert.image",-1)},this));this.view.workspace.invalidate()};
silex.controller.ControllerBase.prototype.addElement=function(c){this.tracker.trackAction("controller-events","request","insert."+c,0);try{var d=this.model.element.createElement(c),e=silex.utils.PageablePlugin.getCurrentPageName();silex.utils.PageablePlugin.addToPage(d,e);this.checkElementVisibility(d);this.model.element.setSelected(d,!0);this.view.propertyTool.redraw();silex.utils.EditablePlugin.resetEditable(this.model.body.bodyElement);this.tracker.trackAction("controller-events","success","insert."+
c,1)}catch(f){this.tracker.trackAction("controller-events","error","insert."+c,-1),console.error("could not add element of type",c," - ",f.message)}return d};silex.controller.ControllerBase.prototype.styleChanged=function(c,d){var e=this.view.stage.getSelection()[0];e&&c?(this.model.element.setStyle(e,c,d),this.view.propertyTool.redraw(),silex.utils.EditablePlugin.resetEditable(this.model.body.bodyElement)):console.error("can not set style ",c," on element ",e)};
silex.controller.ControllerBase.prototype.propertyChanged=function(c,d){var e=this.view.stage.getSelection()[0];e&&c?(this.model.element.setProperty(e,c,d),this.view.propertyTool.redraw()):console.error("can not set style ",c," on element ",e)};silex.controller.ControllerBase.prototype.openCssEditor=function(){this.view.cssEditor.openEditor(this.model.head.getHeadStyle())};silex.controller.ControllerBase.prototype.openJsEditor=function(){this.view.jsEditor.openEditor(this.model.head.getHeadScript())};
silex.controller.ControllerBase.prototype.setClassName=function(c){var d=this.view.stage.getSelection()[0];d&&c?(silex.utils.Style.setClassName(d,c),this.view.propertyTool.redraw()):console.error("can not add class ",c," to element ",d)};
silex.controller.ControllerBase.prototype.editElement=function(c){c||(c=this.view.stage.getSelection()[0]);switch(this.model.element.getType(c)){case silex.model.Element.TYPE_TEXT:for(var d=c,e;d&&(!e||"transparent"==e);)d.style&&(e=d.style.backgroundColor),d=d.parentNode;this.view.textEditor.openEditor(this.model.element.getInnerHtml(c),e);break;case silex.model.Element.TYPE_HTML:this.view.htmlEditor.openEditor(this.model.element.getInnerHtml(c));break;case silex.model.Element.TYPE_IMAGE:this.view.fileExplorer.openDialog(goog.bind(function(d){var e=
silex.utils.Url.getBaseUrl();d=silex.utils.Url.getAbsolutePath(d,e);this.model.element.setImageUrl(c,d)},this),{mimetype:"image/*"},goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+(c.message||""))},this)),this.view.workspace.invalidate()}};silex.controller.ControllerBase.prototype.openPage=function(c){silex.utils.PageablePlugin.setCurrentPage(c);this.view.pageTool.redraw()};
silex.controller.ControllerBase.prototype.renamePage=function(c){c||(c=silex.utils.PageablePlugin.getCurrentPageName());this.getUserInputPageName(silex.utils.PageablePlugin.getDisplayName(c),goog.bind(function(d,e){e&&(silex.utils.PageablePlugin.renamePage(c,d,e),this.openPage(d));this.view.pageTool.redraw();this.view.propertyTool.redraw()},this))};
silex.controller.ControllerBase.prototype.removePage=function(c){c||(c=silex.utils.PageablePlugin.getCurrentPage(this.model.body.bodyElement));silex.utils.Notification.confirm('I am about to delete the page "'+silex.utils.PageablePlugin.getDisplayName(c)+'", are you sure?',goog.bind(function(d){d&&(silex.utils.PageablePlugin.removePage(c),this.view.pageTool.redraw(),this.view.propertyTool.redraw())},this))};
silex.controller.ControllerBase.prototype.getUserInputPageName=function(c,d){silex.utils.Notification.prompt("Enter a name for your page!",goog.bind(function(c,f){if(c&&f&&0<f.length){var h=f;f=f.replace(/\ /g,"-").replace(/\./g,"-").replace(/'/g,"-").replace(/"/g,"-").toLowerCase();var k=silex.utils.PageablePlugin.getPages(),l=!1;goog.array.forEach(k,function(c){c===f&&(l=!0)});l?this.openPage(f):d(f,h)}d(null)},this),c)};
silex.controller.ControllerBase.prototype.checkElementVisibility=function(c){if(null!==silex.utils.PageablePlugin.getParentPage(c)){var d=silex.utils.PageablePlugin.getPagesForElement(c);for(idx in d)silex.utils.PageablePlugin.removeFromPage(c,d[idx]);this.view.propertyTool.redraw()}};
silex.controller.ControllerBase.prototype.createPage=function(c,d){this.tracker.trackAction("controller-events","request","insert.page",0);this.getUserInputPageName("Your new page name",goog.bind(function(e,f){e?(silex.utils.PageablePlugin.createPage(e,f),this.openPage(e),this.view.pageTool.redraw(),this.view.propertyTool.redraw(),c&&c(),this.tracker.trackAction("controller-events","success","insert.page",1)):(d&&d(),this.tracker.trackAction("controller-events","cancel","insert.page",0))},this))};
silex.controller.ControllerBase.prototype.preview=function(){this.tracker.trackAction("controller-events","request","view.file",0);try{this.model.file.getUrl()?(window.open(this.model.file.getUrl()),this.tracker.trackAction("controller-events","success","view.file",1)):silex.utils.Notification.confirm("Save your file before preview?",goog.bind(function(c){c&&this.save(null,goog.bind(function(){window.open(this.model.file.getUrl());this.tracker.trackAction("controller-events","success","view.file",
1)},this))},this))}catch(c){this.tracker.trackAction("controller-events","error","view.file",-1)}};silex.controller.ControllerBase.prototype.promptTitle=function(){silex.utils.Notification.prompt("What is the name of your website?",goog.bind(function(c,d){c&&(this.model.head.setTitle(d),this.view.menu.redraw())},this),this.model.head.getTitle())};silex.controller.ControllerBase.prototype.refreshFonts=function(){var c=this.view.stage.getNeededFonts();this.model.head.refreshFontList(c)};
silex.controller.ControllerBase.prototype.newFile=function(c,d){this.tracker.trackAction("controller-events","request","file.new",0);this.model.file.newFile(goog.bind(function(d){this.model.file.setHtml(d);this.fileOperationSuccess(null,!0);this.tracker.trackAction("controller-events","success","file.new",1);c&&c()},this),function(c){this.tracker.trackAction("controller-events","error","file.new",-1);d&&d(c)})};
silex.controller.ControllerBase.prototype.openFile=function(c,d){this.tracker.trackAction("controller-events","request","file.open",0);this.view.fileExplorer.openDialog(goog.bind(function(e){this.model.file.open(e,goog.bind(function(d){this.model.file.setHtml(d);silex.utils.RetroCompat.process(this.model.body.bodyElement,this.model.head.headElement);this.fileOperationSuccess(this.model.head.getTitle()+" opened.",!0);this.tracker.trackAction("controller-events","success","file.open",1);c&&c()},this),
goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to open this file. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)},this))},this),{mimetype:"text/html"},function(c){this.tracker.trackAction("controller-events","error","file.open",-1);d&&d(c)})};
silex.controller.ControllerBase.prototype.doSave=function(c,d,e){this.model.file.setUrl(c);var f=this.model.file.getHtml();this.model.file.saveAs(c,f,goog.bind(function(){this.tracker.trackAction("controller-events","success","file.save",1);this.fileOperationSuccess("File is saved.",!1);d&&d()},this),goog.bind(function(c){silex.utils.Notification.notifyError("Error: I did not manage to save the file. <br /><br />"+(c.message||""));this.tracker.trackAction("controller-events","error","file.save",-1);
e&&e(c)},this))};silex.controller.ControllerBase.prototype.save=function(c,d,e){this.tracker.trackAction("controller-events","request","file.save",0);c?this.doSave(c,d,e):this.view.fileExplorer.saveAsDialog(goog.bind(function(c){this.doSave(c,d,e)},this),{mimetype:"text/html"})};
silex.controller.ControllerBase.prototype.fileOperationSuccess=function(c,d){console.log(arguments);if(d){var e=silex.utils.PageablePlugin.getPages();silex.utils.PageablePlugin.setCurrentPage(e[0]);this.view.pageTool.redraw();this.view.propertyTool.redraw();this.view.menu.redraw();this.refreshFonts()}c&&silex.utils.Notification.notifySuccess(c);this.model.head.updateBrowserStyle()};
silex.controller.ControllerBase.prototype.publish=function(){this.tracker.trackAction("controller-events","request","file.publish",0);this.model.head.getPublicationPath()?this.model.file.publish(this.model.head.getPublicationPath(),goog.bind(function(c){c&&!1==c.success?(console.error("Error: I did not manage to publish the file. (1)"),silex.utils.Notification.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
(c.message||c.code||"")),this.tracker.trackAction("controller-events","error","file.publish",-1)):(silex.utils.Notification.notifySuccess("I am about to publish your site. This may take several minutes."),this.tracker.trackAction("controller-events","success","file.publish",1))},this),goog.bind(function(c){console.error("Error: I did not manage to publish the file. (2)",c);silex.utils.Notification.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
c);this.tracker.trackAction("controller-events","error","file.publish",-1)},this)):silex.utils.Notification.alert('I do not know where to publish your site.       Select a folder in the settings pannel and do "publish" again.       <br /><br />Now I will open the publish settings.',goog.bind(function(){this.view.settingsDialog.openDialog();this.view.workspace.invalidate();this.tracker.trackAction("controller-events","cancel","file.publish",0)},this))};silex.controller.JsEditorController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.jsEditor.onStatus=goog.bind(this.jsEditorCallback,this)};goog.inherits(silex.controller.JsEditorController,silex.controller.ControllerBase);silex.controller.JsEditorController.prototype.jsEditorCallback=function(c,d){switch(c){case "changed":this.model.head.setHeadScript(d)}};goog.string={};goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(c,d){return 0==c.lastIndexOf(d,0)};goog.string.endsWith=function(c,d){var e=c.length-d.length;return 0<=e&&c.indexOf(d,e)==e};goog.string.caseInsensitiveStartsWith=function(c,d){return 0==goog.string.caseInsensitiveCompare(d,c.substr(0,d.length))};goog.string.caseInsensitiveEndsWith=function(c,d){return 0==goog.string.caseInsensitiveCompare(d,c.substr(c.length-d.length,d.length))};
...
goog.string.htmlEscape=function(c,d){if(d)return c.replace(goog.string.amperRe_,"&amp;").replace(goog.string.ltRe_,"&lt;").replace(goog.string.gtRe_,"&gt;").replace(goog.string.quotRe_,"&quot;").replace(goog.string.singleQuoteRe_,"&#39;");if(!goog.string.allRe_.test(c))return c;-1!=c.indexOf("&")&&(c=c.replace(goog.string.amperRe_,"&amp;"));-1!=c.indexOf("<")&&(c=c.replace(goog.string.ltRe_,"&lt;"));-1!=c.indexOf(">")&&(c=c.replace(goog.string.gtRe_,"&gt;"));-1!=c.indexOf('"')&&(c=c.replace(goog.string.quotRe_,
"&quot;"));-1!=c.indexOf("'")&&(c=c.replace(goog.string.singleQuoteRe_,"&#39;"));return c};goog.string.amperRe_=/&/g;goog.string.ltRe_=/</g;goog.string.gtRe_=/>/g;goog.string.quotRe_=/"/g;goog.string.singleQuoteRe_=/'/g;goog.string.allRe_=/[&<>"']/;goog.string.unescapeEntities=function(c){return goog.string.contains(c,"&")?"document"in goog.global?goog.string.unescapeEntitiesUsingDom_(c):goog.string.unescapePureXmlEntities_(c):c};
goog.string.unescapeEntitiesWithDocument=function(c,d){return goog.string.contains(c,"&")?goog.string.unescapeEntitiesUsingDom_(c,d):c};
goog.string.unescapeEntitiesUsingDom_=function(c,d){var e={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"'},f;f=d?d.createElement("div"):document.createElement("div");return c.replace(goog.string.HTML_ENTITY_PATTERN_,function(c,d){var l=e[c];if(l)return l;if("#"==d.charAt(0)){var m=Number("0"+d.substr(1));isNaN(m)||(l=String.fromCharCode(m))}l||(f.innerHTML=c+" ",l=f.firstChild.nodeValue.slice(0,-1));return e[c]=l})};
...
goog.string.compareVersions=function(c,d){for(var e=0,f=goog.string.trim(String(c)).split("."),h=goog.string.trim(String(d)).split("."),k=Math.max(f.length,h.length),l=0;0==e&&l<k;l++){var m=f[l]||"",n=h[l]||"",p=RegExp("(\\d*)(\\D*)","g"),q=RegExp("(\\d*)(\\D*)","g");do{var s=p.exec(m)||["","",""],t=q.exec(n)||["","",""];if(0==s[0].length&&0==t[0].length)break;var e=0==s[1].length?0:parseInt(s[1],10),u=0==t[1].length?0:parseInt(t[1],10),e=goog.string.compareElements_(e,u)||goog.string.compareElements_(0==
s[2].length,0==t[2].length)||goog.string.compareElements_(s[2],t[2])}while(0==e)}return e};goog.string.compareElements_=function(c,d){return c<d?-1:c>d?1:0};goog.string.HASHCODE_MAX_=4294967296;goog.string.hashCode=function(c){for(var d=0,e=0;e<c.length;++e)d=31*d+c.charCodeAt(e),d%=goog.string.HASHCODE_MAX_;return d};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};
...
goog.string.toTitleCase=function(c,d){var e=goog.isString(d)?goog.string.regExpEscape(d):"\\s";return c.replace(RegExp("(^"+(e?"|["+e+"]+":"")+")([a-z])","g"),function(c,d,e){return d+e.toUpperCase()})};goog.string.parseInt=function(c){isFinite(c)&&(c=String(c));return goog.isString(c)?/^\s*-?0x/i.test(c)?parseInt(c,16):parseInt(c,10):NaN};goog.string.splitLimit=function(c,d,e){c=c.split(d);for(var f=[];0<e&&c.length;)f.push(c.shift()),e--;c.length&&f.push(c.join(d));return f};goog.userAgent={};goog.userAgent.ASSUME_IE=!1;goog.userAgent.ASSUME_GECKO=!1;goog.userAgent.ASSUME_WEBKIT=!1;goog.userAgent.ASSUME_MOBILE_WEBKIT=!1;goog.userAgent.ASSUME_OPERA=!1;goog.userAgent.ASSUME_ANY_VERSION=!1;goog.userAgent.BROWSER_KNOWN_=goog.userAgent.ASSUME_IE||goog.userAgent.ASSUME_GECKO||goog.userAgent.ASSUME_MOBILE_WEBKIT||goog.userAgent.ASSUME_WEBKIT||goog.userAgent.ASSUME_OPERA;
...
goog.userAgent.determineVersion_=function(){var c="",d;goog.userAgent.OPERA&&goog.global.opera?(c=goog.global.opera.version,c="function"==typeof c?c():c):(goog.userAgent.GECKO?d=/rv\:([^\);]+)(\)|;)/:goog.userAgent.IE?d=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:goog.userAgent.WEBKIT&&(d=/WebKit\/(\S+)/),d&&(c=(c=d.exec(goog.userAgent.getUserAgentString()))?c[1]:""));return goog.userAgent.IE&&(d=goog.userAgent.getDocumentMode_(),d>parseFloat(c))?String(d):c};
...
goog.userAgent.DOCUMENT_MODE=function(){var c=goog.global.document;return c&&goog.userAgent.IE?goog.userAgent.getDocumentMode_()||("CSS1Compat"==c.compatMode?parseInt(goog.userAgent.VERSION,10):5):void 0}();goog.events={};
...
default:return!1}};goog.events.KeyCodes.normalizeKeyCode=function(c){return goog.userAgent.GECKO?goog.events.KeyCodes.normalizeGeckoKeyCode(c):goog.userAgent.MAC&&goog.userAgent.WEBKIT?goog.events.KeyCodes.normalizeMacWebKitKeyCode(c):c};
goog.events.KeyCodes.normalizeGeckoKeyCode=function(c){switch(c){case goog.events.KeyCodes.FF_EQUALS:return goog.events.KeyCodes.EQUALS;case goog.events.KeyCodes.FF_SEMICOLON:return goog.events.KeyCodes.SEMICOLON;case goog.events.KeyCodes.FF_DASH:return goog.events.KeyCodes.DASH;case goog.events.KeyCodes.MAC_FF_META:return goog.events.KeyCodes.META;case goog.events.KeyCodes.WIN_KEY_FF_LINUX:return goog.events.KeyCodes.WIN_KEY;default:return c}};
goog.events.KeyCodes.normalizeMacWebKitKeyCode=function(c){switch(c){case goog.events.KeyCodes.MAC_WK_CMD_RIGHT:return goog.events.KeyCodes.META;default:return c}};goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.debug={};goog.debug.Error=function(c){Error.captureStackTrace?Error.captureStackTrace(this,goog.debug.Error):this.stack=Error().stack||"";c&&(this.message=String(c))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.asserts={};goog.asserts.ENABLE_ASSERTS=goog.DEBUG;goog.asserts.AssertionError=function(c,d){d.unshift(c);goog.debug.Error.call(this,goog.string.subs.apply(null,d));d.shift();this.messagePattern=c};goog.inherits(goog.asserts.AssertionError,goog.debug.Error);goog.asserts.AssertionError.prototype.name="AssertionError";goog.asserts.doAssertFailure_=function(c,d,e,f){var h="Assertion failed";if(e)var h=h+(": "+e),k=f;else c&&(h+=": "+c,k=d);throw new goog.asserts.AssertionError(""+h,k||[]);};
...
goog.object.createImmutableView=function(c){var d=c;Object.isFrozen&&!Object.isFrozen(c)&&(d=Object.create(c),Object.freeze(d));return d};goog.object.isImmutableView=function(c){return!!Object.isFrozen&&Object.isFrozen(c)};goog.array={};goog.NATIVE_ARRAY_PROTOTYPES=goog.TRUSTED_SITE;goog.array.peek=function(c){return c[c.length-1]};goog.array.ARRAY_PROTOTYPE_=Array.prototype;
...
goog.array.map=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.map?function(c,d,e){goog.asserts.assert(null!=c.length);return goog.array.ARRAY_PROTOTYPE_.map.call(c,d,e)}:function(c,d,e){for(var f=c.length,h=Array(f),k=goog.isString(c)?c.split(""):c,l=0;l<f;l++)l in k&&(h[l]=d.call(e,k[l],l,c));return h};
goog.array.reduce=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.reduce?function(c,d,e,f){goog.asserts.assert(null!=c.length);f&&(d=goog.bind(d,f));return goog.array.ARRAY_PROTOTYPE_.reduce.call(c,d,e)}:function(c,d,e,f){var h=e;goog.array.forEach(c,function(e,l){h=d.call(f,h,e,l,c)});return h};
goog.array.reduceRight=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.reduceRight?function(c,d,e,f){goog.asserts.assert(null!=c.length);f&&(d=goog.bind(d,f));return goog.array.ARRAY_PROTOTYPE_.reduceRight.call(c,d,e)}:function(c,d,e,f){var h=e;goog.array.forEachRight(c,function(e,l){h=d.call(f,h,e,l,c)});return h};
...
goog.dom.vendor.getPrefixedPropertyName=function(c,d){if(d&&c in d)return c;var e=goog.dom.vendor.getVendorJsPrefix();return e?(e=e.toLowerCase(),e+=goog.string.toTitleCase(c),!goog.isDef(d)||e in d?e:null):null};goog.dom.vendor.getPrefixedEventType=function(c){return((goog.dom.vendor.getVendorJsPrefix()||"")+c).toLowerCase()};goog.dom.classes={};goog.dom.classes.set=function(c,d){c.className=d};goog.dom.classes.get=function(c){c=c.className;return goog.isString(c)&&c.match(/\S+/g)||[]};goog.dom.classes.add=function(c,d){var e=goog.dom.classes.get(c),f=goog.array.slice(arguments,1),h=e.length+f.length;goog.dom.classes.add_(e,f);goog.dom.classes.set(c,e.join(" "));return e.length==h};
...
goog.functions.not=function(c){return function(){return!c.apply(this,arguments)}};goog.functions.create=function(c,d){var e=function(){};e.prototype=c.prototype;e=new e;c.apply(e,Array.prototype.slice.call(arguments,1));return e};goog.functions.CACHE_RETURN_VALUE=!0;goog.functions.cacheReturnValue=function(c){var d=!1,e;return function(){if(!goog.functions.CACHE_RETURN_VALUE)return c();d||(e=c(),d=!0);return e}};goog.dom.BrowserFeature={CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),CAN_USE_CHILDREN_ATTRIBUTE:!goog.userAgent.GECKO&&!goog.userAgent.IE||goog.userAgent.IE&&goog.userAgent.isDocumentModeOrHigher(9)||goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9.1"),CAN_USE_INNER_TEXT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),CAN_USE_PARENT_ELEMENT_PROPERTY:goog.userAgent.IE||goog.userAgent.OPERA||goog.userAgent.WEBKIT,INNER_HTML_NEEDS_SCOPED_ELEMENT:goog.userAgent.IE};goog.dom.ASSUME_QUIRKS_MODE=!1;goog.dom.ASSUME_STANDARDS_MODE=!1;goog.dom.COMPAT_MODE_KNOWN_=goog.dom.ASSUME_QUIRKS_MODE||goog.dom.ASSUME_STANDARDS_MODE;goog.dom.getDomHelper=function(c){return c?new goog.dom.DomHelper(goog.dom.getOwnerDocument(c)):goog.dom.defaultDomHelper_||(goog.dom.defaultDomHelper_=new goog.dom.DomHelper)};goog.dom.getDocument=function(){return document};goog.dom.getElement=function(c){return goog.dom.getElementHelper_(document,c)};
goog.dom.getElementHelper_=function(c,d){return goog.isString(d)?c.getElementById(d):d};goog.dom.getRequiredElement=function(c){return goog.dom.getRequiredElementHelper_(document,c)};goog.dom.getRequiredElementHelper_=function(c,d){goog.asserts.assertString(d);var e=goog.dom.getElementHelper_(c,d);return e=goog.asserts.assertElement(e,"No element found with id: "+d)};goog.dom.$=goog.dom.getElement;
goog.dom.getElementsByTagNameAndClass=function(c,d,e){return goog.dom.getElementsByTagNameAndClass_(document,c,d,e)};goog.dom.getElementsByClass=function(c,d){var e=d||document;return goog.dom.canUseQuerySelector_(e)?e.querySelectorAll("."+c):e.getElementsByClassName?e.getElementsByClassName(c):goog.dom.getElementsByTagNameAndClass_(document,"*",c,d)};
goog.dom.getElementByClass=function(c,d){var e=d||document,f=null;return(f=goog.dom.canUseQuerySelector_(e)?e.querySelector("."+c):goog.dom.getElementsByClass(c,d)[0])||null};goog.dom.getRequiredElementByClass=function(c,d){var e=goog.dom.getElementByClass(c,d);return goog.asserts.assert(e,"No element found with className: "+c)};goog.dom.canUseQuerySelector_=function(c){return!(!c.querySelectorAll||!c.querySelector)};
...
goog.dom.getDocumentScrollElement_=function(c){return!goog.userAgent.WEBKIT&&goog.dom.isCss1CompatMode_(c)?c.documentElement:c.body||c.documentElement};goog.dom.getWindow=function(c){return c?goog.dom.getWindow_(c):window};goog.dom.getWindow_=function(c){return c.parentWindow||c.defaultView};goog.dom.createDom=function(c,d,e){return goog.dom.createDom_(document,arguments)};
...
goog.dom.getFrameContentDocument=function(c){return c.contentDocument||c.contentWindow.document};goog.dom.getFrameContentWindow=function(c){return c.contentWindow||goog.dom.getWindow(goog.dom.getFrameContentDocument(c))};
goog.dom.setTextContent=function(c,d){goog.asserts.assert(null!=c,"goog.dom.setTextContent expects a non-null value for node");if("textContent"in c)c.textContent=d;else if(c.nodeType==goog.dom.NodeType.TEXT)c.data=d;else if(c.firstChild&&c.firstChild.nodeType==goog.dom.NodeType.TEXT){for(;c.lastChild!=c.firstChild;)c.removeChild(c.lastChild);c.firstChild.data=d}else{goog.dom.removeChildren(c);var e=goog.dom.getOwnerDocument(c);c.appendChild(e.createTextNode(String(d)))}};
goog.dom.getOuterHtml=function(c){if("outerHTML"in c)return c.outerHTML;var d=goog.dom.getOwnerDocument(c).createElement("div");d.appendChild(c.cloneNode(!0));return d.innerHTML};goog.dom.findNode=function(c,d){var e=[];return goog.dom.findNodes_(c,d,e,!0)?e[0]:void 0};goog.dom.findNodes=function(c,d){var e=[];goog.dom.findNodes_(c,d,e,!1);return e};goog.dom.findNodes_=function(c,d,e,f){if(null!=c)for(c=c.firstChild;c;){if(d(c)&&(e.push(c),f)||goog.dom.findNodes_(c,d,e,f))return!0;c=c.nextSibling}return!1};
goog.dom.TAGS_TO_IGNORE_={SCRIPT:1,STYLE:1,HEAD:1,IFRAME:1,OBJECT:1};goog.dom.PREDEFINED_TAG_VALUES_={IMG:" ",BR:"\n"};goog.dom.isFocusableTabIndex=function(c){return goog.dom.hasSpecifiedTabIndex_(c)&&goog.dom.isTabIndexFocusable_(c)};goog.dom.setFocusableTabIndex=function(c,d){d?c.tabIndex=0:(c.tabIndex=-1,c.removeAttribute("tabIndex"))};
goog.dom.isFocusable=function(c){var d;return(d=goog.dom.nativelySupportsFocus_(c)?!c.disabled&&(!goog.dom.hasSpecifiedTabIndex_(c)||goog.dom.isTabIndexFocusable_(c)):goog.dom.isFocusableTabIndex(c))&&goog.userAgent.IE?goog.dom.hasNonZeroBoundingRect_(c):d};goog.dom.hasSpecifiedTabIndex_=function(c){c=c.getAttributeNode("tabindex");return goog.isDefAndNotNull(c)&&c.specified};goog.dom.isTabIndexFocusable_=function(c){c=c.tabIndex;return goog.isNumber(c)&&0<=c&&32768>c};
goog.dom.nativelySupportsFocus_=function(c){return c.tagName==goog.dom.TagName.A||c.tagName==goog.dom.TagName.INPUT||c.tagName==goog.dom.TagName.TEXTAREA||c.tagName==goog.dom.TagName.SELECT||c.tagName==goog.dom.TagName.BUTTON};goog.dom.hasNonZeroBoundingRect_=function(c){c=goog.isFunction(c.getBoundingClientRect)?c.getBoundingClientRect():{height:c.offsetHeight,width:c.offsetWidth};return goog.isDefAndNotNull(c)&&0<c.height&&0<c.width};
...
goog.dom.getAncestorByClass=function(c,d){return goog.dom.getAncestorByTagNameAndClass(c,null,d)};goog.dom.getAncestor=function(c,d,e,f){e||(c=c.parentNode);e=null==f;for(var h=0;c&&(e||h<=f);){if(d(c))return c;c=c.parentNode;h++}return null};goog.dom.getActiveElement=function(c){try{return c&&c.activeElement}catch(d){}return null};
goog.dom.getPixelRatio=goog.functions.cacheReturnValue(function(){var c=goog.dom.getWindow(),d=goog.userAgent.GECKO&&goog.userAgent.MOBILE;return goog.isDef(c.devicePixelRatio)&&!d?c.devicePixelRatio:c.matchMedia?goog.dom.matchesPixelRatio_(0.75)||goog.dom.matchesPixelRatio_(1.5)||goog.dom.matchesPixelRatio_(2)||goog.dom.matchesPixelRatio_(3)||1:1});
goog.dom.matchesPixelRatio_=function(c){return goog.dom.getWindow().matchMedia("(-webkit-min-device-pixel-ratio: "+c+"),(min--moz-device-pixel-ratio: "+c+"),(min-resolution: "+c+"dppx)").matches?c:0};goog.dom.DomHelper=function(c){this.document_=c||goog.global.document||document};goog.dom.DomHelper.prototype.getDomHelper=goog.dom.getDomHelper;goog.dom.DomHelper.prototype.setDocument=function(c){this.document_=c};goog.dom.DomHelper.prototype.getDocument=function(){return this.document_};
goog.dom.DomHelper.prototype.getElement=function(c){return goog.dom.getElementHelper_(this.document_,c)};goog.dom.DomHelper.prototype.getRequiredElement=function(c){return goog.dom.getRequiredElementHelper_(this.document_,c)};goog.dom.DomHelper.prototype.$=goog.dom.DomHelper.prototype.getElement;goog.dom.DomHelper.prototype.getElementsByTagNameAndClass=function(c,d,e){return goog.dom.getElementsByTagNameAndClass_(this.document_,c,d,e)};
goog.dom.DomHelper.prototype.getElementsByClass=function(c,d){return goog.dom.getElementsByClass(c,d||this.document_)};goog.dom.DomHelper.prototype.getElementByClass=function(c,d){return goog.dom.getElementByClass(c,d||this.document_)};goog.dom.DomHelper.prototype.getRequiredElementByClass=function(c,d){return goog.dom.getRequiredElementByClass(c,d||this.document_)};goog.dom.DomHelper.prototype.$$=goog.dom.DomHelper.prototype.getElementsByTagNameAndClass;
goog.dom.DomHelper.prototype.setProperties=goog.dom.setProperties;goog.dom.DomHelper.prototype.getViewportSize=function(c){return goog.dom.getViewportSize(c||this.getWindow())};goog.dom.DomHelper.prototype.getDocumentHeight=function(){return goog.dom.getDocumentHeight_(this.getWindow())};goog.dom.DomHelper.prototype.createDom=function(c,d,e){return goog.dom.createDom_(this.document_,arguments)};goog.dom.DomHelper.prototype.$dom=goog.dom.DomHelper.prototype.createDom;
goog.dom.DomHelper.prototype.createElement=function(c){return this.document_.createElement(c)};goog.dom.DomHelper.prototype.createTextNode=function(c){return this.document_.createTextNode(String(c))};goog.dom.DomHelper.prototype.createTable=function(c,d,e){return goog.dom.createTable_(this.document_,c,d,!!e)};goog.dom.DomHelper.prototype.htmlToDocumentFragment=function(c){return goog.dom.htmlToDocumentFragment_(this.document_,c)};goog.dom.DomHelper.prototype.isCss1CompatMode=function(){return goog.dom.isCss1CompatMode_(this.document_)};
goog.dom.DomHelper.prototype.getWindow=function(){return goog.dom.getWindow_(this.document_)};goog.dom.DomHelper.prototype.getDocumentScrollElement=function(){return goog.dom.getDocumentScrollElement_(this.document_)};goog.dom.DomHelper.prototype.getDocumentScroll=function(){return goog.dom.getDocumentScroll_(this.document_)};goog.dom.DomHelper.prototype.getActiveElement=function(c){return goog.dom.getActiveElement(c||this.document_)};goog.dom.DomHelper.prototype.appendChild=goog.dom.appendChild;
...
goog.style.getComputedBoxSizing=function(c){return goog.style.getStyle_(c,"boxSizing")||goog.style.getStyle_(c,"MozBoxSizing")||goog.style.getStyle_(c,"WebkitBoxSizing")||null};goog.style.getComputedPosition=function(c){return goog.style.getStyle_(c,"position")};goog.style.getBackgroundColor=function(c){return goog.style.getStyle_(c,"backgroundColor")};goog.style.getComputedOverflowX=function(c){return goog.style.getStyle_(c,"overflowX")};
goog.style.getComputedOverflowY=function(c){return goog.style.getStyle_(c,"overflowY")};goog.style.getComputedZIndex=function(c){return goog.style.getStyle_(c,"zIndex")};goog.style.getComputedTextAlign=function(c){return goog.style.getStyle_(c,"textAlign")};goog.style.getComputedCursor=function(c){return goog.style.getStyle_(c,"cursor")};
goog.style.setPosition=function(c,d,e){var f,h=goog.userAgent.GECKO&&(goog.userAgent.MAC||goog.userAgent.X11)&&goog.userAgent.isVersionOrHigher("1.9");d instanceof goog.math.Coordinate?(f=d.x,d=d.y):(f=d,d=e);c.style.left=goog.style.getPixelStyleValue_(f,h);c.style.top=goog.style.getPixelStyleValue_(d,h)};goog.style.getPosition=function(c){return new goog.math.Coordinate(c.offsetLeft,c.offsetTop)};
goog.style.getClientViewportElement=function(c){c=c?goog.dom.getOwnerDocument(c):goog.dom.getDocument();return!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9)||goog.dom.getDomHelper(c).isCss1CompatMode()?c.documentElement:c.body};goog.style.getViewportPageOffset=function(c){var d=c.body;c=c.documentElement;return new goog.math.Coordinate(d.scrollLeft||c.scrollLeft,d.scrollTop||c.scrollTop)};
goog.style.getBoundingClientRect_=function(c){var d;try{d=c.getBoundingClientRect()}catch(e){return{left:0,top:0,right:0,bottom:0}}goog.userAgent.IE&&c.ownerDocument.body&&(c=c.ownerDocument,d.left-=c.documentElement.clientLeft+c.body.clientLeft,d.top-=c.documentElement.clientTop+c.body.clientTop);return d};
...
goog.style.installStyles=function(c,d){var e=goog.dom.getDomHelper(d),f=null,h=e.getDocument();goog.userAgent.IE&&h.createStyleSheet?(f=h.createStyleSheet(),goog.style.setStyles(f,c)):(h=e.getElementsByTagNameAndClass("head")[0],h||(f=e.getElementsByTagNameAndClass("body")[0],h=e.createDom("head"),f.parentNode.insertBefore(h,f)),f=e.createDom("style"),goog.style.setStyles(f,c),e.appendChild(h,f));return f};goog.style.uninstallStyles=function(c){goog.dom.removeNode(c.ownerNode||c.owningElement||c)};
goog.style.setStyles=function(c,d){goog.userAgent.IE&&goog.isDef(c.cssText)?c.cssText=d:c.innerHTML=d};goog.style.setPreWrap=function(c){c=c.style;goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("8")?(c.whiteSpace="pre",c.wordWrap="break-word"):c.whiteSpace=goog.userAgent.GECKO?"-moz-pre-wrap":"pre-wrap"};
...
goog.style.getBorderBox=function(c){if(goog.userAgent.IE&&!goog.userAgent.isDocumentModeOrHigher(9)){var d=goog.style.getIePixelBorder_(c,"borderLeft"),e=goog.style.getIePixelBorder_(c,"borderRight"),f=goog.style.getIePixelBorder_(c,"borderTop");c=goog.style.getIePixelBorder_(c,"borderBottom");return new goog.math.Box(f,e,c,d)}d=goog.style.getComputedStyle(c,"borderLeftWidth");e=goog.style.getComputedStyle(c,"borderRightWidth");f=goog.style.getComputedStyle(c,"borderTopWidth");c=goog.style.getComputedStyle(c,
"borderBottomWidth");return new goog.math.Box(parseFloat(f),parseFloat(e),parseFloat(c),parseFloat(d))};goog.style.getFontFamily=function(c){var d=goog.dom.getOwnerDocument(c),e="";if(d.body.createTextRange){d=d.body.createTextRange();d.moveToElementText(c);try{e=d.queryCommandValue("FontName")}catch(f){e=""}}e||(e=goog.style.getStyle_(c,"fontFamily"));c=e.split(",");1<c.length&&(e=c[0]);return goog.string.stripQuotes(e,"\"'")};goog.style.lengthUnitRegex_=/[^\d]+$/;
...
goog.dom.createDom("span",{style:"visibility:hidden;position:absolute;line-height:0;padding:0;margin:0;border:0;height:1em;"});goog.dom.appendChild(c,e);d=e.offsetHeight;goog.dom.removeNode(e);return d};goog.style.parseStyleAttribute=function(c){var d={};goog.array.forEach(c.split(/\s*;\s*/),function(c){c=c.split(/\s*:\s*/);2==c.length&&(d[goog.string.toCamelCase(c[0].toLowerCase())]=c[1])});return d};
...
goog.style.getCssTranslation=function(c){var d;goog.userAgent.IE?d="-ms-transform":goog.userAgent.WEBKIT?d="-webkit-transform":goog.userAgent.OPERA?d="-o-transform":goog.userAgent.GECKO&&(d="-moz-transform");var e;d&&(e=goog.style.getStyle_(c,d));e||(e=goog.style.getStyle_(c,"transform"));return e?(c=e.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(c[1]),parseFloat(c[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(c){var d=goog.style.isRightToLeft(c);return d&&goog.userAgent.GECKO?-c.scrollLeft:!d||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(c)?c.scrollLeft:c.scrollWidth-c.clientWidth-c.scrollLeft};
...
goog.positioning.positionAtAnchor=function(c,d,e,f,h,k,l,m,n){goog.asserts.assert(e);var p=goog.positioning.getOffsetParentPageOffset(e),q=goog.positioning.getVisiblePart_(c);goog.style.translateRectForAnotherFrame(q,goog.dom.getDomHelper(c),goog.dom.getDomHelper(e));c=goog.positioning.getEffectiveCorner(c,d);q=new goog.math.Coordinate(c&goog.positioning.CornerBit.RIGHT?q.left+q.width:q.left,c&goog.positioning.CornerBit.BOTTOM?q.top+q.height:q.top);q=goog.math.Coordinate.difference(q,p);h&&(q.x+=
(c&goog.positioning.CornerBit.RIGHT?-1:1)*h.x,q.y+=(c&goog.positioning.CornerBit.BOTTOM?-1:1)*h.y);var s;if(l)if(n)s=n;else if(s=goog.style.getVisibleRectForElement(e))s.top-=p.y,s.right-=p.x,s.bottom-=p.y,s.left-=p.x;return goog.positioning.positionAtCoordinate(q,e,f,k,s,l,m)};
...
goog.positioning.flipCornerHorizontal=function(c){return c^goog.positioning.CornerBit.RIGHT};goog.positioning.flipCornerVertical=function(c){return c^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(c){return c^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.events.getVendorPrefixedName_=function(c){return goog.userAgent.WEBKIT?"webkit"+c:goog.userAgent.OPERA?"o"+c.toLowerCase():c.toLowerCase()};
...
LOADREDIRECT:"loadredirect",LOADSTART:"loadstart",LOADSTOP:"loadstop",RESPONSIVE:"responsive",SIZECHANGED:"sizechanged",UNRESPONSIVE:"unresponsive",VISIBILITYCHANGE:"visibilitychange"};goog.a11y={};goog.a11y.aria={};
...
goog.a11y.aria.getStateBoolean=function(c,d){var e=c.getAttribute(goog.a11y.aria.getAriaAttributeName_(d));goog.asserts.assert(goog.isBoolean(e)||null==e||"true"==e||"false"==e);return null==e?e:goog.isBoolean(e)?e:"true"==e};goog.a11y.aria.getStateNumber=function(c,d){var e=c.getAttribute(goog.a11y.aria.getAriaAttributeName_(d));goog.asserts.assert((null==e||!isNaN(Number(e)))&&!goog.isBoolean(e));return null==e?null:Number(e)};
goog.a11y.aria.getStateString=function(c,d){var e=c.getAttribute(goog.a11y.aria.getAriaAttributeName_(d));goog.asserts.assert((null==e||goog.isString(e))&&isNaN(Number(e))&&"true"!=e&&"false"!=e);return null==e?null:e};goog.a11y.aria.getStringArrayStateInternalUtil=function(c,d){var e=c.getAttribute(goog.a11y.aria.getAriaAttributeName_(d));return goog.a11y.aria.splitStringOnWhitespace_(e)};goog.a11y.aria.splitStringOnWhitespace_=function(c){return c?c.split(/\s+/):[]};
goog.a11y.aria.getAriaAttributeName_=function(c){goog.asserts.ENABLE_ASSERTS&&(goog.asserts.assert(c,"ARIA attribute cannot be empty."),goog.asserts.assert(goog.object.containsValue(goog.a11y.aria.State,c),"No such ARIA attribute "+c));return goog.a11y.aria.ARIA_PREFIX_+c};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
goog.Disposable.isDisposed=function(c){return c&&"function"==typeof c.isDisposed?c.isDisposed():!1};goog.dispose=function(c){c&&"function"==typeof c.dispose&&c.dispose()};goog.disposeAll=function(c){for(var d=0,e=arguments.length;d<e;++d){var f=arguments[d];goog.isArrayLike(f)?goog.disposeAll.apply(null,f):goog.dispose(f)}};goog.events.EventId=function(c){this.id=c};goog.events.EventId.prototype.toString=function(){return this.id};goog.events.Listenable=function(){};goog.events.Listenable.IMPLEMENTED_BY_PROP="closure_listenable_"+(1E6*Math.random()|0);goog.events.Listenable.addImplementation=function(c){c.prototype[goog.events.Listenable.IMPLEMENTED_BY_PROP]=!0};goog.events.Listenable.isImplementedBy=function(c){try{return!(!c||!c[goog.events.Listenable.IMPLEMENTED_BY_PROP])}catch(d){return!1}};goog.events.ListenableKey=function(){};goog.events.ListenableKey.counter_=0;goog.events.ListenableKey.reserveKey=function(){return++goog.events.ListenableKey.counter_};goog.events.Listener=function(c,d,e,f,h,k){goog.events.Listener.ENABLE_MONITORING&&(this.creationStack=Error().stack);this.listener=c;this.proxy=d;this.src=e;this.type=f;this.capture=!!h;this.handler=k;this.key=goog.events.ListenableKey.reserveKey();this.removed=this.callOnce=!1};goog.events.Listener.ENABLE_MONITORING=!1;goog.events.Listener.prototype.markAsRemoved=function(){this.removed=!0;this.handler=this.src=this.proxy=this.listener=null};goog.events.ListenerMap=function(c){this.src=c;this.listeners={};this.typeCount_=0};goog.events.ListenerMap.prototype.getTypeCount=function(){return this.typeCount_};goog.events.ListenerMap.prototype.getListenerCount=function(){var c=0,d;for(d in this.listeners)c+=this.listeners[d].length;return c};
...
goog.events.ListenerMap.prototype.hasListener=function(c,d){var e=goog.isDef(c),f=goog.isDef(d);return goog.object.some(this.listeners,function(h,k){for(var l=0;l<h.length;++l)if(!(e&&h[l].type!=c||f&&h[l].capture!=d))return!0;return!1})};goog.events.ListenerMap.findListenerIndex_=function(c,d,e,f){for(var h=0;h<c.length;++h){var k=c[h];if(!k.removed&&k.listener==d&&k.capture==!!e&&k.handler==f)return h}return-1};goog.events.BrowserFeature={HAS_W3C_BUTTON:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),HAS_W3C_EVENT_SUPPORT:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),SET_KEY_CODE_TO_PREVENT_DEFAULT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),HAS_NAVIGATOR_ONLINE_PROPERTY:!goog.userAgent.WEBKIT||goog.userAgent.isVersionOrHigher("528"),HAS_HTML5_NETWORK_EVENT_SUPPORT:goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9b")||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||
...
goog.events.listen=function(c,d,e,f,h){if(goog.isArray(d)){for(var k=0;k<d.length;k++)goog.events.listen(c,d[k],e,f,h);return null}e=goog.events.wrapListener_(e);return goog.events.Listenable.isImplementedBy(c)?c.listen(d,e,f,h):goog.events.listen_(c,d,e,!1,f,h)};
goog.events.listen_=function(c,d,e,f,h,k){if(!d)throw Error("Invalid event type");var l=!!h;if(l&&!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT){if(goog.events.CAPTURE_SIMULATION_MODE==goog.events.CaptureSimulationMode.OFF_AND_FAIL)return goog.asserts.fail("Can not register capture listener in IE8-."),null;if(goog.events.CAPTURE_SIMULATION_MODE==goog.events.CaptureSimulationMode.OFF_AND_SILENT)return null}var m=goog.events.getListenerMap_(c);m||(c[goog.events.LISTENER_MAP_PROP_]=m=new goog.events.ListenerMap(c));
e=m.add(d,e,f,h,k);if(e.proxy)return e;f=goog.events.getProxy();e.proxy=f;f.src=c;f.listener=e;c.addEventListener?c.addEventListener(d,f,l):c.attachEvent(goog.events.getOnString_(d),f);goog.events.listenerCountEstimate_++;return e};goog.events.getProxy=function(){var c=goog.events.handleBrowserEvent_,d=goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT?function(e){return c.call(d.src,d.listener,e)}:function(e){e=c.call(d.src,d.listener,e);if(!e)return e};return d};
...
goog.events.unlisten=function(c,d,e,f,h){if(goog.isArray(d)){for(var k=0;k<d.length;k++)goog.events.unlisten(c,d[k],e,f,h);return null}e=goog.events.wrapListener_(e);if(goog.events.Listenable.isImplementedBy(c))return c.unlisten(d,e,f,h);if(!c)return!1;f=!!f;if(c=goog.events.getListenerMap_(c))if(d=c.getListener(d,e,f,h))return goog.events.unlistenByKey(d);return!1};
goog.events.unlistenByKey=function(c){if(goog.isNumber(c)||!c||c.removed)return!1;var d=c.src;if(goog.events.Listenable.isImplementedBy(d))return d.unlistenByKey(c);var e=c.type,f=c.proxy;d.removeEventListener?d.removeEventListener(e,f,c.capture):d.detachEvent&&d.detachEvent(goog.events.getOnString_(e),f);goog.events.listenerCountEstimate_--;(e=goog.events.getListenerMap_(d))?(e.removeByKey(c),0==e.getTypeCount()&&(e.src=null,d[goog.events.LISTENER_MAP_PROP_]=null)):c.markAsRemoved();return!0};
goog.events.unlistenWithWrapper=function(c,d,e,f,h){d.unlisten(c,e,f,h)};goog.events.removeAll=function(c,d){if(!c)return 0;if(goog.events.Listenable.isImplementedBy(c))return c.removeAllListeners(d);var e=goog.events.getListenerMap_(c);if(!e)return 0;var f=0,h;for(h in e.listeners)if(!d||h==d)for(var k=goog.array.clone(e.listeners[h]),l=0;l<k.length;++l)goog.events.unlistenByKey(k[l])&&++f;return f};goog.events.removeAllNativeListeners=function(){return goog.events.listenerCountEstimate_=0};
goog.events.getListeners=function(c,d,e){return goog.events.Listenable.isImplementedBy(c)?c.getListeners(d,e):c?(c=goog.events.getListenerMap_(c))?c.getListeners(d,e):[]:[]};goog.events.getListener=function(c,d,e,f,h){e=goog.events.wrapListener_(e);f=!!f;return goog.events.Listenable.isImplementedBy(c)?c.getListener(d,e,f,h):c?(c=goog.events.getListenerMap_(c))?c.getListener(d,e,f,h):null:null};
goog.events.hasListener=function(c,d,e){if(goog.events.Listenable.isImplementedBy(c))return c.hasListener(d,e);c=goog.events.getListenerMap_(c);return!!c&&c.hasListener(d,e)};goog.events.expose=function(c){var d=[],e;for(e in c)c[e]&&c[e].id?d.push(e+" = "+c[e]+" ("+c[e].id+")"):d.push(e+" = "+c[e]);return d.join("\n")};goog.events.getOnString_=function(c){return c in goog.events.onStringMap_?goog.events.onStringMap_[c]:goog.events.onStringMap_[c]=goog.events.onString_+c};
goog.events.fireListeners=function(c,d,e,f){return goog.events.Listenable.isImplementedBy(c)?c.fireListeners(d,e,f):goog.events.fireListeners_(c,d,e,f)};goog.events.fireListeners_=function(c,d,e,f){var h=1;if(c=goog.events.getListenerMap_(c))if(d=c.listeners[d])for(d=goog.array.clone(d),c=0;c<d.length;c++){var k=d[c];k&&(k.capture==e&&!k.removed)&&(h&=!1!==goog.events.fireListener(k,f))}return Boolean(h)};
goog.events.fireListener=function(c,d){var e=c.listener,f=c.handler||c.src;c.callOnce&&goog.events.unlistenByKey(c);return e.call(f,d)};goog.events.getTotalListenerCount=function(){return goog.events.listenerCountEstimate_};goog.events.dispatchEvent=function(c,d){goog.asserts.assert(goog.events.Listenable.isImplementedBy(c),"Can not use goog.events.dispatchEvent with non-goog.events.Listenable instance.");return c.dispatchEvent(d)};
goog.events.protectBrowserEventEntryPoint=function(c){goog.events.handleBrowserEvent_=c.protectEntryPoint(goog.events.handleBrowserEvent_)};
goog.events.handleBrowserEvent_=function(c,d){if(c.removed)return!0;if(!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT){var e=d||goog.getObjectByName("window.event"),f=new goog.events.BrowserEvent(e,this),h=!0;if(goog.events.CAPTURE_SIMULATION_MODE==goog.events.CaptureSimulationMode.ON){if(!goog.events.isMarkedIeEvent_(e)){goog.events.markIeEvent_(e);for(var e=[],k=f.currentTarget;k;k=k.parentNode)e.push(k);for(var k=c.type,l=e.length-1;!f.propagationStopped_&&0<=l;l--)f.currentTarget=e[l],h&=goog.events.fireListeners_(e[l],
k,!0,f);for(l=0;!f.propagationStopped_&&l<e.length;l++)f.currentTarget=e[l],h&=goog.events.fireListeners_(e[l],k,!1,f)}}else h=goog.events.fireListener(c,f);return h}return goog.events.fireListener(c,new goog.events.BrowserEvent(d,this))};goog.events.markIeEvent_=function(c){var d=!1;if(0==c.keyCode)try{c.keyCode=-1;return}catch(e){d=!0}if(d||void 0==c.returnValue)c.returnValue=!0};goog.events.isMarkedIeEvent_=function(c){return 0>c.keyCode||void 0!=c.returnValue};goog.events.uniqueIdCounter_=0;
goog.events.getUniqueId=function(c){return c+"_"+goog.events.uniqueIdCounter_++};goog.events.getListenerMap_=function(c){c=c[goog.events.LISTENER_MAP_PROP_];return c instanceof goog.events.ListenerMap?c:null};goog.events.LISTENER_WRAPPER_PROP_="__closure_events_fn_"+(1E9*Math.random()>>>0);
goog.events.wrapListener_=function(c){goog.asserts.assert(c,"Listener can not be null.");if(goog.isFunction(c))return c;goog.asserts.assert(c.handleEvent,"An object listener must have handleEvent method.");return c[goog.events.LISTENER_WRAPPER_PROP_]||(c[goog.events.LISTENER_WRAPPER_PROP_]=function(d){return c.handleEvent(d)})};goog.debug.entryPointRegistry.register(function(c){goog.events.handleBrowserEvent_=c(goog.events.handleBrowserEvent_)});goog.events.EventTarget=function(){goog.Disposable.call(this);this.eventTargetListeners_=new goog.events.ListenerMap(this);this.actualEventTarget_=this};goog.inherits(goog.events.EventTarget,goog.Disposable);goog.events.Listenable.addImplementation(goog.events.EventTarget);goog.events.EventTarget.MAX_ANCESTORS_=1E3;goog.events.EventTarget.prototype.parentEventTarget_=null;goog.events.EventTarget.prototype.getParentEventTarget=function(){return this.parentEventTarget_};
...
goog.Timer.callOnce=function(c,d,e){if(goog.isFunction(c))e&&(c=goog.bind(c,e));else if(c&&"function"==typeof c.handleEvent)c=goog.bind(c.handleEvent,c);else throw Error("Invalid listener argument");return d>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(c,d||0)};goog.Timer.clear=function(c){goog.Timer.defaultTimerObject.clearTimeout(c)};goog.events.EventHandler=function(c){goog.Disposable.call(this);this.handler_=c;this.keys_={}};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(c,d,e,f){return this.listen_(c,d,e,f)};goog.events.EventHandler.prototype.listenWithScope=function(c,d,e,f,h){return this.listen_(c,d,e,f,h)};
goog.events.EventHandler.prototype.listen_=function(c,d,e,f,h){goog.isArray(d)||(goog.events.EventHandler.typeArray_[0]=d,d=goog.events.EventHandler.typeArray_);for(var k=0;k<d.length;k++){var l=goog.events.listen(c,d[k],e||this.handleEvent,f||!1,h||this.handler_||this);if(!l)break;this.keys_[l.key]=l}return this};goog.events.EventHandler.prototype.listenOnce=function(c,d,e,f){return this.listenOnce_(c,d,e,f)};
goog.events.EventHandler.prototype.listenOnceWithScope=function(c,d,e,f,h){return this.listenOnce_(c,d,e,f,h)};goog.events.EventHandler.prototype.listenOnce_=function(c,d,e,f,h){if(goog.isArray(d))for(var k=0;k<d.length;k++)this.listenOnce_(c,d[k],e,f,h);else{c=goog.events.listenOnce(c,d,e||this.handleEvent,f,h||this.handler_||this);if(!c)return this;this.keys_[c.key]=c}return this};goog.events.EventHandler.prototype.listenWithWrapper=function(c,d,e,f){return this.listenWithWrapper_(c,d,e,f)};
goog.events.EventHandler.prototype.listenWithWrapperAndScope=function(c,d,e,f,h){return this.listenWithWrapper_(c,d,e,f,h)};goog.events.EventHandler.prototype.listenWithWrapper_=function(c,d,e,f,h){d.listen(c,e,f,h||this.handler_||this,this);return this};goog.events.EventHandler.prototype.getListenerCount=function(){var c=0,d;for(d in this.keys_)Object.prototype.hasOwnProperty.call(this.keys_,d)&&c++;return c};
goog.events.EventHandler.prototype.unlisten=function(c,d,e,f,h){if(goog.isArray(d))for(var k=0;k<d.length;k++)this.unlisten(c,d[k],e,f,h);else if(c=goog.events.getListener(c,d,e||this.handleEvent,f,h||this.handler_||this))goog.events.unlistenByKey(c),delete this.keys_[c.key];return this};goog.events.EventHandler.prototype.unlistenWithWrapper=function(c,d,e,f,h){d.unlisten(c,e,f,h||this.handler_||this,this);return this};
goog.events.EventHandler.prototype.removeAll=function(){goog.object.forEach(this.keys_,goog.events.unlistenByKey);this.keys_={}};goog.events.EventHandler.prototype.disposeInternal=function(){goog.events.EventHandler.superClass_.disposeInternal.call(this);this.removeAll()};goog.events.EventHandler.prototype.handleEvent=function(c){throw Error("EventHandler.handleEvent not implemented");};goog.ui={};goog.ui.IdGenerator=function(){};goog.addSingletonGetter(goog.ui.IdGenerator);goog.ui.IdGenerator.prototype.nextId_=0;goog.ui.IdGenerator.prototype.getNextUniqueId=function(){return":"+(this.nextId_++).toString(36)};goog.ui.Component=function(c){goog.events.EventTarget.call(this);this.dom_=c||goog.dom.getDomHelper();this.rightToLeft_=goog.ui.Component.defaultRightToLeft_};goog.inherits(goog.ui.Component,goog.events.EventTarget);goog.ui.Component.ALLOW_DETACHED_DECORATION=!1;goog.ui.Component.prototype.idGenerator_=goog.ui.IdGenerator.getInstance();goog.ui.Component.DEFAULT_BIDI_DIR=0;goog.ui.Component.defaultRightToLeft_=1==goog.ui.Component.DEFAULT_BIDI_DIR?!1:-1==goog.ui.Component.DEFAULT_BIDI_DIR?!0:null;
...
goog.ui.Component.prototype.removeChildren=function(c){for(var d=[];this.hasChildren();)d.push(this.removeChildAt(0,c));return d};goog.userAgent.product={};goog.userAgent.product.ASSUME_FIREFOX=!1;goog.userAgent.product.ASSUME_CAMINO=!1;goog.userAgent.product.ASSUME_IPHONE=!1;goog.userAgent.product.ASSUME_IPAD=!1;goog.userAgent.product.ASSUME_ANDROID=!1;goog.userAgent.product.ASSUME_CHROME=!1;goog.userAgent.product.ASSUME_SAFARI=!1;
...
!0:-1!=c.indexOf("iPhone")||-1!=c.indexOf("iPod")?goog.userAgent.product.detectedIphone_=!0:-1!=c.indexOf("iPad")?goog.userAgent.product.detectedIpad_=!0:-1!=c.indexOf("Chrome")?goog.userAgent.product.detectedChrome_=!0:-1!=c.indexOf("Android")?goog.userAgent.product.detectedAndroid_=!0:-1!=c.indexOf("Safari")&&(goog.userAgent.product.detectedSafari_=!0))};goog.userAgent.product.PRODUCT_KNOWN_||goog.userAgent.product.init_();goog.userAgent.product.OPERA=goog.userAgent.OPERA;
...
goog.userAgent.product.SAFARI=goog.userAgent.product.PRODUCT_KNOWN_?goog.userAgent.product.ASSUME_SAFARI:goog.userAgent.product.detectedSafari_;goog.dom.classlist={};goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST=!1;goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_=goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST||!!goog.global.DOMTokenList;goog.dom.classlist.get=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c){return c.classList}:function(c){c=c.className;return goog.isString(c)&&c.match(/\S+/g)||[]};goog.dom.classlist.set=function(c,d){c.className=d};
goog.dom.classlist.contains=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c,d){goog.asserts.assert(!!c.classList);return c.classList.contains(d)}:function(c,d){return goog.array.contains(goog.dom.classlist.get(c),d)};goog.dom.classlist.add=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c,d){c.classList.add(d)}:function(c,d){goog.dom.classlist.contains(c,d)||(c.className+=0<c.className.length?" "+d:d)};
goog.dom.classlist.addAll=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c,d){goog.array.forEach(d,function(d){goog.dom.classlist.add(c,d)})}:function(c,d){var e={};goog.array.forEach(goog.dom.classlist.get(c),function(c){e[c]=!0});goog.array.forEach(d,function(c){e[c]=!0});c.className="";for(var f in e)c.className+=0<c.className.length?" "+f:f};
goog.dom.classlist.remove=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c,d){c.classList.remove(d)}:function(c,d){goog.dom.classlist.contains(c,d)&&(c.className=goog.array.filter(goog.dom.classlist.get(c),function(c){return c!=d}).join(" "))};
goog.dom.classlist.removeAll=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(c,d){goog.array.forEach(d,function(d){goog.dom.classlist.remove(c,d)})}:function(c,d){c.className=goog.array.filter(goog.dom.classlist.get(c),function(c){return!goog.array.contains(d,c)}).join(" ")};goog.dom.classlist.enable=function(c,d,e){e?goog.dom.classlist.add(c,d):goog.dom.classlist.remove(c,d)};
goog.dom.classlist.swap=function(c,d,e){return goog.dom.classlist.contains(c,d)?(goog.dom.classlist.remove(c,d),goog.dom.classlist.add(c,e),!0):!1};goog.dom.classlist.toggle=function(c,d){var e=!goog.dom.classlist.contains(c,d);goog.dom.classlist.enable(c,d,e);return e};goog.dom.classlist.addRemove=function(c,d,e){goog.dom.classlist.remove(c,d);goog.dom.classlist.add(c,e)};goog.ui.registry={};goog.ui.registry.getDefaultRenderer=function(c){for(var d;c;){d=goog.getUid(c);if(d=goog.ui.registry.defaultRenderers_[d])break;c=c.superClass_?c.superClass_.constructor:null}return d?goog.isFunction(d.getInstance)?d.getInstance():new d:null};
...
goog.ui.ContainerRenderer.prototype.decorate=function(c,d){d.id&&c.setId(d.id);var e=this.getCssClass(),f=!1,h=goog.dom.classlist.get(d);h&&goog.array.forEach(h,function(d){d==e?f=!0:d&&this.setStateFromClassName(c,d,e)},this);f||goog.dom.classlist.add(d,e);this.decorateChildren(c,this.getContentElement(d));return d};
...
goog.ui.ContainerRenderer.prototype.getClassNames=function(c){var d=this.getCssClass(),e=c.getOrientation()==goog.ui.Container.Orientation.HORIZONTAL,e=[d,e?d+"-horizontal":d+"-vertical"];c.isEnabled()||e.push(d+"-disabled");return e};goog.ui.ContainerRenderer.prototype.getDefaultOrientation=function(){return goog.ui.Container.Orientation.VERTICAL};goog.ui.ControlRenderer=function(){};goog.addSingletonGetter(goog.ui.ControlRenderer);goog.ui.ControlRenderer.getCustomRenderer=function(c,d){var e=new c;e.getCssClass=function(){return d};return e};goog.ui.ControlRenderer.CSS_CLASS="goog-control";goog.ui.ControlRenderer.IE6_CLASS_COMBINATIONS=[];goog.ui.ControlRenderer.prototype.getAriaRole=function(){};
...
m||n.push(k);var p=c.getExtraClassNames();p&&n.push.apply(n,p);if(goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("7")){var q=this.getAppliedCombinedClassNames_(n);0<q.length&&(n.push.apply(n,q),e=!0)}l&&m&&!p&&!e||goog.dom.classes.set(d,n.join(" "));this.setAriaStates(c,d);return d};goog.ui.ControlRenderer.prototype.initializeDom=function(c){c.isRightToLeft()&&this.setRightToLeft(c.getElement(),!0);c.isEnabled()&&this.setFocusable(c,c.isVisible())};
...
c.keyCode!=goog.events.KeyCodes.META&&(this.lastKey_=goog.events.KeyCodes.META));goog.events.KeyHandler.USES_KEYDOWN_&&!goog.events.KeyCodes.firesKeyPressEvent(c.keyCode,this.lastKey_,c.shiftKey,c.ctrlKey,c.altKey)?this.handleEvent(c):(this.keyCode_=goog.events.KeyCodes.normalizeKeyCode(c.keyCode),goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_&&(this.altKey_=c.altKey))};goog.events.KeyHandler.prototype.resetState=function(){this.keyCode_=this.lastKey_=-1};
...
0):(e=d.keyCode||this.keyCode_,f=d.charCode||0,goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_&&(h=this.altKey_),goog.userAgent.MAC&&(f==goog.events.KeyCodes.QUESTION_MARK&&e==goog.events.KeyCodes.WIN_KEY)&&(e=goog.events.KeyCodes.SLASH));var k=e=goog.events.KeyCodes.normalizeKeyCode(e),l=d.keyIdentifier;e?63232<=e&&e in goog.events.KeyHandler.safariKey_?k=goog.events.KeyHandler.safariKey_[e]:25==e&&c.shiftKey&&(k=9):l&&l in goog.events.KeyHandler.keyIdentifier_&&(k=goog.events.KeyHandler.keyIdentifier_[l]);
c=k==this.lastKey_;this.lastKey_=k;d=new goog.events.KeyEvent(k,f,c,d);d.altKey=h;this.dispatchEvent(d)};goog.events.KeyHandler.prototype.getElement=function(){return this.element_};
...
goog.events.KeyEvent=function(c,d,e,f){goog.events.BrowserEvent.call(this,f);this.type=goog.events.KeyHandler.EventType.KEY;this.keyCode=c;this.charCode=d;this.repeat=e};goog.inherits(goog.events.KeyEvent,goog.events.BrowserEvent);goog.ui.Control=function(c,d,e){goog.ui.Component.call(this,e);this.renderer_=d||goog.ui.registry.getDefaultRenderer(this.constructor);this.setContentInternal(goog.isDef(c)?c:null)};goog.inherits(goog.ui.Control,goog.ui.Component);goog.ui.Control.registerDecorator=goog.ui.registry.setDecoratorByClassName;goog.ui.Control.getDecorator=goog.ui.registry.getDecorator;goog.ui.Control.decorate=goog.ui.decorate;goog.ui.Control.prototype.content_=null;goog.ui.Control.prototype.state_=0;
...
goog.ui.MenuRenderer.prototype.initializeDom=function(c){goog.ui.MenuRenderer.superClass_.initializeDom.call(this,c);c=c.getElement();goog.asserts.assert(c,"The menu DOM element cannot be null.");goog.a11y.aria.setState(c,goog.a11y.aria.State.HASPOPUP,"true")};goog.ui.MenuSeparator=function(c){goog.ui.Separator.call(this,goog.ui.MenuSeparatorRenderer.getInstance(),c)};goog.inherits(goog.ui.MenuSeparator,goog.ui.Separator);goog.ui.registry.setDecoratorByClassName(goog.ui.MenuSeparatorRenderer.CSS_CLASS,function(){return new goog.ui.Separator});goog.ui.MenuItemRenderer=function(){goog.ui.ControlRenderer.call(this);this.classNameCache_=[]};goog.inherits(goog.ui.MenuItemRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.MenuItemRenderer);goog.ui.MenuItemRenderer.CSS_CLASS="goog-menuitem";goog.ui.MenuItemRenderer.CompositeCssClassIndex_={HOVER:0,CHECKBOX:1,CONTENT:2};
...
goog.ui.MenuItemRenderer.prototype.hasCheckBoxStructure=function(c){if(c=this.getContentElement(c)){c=c.firstChild;var d=this.getCompositeCssClass_(goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX);return!!c&&goog.dom.isElement(c)&&goog.dom.classlist.contains(c,d)}return!1};
goog.ui.MenuItemRenderer.prototype.setEnableCheckBoxStructure=function(c,d,e){e!=this.hasCheckBoxStructure(d)&&(goog.dom.classlist.enable(d,"goog-option",e),d=this.getContentElement(d),e?(e=this.getCompositeCssClass_(goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX),d.insertBefore(c.getDomHelper().createDom("div",e),d.firstChild||null)):d.removeChild(d.firstChild))};
...
goog.ui.MenuItem.prototype.getCaption=function(){var c=this.getContent();if(goog.isArray(c)){var d=goog.ui.MenuItem.ACCELERATOR_CLASS_,e=goog.ui.MenuItem.MNEMONIC_WRAPPER_CLASS_,c=goog.array.map(c,function(c){return goog.dom.isElement(c)&&(goog.dom.classlist.contains(c,d)||goog.dom.classlist.contains(c,e))?"":goog.dom.getRawTextContent(c)}).join("");return goog.string.collapseBreakingSpaces(c)}return goog.ui.MenuItem.superClass_.getCaption.call(this)};
...
goog.ui.NativeButtonRenderer.prototype.decorate=function(c,d){this.setUpNativeButton_(c);if(d.disabled){var e=goog.asserts.assertString(this.getClassForState(goog.ui.Component.State.DISABLED));goog.dom.classlist.add(d,e)}return goog.ui.NativeButtonRenderer.superClass_.decorate.call(this,c,d)};goog.ui.NativeButtonRenderer.prototype.initializeDom=function(c){c.getHandler().listen(c.getElement(),goog.events.EventType.CLICK,c.performActionInternal)};
goog.ui.NativeButtonRenderer.prototype.setAllowTextSelection=goog.nullFunction;goog.ui.NativeButtonRenderer.prototype.setRightToLeft=goog.nullFunction;goog.ui.NativeButtonRenderer.prototype.isFocusable=function(c){return c.isEnabled()};goog.ui.NativeButtonRenderer.prototype.setFocusable=goog.nullFunction;
goog.ui.NativeButtonRenderer.prototype.setState=function(c,d,e){goog.ui.NativeButtonRenderer.superClass_.setState.call(this,c,d,e);(c=c.getElement())&&d==goog.ui.Component.State.DISABLED&&(c.disabled=e)};goog.ui.NativeButtonRenderer.prototype.getValue=function(c){return c.value};goog.ui.NativeButtonRenderer.prototype.setValue=function(c,d){c&&(c.value=d)};goog.ui.NativeButtonRenderer.prototype.updateAriaState=goog.nullFunction;
goog.ui.NativeButtonRenderer.prototype.setUpNativeButton_=function(c){c.setHandleMouseEvents(!1);c.setAutoStates(goog.ui.Component.State.ALL,!1);c.setSupportedState(goog.ui.Component.State.FOCUSED,!1)};goog.ui.Button=function(c,d,e){goog.ui.Control.call(this,c,d||goog.ui.NativeButtonRenderer.getInstance(),e)};goog.inherits(goog.ui.Button,goog.ui.Control);goog.ui.Button.Side=goog.ui.ButtonSide;goog.ui.Button.prototype.getValue=function(){return this.value_};goog.ui.Button.prototype.setValue=function(c){this.value_=c;this.getRenderer().setValue(this.getElement(),c)};goog.ui.Button.prototype.setValueInternal=function(c){this.value_=c};goog.ui.Button.prototype.getTooltip=function(){return this.tooltip_};
...
goog.ui.CustomButtonRenderer.prototype.hasBoxStructure=function(c,d){var e=c.getDomHelper().getFirstElementChild(d),f=this.getCssClass()+"-outer-box";return e&&goog.dom.classlist.contains(e,f)&&(e=c.getDomHelper().getFirstElementChild(e),f=this.getCssClass()+"-inner-box",e&&goog.dom.classlist.contains(e,f))?!0:!1};
goog.ui.CustomButtonRenderer.prototype.decorate=function(c,d){goog.ui.CustomButtonRenderer.trimTextNodes_(d,!0);goog.ui.CustomButtonRenderer.trimTextNodes_(d,!1);this.hasBoxStructure(c,d)||d.appendChild(this.createButton(d.childNodes,c.getDomHelper()));goog.dom.classlist.addAll(d,[goog.ui.INLINE_BLOCK_CLASSNAME,this.getCssClass()]);return goog.ui.CustomButtonRenderer.superClass_.decorate.call(this,c,d)};goog.ui.CustomButtonRenderer.prototype.getCssClass=function(){return goog.ui.CustomButtonRenderer.CSS_CLASS};
...
goog.ui.MenuButton.prototype.attachPopupListeners_=function(c){var d=this.getHandler(),e=c?d.listen:d.unlisten;e.call(d,this.getDomHelper().getDocument(),goog.events.EventType.MOUSEDOWN,this.handleDocumentMouseDown,!0);this.isFocusablePopupMenu()&&e.call(d,this.menu_,goog.ui.Component.EventType.BLUR,this.handleMenuBlur);e.call(d,this.timer_,goog.Timer.TICK,this.onTick_);c?this.timer_.start():this.timer_.stop()};goog.ui.registry.setDecoratorByClassName(goog.ui.MenuButtonRenderer.CSS_CLASS,function(){return new goog.ui.MenuButton(null)});goog.ui.MenuBarRenderer=function(){goog.ui.ContainerRenderer.call(this)};goog.inherits(goog.ui.MenuBarRenderer,goog.ui.ContainerRenderer);goog.addSingletonGetter(goog.ui.MenuBarRenderer);goog.ui.MenuBarRenderer.CSS_CLASS="goog-menubar";goog.ui.MenuBarRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.MENUBAR};goog.ui.MenuBarRenderer.prototype.getCssClass=function(){return goog.ui.MenuBarRenderer.CSS_CLASS};goog.ui.MenuBarRenderer.prototype.getDefaultOrientation=function(){return goog.ui.Container.Orientation.HORIZONTAL};goog.ui.menuBar={};goog.ui.menuBar.create=function(c,d){return new goog.ui.Container(null,c?c:goog.ui.MenuBarRenderer.getInstance(),d)};goog.events.KeyNames={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"caps-lock",27:"esc",32:"space",33:"pg-up",34:"pg-down",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"delete",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",59:"semicolon",61:"equals",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",
89:"y",90:"z",93:"context",96:"num-0",97:"num-1",98:"num-2",99:"num-3",100:"num-4",101:"num-5",102:"num-6",103:"num-7",104:"num-8",105:"num-9",106:"num-multiply",107:"num-plus",109:"num-minus",110:"num-period",111:"num-division",112:"f1",113:"f2",114:"f3",115:"f4",116:"f5",117:"f6",118:"f7",119:"f8",120:"f9",121:"f10",122:"f11",123:"f12",186:"semicolon",187:"equals",189:"dash",188:",",190:".",191:"/",192:"`",219:"open-square-bracket",220:"\\",221:"close-square-bracket",222:"single-quote",224:"win"};goog.ui.KeyboardShortcutHandler=function(c){goog.events.EventTarget.call(this);this.shortcuts_={};this.lastKeys_={strokes:[],time:0};this.globalKeys_=goog.object.createSet(goog.ui.KeyboardShortcutHandler.DEFAULT_GLOBAL_KEYS_);this.textInputs_=goog.object.createSet(goog.ui.KeyboardShortcutHandler.DEFAULT_TEXT_INPUTS_);this.alwaysPreventDefault_=!0;this.allShortcutsAreGlobal_=this.alwaysStopPropagation_=!1;this.modifierShortcutsAreGlobal_=!0;this.allowSpaceKeyOnButtons_=!1;this.initializeKeyListener(c)};
...
goog.ui.KeyboardShortcutHandler.EventType={SHORTCUT_TRIGGERED:"shortcut",SHORTCUT_PREFIX:"shortcut_"};goog.ui.KeyboardShortcutHandler.getKeyCode=function(c){if(!goog.ui.KeyboardShortcutHandler.nameToKeyCodeCache_){var d={},e;for(e in goog.events.KeyNames)d[goog.events.KeyNames[e]]=e;goog.ui.KeyboardShortcutHandler.nameToKeyCodeCache_=d}return goog.ui.KeyboardShortcutHandler.nameToKeyCodeCache_[c]};
goog.ui.KeyboardShortcutHandler.prototype.setAlwaysPreventDefault=function(c){this.alwaysPreventDefault_=c};goog.ui.KeyboardShortcutHandler.prototype.getAlwaysPreventDefault=function(){return this.alwaysPreventDefault_};goog.ui.KeyboardShortcutHandler.prototype.setAlwaysStopPropagation=function(c){this.alwaysStopPropagation_=c};goog.ui.KeyboardShortcutHandler.prototype.getAlwaysStopPropagation=function(){return this.alwaysStopPropagation_};
goog.ui.KeyboardShortcutHandler.prototype.setAllShortcutsAreGlobal=function(c){this.allShortcutsAreGlobal_=c};goog.ui.KeyboardShortcutHandler.prototype.getAllShortcutsAreGlobal=function(){return this.allShortcutsAreGlobal_};goog.ui.KeyboardShortcutHandler.prototype.setModifierShortcutsAreGlobal=function(c){this.modifierShortcutsAreGlobal_=c};goog.ui.KeyboardShortcutHandler.prototype.getModifierShortcutsAreGlobal=function(){return this.modifierShortcutsAreGlobal_};
goog.ui.KeyboardShortcutHandler.prototype.setAllowSpaceKeyOnButtons=function(c){this.allowSpaceKeyOnButtons_=c};goog.ui.KeyboardShortcutHandler.prototype.registerShortcut=function(c,d){goog.ui.KeyboardShortcutHandler.setShortcut_(this.shortcuts_,this.interpretStrokes_(1,arguments),c)};goog.ui.KeyboardShortcutHandler.prototype.unregisterShortcut=function(c){goog.ui.KeyboardShortcutHandler.setShortcut_(this.shortcuts_,this.interpretStrokes_(0,arguments),null)};
goog.ui.KeyboardShortcutHandler.prototype.isShortcutRegistered=function(c){return this.checkShortcut_(this.interpretStrokes_(0,arguments))};goog.ui.KeyboardShortcutHandler.prototype.interpretStrokes_=function(c,d){var e;if(goog.isString(d[c]))e=goog.ui.KeyboardShortcutHandler.parseStringShortcut(d[c]);else{var f=d,h=c;goog.isArray(d[c])&&(f=d[c],h=0);for(e=[];h<f.length;h+=2)e.push({keyCode:f[h],modifiers:f[h+1]})}return e};
goog.ui.KeyboardShortcutHandler.prototype.unregisterAll=function(){this.shortcuts_={}};goog.ui.KeyboardShortcutHandler.prototype.setGlobalKeys=function(c){this.globalKeys_=goog.object.createSet(c)};goog.ui.KeyboardShortcutHandler.prototype.getGlobalKeys=function(){return goog.object.getKeys(this.globalKeys_)};goog.ui.KeyboardShortcutHandler.prototype.disposeInternal=function(){goog.ui.KeyboardShortcutHandler.superClass_.disposeInternal.call(this);this.unregisterAll();this.clearKeyListener()};
goog.ui.KeyboardShortcutHandler.prototype.getEventType=function(c){return goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_PREFIX+c};
goog.ui.KeyboardShortcutHandler.parseStringShortcut=function(c){c=c.replace(/[ +]*\+[ +]*/g,"+").replace(/[ ]+/g," ").toLowerCase();c=c.split(" ");for(var d=[],e,f=0;e=c[f];f++){e=e.split("+");for(var h,k=goog.ui.KeyboardShortcutHandler.Modifiers.NONE,l,m=0;l=e[m];m++){switch(l){case "shift":k|=goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT;continue;case "ctrl":k|=goog.ui.KeyboardShortcutHandler.Modifiers.CTRL;continue;case "alt":k|=goog.ui.KeyboardShortcutHandler.Modifiers.ALT;continue;case "meta":k|=
goog.ui.KeyboardShortcutHandler.Modifiers.META;continue}h=goog.ui.KeyboardShortcutHandler.getKeyCode(l);break}d.push({keyCode:h,modifiers:k})}return d};
goog.ui.KeyboardShortcutHandler.prototype.initializeKeyListener=function(c){this.keyTarget_=c;goog.events.listen(this.keyTarget_,goog.events.EventType.KEYDOWN,this.handleKeyDown_,!1,this);goog.userAgent.MAC&&(goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.8"))&&goog.events.listen(this.keyTarget_,goog.events.EventType.KEYUP,this.handleMacGeckoKeyUp_,!1,this);goog.userAgent.WINDOWS&&!goog.userAgent.GECKO&&(goog.events.listen(this.keyTarget_,goog.events.EventType.KEYPRESS,this.handleWindowsKeyPress_,
!1,this),goog.events.listen(this.keyTarget_,goog.events.EventType.KEYUP,this.handleWindowsKeyUp_,!1,this))};
goog.ui.KeyboardShortcutHandler.prototype.handleMacGeckoKeyUp_=function(c){if(c.keyCode==goog.events.KeyCodes.MAC_FF_META)this.metaKeyRecentlyReleased_=!0,goog.Timer.callOnce(function(){this.metaKeyRecentlyReleased_=!1},400,this);else{var d=c.metaKey||this.metaKeyRecentlyReleased_;c.keyCode!=goog.events.KeyCodes.C&&c.keyCode!=goog.events.KeyCodes.X&&c.keyCode!=goog.events.KeyCodes.V||!d||(c.metaKey=d,this.handleKeyDown_(c))}};
goog.ui.KeyboardShortcutHandler.prototype.isPossiblePrintableKey_=function(c){return goog.userAgent.WINDOWS&&!goog.userAgent.GECKO&&c.ctrlKey&&c.altKey&&!c.shiftKey};goog.ui.KeyboardShortcutHandler.prototype.handleWindowsKeyPress_=function(c){32<c.keyCode&&this.isPossiblePrintableKey_(c)&&(this.isPrintableKey_=!0)};goog.ui.KeyboardShortcutHandler.prototype.handleWindowsKeyUp_=function(c){!this.isPrintableKey_&&this.isPossiblePrintableKey_(c)&&this.handleKeyDown_(c)};
goog.ui.KeyboardShortcutHandler.prototype.clearKeyListener=function(){goog.events.unlisten(this.keyTarget_,goog.events.EventType.KEYDOWN,this.handleKeyDown_,!1,this);goog.userAgent.MAC&&(goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.8"))&&goog.events.unlisten(this.keyTarget_,goog.events.EventType.KEYUP,this.handleMacGeckoKeyUp_,!1,this);goog.userAgent.WINDOWS&&!goog.userAgent.GECKO&&(goog.events.unlisten(this.keyTarget_,goog.events.EventType.KEYPRESS,this.handleWindowsKeyPress_,!1,this),
goog.events.unlisten(this.keyTarget_,goog.events.EventType.KEYUP,this.handleWindowsKeyUp_,!1,this));this.keyTarget_=null};goog.ui.KeyboardShortcutHandler.setShortcut_=function(c,d,e){var f=d.shift(),f=goog.ui.KeyboardShortcutHandler.makeKey_(f.keyCode,f.modifiers),h=c[f];if(h&&e&&(0==d.length||goog.isString(h)))throw Error("Keyboard shortcut conflicts with existing shortcut");d.length?(h||(h=c[f]={}),goog.ui.KeyboardShortcutHandler.setShortcut_(h,d,e)):c[f]=e};
goog.ui.KeyboardShortcutHandler.prototype.getShortcut_=function(c,d,e){d=d||0;return(e=(e||this.shortcuts_)[c[d]])&&!goog.isString(e)&&1<c.length-d?this.getShortcut_(c,d+1,e):e};goog.ui.KeyboardShortcutHandler.prototype.checkShortcut_=function(c){for(var d=this.shortcuts_;0<c.length&&d;){var e=c.shift(),e=goog.ui.KeyboardShortcutHandler.makeKey_(e.keyCode,e.modifiers),d=d[e];if(goog.isString(d))return!0}return!1};goog.ui.KeyboardShortcutHandler.makeKey_=function(c,d){return c&255|d<<8};
goog.ui.KeyboardShortcutHandler.prototype.handleKeyDown_=function(c){if(this.isValidShortcut_(c))if("keydown"==c.type&&this.isPossiblePrintableKey_(c))this.isPrintableKey_=!1;else{var d=goog.userAgent.GECKO?goog.events.KeyCodes.normalizeGeckoKeyCode(c.keyCode):c.keyCode,d=goog.ui.KeyboardShortcutHandler.makeKey_(d,(c.shiftKey?goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT:0)|(c.ctrlKey?goog.ui.KeyboardShortcutHandler.Modifiers.CTRL:0)|(c.altKey?goog.ui.KeyboardShortcutHandler.Modifiers.ALT:0)|(c.metaKey?
goog.ui.KeyboardShortcutHandler.Modifiers.META:0)),e,f,h=goog.now();this.lastKeys_.strokes.length&&h-this.lastKeys_.time<=goog.ui.KeyboardShortcutHandler.MAX_KEY_SEQUENCE_DELAY?e=this.getShortcut_(this.lastKeys_.strokes):this.lastKeys_.strokes.length=0;e=e?e[d]:this.shortcuts_[d];e||(e=this.shortcuts_[d],this.lastKeys_.strokes=[]);e&&goog.isString(e)?f=e:e?(this.lastKeys_.strokes.push(d),this.lastKeys_.time=h,goog.userAgent.GECKO&&c.preventDefault()):this.lastKeys_.strokes.length=0;f&&(this.alwaysPreventDefault_&&
c.preventDefault(),this.alwaysStopPropagation_&&c.stopPropagation(),e=goog.ui.KeyboardShortcutHandler.EventType,d=c.target,h=new goog.ui.KeyboardShortcutEvent(e.SHORTCUT_TRIGGERED,f,d),h=this.dispatchEvent(h),f=new goog.ui.KeyboardShortcutEvent(e.SHORTCUT_PREFIX+f,f,d),(h&=this.dispatchEvent(f))||c.preventDefault(),this.lastKeys_.strokes.length=0)}};
goog.ui.KeyboardShortcutHandler.prototype.isValidShortcut_=function(c){var d=c.keyCode;if(d==goog.events.KeyCodes.SHIFT||d==goog.events.KeyCodes.CTRL||d==goog.events.KeyCodes.ALT)return!1;var e=c.target,f="TEXTAREA"==e.tagName||"INPUT"==e.tagName||"BUTTON"==e.tagName||"SELECT"==e.tagName,h=!f&&(e.isContentEditable||e.ownerDocument&&"on"==e.ownerDocument.designMode);return!f&&!h||this.globalKeys_[d]||this.allShortcutsAreGlobal_?!0:h?!1:this.modifierShortcutsAreGlobal_&&(c.altKey||c.ctrlKey||c.metaKey)?
!0:"INPUT"==e.tagName&&this.textInputs_[e.type]?d==goog.events.KeyCodes.ENTER:"INPUT"==e.tagName||"BUTTON"==e.tagName?this.allowSpaceKeyOnButtons_?!0:d!=goog.events.KeyCodes.SPACE:!1};goog.ui.KeyboardShortcutEvent=function(c,d,e){goog.events.Event.call(this,c,e);this.identifier=d};goog.inherits(goog.ui.KeyboardShortcutEvent,goog.events.Event);silex.Config={};var ctrlKeyDisplay=goog.userAgent.MAC?"\u2318":"Ctrl+",altKeyDisplay=goog.userAgent.MAC?"\u2325":"Alt+";silex.Config.debug={debugMode:!1,showPreventQuitMessage:!1,doAfterReady:null};silex.Config.ABOUT_SILEX="http://www.silexlabs.org/silex/";silex.Config.ABOUT_SILEX_LABS="http://www.silexlabs.org/";silex.Config.SUBSCRIBE_SILEX_LABS="http://eepurl.com/F48q5";silex.Config.SOCIAL_GPLUS="https://plus.google.com/communities/107373636457908189681";silex.Config.SOCIAL_TWITTER="http://twitter.com/silexlabs";
silex.Config.SOCIAL_FB="http://www.facebook.com/silexlabs";silex.Config.FORK_CODE="https://github.com/silexlabs/Silex";
silex.Config.menu={names:[{label:"File",className:"menu-item-file"},{label:"Edit",className:"menu-item-edit"},{label:"View",className:"menu-item-view"},{label:"Insert",className:"menu-item-insert"},{label:"Tools",className:"menu-item-tools"},{label:"Help",className:"menu-item-help"}],options:[[{label:"New File",id:"file.new",className:"menu-item-file-new",globalKey:goog.events.KeyCodes.N,shortcut:[[goog.events.KeyCodes.N,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"n",mnemonic:goog.events.KeyCodes.N,
accelerator:"n"},{label:"Open File...",id:"file.open",className:"menu-item-file-open",globalKey:goog.events.KeyCodes.O,shortcut:[[goog.events.KeyCodes.O,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"o",mnemonic:goog.events.KeyCodes.O,accelerator:"o"},{label:"Save File",id:"file.save",className:"menu-item-file-save",globalKey:goog.events.KeyCodes.S,shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"s",mnemonic:goog.events.KeyCodes.S,
accelerator:"s"},{label:"Save As...",id:"file.saveas",className:"menu-item-file-saveas",globalKey:goog.events.KeyCodes.S,shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META+goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT]],tooltip:ctrlKeyDisplay+"\u21e7S"},null,{label:"Rename...",id:"file.rename",className:"menu-item-file-rename"},{label:"Publish",id:"file.publish",className:"menu-item-file-publish",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.META]],
tooltip:ctrlKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"},{label:"Settings...",id:"file.publish.settings",className:"menu-item-file-publish-settings"},null,{label:"Close File",id:"file.close",className:"menu-item-file-close",globalKey:goog.events.KeyCodes.W,shortcut:[[goog.events.KeyCodes.W,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"w",mnemonic:goog.events.KeyCodes.W,accelerator:"w"}],[{label:"Delete selection",id:"edit.delete.selection",className:"menu-item-edit-delete-selection",
shortcut:[[goog.events.KeyCodes.DELETE],[goog.events.KeyCodes.BACKSPACE]],tooltip:"suppr",mnemonic:goog.events.KeyCodes.R,accelerator:"r"},null,{label:"Edit selection",id:"view.open.editor",className:"menu-item-view-open-textEditor",tooltip:"\u21b5"},null,{label:"Rename page",id:"edit.rename.page",className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],[{label:"View in new window",id:"view.file",className:"menu-item-view-file",globalKey:goog.events.KeyCodes.V,
shortcut:[[goog.events.KeyCodes.V,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"JS scripts editor",id:"view.open.jsEditor",className:"menu-item-view-open-jsEditor",globalKey:goog.events.KeyCodes.J,shortcut:[[goog.events.KeyCodes.J,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"J",mnemonic:goog.events.KeyCodes.J,accelerator:"j"},{label:"CSS styles editor",id:"view.open.cssEditor",className:"menu-item-view-open-cssEditor",
globalKey:goog.events.KeyCodes.D,shortcut:[[goog.events.KeyCodes.D,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"D",mnemonic:goog.events.KeyCodes.D,accelerator:"d"},{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",globalKey:goog.events.KeyCodes.T,shortcut:[[goog.events.KeyCodes.T,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"T",
mnemonic:goog.events.KeyCodes.T,accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",globalKey:goog.events.KeyCodes.I,shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",globalKey:goog.events.KeyCodes.C,shortcut:[[goog.events.KeyCodes.C,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],
tooltip:altKeyDisplay+"C",mnemonic:goog.events.KeyCodes.C,accelerator:"c"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html",globalKey:goog.events.KeyCodes.H,shortcut:[[goog.events.KeyCodes.H,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"H",mnemonic:goog.events.KeyCodes.H,accelerator:"h"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],
tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Talk with us on twitter",id:"help.twitter",
className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",className:"menu-item-help-forkMe"}]]};
...
value:"Bree Serif"},"Arial Black":{value:"Arial Black, Gadget, sans-serif"},Impact:{value:"Impact, Charcoal, sans-serif"},"Lucida Console":{value:"Lucida Console, Monaco, monospace"},"Lucida Sans":{value:"Lucida Sans Unicode, Lucida Grande, sans-serif"},Palatino:{value:"Palatino Linotype, Book Antiqua, Palatino, serif"},Tahoma:{value:"Tahoma, Geneva, sans-serif"}};silex.model={};silex.model.ModelBase=function(c,d){this.bodyElement=c;this.headElement=d};goog.net={};goog.net.EventType={COMPLETE:"complete",SUCCESS:"success",ERROR:"error",ABORT:"abort",READY:"ready",READY_STATE_CHANGE:"readystatechange",TIMEOUT:"timeout",INCREMENTAL_DATA:"incrementaldata",PROGRESS:"progress"};goog.net.ImageLoader=function(c){goog.events.EventTarget.call(this);this.imageIdToUrlMap_={};this.imageIdToImageMap_={};this.handler_=new goog.events.EventHandler(this);this.parent_=c};goog.inherits(goog.net.ImageLoader,goog.events.EventTarget);goog.net.ImageLoader.IMAGE_LOAD_EVENTS_=[goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("11")?goog.net.EventType.READY_STATE_CHANGE:goog.events.EventType.LOAD,goog.net.EventType.ABORT,goog.net.EventType.ERROR];
goog.net.ImageLoader.prototype.addImage=function(c,d){var e=goog.isString(d)?d:d.src;e&&(this.imageIdToUrlMap_[c]=e)};goog.net.ImageLoader.prototype.removeImage=function(c){delete this.imageIdToUrlMap_[c];var d=this.imageIdToImageMap_[c];d&&(delete this.imageIdToImageMap_[c],this.handler_.unlisten(d,goog.net.ImageLoader.IMAGE_LOAD_EVENTS_,this.onNetworkEvent_),goog.object.isEmpty(this.imageIdToImageMap_)&&goog.object.isEmpty(this.imageIdToUrlMap_)&&this.dispatchEvent(goog.net.EventType.COMPLETE))};
goog.net.ImageLoader.prototype.start=function(){var c=this.imageIdToUrlMap_;goog.array.forEach(goog.object.getKeys(c),function(d){var e=c[d];e&&(delete c[d],this.loadImage_(e,d))},this)};goog.net.ImageLoader.prototype.loadImage_=function(c,d){if(!this.isDisposed()){var e;e=this.parent_?goog.dom.getDomHelper(this.parent_).createDom("img"):new Image;this.handler_.listen(e,goog.net.ImageLoader.IMAGE_LOAD_EVENTS_,this.onNetworkEvent_);this.imageIdToImageMap_[d]=e;e.id=d;e.src=c}};
goog.net.ImageLoader.prototype.onNetworkEvent_=function(c){var d=c.currentTarget;if(d){if(c.type==goog.net.EventType.READY_STATE_CHANGE)if(d.readyState==goog.net.EventType.COMPLETE)c.type=goog.events.EventType.LOAD;else return;"undefined"==typeof d.naturalWidth&&(c.type==goog.events.EventType.LOAD?(d.naturalWidth=d.width,d.naturalHeight=d.height):(d.naturalWidth=0,d.naturalHeight=0));this.dispatchEvent({type:c.type,target:d});this.isDisposed()||this.removeImage(d.id)}};
goog.net.ImageLoader.prototype.disposeInternal=function(){delete this.imageIdToUrlMap_;delete this.imageIdToImageMap_;goog.dispose(this.handler_);goog.net.ImageLoader.superClass_.disposeInternal.call(this)};silex.model.Element=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.Element,silex.model.ModelBase);silex.model.Element.TYPE_CONTAINER="container";silex.model.Element.TYPE_IMAGE="image";silex.model.Element.TYPE_TEXT="text";silex.model.Element.TYPE_HTML="html";silex.model.Element.TYPE_ATTR="data-silex-type";silex.model.Element.ELEMENT_CONTENT_CLASS_NAME="silex-element-content";silex.model.Element.SELECTED_CLASS_NAME="silex-selected";
silex.model.Element.prototype.getType=function(c){return c.getAttribute(silex.model.Element.TYPE_ATTR)};silex.model.Element.prototype.setType=function(c,d){console.error("Error: not implemented");throw"Error: not implemented";};silex.model.Element.prototype.getStyle=function(c,d){return c.style[d]};silex.model.Element.prototype.setStyle=function(c,d,e){goog.isDef(e)?c.style[d]=e:c.style[d]=""};silex.model.Element.prototype.setProperty=function(c,d,e){goog.isDef(e)?c.setAttribute(d,e):c.removeAttribute(d)};
silex.model.Element.prototype.setBgImage=function(c,d){d?this.setStyle(c,"backgroundImage","url("+d+")"):this.setStyle(c,"backgroundImage")};silex.model.Element.prototype.getInnerHtml=function(c){silex.utils.EditablePlugin.setEditable(c,!1);var d=this.getContentNode(c).innerHTML;silex.utils.EditablePlugin.setEditable(c,!0);return d};
silex.model.Element.prototype.setInnerHtml=function(c,d){var e=this.getContentNode(c);silex.utils.EditablePlugin.setEditable(c,!1);e.innerHTML=d;silex.utils.EditablePlugin.setEditable(c,!0)};silex.model.Element.prototype.getContentNode=function(c){var d=goog.dom.getElementsByClass(silex.model.Element.ELEMENT_CONTENT_CLASS_NAME,c);return d&&1===d.length?d[0]:c};
silex.model.Element.prototype.setContentNode=function(c,d){var e=this.getContentNode(c);e===c?(silex.utils.EditablePlugin.setEditable(c,!1),c.innerhtml=d.innerhtml,silex.utils.EditablePlugin.setEditable(c,!0)):goog.dom.replaceNode(d,e)};
silex.model.Element.prototype.getImageUrl=function(c){var d="";if(c.getAttribute(silex.model.Element.TYPE_ATTR)===silex.model.Element.TYPE_IMAGE){var e=this.getContentNode(c);e?d=e.getAttribute("src"):console.error("The image could not be retrieved from the element.",c)}else console.error("The element is not an image.",c);return d};
silex.model.Element.prototype.setImageUrl=function(c,d,e,f){if(c.getAttribute(silex.model.Element.TYPE_ATTR)===silex.model.Element.TYPE_IMAGE)if(this.getContentNode(c)){var h=new goog.net.ImageLoader;goog.events.listenOnce(h,goog.events.EventType.LOAD,function(d){goog.dom.classes.remove(c,"loading-image");d=d.target;goog.style.setStyle(d,"width","100%");goog.style.setStyle(d,"height","100%");goog.dom.appendChild(c,d);goog.dom.classes.add(d,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);d.removeAttribute("id");
e&&e(c,d)});goog.events.listenOnce(h,goog.net.EventType.ERROR,function(d){console.error("An error occured while loading the image.",c);f&&f(c,"An error occured while loading the image.")});goog.dom.classes.add(c,"loading-image");var k=goog.dom.getElementsByTagNameAndClass("img",silex.model.Element.ELEMENT_CONTENT_CLASS_NAME,c);0<k.length&&goog.dom.removeNode(k[0]);h.addImage(d,d);h.start()}else console.error("The image could not be retrieved from the element.",c),f&&f(c,"The image could not be retrieved from the element.");
else console.error("The element is not an image.",c),f&&f(c,"The element is not an image.")};silex.model.Element.prototype.removeElement=function(c){goog.dom.removeNode(c)};
silex.model.Element.prototype.createElement=function(c){var d,e={height:"100px",width:"100px",top:100+this.bodyElement.scrollTop+"px",left:100+this.bodyElement.scrollLeft+"px",position:"absolute"};switch(c){case silex.model.Element.TYPE_CONTAINER:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);e.backgroundColor="#FFFFFF";break;case silex.model.Element.TYPE_TEXT:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,
silex.model.Element.TYPE_TEXT);var f=goog.dom.createElement("div");f.innerHTML="<p>New text box</p>";goog.style.setStyle(f,"width","100%");goog.style.setStyle(f,"height","100%");goog.dom.appendChild(d,f);goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);e.backgroundColor="#FFFFFF";break;case silex.model.Element.TYPE_HTML:d=goog.dom.createElement("div");d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME;d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);
f=goog.dom.createElement("div");f.innerHTML="<p>New HTML box</p>";goog.style.setStyle(f,"width","100%");goog.style.setStyle(f,"height","100%");goog.dom.appendChild(d,f);goog.dom.classes.add(f,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);e.backgroundColor="#FFFFFF";break;case silex.model.Element.TYPE_IMAGE:d=goog.dom.createElement("div"),d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE)}goog.dom.classes.add(d,
silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);silex.utils.EditablePlugin.setEditable(d,!0);f=goog.dom.getElementByClass("background",this.bodyElement);f||(f=this.bodyElement);goog.style.setStyle(d,e);goog.dom.classes.add(d,c+"-element");goog.dom.appendChild(f,d);return d};silex.model.Element.prototype.setSelected=function(c,d){d?(this.resetSelection(),goog.dom.classes.add(c,silex.model.Element.SELECTED_CLASS_NAME)):goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)};
silex.model.Element.prototype.resetSelection=function(){var c=goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement);goog.array.forEach(c,function(c){goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)},this)};silex.model.Element.prototype.getSelected=function(c){return goog.dom.classes.has(c,silex.model.Element.SELECTED_CLASS_NAME)};silex.view={};silex.view.ViewBase=function(c,d,e){this.element=c;this.bodyElement=d;this.headElement=e};silex.view.ViewBase.prototype.getSelection=function(){var c=goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement);return c&&0!==c.length?c:[this.bodyElement]};silex.view.Menu=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.buildMenu(c)};goog.inherits(silex.view.Menu,silex.view.ViewBase);silex.view.Menu.prototype.redraw=function(){var c=null;$("title",this.headElement).each(function(){c=this.innerHTML});this.setWebsiteName(c)};
silex.view.Menu.prototype.buildMenu=function(c){this.menu=goog.ui.menuBar.create();var d=new goog.ui.KeyboardShortcutHandler(document),e=[];for(i in silex.Config.menu.names){var f=new goog.ui.Menu;goog.array.forEach(silex.Config.menu.options[i],function(c){var h;if(c){var k=c.id;h=new goog.ui.MenuItem(c.label);h.setId(k);h.addClassName(c.className);c.checkable&&h.setCheckable(!0);c.mnemonic&&h.setMnemonic(c.mnemonic);if(c.shortcut)for(var p in c.shortcut)d.registerShortcut(c.id,c.shortcut[p]),c.globalKey&&
e.push(c.globalKey)}else h=new goog.ui.MenuSeparator;f.addItem(h);c&&c.tooltip&&(k=goog.dom.createElement("span"),k.innerHTML=c.tooltip,k.className="goog-menuitem-accel",h.getElement().appendChild(k))},this);var h=silex.Config.menu.names[i],k=new goog.ui.MenuButton(h.label,f);k.addClassName(h.className);k.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);this.menu.addChild(k,!0)}d.setAlwaysPreventDefault(!1);d.setModifierShortcutsAreGlobal(!1);d.setGlobalKeys(e);goog.events.listen(d,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,
goog.bind(function(c){c.preventDefault();this.onMenuEvent(c.identifier)},this));h=new goog.events.KeyHandler(document);goog.events.listen(h,"key",goog.bind(function(c){c.keyCode===goog.events.KeyCodes.ENTER&&("INPUT"!==c.target.tagName.toUpperCase()&&"TEXTAREA"!==c.target.tagName.toUpperCase()&&c.target.tagName!==d.textInputs_[c.target.type])&&(c.preventDefault(),this.onMenuEvent("view.open.editor"))},this));this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,function(c){this.onClick(c)},
!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),goog.events.EventType.CLICK,function(c){this.onClick(c)},!1,this)};silex.view.Menu.prototype.onClick=function(c){if(this.onStatus&&c&&c.target)if(goog.dom.classes.has(c.target,"website-name"))this.onMenuEvent("title.changed");else this.onMenuEvent(c.target.getId())};silex.view.Menu.prototype.onMenuEvent=function(c){if(this.onStatus)this.onStatus(c)};
silex.view.Menu.prototype.setWebsiteName=function(c){c&&""!==c||(c="Untitled website");goog.dom.getElementByClass("website-name").innerHTML=c};silex.view.Menu.prototype.getWebsiteName=function(){return goog.dom.getElementByClass(headElement,"website-name").innerHTML};silex.controller.TextEditorController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.textEditor.onStatus=goog.bind(this.textEditorCallback,this)};goog.inherits(silex.controller.TextEditorController,silex.controller.ControllerBase);silex.controller.TextEditorController.prototype.textEditorCallback=function(c,d){switch(c){case "changed":var e=this.view.stage.getSelection()[0];this.model.element.setInnerHtml(e,d);this.refreshFonts()}};silex.service={};silex.service.Tracker=function(){ga||console.error("google analytcs not loaded")};goog.addSingletonGetter(silex.service.Tracker);silex.service.Tracker.SILEX_ACTIONS_CATEGORY="silex-event";silex.service.Tracker.prototype.trackAction=function(c,d,e,f){ga("send","event",c,d,e,f,!0)};silex.view.AceEditorBase=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initUI();c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};goog.inherits(silex.view.AceEditorBase,silex.view.ViewBase);
silex.view.AceEditorBase.prototype.initUI=function(){this.ace=ace.edit(goog.dom.getElementByClass("ace-editor",this.element));this.iAmSettingValue=!1;this.ace.getSession().on("change",goog.bind(function(c){!1===this.iAmSettingValue&&(this.ace.getValue(),setTimeout(goog.bind(function(){this.contentChanged()},this),100))},this));goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
silex.view.AceEditorBase.prototype.openEditor=function(c){var d=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(d,"display","inherit");goog.style.setStyle(this.element,"display","inherit");goog.events.listenOnce(d,goog.events.EventType.CLICK,function(c){this.closeEditor()},!1,this);this.iAmSettingValue=!0;this.ace.setValue(c);this.iAmSettingValue=!1;this.ace.resize()};
silex.view.AceEditorBase.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none")};silex.view.AceEditorBase.prototype.getData=function(){return this.ace.getValue()};silex.view.AceEditorBase.prototype.contentChanged=function(){if(this.onStatus)this.onStatus("changed",this.getData())};silex.view.CssEditor=function(c,d,e){silex.view.AceEditorBase.call(this,c,d,e)};goog.inherits(silex.view.CssEditor,silex.view.AceEditorBase);silex.view.CssEditor.prototype.initUI=function(){silex.view.CssEditor.superClass_.initUI.call(this);this.ace.getSession().setMode("ace/mode/css")};silex.controller.HtmlEditorController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.htmlEditor.onStatus=goog.bind(this.htmlEditorCallback,this)};goog.inherits(silex.controller.HtmlEditorController,silex.controller.ControllerBase);silex.controller.HtmlEditorController.prototype.htmlEditorCallback=function(c,d){switch(c){case "changed":var e=this.view.stage.getSelection()[0];this.model.element.setInnerHtml(e,d)}};goog.events.MouseWheelHandler=function(c,d){goog.events.EventTarget.call(this);this.element_=c;var e=goog.dom.isElement(this.element_)?this.element_:this.element_?this.element_.body:null;this.isRtl_=!!e&&goog.style.isRightToLeft(e);this.listenKey_=goog.events.listen(this.element_,goog.userAgent.GECKO?"DOMMouseScroll":"mousewheel",this,d)};goog.inherits(goog.events.MouseWheelHandler,goog.events.EventTarget);goog.events.MouseWheelHandler.EventType={MOUSEWHEEL:"mousewheel"};
goog.events.MouseWheelHandler.prototype.setMaxDeltaX=function(c){this.maxDeltaX_=c};goog.events.MouseWheelHandler.prototype.setMaxDeltaY=function(c){this.maxDeltaY_=c};
goog.events.MouseWheelHandler.prototype.handleEvent=function(c){var d=0,e=0,f=0;c=c.getBrowserEvent();if("mousewheel"==c.type){e=1;if(goog.userAgent.IE||goog.userAgent.WEBKIT&&(goog.userAgent.WINDOWS||goog.userAgent.isVersionOrHigher("532.0")))e=40;f=goog.events.MouseWheelHandler.smartScale_(-c.wheelDelta,e);goog.isDef(c.wheelDeltaX)?(d=goog.events.MouseWheelHandler.smartScale_(-c.wheelDeltaX,e),e=goog.events.MouseWheelHandler.smartScale_(-c.wheelDeltaY,e)):e=f}else f=c.detail,100<f?f=3:-100>f&&(f=
-3),goog.isDef(c.axis)&&c.axis===c.HORIZONTAL_AXIS?d=f:e=f;goog.isNumber(this.maxDeltaX_)&&(d=goog.math.clamp(d,-this.maxDeltaX_,this.maxDeltaX_));goog.isNumber(this.maxDeltaY_)&&(e=goog.math.clamp(e,-this.maxDeltaY_,this.maxDeltaY_));this.isRtl_&&(d=-d);d=new goog.events.MouseWheelEvent(f,c,d,e);this.dispatchEvent(d)};goog.events.MouseWheelHandler.smartScale_=function(c,d){return goog.userAgent.WEBKIT&&(goog.userAgent.MAC||goog.userAgent.LINUX)&&0!=c%d?c:c/d};
goog.events.MouseWheelHandler.prototype.disposeInternal=function(){goog.events.MouseWheelHandler.superClass_.disposeInternal.call(this);goog.events.unlistenByKey(this.listenKey_);this.listenKey_=null};goog.events.MouseWheelEvent=function(c,d,e,f){goog.events.BrowserEvent.call(this,d);this.type=goog.events.MouseWheelHandler.EventType.MOUSEWHEEL;this.detail=c;this.deltaX=e;this.deltaY=f};goog.inherits(goog.events.MouseWheelEvent,goog.events.BrowserEvent);silex.utils.EditablePlugin=function(){};silex.utils.EditablePlugin.EDITABLE_CLASS_NAME="editable-style";silex.utils.EditablePlugin.UI_RESIZABLE_CLASS_NAME="ui-resizable";silex.utils.EditablePlugin.UI_DRAGGABLE_CLASS_NAME="ui-draggable";silex.utils.EditablePlugin.UI_DROPPABLE_CLASS_NAME="ui-droppable";silex.utils.EditablePlugin.UI_DRAGGABLE_DRAGGING_CLASS_NAME="ui-draggable-dragging";
silex.utils.EditablePlugin.getFirstEditableParent=function(c){for(var d=c;d&&d.getAttribute&&!$(d).hasClass(silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);)d=d.parentNode;if(d&&d.getAttribute&&$(d).hasClass(silex.utils.EditablePlugin.EDITABLE_CLASS_NAME))return d;console.warn("this element has no editable parent",c);return c};silex.utils.EditablePlugin.resetEditable=function(c){setTimeout(function(){silex.utils.EditablePlugin.setEditable(c,!1);silex.utils.EditablePlugin.setEditable(c,!0)},10)};
silex.utils.EditablePlugin.setEditable=function(c,d,e){d?($(".editable-style",c).each(function(){"container"===this.getAttribute("data-silex-type")?$(this).editable({isContainer:!0}):$(this).editable()}),"container"===c.getAttribute("data-silex-type")?e?$(c).editable({isContainer:!0,isResizable:!1,isDroppable:!0,isDraggable:!1}):$(c).editable({isContainer:!0}):$(c).editable()):($(".editable-style",c).editable("destroy"),$(c).editable("destroy"),$(c).find(silex.model.Element.SELECTED_CLASS_NAME).removeClass(silex.utils.EditablePlugin.SILEX_SELECTED_CLASS_NAME),
$(c).find(silex.utils.EditablePlugin.UI_RESIZABLE_CLASS_NAME).removeClass(silex.utils.EditablePlugin.UI_RESIZABLE_CLASS_NAME),$(c).find(silex.utils.EditablePlugin.UI_DRAGGABLE_CLASS_NAME).removeClass(silex.utils.EditablePlugin.UI_DRAGGABLE_CLASS_NAME),$(c).find(silex.utils.EditablePlugin.UI_DROPPABLE_CLASS_NAME).removeClass(silex.utils.EditablePlugin.UI_DROPPABLE_CLASS_NAME),$(c).find(silex.utils.EditablePlugin.UI_DRAGGABLE_DRAGGING_CLASS_NAME).removeClass(silex.utils.EditablePlugin.UI_DRAGGABLE_DRAGGING_CLASS_NAME),
$(c).find("[aria-disabled]").removeAttr("aria-disabled"),$(c).find(".ui-resizable-handle").remove())};silex.view.Stage=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initEvents()};goog.inherits(silex.view.Stage,silex.view.ViewBase);
silex.view.Stage.prototype.initEvents=function(){goog.events.listen(this.element,"mousedown",function(c){this.element.focus();if(this.onStatus)this.onStatus("select",silex.utils.EditablePlugin.getFirstEditableParent(c.target));this.isDragging=!0},!1,this);goog.events.listen(document.body,"mouseup",function(c){if(this.isDragging){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1}},!1,this);goog.events.listen(this.element,"dragstop",function(c){if(this.onStatus)this.onStatus("change",
c.target);this.isDragging=!1},!1,this);goog.events.listen(this.element,"resize",function(c){if(this.onStatus)this.onStatus("change",c.target);this.isDragging=!1},!1,this);goog.events.listen(this.element,"newContainer",function(c){if(this.onStatus)this.onStatus("newContainer")},!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(c){if(this.onStatus)this.onStatus("edit")},!1,this);var c=new goog.events.MouseWheelHandler(this.element);goog.events.listen(c,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,
function(c){0>c.deltaX&&0>=this.bodyElement.scrollLeft&&c.preventDefault()},!1,this)};silex.view.Stage.prototype.getNeededFonts=function(){var c=[];this.bodyElement.innerHTML.replace(/<font[^"]*face="?([^"]*)"/g,function(d,e,f){c[e]=!0;return d});return c};silex.controller.SettingsDialogController=function(c,d){silex.controller.ControllerBase.call(this,c,d);this.view.settingsDialog.onStatus=goog.bind(this.settingsDialogCallback,this)};goog.inherits(silex.controller.SettingsDialogController,silex.controller.ControllerBase);
silex.controller.SettingsDialogController.prototype.settingsDialogCallback=function(c,d){switch(c){case "browsePublishPath":this.view.fileExplorer.openDialog(goog.bind(function(d){d=d.substring(d.indexOf("/api/v1.0/"),d.lastIndexOf("/"));d=d.replace("/exec/get","/exec/put");this.model.head.setPublicationPath(d);this.view.settingsDialog.redraw();this.tracker.trackAction("controller-events","success",c,1)},this),{mimetype:"folder"},goog.bind(function(d){silex.utils.Notification.notifyError("Error: I could not select the publish path. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));break;case "change":this.model.head.setPublicationPath(d),this.view.settingsDialog.redraw()}};silex.controller.PageToolController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.pageTool.onStatus=goog.bind(this.pageToolCallback,this)};goog.inherits(silex.controller.PageToolController,silex.controller.ControllerBase);silex.controller.PageToolController.prototype.pageToolCallback=function(c,d){this.tracker.trackAction("controller-events","request",c,0);switch(c){case "changed":this.openPage(d);break;case "delete":this.removePage(d);break;case "rename":this.renamePage(d)}};silex.controller.StageController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.stage.onStatus=goog.bind(this.stageCallback,this)};goog.inherits(silex.controller.StageController,silex.controller.ControllerBase);
silex.controller.StageController.prototype.stageCallback=function(c,d){switch(c){case "select":this.model.element.setSelected(d,!0);this.view.propertyTool.redraw();break;case "change":this.view.propertyTool.redraw();silex.utils.EditablePlugin.resetEditable(this.model.body.bodyElement);break;case "newContainer":var e=this.view.stage.getSelection()[0];this.checkElementVisibility(e);silex.utils.EditablePlugin.resetEditable(this.model.body.bodyElement);break;case "edit":this.editElement()}};silex.controller.PropertyToolController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.propertyTool.onStatus=goog.bind(this.propertyToolCallback,this)};goog.inherits(silex.controller.PropertyToolController,silex.controller.ControllerBase);
silex.controller.PropertyToolController.prototype.propertyToolCallback=function(c,d,e){switch(c){case "editHTML":this.editElement();break;case "editText":this.editElement();break;case "selectBgImage":this.browseBgImage();break;case "selectImage":this.editElement();break;case "styleChanged":this.styleChanged(d,e);break;case "classNameChanged":this.setClassName(d);break;case "propertyChanged":this.propertyChanged(d,e);break;case "addToPage":silex.utils.PageablePlugin.addToPage(this.view.stage.getSelection()[0],
d);break;case "removeFromPage":silex.utils.PageablePlugin.removeFromPage(this.view.stage.getSelection()[0],d);break;case "addLink":silex.utils.PageablePlugin.setLink(this.view.stage.getSelection()[0],d);break;case "removeLink":silex.utils.PageablePlugin.setLink(this.view.stage.getSelection()[0])}};silex.controller.MenuController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.menu.onStatus=goog.bind(this.menuCallback,this)};goog.inherits(silex.controller.MenuController,silex.controller.ControllerBase);
silex.controller.MenuController.prototype.menuCallback=function(c){switch(c){case "title.changed":this.promptTitle();break;case "file.close":case "file.new":this.newFile();break;case "file.saveas":this.save(null,goog.bind(function(){this.tracker.trackAction("controller-events","success",c,1)},this));break;case "file.rename":this.promptTitle();break;case "file.publish.settings":this.view.settingsDialog.openDialog();this.view.workspace.invalidate();break;case "file.publish":this.publish();break;case "file.save":this.save(this.model.file.getUrl());
break;case "file.open":this.openFile();break;case "view.file":this.preview();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "view.open.fileExplorer":this.view.fileExplorer.openDialog();this.view.workspace.invalidate();
break;case "view.open.cssEditor":this.openCssEditor();break;case "view.open.jsEditor":this.openJsEditor();break;case "view.open.editor":this.editElement();break;case "insert.page":this.createPage();break;case "insert.text":this.addElement(silex.model.Element.TYPE_TEXT);break;case "insert.html":this.addElement(silex.model.Element.TYPE_HTML);break;case "insert.image":this.browseAndAddImage(silex.model.Element.TYPE_IMAGE);break;case "insert.container":this.addElement(silex.model.Element.TYPE_CONTAINER);
break;case "edit.delete.selection":this.removeElement();break;case "edit.delete.page":this.removePage();break;case "edit.rename.page":this.renamePage();break;case "help.about":window.open(silex.Config.ABOUT_SILEX);break;case "help.aboutSilexLabs":window.open(silex.Config.ABOUT_SILEX_LABS);break;case "help.newsLetter":window.open(silex.Config.SUBSCRIBE_SILEX_LABS);break;case "help.googlPlus":window.open(silex.Config.SOCIAL_GPLUS);break;case "help.twitter":window.open(silex.Config.SOCIAL_TWITTER);break;
case "help.facebook":window.open(silex.Config.SOCIAL_FB);break;case "help.forkMe":window.open(silex.Config.FORK_CODE)}};silex.controller.CssEditorController=function(c,d){silex.controller.ControllerBase.call(this,c,d);d.cssEditor.onStatus=goog.bind(this.cssEditorCallback,this)};goog.inherits(silex.controller.CssEditorController,silex.controller.ControllerBase);silex.controller.CssEditorController.prototype.cssEditorCallback=function(c,d){switch(c){case "changed":this.model.head.setHeadStyle(d),this.model.head.updateBrowserStyle(),this.view.textEditor.redraw()}};silex.types={};silex.types.Model=function(c,d,e,f){this.file=c;this.head=d;this.body=e;this.element=f};silex.types.Controller=function(c,d,e,f,h,k,l,m,n){this.menuController=c;this.stageController=d;this.pageToolController=e;this.propertyToolController=f;this.settingsDialogController=h;this.htmlEditorController=k;this.cssEditorController=l;this.jsEditorController=m;this.textEditorController=n};
silex.types.View=function(c,d,e,f,h,k,l,m,n,p,q){this.workspace=c;this.menu=d;this.stage=e;this.pageTool=f;this.propertyTool=h;this.htmlEditor=k;this.cssEditor=l;this.jsEditor=m;this.textEditor=n;this.fileExplorer=p;this.settingsDialog=q};silex.view.SettingsDialog=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.publicationPath="";goog.style.setStyle(this.element,"display","none");c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this));c=goog.dom.getElementByClass("close-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.closeEditor()},
!1,this);c=goog.dom.getElementByClass("browse-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.onStatus("browsePublishPath")},!1,this);var f=goog.dom.getElementByClass("input-publication-path");goog.events.listen(f,goog.ui.Component.EventType.CHANGE,function(){this.onStatus("change",f.value)},!1,this)};goog.inherits(silex.view.SettingsDialog,silex.view.ViewBase);
silex.view.SettingsDialog.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};silex.view.SettingsDialog.prototype.redraw=function(){goog.dom.getElementByClass("input-publication-path").value=this.getPublicationPath()};
silex.view.SettingsDialog.prototype.openDialog=function(c){this.onClose=c;c=goog.dom.getElementByClass("settings-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(c,goog.events.EventType.CLICK,this.closeEditor,!0,this);this.redraw()};
silex.view.SettingsDialog.prototype.closeEditor=function(){if(this.onClose)this.onClose();var c=goog.dom.getElementByClass("settings-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};goog.uri={};goog.uri.utils={};goog.uri.utils.CharCode_={AMPERSAND:38,EQUAL:61,HASH:35,QUESTION:63};goog.uri.utils.buildFromEncodedParts=function(c,d,e,f,h,k,l){var m="";c&&(m+=c+":");e&&(m+="//",d&&(m+=d+"@"),m+=e,f&&(m+=":"+f));h&&(m+=h);k&&(m+="?"+k);l&&(m+="#"+l);return m};goog.uri.utils.splitRe_=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
...
goog.net.XmlHttp.setGlobalFactory(new goog.net.DefaultXmlHttpFactory);goog.structs.Collection=function(){};goog.iter={};goog.iter.StopIteration="StopIteration"in goog.global?goog.global.StopIteration:Error("StopIteration");goog.iter.Iterator=function(){};goog.iter.Iterator.prototype.next=function(){throw goog.iter.StopIteration;};goog.iter.Iterator.prototype.__iterator__=function(c){return this};
...
goog.iter.chain=function(c){var d=goog.iter.toIterator(arguments),e=new goog.iter.Iterator,f=null;e.next=function(){for(;;){if(null==f){var c=d.next();f=goog.iter.toIterator(c)}try{return f.next()}catch(e){if(e!==goog.iter.StopIteration)throw e;f=null}}};return e};goog.iter.chainFromIterable=function(c){return goog.iter.chain.apply(void 0,c)};
goog.iter.dropWhile=function(c,d,e){var f=goog.iter.toIterator(c);c=new goog.iter.Iterator;var h=!0;c.next=function(){for(;;){var c=f.next();if(!h||!d.call(e,c,void 0,f))return h=!1,c}};return c};goog.iter.takeWhile=function(c,d,e){var f=goog.iter.toIterator(c);c=new goog.iter.Iterator;var h=!0;c.next=function(){for(;;)if(h){var c=f.next();if(d.call(e,c,void 0,f))return c;h=!1}else throw goog.iter.StopIteration;};return c};
goog.iter.toArray=function(c){if(goog.isArrayLike(c))return goog.array.toArray(c);c=goog.iter.toIterator(c);var d=[];goog.iter.forEach(c,function(c){d.push(c)});return d};goog.iter.equals=function(c,d){var e=goog.iter.zipLongest({},c,d);return goog.iter.every(e,function(c){return c[0]==c[1]})};goog.iter.nextOrValue=function(c,d){try{return goog.iter.toIterator(c).next()}catch(e){if(e!=goog.iter.StopIteration)throw e;return d}};
...
goog.iter.cycle=function(c){var d=goog.iter.toIterator(c),e=[],f=0;c=new goog.iter.Iterator;var h=!1;c.next=function(){var c=null;if(!h)try{return c=d.next(),e.push(c),c}catch(l){if(l!=goog.iter.StopIteration||goog.array.isEmpty(e))throw l;h=!0}c=e[f];f=(f+1)%e.length;return c};return c};goog.iter.count=function(c,d){var e=c||0,f=goog.isDef(d)?d:1,h=new goog.iter.Iterator;h.next=function(){var c=e;e+=f;return c};return h};
goog.iter.repeat=function(c){var d=new goog.iter.Iterator;d.next=goog.functions.constant(c);return d};goog.iter.accumulate=function(c){var d=goog.iter.toIterator(c),e=0;c=new goog.iter.Iterator;c.next=function(){return e+=d.next()};return c};goog.iter.zip=function(c){var d=arguments,e=new goog.iter.Iterator;if(0<d.length){var f=goog.array.map(d,goog.iter.toIterator);e.next=function(){return goog.array.map(f,function(c){return c.next()})}}return e};
goog.iter.zipLongest=function(c,d){var e=goog.array.slice(arguments,1),f=new goog.iter.Iterator;if(0<e.length){var h=goog.array.map(e,goog.iter.toIterator);f.next=function(){var d=!1,e=goog.array.map(h,function(e){var f;try{f=e.next(),d=!0}catch(h){if(h!==goog.iter.StopIteration)throw h;f=c}return f});if(!d)throw goog.iter.StopIteration;return e}}return f};goog.iter.compress=function(c,d){var e=goog.iter.toIterator(d);return goog.iter.filter(c,function(){return!!e.next()})};
goog.iter.GroupByIterator_=function(c,d){this.iterator=goog.iter.toIterator(c);this.keyFunc=d||goog.functions.identity};goog.inherits(goog.iter.GroupByIterator_,goog.iter.Iterator);goog.iter.GroupByIterator_.prototype.next=function(){for(;this.currentKey==this.targetKey;)this.currentValue=this.iterator.next(),this.currentKey=this.keyFunc(this.currentValue);this.targetKey=this.currentKey;return[this.currentKey,this.groupItems_(this.targetKey)]};
goog.iter.GroupByIterator_.prototype.groupItems_=function(c){for(var d=[];this.currentKey==c;){d.push(this.currentValue);try{this.currentValue=this.iterator.next()}catch(e){if(e!==goog.iter.StopIteration)throw e;break}this.currentKey=this.keyFunc(this.currentValue)}return d};goog.iter.groupBy=function(c,d){return new goog.iter.GroupByIterator_(c,d)};
goog.iter.tee=function(c,d){var e=goog.iter.toIterator(c),f=goog.isNumber(d)?d:2,h=goog.array.map(goog.array.range(f),function(){return[]}),k=function(){var c=e.next();goog.array.forEach(h,function(d){d.push(c)})};return goog.array.map(h,function(c){var d=new goog.iter.Iterator;d.next=function(){goog.array.isEmpty(c)&&k();goog.asserts.assert(!goog.array.isEmpty(c));return c.shift()};return d})};goog.iter.enumerate=function(c,d){return goog.iter.zip(goog.iter.count(d),c)};
goog.iter.limit=function(c,d){goog.asserts.assert(goog.math.isInt(d)&&0<=d);var e=goog.iter.toIterator(c),f=new goog.iter.Iterator,h=d;f.next=function(){if(0<h--)return e.next();throw goog.iter.StopIteration;};return f};goog.iter.consume=function(c,d){goog.asserts.assert(goog.math.isInt(d)&&0<=d);for(var e=goog.iter.toIterator(c);0<d--;)goog.iter.nextOrValue(e,null);return e};
goog.iter.slice=function(c,d,e){goog.asserts.assert(goog.math.isInt(d)&&0<=d);c=goog.iter.consume(c,d);goog.isNumber(e)&&(goog.asserts.assert(goog.math.isInt(e)&&e>=d),c=goog.iter.limit(c,e-d));return c};goog.iter.hasDuplicates_=function(c){var d=[];goog.array.removeDuplicates(c,d);return c.length!=d.length};goog.iter.permutations=function(c,d){var e=goog.iter.toArray(c),f=goog.isNumber(d)?d:e.length,e=goog.array.repeat(e,f),e=goog.iter.product.apply(void 0,e);return goog.iter.filter(e,function(c){return!goog.iter.hasDuplicates_(c)})};
goog.iter.combinations=function(c,d){function e(c){return f[c]}var f=goog.iter.toArray(c),h=goog.iter.range(f.length),h=goog.iter.permutations(h,d),k=goog.iter.filter(h,function(c){return goog.array.isSorted(c)}),h=new goog.iter.Iterator;h.next=function(){return goog.array.map(k.next(),e)};return h};
goog.iter.combinationsWithReplacement=function(c,d){function e(c){return f[c]}var f=goog.iter.toArray(c),h=goog.array.range(f.length),h=goog.array.repeat(h,d),h=goog.iter.product.apply(void 0,h),k=goog.iter.filter(h,function(c){return goog.array.isSorted(c)}),h=new goog.iter.Iterator;h.next=function(){return goog.array.map(k.next(),e)};return h};goog.structs.Map=function(c,d){this.map_={};this.keys_=[];this.version_=this.count_=0;var e=arguments.length;if(1<e){if(e%2)throw Error("Uneven number of arguments");for(var f=0;f<e;f+=2)this.set(arguments[f],arguments[f+1])}else c&&this.addAll(c)};goog.structs.Map.prototype.getCount=function(){return this.count_};goog.structs.Map.prototype.getValues=function(){this.cleanupKeysArray_();for(var c=[],d=0;d<this.keys_.length;d++)c.push(this.map_[this.keys_[d]]);return c};
goog.structs.Map.prototype.getKeys=function(){this.cleanupKeysArray_();return this.keys_.concat()};goog.structs.Map.prototype.containsKey=function(c){return goog.structs.Map.hasKey_(this.map_,c)};goog.structs.Map.prototype.containsValue=function(c){for(var d=0;d<this.keys_.length;d++){var e=this.keys_[d];if(goog.structs.Map.hasKey_(this.map_,e)&&this.map_[e]==c)return!0}return!1};
...
goog.structs.Map.prototype.remove=function(c){return goog.structs.Map.hasKey_(this.map_,c)?(delete this.map_[c],this.count_--,this.version_++,this.keys_.length>2*this.count_&&this.cleanupKeysArray_(),!0):!1};
...
"Can not get response: "+c.message),null}};goog.net.XhrIo.prototype.getResponseHeader=function(c){return this.xhr_&&this.isComplete()?this.xhr_.getResponseHeader(c):void 0};goog.net.XhrIo.prototype.getAllResponseHeaders=function(){return this.xhr_&&this.isComplete()?this.xhr_.getAllResponseHeaders():""};
goog.net.XhrIo.prototype.getResponseHeaders=function(){for(var c={},d=this.getAllResponseHeaders().split("\r\n"),e=0;e<d.length;e++)if(!goog.string.isEmpty(d[e])){var f=goog.string.splitLimit(d[e],": ",2);c[f[0]]=c[f[0]]?c[f[0]]+(", "+f[1]):f[1]}return c};goog.net.XhrIo.prototype.getLastErrorCode=function(){return this.lastErrorCode_};goog.net.XhrIo.prototype.getLastError=function(){return goog.isString(this.lastError_)?this.lastError_:String(this.lastError_)};
goog.net.XhrIo.prototype.formatMsg_=function(c){return c+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(c){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=c(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});silex.service.CloudStorage=function(){this.filePicker=cloudExplorer};goog.addSingletonGetter(silex.service.CloudStorage);silex.service.CloudStorage.prototype.createBlob=function(c){if(silex.utils.Url.isAbsoluteUrl(c))throw console.error("cloud explorer expects relative path"),Error("cloud explorer expects relative path");return{url:c}};
silex.service.CloudStorage.prototype.save=function(c,d,e,f){c=this.createBlob(c);this.filePicker.write(c,d,function(c){(new goog.async.Delay(function(){e&&e()},10)).start()},function(c){console.error(c);f&&(console.error(c),f(c))})};silex.service.CloudStorage.prototype.load=function(c,d,e){c=this.createBlob(c);this.filePicker.read(c,function(c){(new goog.async.Delay(function(){d&&d(c)},10)).start()},function(c){console.error(c);e&&(console.error(c),e(c))})};
silex.service.CloudStorage.prototype.loadLocal=function(c,d,e){goog.net.XhrIo.send(c,function(c){c=c.target;var h=c.getResponse();if(c.isSuccess())(new goog.async.Delay(function(){d&&d(h)},10)).start();else{var k=c.getLastError();console.error(k,c,c.isSuccess(),c.getStatus(),c.headers.toString());e&&(console.error(FPError),e(k))}})};goog.async={};goog.async.Delay=function(c,d,e){goog.Disposable.call(this);this.listener_=c;this.interval_=d||0;this.handler_=e;this.callback_=goog.bind(this.doAction_,this)};goog.inherits(goog.async.Delay,goog.Disposable);goog.Delay=goog.async.Delay;goog.async.Delay.prototype.id_=0;goog.async.Delay.prototype.disposeInternal=function(){goog.async.Delay.superClass_.disposeInternal.call(this);this.stop();delete this.listener_;delete this.handler_};
...
goog.Uri.QueryData.prototype.extend=function(c){for(var d=0;d<arguments.length;d++)goog.structs.forEach(arguments[d],function(c,d){this.add(d,c)},this)};silex.utils.Url={};silex.utils.Url.getBaseUrl=function(c){c=c?silex.utils.Url.getAbsolutePath(c,window.location.href):window.location.href;return c.substr(0,c.lastIndexOf("/")+1)};silex.utils.Url.isAbsoluteUrl=function(c){return 0===c.indexOf("http")};
silex.utils.Url.absolute2Relative=function(c,d){c=c.replace(/src="?([^" ]*)" /g,function(c,f,h){return c.replace(f,silex.utils.Url.getRelativePath(f,d))});return c=c.replace(/url\(()(.+?)\1\)/g,function(c,f,h){0===h.indexOf("'")&&(h=h.substr(1));h.lastIndexOf("'")===h.length-1&&(h=h.substr(0,h.length-1));return"url('"+silex.utils.Url.getRelativePath(h,d)+"')"})};
silex.utils.Url.relative2absolute=function(c,d){c=c.replace(/src="?([^" ]*)" /g,function(c,f,h){return c.replace(f,silex.utils.Url.getAbsolutePath(f,d))});return c=c.replace(/url\(()(.+?)\1\)/g,function(c,f,h){0===h.indexOf("'")&&(h=h.substr(1));h.lastIndexOf("'")===h.length-1&&(h=h.substr(0,h.length-1));return"url('"+silex.utils.Url.getAbsolutePath(h,d)+"')"})};
silex.utils.Url.getRelativePath=function(c,d){if(0!==d.indexOf("http")||0!==c.indexOf("http"))return console.warn("Warning: the URL is not absolute ",c,d),c;var e=c.split("/"),f=d.split("/"),h=e[e.length-1];e.pop();f.pop();e.shift();e.shift();f.shift();f.shift();if(f[0]!==e[0])return console.warn("Warning: the URL is not on the same domain as the base url ",c,d),c;for(;0<f.length&&0<e.length&&f[0]===e[0];)f.shift(),e.shift();for(var k="",l=0;l<f.length;l++)k+="../";0<e.length&&(k+=e.join("/")+"/");
return k+h};silex.utils.Url.getAbsolutePath=function(c,d){return goog.Uri.resolve(d,c).toString()};silex.utils.Url.checkFileExt=function(c,d){var e=c.substring(c.lastIndexOf(".")+1).toLowerCase();for(idx in d)if(d[idx]===e)return!0;return!1};silex.view.FileExplorer=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);goog.style.setStyle(this.element,"display","none");(new goog.async.Delay(function(){this.init()},1E3,this)).start();c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};goog.inherits(silex.view.FileExplorer,silex.view.ViewBase);
silex.view.FileExplorer.CONTAINER_TYPE="modal";silex.view.FileExplorer.SERVICES=["DROPBOX","GOOGLE_DRIVE","EVERNOTE","FTP"];silex.view.FileExplorer.prototype.init=function(){this.filePicker=silex.service.CloudStorage.getInstance().filePicker;goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
silex.view.FileExplorer.prototype.openDialog=function(c,d,e){var f;d&&(0===d.mimetype.indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d.mimetype.indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d)},10,this)).start()};this.filePicker.pick(goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");if(f&&!1===silex.utils.Url.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+
1);silex.utils.Notification.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c.url):h({message:"Wrong file type."})})}else k(c.url)},this),h);this.openEditor()};
silex.view.FileExplorer.prototype.saveAsDialog=function(c,d,e){var f;d&&(0===d.mimetype.indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d.mimetype.indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d.url)},10,this)).start()};this.filePicker.exportFile("http://google.com/",d,goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");if(f&&!1===silex.utils.Url.checkFileExt(c.url,f)){var d=
c.url.substring(c.url.lastIndexOf("/")+1);silex.utils.Notification.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};
silex.view.FileExplorer.prototype.openEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};
silex.view.FileExplorer.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};silex.model.Body=function(c,d){silex.model.ModelBase.call(this,c,d);silex.utils.EditablePlugin.setEditable(c,!0,!0);silex.utils.PageablePlugin.setPageable(c,!0)};goog.inherits(silex.model.Body,silex.model.ModelBase);silex.model.Head=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.Head,silex.model.ModelBase);silex.model.Head.SILEX_STYLE_ELEMENT_ID="silex-style";silex.model.Head.SILEX_SCRIPT_ELEMENT_ID="silex-script";silex.model.Head.prototype.getHeadScript=function(){var c=goog.dom.getElementByClass(silex.model.Head.SILEX_SCRIPT_ELEMENT_ID,this.headElement);return c?c.innerHTML:(console.warn("no silex editable styles defined"),"")};
silex.model.Head.prototype.setHeadScript=function(c){var d=goog.dom.getElementByClass(silex.model.Head.SILEX_SCRIPT_ELEMENT_ID,this.headElement);d||(d=goog.dom.createElement("script"),d.type="text/javascript",d.className=silex.model.Head.SILEX_SCRIPT_ELEMENT_ID,goog.dom.appendChild(this.headElement,d));d.innerHTML=c};
silex.model.Head.prototype.getHeadStyle=function(){var c=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,this.headElement);return c?c.innerHTML:(console.warn("no silex editable styles defined"),"")};
silex.model.Head.prototype.setHeadStyle=function(c){var d=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,this.headElement);d||(d=goog.dom.createElement("style"),d.type="text/css",d.className=silex.model.Head.SILEX_STYLE_ELEMENT_ID,goog.dom.appendChild(this.headElement,d));d.innerHTML=c};
silex.model.Head.prototype.updateBrowserStyle=function(){var c=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,document.head);c||(c=goog.dom.createElement("style"),c.type="text/css",c.className=silex.model.Head.SILEX_STYLE_ELEMENT_ID,goog.dom.appendChild(document.head,c));c.innerHTML=this.getHeadStyle()};
silex.model.Head.prototype.refreshFontList=function(c){var d=goog.dom.getElementsByTagNameAndClass("link");goog.array.forEach(d,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});var e=this.headElement,d=goog.dom.getElementsByTagNameAndClass("link",null,e);goog.array.forEach(d,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});d=goog.dom.getElementsByTagNameAndClass("link",null,e);goog.array.forEach(d,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&
c.parentNode.removeChild(c)});d=goog.dom.getElementsByTagNameAndClass("font",null,e);goog.array.forEach(d,function(d){null!==d.getAttribute("face")&&(c[d.getAttribute("face")]=!0)});var f=silex.Config.fonts,d=function(c){for(var d in f)if(f[d].value===c)return f[d];return null},h;for(h in c){var k=d(h);if(k&&void 0!==k.href){var l=goog.dom.createElement("link");l.setAttribute("href",k.href);l.setAttribute("rel","stylesheet");l.setAttribute("type","text/css");e.appendChild(l);l=goog.dom.createElement("link");
l.setAttribute("href",k.href);l.setAttribute("rel","stylesheet");l.setAttribute("type","text/css");document.head.appendChild(l)}}};silex.model.Head.prototype.setPublicationPath=function(c){var d=!1;$('meta[name="publicationPath"]',this.headElement).each(function(){c&&""!==c?this.setAttribute("content",c):$(this).remove();d=!0});if(!d&&c&&""!==c){var e=goog.dom.createElement("meta");e.name="publicationPath";e.content=c;goog.dom.appendChild(this.headElement,e)}};
silex.model.Head.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};silex.model.Head.prototype.getTitle=function(){var c=null;$("title",this.headElement).each(function(){c=this.innerHTML});return c};
silex.model.Head.prototype.setTitle=function(c){var d=!1;$("title",this.headElement).each(function(){this.innerHTML=c;d=!0});if(!d){var e=goog.dom.createElement("title");e.innerHTML=c;goog.dom.appendChild(this.headElement,e)}};silex.utils.Dom=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Dom.renderList=function(c,d){var e="";for(itemIdx in d){var f=c;for(key in d[itemIdx])f=f.replace(RegExp("{{"+key+"}}","g"),d[itemIdx][key]);e+=f}return e};silex.view.pane={};silex.view.pane.PaneBase=function(c,d,e){silex.view.ViewBase.call(this,c,d,e)};goog.inherits(silex.view.pane.PaneBase,silex.view.ViewBase);silex.view.pane.PaneBase.prototype.selectBgImage=function(){if(this.onStatus)this.onStatus("selectBgImage")};silex.view.pane.PaneBase.prototype.selectImage=function(){if(this.onStatus)this.onStatus("selectImage")};silex.view.pane.PaneBase.prototype.editHTML=function(){if(this.onStatus)this.onStatus("editHTML")};
silex.view.pane.PaneBase.prototype.editText=function(){if(this.onStatus)this.onStatus("editText")};silex.view.pane.PaneBase.prototype.styleChanged=function(c,d){if(this.onStatus)this.onStatus("styleChanged",c,d)};silex.view.pane.PaneBase.prototype.redraw=function(){};silex.view.pane.PaneBase.prototype.getBaseUrl=function(){return this.baseUrl};silex.view.pane.PaneBase.prototype.setBaseUrl=function(c){this.baseUrl=c;this.redraw()};silex.view.pane.PropertyPane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.PropertyPane,silex.view.pane.PaneBase);
silex.view.pane.PropertyPane.prototype.buildUi=function(){this.leftInput=goog.dom.getElementByClass("left-input");this.leftInput.setAttribute("data-style-name","left");this.leftInput.setAttribute("data-style-unit","px");goog.events.listen(this.leftInput,"change",this.onPositionChanged,!1,this);this.widthInput=goog.dom.getElementByClass("width-input");this.widthInput.setAttribute("data-style-name","width");this.widthInput.setAttribute("data-style-unit","px");goog.events.listen(this.widthInput,"change",
this.onPositionChanged,!1,this);this.topInput=goog.dom.getElementByClass("top-input");this.topInput.setAttribute("data-style-name","top");this.topInput.setAttribute("data-style-unit","px");goog.events.listen(this.topInput,"change",this.onPositionChanged,!1,this);this.heightInput=goog.dom.getElementByClass("height-input");this.heightInput.setAttribute("data-style-name","height");this.heightInput.setAttribute("data-style-unit","px");goog.events.listen(this.heightInput,"change",this.onPositionChanged,
!1,this)};silex.view.pane.PropertyPane.prototype.onPositionChanged=function(c){this.getSelection();c=c.target;c.value&&""!=c.value?this.styleChanged(c.getAttribute("data-style-name"),c.value+c.getAttribute("data-style-unit")):this.styleChanged(c.getAttribute("data-style-name"))};
silex.view.pane.PropertyPane.prototype.redraw=function(){silex.view.pane.PropertyPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){if(c.getAttribute(silex.model.Element.TYPE_ATTR)===silex.model.Element.TYPE_IMAGE){var d=goog.dom.getElement(silex.model.Element.ELEMENT_CONTENT_CLASS_NAME,c);d&&(this.baseUrl?silex.utils.Style.getRelativePath(d.getAttribute("src"),this.baseUrl):d.getAttribute("src"))}this.element&&(goog.dom.classes.has(c,"editable-style")?(this.leftInput.value=void 0!==
c.style.left?c.style.left.substr(0,c.style.left.indexOf("px")):"",this.widthInput.value=void 0!==c.style.width?c.style.width.substr(0,c.style.width.indexOf("px")):"",this.topInput.value=void 0!==c.style.top?c.style.top.substr(0,c.style.top.indexOf("px")):"",this.heightInput.value=void 0!==c.style.height?c.style.height.substr(0,c.style.height.indexOf("px")):""):(this.leftInput.value="",this.widthInput.value="",this.topInput.value="",this.heightInput.value=""))}};goog.editor={};goog.editor.defines={};goog.editor.defines.USE_CONTENTEDITABLE_IN_FIREFOX_3=!1;goog.userAgent.product.determineVersion_=function(){if(goog.userAgent.product.FIREFOX)return goog.userAgent.product.getFirstRegExpGroup_(/Firefox\/([0-9.]+)/);if(goog.userAgent.product.IE||goog.userAgent.product.OPERA)return goog.userAgent.VERSION;if(goog.userAgent.product.CHROME)return goog.userAgent.product.getFirstRegExpGroup_(/Chrome\/([0-9.]+)/);if(goog.userAgent.product.SAFARI)return goog.userAgent.product.getFirstRegExpGroup_(/Version\/([0-9.]+)/);if(goog.userAgent.product.IPHONE||goog.userAgent.product.IPAD){var c=
...
goog.dom.browserrange.IeRange.prototype.getEndpointNode_=function(c,d){var e=d||this.getContainer();if(!e||!e.firstChild)return e;for(var f=goog.dom.RangeEndpoint.START,h=goog.dom.RangeEndpoint.END,k=c==f,l=0,m=e.childNodes.length;l<m;l++){var n=k?l:m-l-1,p=e.childNodes[n],q;try{q=goog.dom.browserrange.createRangeFromNodeContents(p)}catch(s){continue}var t=q.getBrowserRange();if(this.isCollapsed())if(!goog.dom.browserrange.canContainRangeEndpoint(p)){if(0==this.compareBrowserRangeEndpoints(t,f,f)){this.startOffset_=
this.endOffset_=n;break}}else{if(q.containsRange(this))return this.getEndpointNode_(c,p)}else{if(this.containsRange(q)){if(!goog.dom.browserrange.canContainRangeEndpoint(p)){k?this.startOffset_=n:this.endOffset_=n+1;break}return this.getEndpointNode_(c,p)}if(0>this.compareBrowserRangeEndpoints(t,f,h)&&0<this.compareBrowserRangeEndpoints(t,h,f))return this.getEndpointNode_(c,p)}}return e};
...
goog.editor.Field.prototype.addListener=function(c,d,e,f){var h=this.getElement();goog.editor.BrowserFeature.USE_DOCUMENT_FOR_KEY_EVENTS&&(h&&this.usesIframe())&&(h=h.ownerDocument);f?this.eventRegister.listenWithScope(h,c,d,e,f):this.eventRegister.listen(h,c,d,e)};goog.editor.Field.prototype.getPluginByClassId=function(c){return this.plugins_[c]};
...
goog.cssom.addCssRule=function(c,d,e){if(0>e||void 0==e)e=(c.cssRules||c.rules).length;if(c.insertRule)c.insertRule(d,e);else if(d=/^([^\{]+)\{([^\{]+)\}/.exec(d),3==d.length)c.addRule(d[1],d[2],e);else throw Error("Your CSSRule appears to be ill-formatted.");};goog.cssom.removeCssRule=function(c,d){c.deleteRule?c.deleteRule(d):c.removeRule(d)};
...
goog.ui.HsvPalette.prototype.enterDocument=function(){goog.ui.HsvPalette.superClass_.enterDocument.call(this);this.updateUi();var c=this.getHandler();c.listen(this.getElement(),goog.events.EventType.MOUSEDOWN,this.handleMouseDown);this.inputHandler_||(this.inputHandler_=new goog.events.InputHandler(this.inputElement));c.listen(this.inputHandler_,goog.events.InputHandler.EventType.INPUT,this.handleInput)};
...
goog.ui.HsvaPalette.parseUserInput_=function(c){return/^#[0-9a-f]{8}$/i.test(c)?goog.ui.HsvaPalette.parseColorRgbaHex_(c):/^#[0-9a-f]{6}$/i.test(c)?[c,1]:null};goog.ui.HsvaPalette.parseColorRgbaHex_=function(c){c=goog.color.alpha.parse(c).hex;return[goog.color.alpha.extractHexColor(c),parseInt(goog.color.alpha.extractAlpha(c),16)/255]};goog.ui.CheckboxRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.CheckboxRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.CheckboxRenderer);goog.ui.CheckboxRenderer.CSS_CLASS="goog-checkbox";goog.ui.CheckboxRenderer.prototype.createDom=function(c){var d=c.getDomHelper().createDom("span",this.getClassNames(c).join(" "));c=c.getChecked();this.setCheckboxState(d,c);return d};
goog.ui.CheckboxRenderer.prototype.decorate=function(c,d){d=goog.ui.CheckboxRenderer.superClass_.decorate.call(this,c,d);var e=goog.dom.classlist.get(d),f=goog.ui.Checkbox.State.UNCHECKED;goog.array.contains(e,this.getClassForCheckboxState(goog.ui.Checkbox.State.UNDETERMINED))?f=goog.ui.Checkbox.State.UNDETERMINED:goog.array.contains(e,this.getClassForCheckboxState(goog.ui.Checkbox.State.CHECKED))?f=goog.ui.Checkbox.State.CHECKED:goog.array.contains(e,this.getClassForCheckboxState(goog.ui.Checkbox.State.UNCHECKED))&&
...
goog.ui.CheckboxRenderer.prototype.setCheckboxState=function(c,d){if(c){var e=this.getClassForCheckboxState(d);goog.asserts.assert(e);goog.dom.classlist.contains(c,e)||(goog.object.forEach(goog.ui.Checkbox.State,function(d){d=this.getClassForCheckboxState(d);goog.dom.classlist.enable(c,d,d==e)},this),goog.a11y.aria.setState(c,goog.a11y.aria.State.CHECKED,this.ariaStateFromCheckState_(d)))}};
...
goog.ui.Checkbox.prototype.handleClickOrSpace_=function(c){c.stopPropagation();var d=this.checked_?goog.ui.Component.EventType.UNCHECK:goog.ui.Component.EventType.CHECK;this.isEnabled()&&(!c.target.href&&this.dispatchEvent(d))&&(c.preventDefault(),this.toggle(),this.dispatchEvent(goog.ui.Component.EventType.CHANGE))};goog.ui.Checkbox.prototype.handleKeyEventInternal=function(c){c.keyCode==goog.events.KeyCodes.SPACE&&this.handleClickOrSpace_(c);return!1};
goog.ui.registry.setDecoratorByClassName(goog.ui.CheckboxRenderer.CSS_CLASS,function(){return new goog.ui.Checkbox});silex.view.pane.BorderPane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.BorderPane,silex.view.pane.PaneBase);
silex.view.pane.BorderPane.prototype.buildUi=function(){this.borderWidthInput=goog.dom.getElementByClass("border-width-input",this.element);this.borderStyleComboBox=goog.ui.decorate(goog.dom.getElementByClass("border-type-combo-box",this.element));var c=goog.dom.getElementByClass("border-color-palette",this.element);this.hsvPalette=new goog.ui.HsvaPalette(null,null,null,"goog-hsva-palette-sm");this.hsvPalette.render(c);this.bgColorPicker=new goog.ui.ColorButton;this.bgColorPicker.setTooltip("Click to select color");
this.bgColorPicker.render(goog.dom.getElementByClass("border-color-button",this.element));this.hsvPalette.setColorRgbaHex("#000000FF");this.setColorPaletteVisibility(!1);this.borderPlacementCheckBoxes=[];var c=goog.dom.getElementsByTagNameAndClass("span",null,goog.dom.getElementByClass("border-placement-container",this.element)),d,e=c.length;for(d=0;d<e;d++){var f=goog.ui.decorate(c[d]);this.borderPlacementCheckBoxes.push(f);goog.events.listen(f,goog.ui.Component.EventType.CHANGE,this.onBorderWidthChanged,
!1,this)}this.cornerRadiusInput=goog.dom.getElementByClass("corner-radius-input",this.element);this.cornerPlacementCheckBoxes=[];c=goog.dom.getElementsByTagNameAndClass("span",null,goog.dom.getElementByClass("corner-placement-container",this.element));e=c.length;for(d=0;d<e;d++)f=goog.ui.decorate(c[d]),this.cornerPlacementCheckBoxes.push(f),goog.events.listen(f,goog.ui.Component.EventType.CHANGE,this.onBorderCornerChanged,!1,this);goog.events.listen(this.borderWidthInput,"change",this.onBorderWidthChanged,
!1,this);goog.events.listen(this.borderStyleComboBox,goog.ui.Component.EventType.CHANGE,this.onBorderStyleChanged,!1,this);goog.events.listen(this.hsvPalette,goog.ui.Component.EventType.ACTION,this.onBorderColorChanged,!1,this);goog.events.listen(this.bgColorPicker,goog.ui.Component.EventType.ACTION,this.toggleColorPaletteVisibility,!1,this);goog.events.listen(this.cornerRadiusInput,"change",this.onBorderCornerChanged,!1,this)};
silex.view.pane.BorderPane.prototype.redraw=function(){silex.view.pane.BorderPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){if(c.style.borderWidth){var d=c.style.borderWidth.split(" ");1===d.length?d[1]=d[2]=d[3]=d[0]:2===d.length?(d[2]=d[0],d[3]=d[1]):3===d.length&&(d[0],d[3]=d[1]);var e=d[0];if(goog.isDef(d[1])&&"0"===e||"0px"===e)e=d[1];if(goog.isDef(d[2])&&"0"===e||"0px"===e)e=d[2];if(goog.isDef(d[3])&&"0"===e||"0px"===e)e=d[3];if(goog.isDef(e)&&"0"!==e&&"0px"!==e){this.borderWidthInput.value=
e.substr(0,e.indexOf("px"));for(var f=this.borderPlacementCheckBoxes.length,e=0;e<f;e++){var h=this.borderPlacementCheckBoxes[e];d.length>e&&"0"!==d[e]&&"0px"!==d[e]?h.setChecked(!0):h.setChecked(!1)}}else this.resetBorder();d=c.style.borderColor;void 0===d||"transparent"===d||""===d?this.setColorPaletteVisibility(!1):(d=silex.utils.Style.rgbaToHex(d),this.bgColorPicker.setValue(d.substring(0,7)),this.hsvPalette.setColorRgbaHex(d))}else this.resetBorder();c.style.borderStyle?this.borderStyleComboBox.setValue(c.style.borderStyle):
this.borderStyleComboBox.setSelectedIndex(0);if(c.style.borderRadius){d=c.style.borderRadius.split(" ");goog.isDef(d[1])||(d[1]=d[0]);goog.isDef(d[2])||(d[2]=d[0]);goog.isDef(d[3])||(d[3]=d[1]);e=d[0];if(goog.isDef(d[1])&&"0"===e||"0px"===e)e=d[1];if(goog.isDef(d[2])&&"0"===e||"0px"===e)e=d[2];if(goog.isDef(d[3])&&"0"===e||"0px"===e)e=d[3];if(goog.isDef(e)&&"0"!==e&&"0px"!==e)for(this.cornerRadiusInput.value=e.substr(0,e.indexOf("px")),f=this.cornerPlacementCheckBoxes.length,e=0;e<f;e++)h=this.cornerPlacementCheckBoxes[e],
"0"!==d[e]&&"0px"!==d[e]?h.setChecked(!0):h.setChecked(!1);else this.resetBorderRadius()}else this.resetBorderRadius();this.isRedraw=!1}};silex.view.pane.BorderPane.prototype.resetBorderRadius=function(){this.cornerRadiusInput.value="";var c,d=this.cornerPlacementCheckBoxes.length;for(c=0;c<d;c++)this.cornerPlacementCheckBoxes[c].setChecked(!0)};silex.view.pane.BorderPane.prototype.resetBorder=function(){this.borderWidthInput.value="";var c,d=this.borderPlacementCheckBoxes.length;for(c=0;c<d;c++)this.borderPlacementCheckBoxes[c].setChecked(!0)};
silex.view.pane.BorderPane.prototype.onBorderWidthChanged=function(){if(this.borderWidthInput.value&&""!==this.borderWidthInput.value){var c="",d,e=this.borderPlacementCheckBoxes.length;for(d=0;d<e;d++)c=this.borderPlacementCheckBoxes[d].getChecked()?c+(this.borderWidthInput.value+"px "):c+"0 ";this.styleChanged("borderWidth",c);this.onBorderStyleChanged()}else this.styleChanged("borderWidth",""),this.styleChanged("borderStyle","")};
silex.view.pane.BorderPane.prototype.onBorderStyleChanged=function(){this.styleChanged("borderStyle",this.borderStyleComboBox.getSelectedItem().getValue())};silex.view.pane.BorderPane.prototype.onBorderColorChanged=function(){var c=this.hsvPalette.getColorRgbaHex(),d=silex.utils.Style.hexToRgba(c);this.styleChanged("borderColor",d);this.bgColorPicker.setValue(c.substring(0,7))};
silex.view.pane.BorderPane.prototype.onBorderCornerChanged=function(){if(goog.isDef(this.cornerRadiusInput.value)&&""!==this.cornerRadiusInput.value){var c="",d,e=this.cornerPlacementCheckBoxes.length;for(d=0;d<e;d++)c=this.cornerPlacementCheckBoxes[d].getChecked()?c+(this.cornerRadiusInput.value+"px "):c+"0 ";this.styleChanged("borderRadius",c)}else this.styleChanged("borderRadius","")};silex.view.pane.BorderPane.prototype.toggleColorPaletteVisibility=function(){this.setColorPaletteVisibility(!this.getColorPaletteVisibility())};
silex.view.pane.BorderPane.prototype.getColorPaletteVisibility=function(){return"hidden"!==goog.style.getStyle(this.hsvPalette.getElement(),"visibility")};
silex.view.pane.BorderPane.prototype.setColorPaletteVisibility=function(c){c?this.getColorPaletteVisibility()||(goog.style.setStyle(this.hsvPalette.getElement(),"visibility",null),goog.style.setStyle(this.hsvPalette.getElement(),"position",null)):this.getColorPaletteVisibility()&&(goog.style.setStyle(this.hsvPalette.getElement(),"visibility","hidden"),goog.style.setStyle(this.hsvPalette.getElement(),"position","absolute"))};goog.ui.LabelInput=function(c,d){goog.ui.Component.call(this,d);this.label_=c||""};goog.inherits(goog.ui.LabelInput,goog.ui.Component);goog.ui.LabelInput.prototype.ffKeyRestoreValue_=null;goog.ui.LabelInput.prototype.labelRestoreDelayMs=10;goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_="placeholder"in document.createElement("input");goog.ui.LabelInput.prototype.hasFocus_=!1;goog.ui.LabelInput.prototype.createDom=function(){this.setElementInternal(this.getDomHelper().createDom("input",{type:"text"}))};
goog.ui.LabelInput.prototype.decorateInternal=function(c){goog.ui.LabelInput.superClass_.decorateInternal.call(this,c);this.label_||(this.label_=c.getAttribute("label")||"");goog.dom.getActiveElement(goog.dom.getOwnerDocument(c))==c&&(this.hasFocus_=!0,c=this.getElement(),goog.asserts.assert(c),goog.dom.classlist.remove(c,this.LABEL_CLASS_NAME));goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_?this.getElement().placeholder=this.label_:(c=this.getElement(),goog.asserts.assert(c,"The label input element cannot be null."),
goog.a11y.aria.setState(c,goog.a11y.aria.State.LABEL,this.label_))};goog.ui.LabelInput.prototype.enterDocument=function(){goog.ui.LabelInput.superClass_.enterDocument.call(this);this.attachEvents_();this.check_();this.getElement().labelInput_=this};goog.ui.LabelInput.prototype.exitDocument=function(){goog.ui.LabelInput.superClass_.exitDocument.call(this);this.detachEvents_();this.getElement().labelInput_=null};
goog.ui.LabelInput.prototype.attachEvents_=function(){var c=new goog.events.EventHandler(this);c.listen(this.getElement(),goog.events.EventType.FOCUS,this.handleFocus_);c.listen(this.getElement(),goog.events.EventType.BLUR,this.handleBlur_);if(goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_)this.eventHandler_=c;else{goog.userAgent.GECKO&&c.listen(this.getElement(),[goog.events.EventType.KEYPRESS,goog.events.EventType.KEYDOWN,goog.events.EventType.KEYUP],this.handleEscapeKeys_);var d=goog.dom.getOwnerDocument(this.getElement()),
d=goog.dom.getWindow(d);c.listen(d,goog.events.EventType.LOAD,this.handleWindowLoad_);this.eventHandler_=c;this.attachEventsToForm_()}};goog.ui.LabelInput.prototype.attachEventsToForm_=function(){!this.formAttached_&&(this.eventHandler_&&this.getElement().form)&&(this.eventHandler_.listen(this.getElement().form,goog.events.EventType.SUBMIT,this.handleFormSubmit_),this.formAttached_=!0)};
...
goog.ui.LabelInput.prototype.handleFocus_=function(c){this.hasFocus_=!0;c=this.getElement();goog.asserts.assert(c);goog.dom.classlist.remove(c,this.LABEL_CLASS_NAME);if(!goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_&&!this.hasChanged()&&!this.inFocusAndSelect_){var d=this;c=function(){d.getElement()&&(d.getElement().value="")};goog.userAgent.IE?goog.Timer.callOnce(c,10):c()}};
goog.ui.LabelInput.prototype.handleBlur_=function(c){goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_||(this.eventHandler_.unlisten(this.getElement(),goog.events.EventType.CLICK,this.handleFocus_),this.ffKeyRestoreValue_=null);this.hasFocus_=!1;this.check_()};
goog.ui.LabelInput.prototype.handleEscapeKeys_=function(c){27==c.keyCode&&(c.type==goog.events.EventType.KEYDOWN?this.ffKeyRestoreValue_=this.getElement().value:c.type==goog.events.EventType.KEYPRESS?this.getElement().value=this.ffKeyRestoreValue_:c.type==goog.events.EventType.KEYUP&&(this.ffKeyRestoreValue_=null),c.preventDefault())};goog.ui.LabelInput.prototype.handleFormSubmit_=function(c){this.hasChanged()||(this.getElement().value="",goog.Timer.callOnce(this.handleAfterSubmit_,10,this))};
goog.ui.LabelInput.prototype.handleAfterSubmit_=function(c){this.hasChanged()||(this.getElement().value=this.label_)};goog.ui.LabelInput.prototype.handleWindowLoad_=function(c){this.check_()};goog.ui.LabelInput.prototype.hasFocus=function(){return this.hasFocus_};goog.ui.LabelInput.prototype.hasChanged=function(){return!!this.getElement()&&""!=this.getElement().value&&this.getElement().value!=this.label_};
goog.ui.LabelInput.prototype.clear=function(){this.getElement().value="";null!=this.ffKeyRestoreValue_&&(this.ffKeyRestoreValue_="")};goog.ui.LabelInput.prototype.reset=function(){this.hasChanged()&&(this.clear(),this.check_())};goog.ui.LabelInput.prototype.setValue=function(c){null!=this.ffKeyRestoreValue_&&(this.ffKeyRestoreValue_=c);this.getElement().value=c;this.check_()};
...
goog.ui.LabelInput.prototype.setLabel=function(c){goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_?(this.label_=c,this.getElement()&&(this.getElement().placeholder=this.label_)):(this.getElement()&&!this.hasChanged()&&(this.getElement().value=""),this.label_=c,this.restoreLabel_(),(c=this.getElement())&&goog.a11y.aria.setState(c,goog.a11y.aria.State.LABEL,this.label_))};goog.ui.LabelInput.prototype.getLabel=function(){return this.label_};
goog.ui.LabelInput.prototype.check_=function(){var c=this.getElement();goog.asserts.assert(c,"The label input element cannot be null.");goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_?this.getElement().placeholder!=this.label_&&(this.getElement().placeholder=this.label_):(this.attachEventsToForm_(),goog.a11y.aria.setState(c,goog.a11y.aria.State.LABEL,this.label_));this.hasChanged()?(c=this.getElement(),goog.asserts.assert(c),goog.dom.classlist.remove(c,this.LABEL_CLASS_NAME)):(this.inFocusAndSelect_||this.hasFocus_||
(c=this.getElement(),goog.asserts.assert(c),goog.dom.classlist.add(c,this.LABEL_CLASS_NAME)),goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_||goog.Timer.callOnce(this.restoreLabel_,this.labelRestoreDelayMs,this))};
goog.ui.LabelInput.prototype.focusAndSelect=function(){var c=this.hasChanged();this.inFocusAndSelect_=!0;this.getElement().focus();c||goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_||(this.getElement().value=this.label_);this.getElement().select();goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_||(this.eventHandler_&&this.eventHandler_.listenOnce(this.getElement(),goog.events.EventType.CLICK,this.handleFocus_),goog.Timer.callOnce(this.focusAndSelect_,10,this))};
goog.ui.LabelInput.prototype.setEnabled=function(c){this.getElement().disabled=!c;var d=this.getElement();goog.asserts.assert(d);goog.dom.classlist.enable(d,this.LABEL_CLASS_NAME+"-disabled",!c)};goog.ui.LabelInput.prototype.isEnabled=function(){return!this.getElement().disabled};goog.ui.LabelInput.prototype.focusAndSelect_=function(){this.inFocusAndSelect_=!1};goog.ui.LabelInput.prototype.restoreLabel_=function(){!this.getElement()||(this.hasChanged()||this.hasFocus_)||(this.getElement().value=this.label_)};silex.view.pane.PagePane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.PagePane,silex.view.pane.PaneBase);
silex.view.pane.PagePane.prototype.buildUi=function(){this.linkDropdown=goog.dom.getElementByClass("link-combo-box",this.element);this.linkDropdown.onchange=goog.bind(this.onLinkChanged,this);var c=goog.dom.getElementByClass("link-input-text",this.element);this.linkInputTextField=new goog.ui.LabelInput;this.linkInputTextField.decorate(c);goog.style.setStyle(c,"display","none");goog.events.listen(c,goog.ui.Component.EventType.CHANGE,this.onLinkTextChanged,!1,this);goog.events.listen(c,goog.events.EventType.KEYDOWN,
this.onLinkTextChanged,!1,this)};
silex.view.pane.PagePane.prototype.setPages=function(c){this.pages=c;c=c.map(goog.bind(function(c){return{name:c,displayName:silex.utils.PageablePlugin.getDisplayName(c),linkName:"#!"+c}},this));this.pageCheckboxes&&goog.array.forEach(this.pageCheckboxes,function(c){c.checkbox.dispose()});var d=[{name:"none",displayName:"None",linkName:"none"},{name:"custom",displayName:"External link",linkName:"custom"}].concat(c),e=goog.dom.getElementByClass("link-combo-box",this.element),f=goog.dom.getElementByClass("link-template",
this.element).innerHTML;e.innerHTML=silex.utils.Dom.renderList(f,d);d=goog.dom.getElementByClass("pages-container",this.element);f=goog.dom.getElementByClass("pages-selector-template",this.element).innerHTML;d.innerHTML=silex.utils.Dom.renderList(f,c);this.pageCheckboxes=[];c=goog.dom.getElementByClass("pages-container",this.element);c=goog.dom.getElementsByClass("page-container",c);var h=0;goog.array.forEach(c,function(c){var d=goog.dom.getElementByClass("page-check",c);c=goog.dom.getElementByClass("page-label",
c);var e=new goog.ui.Checkbox,f=this.pages[h++];e.render(d);e.setLabel(c);this.pageCheckboxes.push({checkbox:e,pageName:f});goog.events.listen(e,goog.ui.Component.EventType.CHANGE,function(c){this.checkPage(f,e)},!1,this)},this)};
silex.view.pane.PagePane.prototype.onLinkChanged=function(){if("none"===this.linkDropdown.value)this.onStatus("removeLink");else if("custom"===this.linkDropdown.value){this.linkInputTextField.setValue("");var c=goog.dom.getElementByClass("link-input-text",this.element);goog.style.setStyle(c,"display","inherit")}else this.onStatus("addLink",this.linkDropdown.value)};silex.view.pane.PagePane.prototype.onLinkTextChanged=function(){this.onStatus("addLink",this.linkInputTextField.getValue())};
silex.view.pane.PagePane.prototype.redraw=function(){silex.view.pane.PagePane.superClass_.redraw.call(this);this.setPages(silex.utils.PageablePlugin.getPages(this.bodyElement));var c=this.getSelection()[0];if(c){goog.array.forEach(this.pageCheckboxes,function(d){d.checkbox.setEnabled(!0);d.checkbox.setChecked(silex.utils.PageablePlugin.isInPage(c,d.pageName))},this);var d=silex.utils.PageablePlugin.getLink(c);d&&""!==d?0===d.indexOf("#!")?this.linkDropdown.value=d:(this.linkInputTextField.setValue(d),
this.linkDropdown.value="custom"):(this.linkDropdown.value="none",this.linkInputTextField.setValue(""));d=goog.dom.getElementByClass("link-input-text",this.element);"custom"===this.linkDropdown.value?goog.style.setStyle(d,"display","inherit"):goog.style.setStyle(d,"display","none");this.isRedraw=!1}};silex.view.pane.PagePane.prototype.checkPage=function(c,d){if(d.isChecked())this.onStatus("addToPage",c);else this.onStatus("removeFromPage",c)};silex.utils.Style={};
silex.utils.Style.SILEX_CLASS_NAMES=[silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,silex.utils.EditablePlugin.UI_RESIZABLE_CLASS_NAME,silex.utils.EditablePlugin.UI_DRAGGABLE_CLASS_NAME,silex.utils.EditablePlugin.UI_DROPPABLE_CLASS_NAME,silex.utils.EditablePlugin.UI_DRAGGABLE_DRAGGING_CLASS_NAME,silex.utils.PageablePlugin.PAGEABLE_ROOT_CLASS_NAME,silex.utils.PageablePlugin.PAGE_CLASS_NAME,silex.model.Element.SELECTED_CLASS_NAME,silex.model.Element.TYPE_CONTAINER+"-element",silex.model.Element.TYPE_IMAGE+"-element",
silex.model.Element.TYPE_TEXT+"-element",silex.model.Element.TYPE_HTML+"-element"];silex.utils.Style.getClassName=function(c){var d=silex.utils.PageablePlugin.getPages();return goog.array.map(c.className.split(" "),function(c){if(!goog.array.contains(silex.utils.Style.SILEX_CLASS_NAMES,c)&&!goog.array.contains(d,c))return c}).join(" ").trim()};
silex.utils.Style.setClassName=function(c,d){var e=silex.utils.PageablePlugin.getPages(),f=goog.array.map(c.className.split(" "),function(c){if(goog.array.contains(silex.utils.Style.SILEX_CLASS_NAMES,c)||goog.array.contains(e,c))return c});c.className=f.join(" ");d&&goog.array.forEach(d.split(" "),function(d){(d=d.trim())&&""!==d&&goog.dom.classes.add(c,d)})};
silex.utils.Style.styleToString=function(c){var d="";goog.object.forEach(c,function(c,f,h){c&&(d+=goog.string.toSelectorCase(f)+": "+c+"; ")});return d};silex.utils.Style.stringToStyle=function(c){return goog.style.parseStyleAttribute(c)};
silex.utils.Style.hexToRgba=function(c){if(0!==c.indexOf("#"))return c;if(9!==c.length)return console.error("Error in length "+c+" - "+c.length),c;hexArr=silex.utils.Style.hexToArray(c);r=hexArr[0];g=hexArr[1];b=hexArr[2];a=hexArr[3];return"rgba("+r+","+g+","+b+","+a+")"};
silex.utils.Style.hexToArray=function(c){if(0!==c.indexOf("#"))return c;c=c.replace("#","");r=parseInt(c.substring(0,2),16);g=parseInt(c.substring(2,4),16);b=parseInt(c.substring(4,6),16);a=parseInt(c.substring(6,8),16)/255;return[r,g,b,a]};
silex.utils.Style.rgbaToHex=function(c){if(0!==c.indexOf("rgb"))return c;rgbaArr=silex.utils.Style.rgbaToArray(c);r=rgbaArr[0].toString(16);2>r.length&&(r="0"+r);g=rgbaArr[1].toString(16);2>g.length&&(g="0"+g);b=rgbaArr[2].toString(16);2>b.length&&(b="0"+b);a=rgbaArr[3].toString(16);2>a.length&&(a="0"+a);return"#"+(r+g+b+a)};
silex.utils.Style.rgbaToArray=function(c){if(0!==c.indexOf("rgb"))return c;c=0!==c.indexOf("rgba")?c.replace("rgb",""):c.replace("rgba","");c=c.replace(" ","");rgbaArr=c.substring(1,c.length-1).split(",");4>rgbaArr.length&&rgbaArr.push("1");r=parseInt(rgbaArr[0]);g=parseInt(rgbaArr[1]);b=parseInt(rgbaArr[2]);a=parseInt(255*rgbaArr[3]);return[r,g,b,a]};goog.ui.TabRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.TabRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.TabRenderer);goog.ui.TabRenderer.CSS_CLASS="goog-tab";goog.ui.TabRenderer.prototype.getCssClass=function(){return goog.ui.TabRenderer.CSS_CLASS};goog.ui.TabRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.TAB};
...
goog.ui.TabBar.getOrientationFromLocation=function(c){return c==goog.ui.TabBar.Location.START||c==goog.ui.TabBar.Location.END?goog.ui.Container.Orientation.VERTICAL:goog.ui.Container.Orientation.HORIZONTAL};goog.ui.registry.setDecoratorByClassName(goog.ui.TabBarRenderer.CSS_CLASS,function(){return new goog.ui.TabBar});silex.view.pane.BgPane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.BgPane,silex.view.pane.PaneBase);
silex.view.pane.BgPane.prototype.buildUi=function(){var c=goog.dom.getElementByClass("color-bg-palette",this.element);this.hsvPalette=new goog.ui.HsvaPalette(null,null,null,"goog-hsva-palette-sm");this.hsvPalette.render(c);this.bgColorPicker=new goog.ui.ColorButton;this.bgColorPicker.setTooltip("Click to select color");this.bgColorPicker.render(goog.dom.getElementByClass("color-bg-button"));this.hsvPalette.setColorRgbaHex("#FFFFFFFF");this.setColorPaletteVisibility(!1);this.transparentBgCheckbox=
new goog.ui.Checkbox;this.transparentBgCheckbox.decorate(goog.dom.getElementByClass("enable-color-bg-button"),this.element);c=goog.dom.getElementByClass("bg-image-button");this.bgSelectBgImage=new goog.ui.CustomButton;this.bgSelectBgImage.decorate(c);this.bgSelectBgImage.setTooltip("Click to select a file");var d=goog.dom.getElementByClass("clear-bg-image-button");this.bgClearBgImage=new goog.ui.CustomButton;this.bgClearBgImage.setTooltip("Click to select a file");this.bgClearBgImage.decorate(d);
this.attachementComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-attachement-combo-box"));this.vPositionComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-position-v-combo-box"));this.hPositionComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-position-h-combo-box"));this.repeatComboBox=goog.ui.decorate(goog.dom.getElementByClass("bg-repeat-combo-box"));goog.events.listen(this.hsvPalette,goog.ui.Component.EventType.ACTION,this.onColorChanged,!1,this);goog.events.listen(this.bgColorPicker,
goog.ui.Component.EventType.ACTION,this.onBgColorButton,!1,this);goog.events.listen(this.transparentBgCheckbox,goog.ui.Component.EventType.CHANGE,this.onTransparentChanged,!1,this);goog.events.listen(c,goog.events.EventType.CLICK,this.onSelectImageButton,!1,this);goog.events.listen(d,goog.events.EventType.CLICK,this.onClearImageButton,!1,this);goog.events.listen(this.attachementComboBox,goog.ui.Component.EventType.CHANGE,function(c){this.styleChanged("backgroundAttachment",c.target.getSelectedItem().getId())},
!1,this);goog.events.listen(this.vPositionComboBox,goog.ui.Component.EventType.CHANGE,function(c){c=this.hPositionComboBox.getSelectedItem().getId();var d=this.vPositionComboBox.getSelectedItem().getId();this.styleChanged("backgroundPosition",d+" "+c)},!1,this);goog.events.listen(this.hPositionComboBox,goog.ui.Component.EventType.CHANGE,function(c){c=this.hPositionComboBox.getSelectedItem().getId();var d=this.vPositionComboBox.getSelectedItem().getId();this.styleChanged("backgroundPosition",d+" "+
c)},!1,this);goog.events.listen(this.repeatComboBox,goog.ui.Component.EventType.CHANGE,function(c){this.styleChanged("backgroundRepeat",c.target.getSelectedItem().getId())},!1,this)};
silex.view.pane.BgPane.prototype.redraw=function(){silex.view.pane.BgPane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){var d=c.style.backgroundColor;void 0===d||"transparent"===d||""===d?(this.transparentBgCheckbox.setChecked(!0),this.bgColorPicker.setEnabled(!1),this.setColorPaletteVisibility(!1)):(d=silex.utils.Style.rgbaToHex(d),this.transparentBgCheckbox.setChecked(!1),this.bgColorPicker.setEnabled(!0),this.bgColorPicker.setValue(d.substring(0,7)),this.hsvPalette.setColorRgbaHex(d));
null!==c.style.backgroundImage&&"none"!==c.style.backgroundImage&&""!==c.style.backgroundImage?this.bgClearBgImage.setEnabled(!0):this.bgClearBgImage.setEnabled(!1);this.bgClearBgImage.setEnabled(!0);if(c.style.backgroundAttachment)switch(c.style.backgroundAttachment){case "scroll":this.attachementComboBox.setSelectedIndex(0);break;case "fixed":this.attachementComboBox.setSelectedIndex(1);break;case "local":this.attachementComboBox.setSelectedIndex(2)}else this.attachementComboBox.setSelectedIndex(0);
if(c.style.backgroundPosition){var d=c.style.backgroundPosition.split(" "),e=d[1];switch(d[0]){case "top":this.vPositionComboBox.setSelectedIndex(0);break;case "center":this.vPositionComboBox.setSelectedIndex(1);break;case "bottom":this.vPositionComboBox.setSelectedIndex(2)}switch(e){case "left":this.hPositionComboBox.setSelectedIndex(0);break;case "center":this.hPositionComboBox.setSelectedIndex(1);break;case "right":this.hPositionComboBox.setSelectedIndex(2)}}else this.vPositionComboBox.setSelectedIndex(0),
this.hPositionComboBox.setSelectedIndex(0);if(c.style.backgroundRepeat)switch(c.style.backgroundRepeat){case "repeat":this.repeatComboBox.setSelectedIndex(0);break;case "repeat-x":this.repeatComboBox.setSelectedIndex(1);break;case "repeat-y":this.repeatComboBox.setSelectedIndex(2);break;case "no-repeat":this.repeatComboBox.setSelectedIndex(3);break;case "inherit":this.repeatComboBox.setSelectedIndex(4)}else this.repeatComboBox.setSelectedIndex(0);this.isRedraw=!1}};
silex.view.pane.BgPane.prototype.onColorChanged=function(){var c=silex.utils.Style.hexToRgba(this.hsvPalette.getColorRgbaHex());this.styleChanged("backgroundColor",c)};silex.view.pane.BgPane.prototype.onBgColorButton=function(){var c=this.getSelection()[0];!1===this.getColorPaletteVisibility()?(this.hsvPalette.setColorRgbaHex(silex.utils.Style.rgbaToHex(c.style.backgroundColor)),this.setColorPaletteVisibility(!0)):this.setColorPaletteVisibility(!1)};
silex.view.pane.BgPane.prototype.onTransparentChanged=function(){var c="transparent";!1===this.transparentBgCheckbox.getChecked()&&((c=silex.utils.Style.hexToRgba(this.hsvPalette.getColorRgbaHex()))||(c="rgba(255, 255, 255, 1)"));this.styleChanged("backgroundColor",c)};silex.view.pane.BgPane.prototype.onSelectImageButton=function(){this.selectBgImage()};silex.view.pane.BgPane.prototype.onClearImageButton=function(){this.styleChanged("backgroundImage","")};
silex.view.pane.BgPane.prototype.getColorPaletteVisibility=function(){return"hidden"!==goog.style.getStyle(this.hsvPalette.getElement(),"visibility")};
silex.view.pane.BgPane.prototype.setColorPaletteVisibility=function(c){c?this.getColorPaletteVisibility()||(goog.style.setStyle(this.hsvPalette.getElement(),"visibility",null),goog.style.setStyle(this.hsvPalette.getElement(),"position",null)):this.getColorPaletteVisibility()&&(goog.style.setStyle(this.hsvPalette.getElement(),"visibility","hidden"),goog.style.setStyle(this.hsvPalette.getElement(),"position","absolute"))};silex.view.pane.StylePane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.StylePane,silex.view.pane.PaneBase);
silex.view.pane.StylePane.prototype.buildUi=function(){this.cssClassesInput=goog.dom.getElementByClass("style-css-classes-input",this.element);goog.events.listen(this.cssClassesInput,"change",this.onInputChanged,!1,this);this.ace=ace.edit(goog.dom.getElementByClass("element-style-editor",this.element));this.iAmSettingValue=!1;this.ace.getSession().setMode("ace/mode/css");this.ace.getSession().on("change",goog.bind(function(c){!1===this.iAmSettingValue&&setTimeout(goog.bind(function(){this.contentChanged()},
this),100)},this))};silex.view.pane.StylePane.prototype.redraw=function(){silex.view.pane.StylePane.superClass_.redraw.call(this);var c=this.getSelection()[0];if(c){this.cssClassesInput.value=silex.utils.Style.getClassName(c);if(c=c.getAttribute("style")){this.iAmSettingValue=!0;var c=".element{\n"+c.replace(/; /g,";\n")+"\n}",d=this.ace.getCursorPosition();this.ace.setValue(c);this.ace.gotoLine(d.row+1,d.column,!1)}else this.iAmSettingValue=!0,this.ace.setValue("");this.iAmSettingValue=!1}};
silex.view.pane.StylePane.prototype.onInputChanged=function(c){if(this.onStatus)this.onStatus("classNameChanged",this.cssClassesInput.value)};silex.view.pane.StylePane.prototype.contentChanged=function(){var c=this.ace.getValue();c&&(c=c.replace(".element{\n",""),c=c.replace("\n}",""),c=c.replace(/\n/," "));if(this.onStatus)this.onStatus("propertyChanged","style",c)};silex.view.pane.GeneralStylePane=function(c,d,e){silex.view.pane.PaneBase.call(this,c,d,e);this.buildUi()};goog.inherits(silex.view.pane.GeneralStylePane,silex.view.pane.PaneBase);silex.view.pane.GeneralStylePane.prototype.buildUi=function(){this.opacityInput=goog.dom.getElementByClass("opacity-input");goog.events.listen(this.opacityInput,"change",this.onInputChanged,!1,this)};
silex.view.pane.GeneralStylePane.prototype.redraw=function(){silex.view.pane.GeneralStylePane.superClass_.redraw.call(this);var c=this.getSelection()[0];c&&(this.opacityInput.value=c.style.opacity?c.style.opacity:"")};silex.view.pane.GeneralStylePane.prototype.onInputChanged=function(c){this.opacityInput.value&&""!==this.opacityInput.value?this.styleChanged("opacity",this.opacityInput.value):this.styleChanged("opacity")};silex.view.PropertyTool=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.buildPanes()};goog.inherits(silex.view.PropertyTool,silex.view.ViewBase);
silex.view.PropertyTool.prototype.buildPanes=function(){var c=goog.bind(function(c,e,f){this.onStatus(c,e,f)},this);this.bgPane=new silex.view.pane.BgPane(goog.dom.getElementByClass("background-editor",this.element),this.bodyElement,this.headElement);this.bgPane.onStatus=c;this.borderPane=new silex.view.pane.BorderPane(goog.dom.getElementByClass("border-editor",this.element),this.bodyElement,this.headElement);this.borderPane.onStatus=c;this.propertyPane=new silex.view.pane.PropertyPane(goog.dom.getElementByClass("property-editor",
this.element),this.bodyElement,this.headElement);this.propertyPane.onStatus=c;this.pagePane=new silex.view.pane.PagePane(goog.dom.getElementByClass("page-editor",this.element),this.bodyElement,this.headElement);this.pagePane.onStatus=c;this.generalStylePane=new silex.view.pane.GeneralStylePane(goog.dom.getElementByClass("general-editor",this.element),this.bodyElement,this.headElement);this.generalStylePane.onStatus=c;this.stylePane=new silex.view.pane.StylePane(goog.dom.getElementByClass("style-editor",
this.element),this.bodyElement,this.headElement);this.stylePane.onStatus=c};silex.view.PropertyTool.prototype.redraw=function(){this.borderPane.redraw();this.propertyPane.redraw();this.pagePane.redraw();this.generalStylePane.redraw();this.stylePane.redraw();this.bgPane.redraw()};silex.view.PropertyTool.prototype.getBaseUrl=function(){return this.baseUrl};
silex.view.PropertyTool.prototype.setBaseUrl=function(c){this.baseUrl=c;this.borderPane.setBaseUrl(c);this.propertyPane.setBaseUrl(c);this.pagePane.setBaseUrl(c);this.generalStylePane.setBaseUrl(c);this.stylePane.setBaseUrl(c);this.bgPane.setBaseUrl(c)};silex.view.JsEditor=function(c,d,e){silex.view.AceEditorBase.call(this,c,d,e)};goog.inherits(silex.view.JsEditor,silex.view.AceEditorBase);silex.view.JsEditor.prototype.initUI=function(){silex.view.JsEditor.superClass_.initUI.call(this);this.ace.getSession().setMode("ace/mode/javascript")};silex.view.PageTool=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initEvents()};goog.inherits(silex.view.PageTool,silex.view.ViewBase);
silex.view.PageTool.prototype.initEvents=function(c){goog.events.listen(this.element,goog.events.EventType.CLICK,function(c){goog.dom.classes.has(c.target,"delete")?this.removePageAtIndex(this.getCellIndex(c.target.parentNode.parentNode)):goog.dom.classes.has(c.target,"label")?this.renamePageAtIndex(this.getCellIndex(c.target.parentNode.parentNode)):this.setSelectedIndex(this.getCellIndex(c.target.parentNode),!0)},!1,this)};
silex.view.PageTool.prototype.redraw=function(){var c=silex.utils.PageablePlugin.getPages(),d=silex.utils.PageablePlugin.getCurrentPageName(),e=0,c=c.map(goog.bind(function(c){var f={name:c,displayName:silex.utils.PageablePlugin.getDisplayName(c),linkName:"#!"+c,idx:e++};f.className=d===c?"ui-selected":"";return f},this)),f=goog.dom.getElementByClass("page-tool-container",this.element),h=goog.dom.getElementByClass("page-tool-template",this.element).innerHTML;f.innerHTML=silex.utils.Dom.renderList(h,
c)};silex.view.PageTool.prototype.removePageAtIndex=function(c){var d=silex.utils.PageablePlugin.getPages();if(this.onStatus)this.onStatus("delete",d[c]);this.redraw()};silex.view.PageTool.prototype.renamePageAtIndex=function(c){var d=silex.utils.PageablePlugin.getPages();if(this.onStatus)this.onStatus("rename",d[c]);this.redraw()};
silex.view.PageTool.prototype.setSelectedIndex=function(c,d){var e=goog.dom.getElementsByClass("page-container",this.element),f="";goog.array.forEach(e,function(d){var e=this.getCellIndex(d);c===e?(goog.dom.classes.add(d,"ui-selected"),f=d.getAttribute("data-page-name")):goog.dom.classes.remove(d,"ui-selected")},this);if(d&&this.onStatus)this.onStatus("changed",f)};silex.view.PageTool.prototype.getCellIndex=function(c){return parseInt(c.getAttribute("data-page-idx"))};goog.ui.ToolbarSeparatorRenderer=function(){goog.ui.MenuSeparatorRenderer.call(this)};goog.inherits(goog.ui.ToolbarSeparatorRenderer,goog.ui.MenuSeparatorRenderer);goog.addSingletonGetter(goog.ui.ToolbarSeparatorRenderer);goog.ui.ToolbarSeparatorRenderer.CSS_CLASS="goog-toolbar-separator";goog.ui.ToolbarSeparatorRenderer.prototype.createDom=function(c){return c.getDomHelper().createDom("div",this.getCssClass()+" "+goog.ui.INLINE_BLOCK_CLASSNAME,"\u00a0")};
goog.ui.ToolbarSeparatorRenderer.prototype.decorate=function(c,d){d=goog.ui.ToolbarSeparatorRenderer.superClass_.decorate.call(this,c,d);goog.dom.classlist.add(d,goog.ui.INLINE_BLOCK_CLASSNAME);return d};goog.ui.ToolbarSeparatorRenderer.prototype.getCssClass=function(){return goog.ui.ToolbarSeparatorRenderer.CSS_CLASS};goog.ui.ToolbarSeparator=function(c,d){goog.ui.Separator.call(this,c||goog.ui.ToolbarSeparatorRenderer.getInstance(),d)};goog.inherits(goog.ui.ToolbarSeparator,goog.ui.Separator);goog.ui.registry.setDecoratorByClassName(goog.ui.ToolbarSeparatorRenderer.CSS_CLASS,function(){return new goog.ui.ToolbarSeparator});goog.editor.plugins={};goog.editor.plugins.HeaderFormatter=function(){goog.editor.Plugin.call(this)};goog.inherits(goog.editor.plugins.HeaderFormatter,goog.editor.Plugin);goog.editor.plugins.HeaderFormatter.prototype.getTrogClassId=function(){return"HeaderFormatter"};goog.editor.plugins.HeaderFormatter.HEADER_COMMAND={H1:"H1",H2:"H2",H3:"H3",H4:"H4"};
...
this.screenY=c.screenY;this.computeInitialPosition();this.pageScroll=goog.dom.getDomHelper(this.document_).getDocumentScroll();this.mouseDownTime_=goog.now()}};
...
goog.fx.Dragger.prototype.limitY=function(c){var d=this.limits,e=isNaN(d.top)?null:d.top,d=isNaN(d.height)?0:d.height;return Math.min(null!=e?e+d:Infinity,Math.max(null!=e?e:-Infinity,c))};goog.fx.Dragger.prototype.computeInitialPosition=function(){this.deltaX=this.useRightPositioningForRtl_?goog.style.bidi.getOffsetStart(this.target):this.target.offsetLeft;this.deltaY=this.target.offsetTop};
goog.fx.Dragger.prototype.defaultAction=function(c,d){this.useRightPositioningForRtl_&&this.isRightToLeft_()?this.target.style.right=c+"px":this.target.style.left=c+"px";this.target.style.top=d+"px"};goog.fx.Dragger.prototype.isDragging=function(){return this.dragging_};goog.fx.DragEvent=function(c,d,e,f,h,k,l,m){goog.events.Event.call(this,c);this.clientX=e;this.clientY=f;this.browserEvent=h;this.left=goog.isDef(k)?k:d.deltaX;this.top=goog.isDef(l)?l:d.deltaY;this.dragger=d;this.dragCanceled=!!m};
goog.inherits(goog.fx.DragEvent,goog.events.Event);goog.fx.Transition=function(){};goog.fx.Transition.EventType={PLAY:"play",BEGIN:"begin",RESUME:"resume",END:"end",STOP:"stop",FINISH:"finish",PAUSE:"pause"};goog.ui.PopupBase=function(c,d){goog.events.EventTarget.call(this);this.handler_=new goog.events.EventHandler(this);this.setElement(c||null);d&&this.setType(d)};goog.inherits(goog.ui.PopupBase,goog.events.EventTarget);goog.ui.PopupBase.Type={TOGGLE_DISPLAY:"toggle_display",MOVE_OFFSCREEN:"move_offscreen"};goog.ui.PopupBase.prototype.element_=null;goog.ui.PopupBase.prototype.autoHide_=!0;goog.ui.PopupBase.prototype.autoHideRegion_=null;goog.ui.PopupBase.prototype.isVisible_=!1;
...
goog.ui.ModalPopup.prototype.getBackgroundIframe=function(){return this.bgIframeEl_};goog.ui.ModalPopup.prototype.getBackgroundElement=function(){return this.bgEl_};goog.ui.ModalPopup.prototype.createDom=function(){goog.ui.ModalPopup.superClass_.createDom.call(this);var c=this.getElement(),d=goog.string.trim(this.getCssClass()).split(" ");goog.dom.classlist.addAll(c,d);goog.dom.setFocusableTabIndex(c,!0);goog.style.setElementShown(c,!1);this.manageBackgroundDom_();this.createTabCatcher_()};
...
goog.ui.ModalPopup.prototype.decorateInternal=function(c){goog.ui.ModalPopup.superClass_.decorateInternal.call(this,c);c=goog.string.trim(this.getCssClass()).split(" ");goog.dom.classlist.addAll(this.getElement(),c);this.manageBackgroundDom_();this.createTabCatcher_();goog.style.setElementShown(this.getElement(),!1)};
...
goog.ui.Dialog.prototype.setDraggingEnabled_=function(c){var d=goog.string.trim(this.class_+"-title-draggable").split(" ");this.getElement()&&(c?goog.dom.classlist.addAll(this.titleEl_,d):goog.dom.classlist.removeAll(this.titleEl_,d));c&&!this.dragger_?(this.dragger_=this.createDragger(),goog.dom.classlist.addAll(this.titleEl_,d),goog.events.listen(this.dragger_,goog.fx.Dragger.EventType.START,this.setDraggerLimits_,!1,this)):!c&&this.dragger_&&(this.dragger_.dispose(),this.dragger_=null)};
...
goog.ui.Dialog.prototype.decorateInternal=function(c){goog.ui.Dialog.superClass_.decorateInternal.call(this,c);c=this.getElement();goog.asserts.assert(c,"The DOM element for dialog cannot be null.");var d=this.class_+"-content";this.contentEl_=goog.dom.getElementsByTagNameAndClass(null,d,c)[0];this.contentEl_||(this.contentEl_=this.getDomHelper().createDom("div",d),this.content_&&(this.contentEl_.innerHTML=this.content_),c.appendChild(this.contentEl_));var d=this.class_+"-title",e=this.class_+"-title-text",
f=this.class_+"-title-close";(this.titleEl_=goog.dom.getElementsByTagNameAndClass(null,d,c)[0])?(this.titleTextEl_=goog.dom.getElementsByTagNameAndClass(null,e,this.titleEl_)[0],this.titleCloseEl_=goog.dom.getElementsByTagNameAndClass(null,f,this.titleEl_)[0],this.titleEl_.id||(this.titleEl_.id=this.getId())):(this.titleEl_=this.getDomHelper().createDom("div",{className:d,id:this.getId()}),c.insertBefore(this.titleEl_,this.contentEl_));this.titleId_=this.titleEl_.id;this.titleTextEl_?this.title_=
goog.dom.getTextContent(this.titleTextEl_):(this.titleTextEl_=this.getDomHelper().createDom("span",e,this.title_),this.titleEl_.appendChild(this.titleTextEl_));goog.a11y.aria.setState(c,goog.a11y.aria.State.LABELLEDBY,this.titleId_||"");this.titleCloseEl_||(this.titleCloseEl_=this.getDomHelper().createDom("span",f),this.titleEl_.appendChild(this.titleCloseEl_));goog.style.setElementShown(this.titleCloseEl_,this.hasTitleCloseButton_);d=this.class_+"-buttons";(this.buttonEl_=goog.dom.getElementsByTagNameAndClass(null,
...
goog.ui.editor.AbstractDialog.Builder.prototype.addClassName=function(c){goog.dom.classlist.add(this.wrappedDialog_.getDialogElement(),c);return this};goog.ui.editor.AbstractDialog.Builder.prototype.setContent=function(c){goog.dom.appendChild(this.wrappedDialog_.getContentElement(),c);return this};
goog.ui.editor.AbstractDialog.Builder.prototype.build=function(){this.buttonSet_.isEmpty()&&(this.addOkButton(),this.addCancelButton());this.wrappedDialog_.setButtonSet(this.buttonSet_);var c=this.buttonHandlers_;this.buttonHandlers_=null;this.wrappedDialog_.listen(goog.ui.Dialog.EventType.SELECT,function(d){if(c[d.key])return c[d.key](d)});this.wrappedDialog_.setModal(!0);var d=this.wrappedDialog_;this.wrappedDialog_=null;return d};goog.ui.editor.AbstractDialog.prototype.getOkButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.OK)};
goog.ui.editor.AbstractDialog.prototype.getCancelButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.CANCEL)};goog.ui.editor.AbstractDialog.prototype.getButtonElement=function(c){return this.dialogInternal_.getButtonSet().getButton(c)};goog.ui.editor.AbstractDialog.prototype.handleOk=function(c){return(c=this.createOkEvent(c))?this.dispatchEvent(c):!1};goog.ui.editor.AbstractDialog.prototype.handleCancel=function(){return this.dispatchEvent(goog.ui.editor.AbstractDialog.EventType.CANCEL)};
goog.ui.editor.AbstractDialog.prototype.disposeInternal=function(){this.dialogInternal_&&(this.hide(),this.dialogInternal_.dispose(),this.dialogInternal_=null);goog.ui.editor.AbstractDialog.superClass_.disposeInternal.call(this)};goog.ui.editor.AbstractDialog.prototype.handleAfterHide_=function(){this.dispatchEvent(goog.ui.editor.AbstractDialog.EventType.AFTER_HIDE)};goog.editor.Link=function(c,d){this.anchor_=c;this.isNew_=d;this.extraAnchors_=[]};goog.editor.Link.prototype.getAnchor=function(){return this.anchor_};goog.editor.Link.prototype.getExtraAnchors=function(){return this.extraAnchors_};goog.editor.Link.prototype.getCurrentText=function(){if(!this.currentText_){var c=this.getAnchor(),c=goog.editor.node.getLeftMostLeaf(c);this.currentText_=c.tagName&&c.tagName==goog.dom.TagName.IMG?c.getAttribute("alt"):goog.dom.getRawTextContent(this.getAnchor())}return this.currentText_};
goog.editor.Link.prototype.isNew=function(){return this.isNew_};goog.editor.Link.prototype.initializeUrl=function(c){this.getAnchor().href=c};goog.editor.Link.prototype.removeLink=function(){goog.dom.flattenElement(this.anchor_);for(this.anchor_=null;this.extraAnchors_.length;)goog.dom.flattenElement(this.extraAnchors_.pop())};
goog.editor.Link.prototype.setTextAndUrl=function(c,d){var e=this.getAnchor();e.href=d;var f=this.getCurrentText();if(c!=f){var h=goog.editor.node.getLeftMostLeaf(e);h.tagName&&h.tagName==goog.dom.TagName.IMG?h.setAttribute("alt",c?c:""):(h.nodeType==goog.dom.NodeType.TEXT&&(h=h.parentNode),goog.dom.getRawTextContent(h)!=f&&(h=e),goog.dom.removeChildren(h),e=goog.dom.getDomHelper(h),goog.dom.appendChild(h,e.createTextNode(c)));this.currentText_=null}this.isNew_=!1};
...
goog.ui.editor.TabPane.prototype.enterDocument=function(){goog.ui.editor.TabPane.superClass_.enterDocument.call(this);var c=this.getElement();goog.dom.classlist.add(c,"tr-tabpane");this.addChild(this.tabBar_,!0);this.eventHandler_.listen(this.tabBar_,goog.ui.Component.EventType.SELECT,this.handleTabSelect_);c.appendChild(this.tabContent_);c.appendChild(this.dom_.createDom(goog.dom.TagName.DIV,{className:"goog-tab-bar-clear"}))};
...
/^[<]?h\d[>]?$/i.test(d))&&this.cleanUpSafariHeadings_();/insert(un)?orderedlist/i.test(c)&&(goog.userAgent.WEBKIT&&!goog.userAgent.isVersionOrHigher(534)&&this.fixSafariLists_(),goog.userAgent.IE&&(this.fixIELists_(),l&&goog.dom.removeNode(l)));k&&goog.dom.removeNode(k);h&&this.getFieldObject().execCommand(h)};
...
goog.ui.Palette.prototype.handleKeyEvent=function(c){var d=this.getContent(),d=d?d.length:0,e=this.size_.width;if(0==d||!this.isEnabled())return!1;if(c.keyCode==goog.events.KeyCodes.ENTER||c.keyCode==goog.events.KeyCodes.SPACE)return this.performActionInternal(c);if(c.keyCode==goog.events.KeyCodes.HOME)return this.setHighlightedIndex(0),!0;if(c.keyCode==goog.events.KeyCodes.END)return this.setHighlightedIndex(d-1),!0;var f=0>this.highlightedIndex_?this.getSelectedIndex():this.highlightedIndex_;switch(c.keyCode){case goog.events.KeyCodes.LEFT:if(-1==
f||0==f)f=d;this.setHighlightedIndex(f-1);c.preventDefault();return!0;case goog.events.KeyCodes.RIGHT:return f==d-1&&(f=-1),this.setHighlightedIndex(f+1),c.preventDefault(),!0;case goog.events.KeyCodes.UP:-1==f&&(f=d+e-1);if(f>=e)return this.setHighlightedIndex(f-e),c.preventDefault(),!0;break;case goog.events.KeyCodes.DOWN:if(-1==f&&(f=-e),f<d-e)return this.setHighlightedIndex(f+e),c.preventDefault(),!0}return!1};goog.ui.Palette.prototype.handleSelectionChange=function(c){};
...
goog.ui.editor.DefaultToolbar.rtlButtonFactory_=function(c,d,e,f,h,k){var l=goog.ui.editor.ToolbarFactory.makeToggleButton(c,d,e,f,h,k);l.updateFromValue=function(c){c=!!c;goog.dom.classlist.enable(l.getParent().getElement(),"tr-rtl-mode",c);l.setChecked(c)};return l};goog.ui.editor.DefaultToolbar.undoRedoButtonFactory_=function(c,d,e,f,h,k){var l=goog.ui.editor.ToolbarFactory.makeButton(c,d,e,f,h,k);l.updateFromValue=function(c){l.setEnabled(c)};return l};
goog.ui.editor.DefaultToolbar.fontFaceFactory_=function(c,d,e,f,h,k){var l=goog.ui.editor.ToolbarFactory.makeSelectButton(c,d,e,f,h,k);goog.ui.editor.DefaultToolbar.addDefaultFonts(l);l.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FONT_NORMAL);goog.dom.classlist.add(l.getMenu().getContentElement(),"goog-menu-noaccel");l.updateFromValue=function(c){var d=null;c&&0<c.length&&(d=l.getMenu().getChild(goog.ui.editor.ToolbarFactory.getPrimaryFont(c)));c=l.getSelectedItem();d!=c&&l.setSelectedItem(d)};
return l};
goog.ui.editor.DefaultToolbar.fontSizeFactory_=function(c,d,e,f,h,k){var l=goog.ui.editor.ToolbarFactory.makeSelectButton(c,d,e,f,h,k);goog.ui.editor.DefaultToolbar.addDefaultFontSizes(l);l.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FONT_SIZE_NORMAL);goog.dom.classlist.add(l.getMenu().getContentElement(),"goog-menu-noaccel");l.updateFromValue=function(c){goog.isString(c)&&"px"==goog.style.getLengthUnits(c)&&(c=goog.ui.editor.ToolbarFactory.getLegacySizeFromPx(parseInt(c,10)));c=0<c?c:null;
...
goog.ui.editor.DefaultToolbar.formatBlockFactory_=function(c,d,e,f,h,k){var l=goog.ui.editor.ToolbarFactory.makeSelectButton(c,d,e,f,h,k);goog.ui.editor.DefaultToolbar.addDefaultFormatOptions(l);l.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FORMAT_NORMAL);goog.dom.classlist.add(l.getMenu().getContentElement(),"goog-menu-noaccel");l.updateFromValue=function(c){c=c&&0<c.length?c:null;c!=l.getValue()&&l.setValue(c)};return l};goog.ui.editor.DefaultToolbar.MSG_FORMAT_BLOCK_TITLE=goog.getMsg("Format");
...
(function(){for(var c=0,d;d=goog.ui.editor.DefaultToolbar.BUTTONS_[c];c++)goog.ui.editor.DefaultToolbar.buttons_[d.command]=d;delete goog.ui.editor.DefaultToolbar.BUTTONS_})();goog.events.EventWrapper=function(){};goog.events.EventWrapper.prototype.listen=function(c,d,e,f,h){};goog.events.EventWrapper.prototype.unlisten=function(c,d,e,f,h){};goog.events.ActionEventWrapper_=function(){};goog.events.actionEventWrapper=new goog.events.ActionEventWrapper_;goog.events.ActionEventWrapper_.EVENT_TYPES_=[goog.events.EventType.CLICK,goog.userAgent.GECKO?goog.events.EventType.KEYPRESS:goog.events.EventType.KEYDOWN,goog.events.EventType.KEYUP];
goog.events.ActionEventWrapper_.prototype.listen=function(c,d,e,f,h){var k=function(c){c.type==goog.events.EventType.CLICK&&c.isMouseActionButton()?d.call(f,c):c.keyCode!=goog.events.KeyCodes.ENTER&&c.keyCode!=goog.events.KeyCodes.MAC_ENTER||c.type==goog.events.EventType.KEYUP?c.keyCode==goog.events.KeyCodes.SPACE&&(c.type==goog.events.EventType.KEYUP&&goog.a11y.aria.getRole(c.target)==goog.a11y.aria.Role.BUTTON)&&(d.call(f,c),c.preventDefault()):(c.type=goog.events.EventType.KEYPRESS,d.call(f,c))};
k.listener_=d;k.scope_=f;h?h.listen(c,goog.events.ActionEventWrapper_.EVENT_TYPES_,k,e):goog.events.listen(c,goog.events.ActionEventWrapper_.EVENT_TYPES_,k,e)};goog.events.ActionEventWrapper_.prototype.unlisten=function(c,d,e,f,h){for(var k,l=0;k=goog.events.ActionEventWrapper_.EVENT_TYPES_[l];l++)for(var m=goog.events.getListeners(c,k,!!e),n,p=0;n=m[p];p++)if(n.listener.listener_==d&&n.listener.scope_==f){h?h.unlisten(c,k,n.listener,e,f):goog.events.unlisten(c,k,n.listener,e,f);break}};goog.dom.ViewportSizeMonitor=function(c){goog.events.EventTarget.call(this);this.window_=c||window;this.listenerKey_=goog.events.listen(this.window_,goog.events.EventType.RESIZE,this.handleResize_,!1,this);this.size_=goog.dom.getViewportSize(this.window_)};goog.inherits(goog.dom.ViewportSizeMonitor,goog.events.EventTarget);
...
1==c?this.openBubble_():2==c&&goog.dom.classlist.add(this.bubbleContainer_,"tr_multi_bubble");this.reposition();return k};goog.ui.editor.Bubble.prototype.removePanel=function(c){goog.dom.removeNode(this.panels_[c].element);delete this.panels_[c];c=goog.object.getCount(this.panels_);1>=c&&goog.dom.classlist.remove(this.bubbleContainer_,"tr_multi_bubble");0==c?this.closeBubble_():this.reposition()};
...
goog.editor.plugins.LinkBubble.Action=function(c,d,e,f,h){this.spanId_=c;this.linkId_=d;this.message_=e;this.toShowFn_=f;this.actionFn_=h};goog.text={};goog.text.LoremIpsum=function(){this.generateChains_(this.sample_);this.generateStatistics_(this.sample_);this.initializeDictionary_(this.dictionary_)};goog.text.LoremIpsum.DELIMITERS_SENTENCES_=[".","?","!"];goog.text.LoremIpsum.SENTENCE_SPLIT_REGEX_=/[\.\?\!]/;goog.text.LoremIpsum.DELIMITERS_WORDS_=[",",".","?","!"];goog.text.LoremIpsum.WORD_SPLIT_REGEX_=/\s/;
goog.text.LoremIpsum.prototype.generateChains_=function(c){c=goog.text.LoremIpsum.splitWords_(c);c=goog.array.map(c,goog.text.LoremIpsum.getWordInfo_);var d=[0,0],e=d.join("-"),f=new goog.structs.Map,h=[e],k={};goog.array.forEach(c,function(c){var m=f.get(e);m?m.push(c):(m=[c],f.set(e,m));goog.array.contains(goog.text.LoremIpsum.DELIMITERS_SENTENCES_,c[1])&&h.push(e);k[e]=d;d=[d[1],c[0]];e=d.join("-")});if(0<f.getCount())this.chains_=f,this.starts_=h,this.chainKeys_=k;else throw Error("Could not generate chains from sample text.");
};goog.text.LoremIpsum.prototype.generateStatistics_=function(c){this.generateSentenceStatistics_(c);this.generateParagraphStatistics_(c)};
goog.text.LoremIpsum.prototype.generateSentenceStatistics_=function(c){c=goog.array.filter(goog.text.LoremIpsum.splitSentences_(c),goog.text.LoremIpsum.isNotEmptyOrWhitepace_);c=goog.array.map(goog.array.map(c,goog.text.LoremIpsum.splitWords_),goog.text.LoremIpsum.arrayLength_);this.sentenceMean_=goog.math.average.apply(null,c);this.sentenceSigma_=goog.math.standardDeviation.apply(null,c)};
goog.text.LoremIpsum.prototype.generateParagraphStatistics_=function(c){c=goog.array.filter(goog.text.LoremIpsum.splitParagraphs_(c),goog.text.LoremIpsum.isNotEmptyOrWhitepace_);c=goog.array.map(goog.array.map(c,goog.text.LoremIpsum.splitSentences_),goog.text.LoremIpsum.arrayLength_);this.paragraphMean_=goog.math.average.apply(null,c);this.paragraphSigma_=goog.math.standardDeviation.apply(null,c)};
goog.text.LoremIpsum.prototype.initializeDictionary_=function(c){c=goog.text.LoremIpsum.splitWords_(c);var d=new goog.structs.Map;goog.array.forEach(c,function(c){var f=d.get(c.length);f||(f=new goog.structs.Set,d.set(c.length,f));f.add(c)});this.words_=d};goog.text.LoremIpsum.prototype.chooseRandomStart_=function(){var c=goog.text.LoremIpsum.randomChoice_(this.starts_);return this.chainKeys_[c]};
goog.text.LoremIpsum.prototype.generateSentence=function(c){if(0==this.chains_.getCount()||0==this.starts_.length)throw Error("No chains created");if(0==this.words_.getCount())throw Error("No dictionary");var d=goog.text.LoremIpsum.randomNormal_(this.sentenceMean_,this.sentenceSigma_),d=Math.max(Math.floor(d),1),e="";if(c){c=goog.text.LoremIpsum.splitWords_("lorem ipsum dolor sit amet, consecteteur adipiscing elit");c.length>d&&(c.length=d);var f=c[c.length-1],f=f.substring(f.length-1);goog.array.contains(goog.text.LoremIpsum.DELIMITERS_WORDS_,
f)&&(e=f)}else c=[];for(var f=[],h="";c.length<d;){this.chains_.containsKey(h)||(f=this.chooseRandomStart_(),h=f.join("-"));var e=goog.text.LoremIpsum.randomChoice_(this.chains_.get(h)),h=e[0],e=goog.array.contains(goog.text.LoremIpsum.DELIMITERS_SENTENCES_,e[1])?"":e[1],k=goog.text.LoremIpsum.chooseClosest(this.words_.getKeys(),h),k=goog.text.LoremIpsum.randomChoice_(this.words_.get(k).getValues());c.push(k+e);f=[f[1],h];h=f.join("-")}c=c.join(" ");c=c.slice(0,1).toUpperCase()+c.slice(1);c.substring(c.length-
1)==e&&(c=c.slice(0,c.length-1));return c+"."};goog.text.LoremIpsum.prototype.generateParagraph=function(c){for(var d=goog.text.LoremIpsum.randomNormal_(this.paragraphMean_,this.paragraphSigma_),d=Math.max(Math.floor(d),1),e=[];e.length<d;)c=this.generateSentence(c),e.push(c),c=!1;return e=e.join(" ")};goog.text.LoremIpsum.splitParagraphs_=function(c){return c.split("\n")};
goog.text.LoremIpsum.splitSentences_=function(c){return goog.array.filter(c.split(goog.text.LoremIpsum.SENTENCE_SPLIT_REGEX_),goog.text.LoremIpsum.isNotEmptyOrWhitepace_)};goog.text.LoremIpsum.splitWords_=function(c){return goog.array.filter(c.split(goog.text.LoremIpsum.WORD_SPLIT_REGEX_),goog.text.LoremIpsum.isNotEmptyOrWhitepace_)};goog.text.LoremIpsum.isNotEmptyOrWhitepace_=function(c){return 0<goog.string.trim(c).length};goog.text.LoremIpsum.arrayLength_=function(c){return c.length};
goog.text.LoremIpsum.chooseClosest=function(c,d){var e=c[0];goog.array.forEach(c,function(c){Math.abs(d-c)<Math.abs(d-e)&&(e=c)});return e};goog.text.LoremIpsum.getWordInfo_=function(c){var d;goog.array.some(goog.text.LoremIpsum.DELIMITERS_WORDS_,function(e){return goog.string.endsWith(c,e)?(d=[c.length-e.length,e],!0):!1});return d||[c.length,""]};goog.text.LoremIpsum.NV_MAGICCONST_=4*Math.exp(-0.5)/Math.sqrt(2);
goog.text.LoremIpsum.randomNormal_=function(c,d){for(;;){var e=Math.random(),f=1-Math.random(),e=goog.text.LoremIpsum.NV_MAGICCONST_*(e-0.5)/f;if(e*e/4<=-Math.log(f))break}return c+e*d};goog.text.LoremIpsum.randomChoice_=function(c){return c[goog.math.randomInt(c.length)]};goog.text.LoremIpsum.DICT_="a ac accumsan ad adipiscing aenean aliquam aliquet amet ante aptent arcu at auctor augue bibendum blandit class commodo condimentum congue consectetuer consequat conubia convallis cras cubilia cum curabitur curae cursus dapibus diam dictum dictumst dignissim dis dolor donec dui duis egestas eget eleifend elementum elit eni enim erat eros est et etiam eu euismod facilisi facilisis fames faucibus felis fermentum feugiat fringilla fusce gravida habitant habitasse hac hendrerit hymenaeos iaculis id imperdiet in inceptos integer interdum ipsum justo lacinia lacus laoreet lectus leo libero ligula litora lobortis lorem luctus maecenas magna magnis malesuada massa mattis mauris metus mi molestie mollis montes morbi mus nam nascetur natoque nec neque netus nibh nisi nisl non nonummy nostra nulla nullam nunc odio orci ornare parturient pede pellentesque penatibus per pharetra phasellus placerat platea porta porttitor posuere potenti praesent pretium primis proin pulvinar purus quam quis quisque rhoncus ridiculus risus rutrum sagittis sapien scelerisque sed sem semper senectus sit sociis sociosqu sodales sollicitudin suscipit suspendisse taciti tellus tempor tempus tincidunt torquent tortor tristique turpis ullamcorper ultrices ultricies urna ut varius ve vehicula vel velit venenatis vestibulum vitae vivamus viverra volutpat vulputate";
...
!1),this.getFieldObject().dispatchSelectionChangeEvent()),c.preventDefault(),!0)};silex.view.TextEditor=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.initUI();this.closeEditor();c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};goog.inherits(silex.view.TextEditor,silex.view.ViewBase);
...
this.textField.registerPlugin(new goog.editor.plugins.HeaderFormatter);this.textField.registerPlugin(new goog.editor.plugins.LinkDialogPlugin);this.textField.registerPlugin(new goog.editor.plugins.LinkBubble);var c=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FONT_FACE),d=silex.Config.fonts,e;for(e in d)goog.ui.editor.ToolbarFactory.addFont(c,e,d[e].value);d=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FONT_SIZE);goog.ui.editor.ToolbarFactory.addFontSize(d,
"1","1");goog.ui.editor.ToolbarFactory.addFontSize(d,"2","2");goog.ui.editor.ToolbarFactory.addFontSize(d,"3","3");goog.ui.editor.ToolbarFactory.addFontSize(d,"4","4");goog.ui.editor.ToolbarFactory.addFontSize(d,"5","5");goog.ui.editor.ToolbarFactory.addFontSize(d,"6","6");goog.ui.editor.ToolbarFactory.addFontSize(d,"7","7");for(e=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FORMAT_BLOCK);0<e.getItemCount();)e.removeItemAt(0);goog.ui.editor.ToolbarFactory.addFormatOption(e,
"Normal text","P");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Title","HEADER");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Subtitle","DIV");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 1","H1");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 2","H2");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 3","H3");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Quote","BLOCKQUOTE");var c=goog.ui.editor.DefaultToolbar.makeToolbar([e,c,d,goog.editor.Command.BOLD,goog.editor.Command.ITALIC,
goog.editor.Command.UNDERLINE,goog.editor.Command.FONT_COLOR,goog.editor.Command.BACKGROUND_COLOR,goog.editor.Command.LINK,goog.editor.Command.UNDO,goog.editor.Command.REDO,goog.editor.Command.UNORDERED_LIST,goog.editor.Command.ORDERED_LIST,goog.editor.Command.INDENT,goog.editor.Command.OUTDENT,goog.editor.Command.JUSTIFY_LEFT,goog.editor.Command.JUSTIFY_CENTER,goog.editor.Command.JUSTIFY_RIGHT,goog.editor.Command.STRIKE_THROUGH,goog.editor.Command.REMOVE_FORMAT],goog.dom.getElementByClass("toolbar",
this.element)),f=new goog.text.LoremIpsum,d=goog.ui.editor.ToolbarFactory.makeButton("loremIpsumBtn","insert lorem ipsum text","L");goog.events.listen(d,goog.ui.Component.EventType.ACTION,function(){var c=f.generateParagraph(!0),d=goog.dom.createElement("div");d.innerHTML=c;this.textField.getRange().replaceContentsWithNode(d)},!1,this);c.addChild(new goog.ui.ToolbarSeparator,!0);c.addChild(d,!0);new goog.ui.editor.ToolbarController(this.textField,c);goog.events.listen(this.textField,goog.editor.Field.EventType.DELAYEDCHANGE,
function(){this.contentChanged()},!1,this);try{this.textField.makeEditable()}catch(h){console.error("error catched",h)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);c=goog.dom.getElementByClass("dialogs-background");goog.events.listen(c,goog.events.EventType.CLICK,function(c){this.closeEditor()},!1,this)};
silex.view.TextEditor.prototype.openEditor=function(c,d){this.textField.setHtml(!1,c);this.textField.focusAndPlaceCursorAtStart();var e=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(e,"display","inherit");goog.style.setStyle(this.element,"display","inherit");d||(d="white");goog.dom.getElementsByTagNameAndClass("iframe",null,this.element)[0].style.backgroundColor=d;this.redraw()};
silex.view.TextEditor.prototype.redraw=function(){var c=goog.dom.getElementsByTagNameAndClass("iframe",null,this.element)[0],c=goog.dom.getFrameContentDocument(c),d=c.body,e=c.head,f=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,this.headElement),h="";f&&(h=f.innerHTML);f=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,e);f||(f=c.createElement("style"),f.type="text/css",goog.dom.classes.add(f,silex.model.Head.SILEX_STYLE_ELEMENT_ID),goog.dom.appendChild(e,f));
f.innerHTML=h;goog.dom.classes.add(d,"text-element")};silex.view.TextEditor.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none")};silex.view.TextEditor.prototype.getData=function(){return this.textField.getCleanContents()};silex.view.TextEditor.prototype.contentChanged=function(){if(this.onStatus)this.onStatus("changed",this.getData())};silex.view.HTMLEditor=function(c,d,e){silex.view.AceEditorBase.call(this,c,d,e)};goog.inherits(silex.view.HTMLEditor,silex.view.AceEditorBase);silex.view.HTMLEditor.prototype.initUI=function(){silex.view.HTMLEditor.superClass_.initUI.call(this);this.ace.getSession().setMode("ace/mode/html")};silex.view.Workspace=function(c,d,e,f,h,k,l,m,n,p){this.element=c;this.menuElement=d;this.stageElement=e;this.pageToolElement=f;this.propertyToolElement=h;this.htmlEditorElement=k;this.cssEditorElement=l;this.textEditorElement=m;this.fileExplorerElement=n;this.publishSettingsElement=p;this.viewport=new goog.dom.ViewportSizeMonitor;goog.events.listen(this.viewport,goog.events.EventType.RESIZE,function(c){this.invalidate()},!1,this);this.isDirty=!1;this.invalidate()};
silex.view.Workspace.prototype.invalidate=function(){!1===this.isDirty&&(this.isDirty=!0,this.redraw())};silex.view.Workspace.prototype.redraw=function(){!1===this.isDirty&&console.warn("Do not call redraw directly, use invalidate() instead");var c=this;setTimeout(function(){c.doRedraw()},400)};
silex.view.Workspace.prototype.doRedraw=function(){this.isDirty=!1;var c=this.viewport.getSize(),d=goog.style.getSize(this.pageToolElement),e=goog.style.getSize(this.propertyToolElement),f=goog.style.getSize(this.menuElement);goog.style.setWidth(this.stageElement,c.width-d.width-e.width);d=c.height-f.height;goog.style.setHeight(this.pageToolElement,d);goog.style.setHeight(this.propertyToolElement,d);goog.style.setHeight(this.stageElement,d);this.htmlEditorElement&&(e=goog.style.getSize(this.htmlEditorElement),
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.htmlEditorElement,d,e));this.cssEditorElement&&(e=goog.style.getSize(this.cssEditorElement),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.cssEditorElement,d,e));this.textEditorElement&&(e=goog.style.getSize(this.textEditorElement),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.textEditorElement,d,e));this.fileExplorerElement&&(e=goog.style.getSize(this.fileExplorerElement),
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.fileExplorerElement,d,e));this.publishSettingsElement&&(e=goog.style.getSize(this.publishSettingsElement),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.publishSettingsElement,d,e));goog.dom.classes.has(document.body,"loading-pending")&&goog.dom.classes.remove(document.body,"loading-pending")};silex.service.SilexTasks=function(){};goog.addSingletonGetter(silex.service.SilexTasks);
silex.service.SilexTasks.prototype.publish=function(c,d,e,f,h,k,l){if(goog.isNull(c)||goog.isNull(d)||goog.isNull(e)||goog.isNull(f)||goog.isNull(h))console.error("Param path, html, css, js or files missing"),l&&l("Param path, html, css, js or files missing");else{var m=new goog.Uri.QueryData;m.add("path",c);m.add("html",d);m.add("css",e);m.add("js",f);m.add("files",JSON.stringify(h));goog.net.XhrIo.send("/silex/tasks/publish",function(c){c=c.target;if(c.isSuccess()){var d=c.getResponseJson();d.success?
k&&k(d):(d=d.code||d.message,console.error(d,c,c.isSuccess(),c.getStatus(),c.headers.toString()),l&&l(d))}else d=c.getLastError(),console.error(c.getLastError(),c.getLastErrorCode(),c.isSuccess(),c.getStatus(),c.headers),l&&l(d)},"POST",m.toString())}};silex.model.File=function(c,d){silex.model.ModelBase.call(this,c,d)};goog.inherits(silex.model.File,silex.model.ModelBase);silex.model.File.CREATION_TEMPLATE="creation-template.html";
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(d=e.indexOf(">",f),d=c.substring(d+1,h));-1<k&&-1<l&&e.indexOf(">",k);c=c.substring(k,l+7);this.getUrl()&&(e=silex.utils.Url.getBaseUrl(this.getUrl()),c=silex.utils.Url.relative2absolute(c,e));silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);this.bodyElement.innerHTML=
c;e=c.indexOf('"');h=c.indexOf('"',e+1);c=c.substring(e+1,h);this.bodyElement.setAttribute("style",c);silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);this.headElement.innerHTML=d};
silex.model.File.prototype.getHtml=function(){silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);var c=this.bodyElement.innerHTML;silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);var d=this.bodyElement.getAttribute("style")||"",e;e="<html>"+("<head>"+this.headElement.innerHTML+"</head>");e+='<body style="'+d+'">'+c+"</body>";e+="</html>";this.getUrl()&&(c=silex.utils.Url.getBaseUrl(this.getUrl()),e=silex.utils.Url.absolute2Relative(e,c));return e};
silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};silex.model.File.prototype.openFromUrl=function(c,d,e){silex.service.CloudStorage.getInstance().loadLocal(c,goog.bind(function(c){this.setUrl(null);d&&d(c)},this),e)};silex.model.File.prototype.saveAs=function(c,d,e,f){this.setUrl(c);this.save(d,e,f)};silex.model.File.prototype.save=function(c,d,e){silex.service.CloudStorage.getInstance().save(this.getUrl(),c,function(){d&&d()},e)};
silex.model.File.prototype.open=function(c,d,e){silex.service.CloudStorage.getInstance().load(c,goog.bind(function(e){this.close();this.setUrl(c);d&&d(e)},this),e)};silex.model.File.prototype.close=function(){this.url=null};silex.model.File.prototype.getUrl=function(){if(this.url){var c=silex.utils.Url.getBaseUrl();this.url=silex.utils.Url.getRelativePath(this.url,c)}return this.url};
silex.model.File.prototype.setUrl=function(c){if(c){var d=silex.utils.Url.getBaseUrl();c=silex.utils.Url.getAbsolutePath(c,d)}this.url=c};silex.model.File.prototype.publish=function(c,d,e){this.cleanup(goog.bind(function(f,h,k,l){silex.service.SilexTasks.getInstance().publish(c,f,h,k,l,d,e)},this),goog.bind(function(c){console.error("publish cleanup error",c);e&&e(c)},this))};
silex.model.File.prototype.cleanup=function(c,d){var e=this.bodyElement.getAttribute("style")||"";silex.utils.EditablePlugin.setEditable(this.bodyElement,!1);var f='<body style="'+e+'">'+this.bodyElement.innerHTML+"</body>";silex.utils.EditablePlugin.setEditable(this.bodyElement,!0);var h=this.headElement.innerHTML,k=[],l=[];if(this.getUrl()){var m=silex.utils.Url.getBaseUrl(this.getUrl()),f=f.replace(/<img[^"]*src="?([^" ]*)"/g,function(c,d,e){var f=silex.utils.Url.getAbsolutePath(d,m),h=silex.utils.Url.getRelativePath(f,
silex.utils.Url.getBaseUrl());console.log(arguments,h,f);silex.utils.Url.isAbsoluteUrl(h)||(h=h.replace("../","/"));var k="assets/"+f.substr(f.lastIndexOf("/")+1);l.push({url:f,destPath:k,srcPath:h});return c.replace(d,k)}),f=f.replace(/url\(()(.+?)\1\)/g,goog.bind(function(c,d,e){return this.filterBgImage(m,l,c,d,e)},this)),h=h.replace(/href="?([^" ]*)"/g,function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,m);var h=silex.utils.Url.getRelativePath(e,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(h)?
0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="css/"+e.substr(e.lastIndexOf("/")+1),l.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),h=h.replace(/src="?([^"]*)"/g,function(c,d,e){var f=!1;e=silex.utils.Url.getAbsolutePath(d,m);var h=silex.utils.Url.getRelativePath(e,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="js/"+e.substr(e.lastIndexOf("/")+1),l.push({url:e,
destPath:f,srcPath:h}),c.replace(d,f))}),e=goog.dom.createElement("div");e.innerHTML=f;f=goog.dom.createElement("div");f.innerHTML=h;$('meta[name="publicationPath"]',f).remove();h=goog.dom.getElementsByClass("editable-style",e);goog.array.forEach(h,function(c){var d=c.getAttribute("data-silex-href");d&&(c.setAttribute("href",d),c.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,
c),goog.dom.removeNode(c))},this);var h=goog.dom.getElementsByClass("editable-style",e),n=0;goog.array.forEach(h,function(c){var d="silex-"+c.getAttribute(silex.model.Element.TYPE_ATTR);goog.dom.classes.add(c,d);d="element-"+n++;goog.dom.classes.add(c,d);var e=c.getAttribute("style");k.push({classNames:["."+d],styles:e});goog.dom.classes.remove(c,"editable-style");c.removeAttribute("data-silex-type");c.removeAttribute("style")},this);var p="";goog.array.forEach(k,function(c){var d="";goog.array.forEach(c.classNames,
function(c){""!=d&&(d+=", ");d+=c},this);d+="{\n\t"+c.styles+"\n}";p+="\n"+d},this);p.replace("; ",";\n\t");if(h=goog.dom.getElementByClass(silex.model.Head.SILEX_STYLE_ELEMENT_ID,f))p+=h.innerHTML,goog.dom.removeNode(h);var h="",q=goog.dom.getElementByClass(silex.model.Head.SILEX_SCRIPT_ELEMENT_ID,f);q&&(h=q.innerHTML,goog.dom.removeNode(q));f="<html>"+("<head>      "+f.innerHTML+'      <link href="css/styles.css" rel="stylesheet">      <script src="js/script.js" type="text/javascript">\x3c/script>  </head>');
f+="<body>"+e.innerHTML+"</body>";f+="</html>";c(f,p,h,l)}else d&&d({message:"The file must be saved before I can clean it up for you."})};
silex.model.File.prototype.filterBgImage=function(c,d,e,f,h){0===h.indexOf("'")&&(h=h.substr(1));h.lastIndexOf("'")===h.length-1&&(h=h.substr(0,h.length-1));c=silex.utils.Url.getAbsolutePath(h,c);e=silex.utils.Url.getRelativePath(c,silex.utils.Url.getBaseUrl());silex.utils.Url.isAbsoluteUrl(e)||(e=e.replace("../","/"));f="assets/"+c.substr(c.lastIndexOf("/")+1);h="url('../"+f+"')";d.push({url:c,destPath:f,srcPath:e});return h};silex.App=function(){silex.service.Tracker.getInstance().trackAction("app-events","start",null,2);"silex"===window.location.href.slice(-5)&&(window.location.href+="/");window.location.hash="";if(!silex.Config.debug.debugMode||silex.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure you want to leave me?"};var c=goog.dom.getElementByClass("silex-stage-body");silex.utils.PageablePlugin.setBodyElement(c);var d=goog.dom.createElement("div"),e=goog.dom.getElementByClass("silex-menu"),
f=new silex.view.Menu(e,c,d),h=goog.dom.getElementByClass("silex-stage"),k=new silex.view.Stage(h,c,d),l=goog.dom.getElementByClass("silex-page-tool"),m=new silex.view.PageTool(l,c,d),n=goog.dom.getElementByClass("silex-html-editor"),p=new silex.view.HTMLEditor(n,c,d),q=goog.dom.getElementByClass("silex-css-editor"),s=new silex.view.CssEditor(q,c,d),t=goog.dom.getElementByClass("silex-js-editor"),u=new silex.view.JsEditor(t,c,d),v=goog.dom.getElementByClass("silex-texteditor"),z=new silex.view.TextEditor(v,
c,d),w=goog.dom.getElementByClass("silex-fileexplorer"),A=new silex.view.FileExplorer(w,c,d),x=goog.dom.getElementByClass("silex-settings-dialog"),B=new silex.view.SettingsDialog(x,c,d),y=goog.dom.getElementByClass("silex-property-tool"),C=new silex.view.PropertyTool(y,c,d),D=goog.dom.getElementByClass("silex-workspace"),e=new silex.view.Workspace(D,e,h,l,y,n,q,t,v,w,x),c=new silex.types.Model(new silex.model.File(c,d),new silex.model.Head(c,d),new silex.model.Body(c,d),new silex.model.Element(c,
d)),f=new silex.types.View(e,f,k,m,C,p,s,u,z,A,B),k=new silex.types.Controller(new silex.controller.MenuController(c,f),new silex.controller.StageController(c,f),new silex.controller.PageToolController(c,f),new silex.controller.PropertyToolController(c,f),new silex.controller.SettingsDialogController(c,f),new silex.controller.HtmlEditorController(c,f),new silex.controller.CssEditorController(c,f),new silex.controller.JsEditorController(c,f),new silex.controller.TextEditorController(c,f));k.menuController.menuCallback("file.new");
silex.Config.debug.debugMode&&silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(c,f,k)};goog.exportSymbol("silex.App",silex.App);
