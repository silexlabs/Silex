...
shortcut:[[goog.events.KeyCodes.DELETE],[goog.events.KeyCodes.BACKSPACE]],tooltip:"suppr",mnemonic:goog.events.KeyCodes.R,accelerator:"r"},null,{label:"Rename page",id:"edit.rename.page",className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],[{label:"View in new window",id:"view.file",className:"menu-item-view-file",globalKey:goog.events.KeyCodes.V,shortcut:[[goog.events.KeyCodes.V,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],
tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"Edit selection",id:"view.open.editor",className:"menu-item-view-open-textEditor",tooltip:"\u21b5"},{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",globalKey:goog.events.KeyCodes.T,shortcut:[[goog.events.KeyCodes.T,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"T",mnemonic:goog.events.KeyCodes.T,
accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",globalKey:goog.events.KeyCodes.I,shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",globalKey:goog.events.KeyCodes.C,shortcut:[[goog.events.KeyCodes.C,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"C",mnemonic:goog.events.KeyCodes.C,
accelerator:"c"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html",globalKey:goog.events.KeyCodes.H,shortcut:[[goog.events.KeyCodes.H,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"H",mnemonic:goog.events.KeyCodes.H,accelerator:"h"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,
accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",
id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",className:"menu-item-help-forkMe"}]]};
...
silex.model.Element.prototype.createElement=function(c){var d;switch(c){case silex.model.Element.TYPE_CONTAINER:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);break;case silex.model.Element.TYPE_TEXT:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_TEXT);d.innerHTML="New text box";break;case silex.model.Element.TYPE_HTML:d=goog.dom.createElement("div");d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME;
d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);c=goog.dom.createElement("div");c.innerHTML="<p>New HTML box</p>";goog.style.setStyle(c,"width","100%");goog.style.setStyle(c,"height","100%");goog.dom.appendChild(d,c);goog.dom.classes.add(c,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);break;case silex.model.Element.TYPE_IMAGE:d=goog.dom.createElement("div"),d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE)}goog.dom.classes.add(d,
silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);silex.utils.EditablePlugin.setEditable(d,!0);c=goog.dom.getElementByClass("background",this.bodyElement);c||(c=this.bodyElement);goog.style.setStyle(d,{height:"100px",width:"100px",top:100+this.bodyElement.scrollTop+"px",left:100+this.bodyElement.scrollLeft+"px",backgroundColor:"rgba(255, 255, 255, 1)",position:"absolute"});goog.dom.appendChild(c,d);return d};
...
goog.bind(function(c){c.preventDefault();this.onMenuEvent(c.identifier)},this));h=new goog.events.KeyHandler(document);goog.events.listen(h,"key",goog.bind(function(c){c.keyCode===goog.events.KeyCodes.ENTER&&("INPUT"!==c.target.tagName&&c.target.tagName!==d.textInputs_[c.target.type])&&(c.preventDefault(),this.onMenuEvent("view.open.textEditor"))},this));this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,function(c){this.onClick(c)},!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),
goog.events.EventType.CLICK,function(c){this.onClick(c)},!1,this)};silex.view.Menu.prototype.onClick=function(c){if(this.onStatus&&c&&c.target)if(goog.dom.classes.has(c.target,"website-name"))this.onMenuEvent("title.changed");else this.onMenuEvent(c.target.getId())};silex.view.Menu.prototype.onMenuEvent=function(c){if(this.onStatus)this.onStatus(c)};silex.view.Menu.prototype.setWebsiteName=function(c){c&&""!==c||(c="Untitled website");goog.dom.getElementByClass("website-name").innerHTML=c};
silex.view.Menu.prototype.getWebsiteName=function(){return goog.dom.getElementByClass(headElement,"website-name").innerHTML};silex.utils={};silex.utils.RetroCompat=function(){throw"this is a static class and it canot be instanciated";};
...
silex.controller.ControllerBase.prototype.addElement=function(c){c=this.model.element.createElement(c);var d=silex.utils.PageablePlugin.getCurrentPageName();silex.utils.PageablePlugin.addToPage(c,d);this.checkElementVisibility(c);this.model.element.setSelected(c,!0);this.view.propertyTool.redraw();return c};
...
silex.controller.MenuController.prototype.menuCallback=function(c){this.tracker.trackAction("controller-events","request",c,0);switch(c){case "title.changed":this.promptTitle();break;case "file.close":case "file.new":this.newFile(goog.bind(function(){this.tracker.trackAction("controller-events","success",c,1)},this));break;case "file.saveas":this.save(null,goog.bind(function(){this.tracker.trackAction("controller-events","success",c,1)},this));break;case "file.rename":this.promptTitle();break;case "file.publish.settings":this.view.settingsDialog.openDialog();
this.view.workspace.invalidate();break;case "file.publish":this.publish();break;case "file.save":this.save(this.model.file.getUrl());break;case "file.open":this.openFile(goog.bind(function(){this.tracker.trackAction("controller-events","success",c,1)},this));break;case "view.file":this.preview();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):
(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "view.open.fileExplorer":this.view.fileExplorer.openDialog();this.view.workspace.invalidate();break;case "view.open.editor":this.editComponent();break;case "insert.page":this.createPage();break;case "insert.text":this.addElement(silex.model.Element.TYPE_TEXT);break;case "insert.html":this.addElement(silex.model.Element.TYPE_IMAGE);break;case "insert.image":this.view.fileExplorer.openDialog(goog.bind(function(d){var e=
this.addElement(silex.model.Element.TYPE_IMAGE);this.model.element.setImageUrl(e,d,goog.bind(function(d,e){goog.style.setStyle(d,{width:e.naturalWidth+"px",height:e.naturalHeight+"px"});this.tracker.trackAction("controller-events","success",c,1)},this),goog.bind(function(d,e){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+e);this.removeElement(d);this.tracker.trackAction("controller-events","error",c,1)},this))},this),["image/*","text/plain"],goog.bind(function(d){silex.utils.Notification.notifyError("Error: I did not manage to load the image. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "insert.container":this.addElement(silex.model.Element.TYPE_CONTAINER);break;case "edit.delete.selection":this.removeElement();break;case "edit.delete.page":this.removePage();break;case "edit.rename.page":this.renamePage();break;case "help.about":window.open(silex.Config.ABOUT_SILEX);break;case "help.aboutSilexLabs":window.open(silex.Config.ABOUT_SILEX_LABS);break;case "help.newsLetter":window.open(silex.Config.SUBSCRIBE_SILEX_LABS);
break;case "help.googlPlus":window.open(silex.Config.SOCIAL_GPLUS);break;case "help.twitter":window.open(silex.Config.SOCIAL_TWITTER);break;case "help.facebook":window.open(silex.Config.SOCIAL_FB);break;case "help.forkMe":window.open(silex.Config.FORK_CODE)}};silex.types={};silex.types.Model=function(c,d,e,f){this.file=c;this.head=d;this.body=e;this.element=f};silex.types.Controller=function(c,d,e,f,h,k,l){this.menuController=c;this.stageController=d;this.pageToolController=e;this.propertyToolController=f;this.settingsDialogController=h;this.htmlEditorController=k;this.textEditorController=l};
silex.types.View=function(c,d,e,f,h,k,l,m,n){this.workspace=c;this.menu=d;this.stage=e;this.pageTool=f;this.propertyTool=h;this.htmlEditor=k;this.textEditor=l;this.fileExplorer=m;this.settingsDialog=n};silex.view.SettingsDialog=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.publicationPath="";goog.style.setStyle(this.element,"display","none");c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this));c=goog.dom.getElementByClass("close-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.closeEditor()},
...
"1","1");goog.ui.editor.ToolbarFactory.addFontSize(d,"2","2");goog.ui.editor.ToolbarFactory.addFontSize(d,"3","3");goog.ui.editor.ToolbarFactory.addFontSize(d,"4","4");goog.ui.editor.ToolbarFactory.addFontSize(d,"5","5");goog.ui.editor.ToolbarFactory.addFontSize(d,"6","6");goog.ui.editor.ToolbarFactory.addFontSize(d,"7","7");var c=goog.ui.editor.DefaultToolbar.makeToolbar([goog.editor.Command.BOLD,goog.editor.Command.ITALIC,goog.editor.Command.UNDERLINE,goog.editor.Command.FONT_COLOR,goog.editor.Command.BACKGROUND_COLOR,
c,d,goog.editor.Command.LINK,goog.editor.Command.UNDO,goog.editor.Command.REDO,goog.editor.Command.UNORDERED_LIST,goog.editor.Command.ORDERED_LIST,goog.editor.Command.INDENT,goog.editor.Command.OUTDENT,goog.editor.Command.JUSTIFY_LEFT,goog.editor.Command.JUSTIFY_CENTER,goog.editor.Command.JUSTIFY_RIGHT,goog.editor.Command.STRIKE_THROUGH,goog.editor.Command.REMOVE_FORMAT],goog.dom.getElementByClass("toolbar",this.element)),f=new goog.text.LoremIpsum,d=goog.ui.editor.ToolbarFactory.makeButton("loremIpsumBtn",
"insert lorem ipsum text","L");goog.events.listen(d,goog.ui.Component.EventType.ACTION,function(){var c=f.generateParagraph(!0),d=goog.dom.createElement("div");d.innerHTML=c;this.textField.getRange().replaceContentsWithNode(d)},!1,this);c.addChild(new goog.ui.ToolbarSeparator,!0);c.addChild(d,!0);new goog.ui.editor.ToolbarController(this.textField,c);goog.events.listen(this.textField,goog.editor.Field.EventType.DELAYEDCHANGE,function(){this.contentChanged()},!1,this);try{this.textField.makeEditable()}catch(h){console.error("error catched",
h)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);c=goog.dom.getElementByClass("dialogs-background");goog.events.listen(c,goog.events.EventType.CLICK,function(c){this.closeEditor()},!1,this)};
silex.view.TextEditor.prototype.openEditor=function(){var c=this.getSelection()[0],c=goog.dom.getElementByClass(silex.model.Element.ELEMENT_CONTENT_CLASS_NAME,c).innerHTML;this.textField.setHtml(!1,c);this.textField.focusAndPlaceCursorAtStart();c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","inherit")};
...
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.htmlEditorElement,d,e));this.textEditorElement&&(e=goog.style.getSize(this.textEditorElement),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.textEditorElement,d,e));this.fileExplorerElement&&(e=goog.style.getSize(this.fileExplorerElement),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.fileExplorerElement,d,e));this.publishSettingsElement&&(e=goog.style.getSize(this.publishSettingsElement),
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.publishSettingsElement,d,e));goog.dom.classes.has(document.body,"loading-pending")&&goog.dom.classes.remove(document.body,"loading-pending")};silex.service.SilexTasks=function(){};goog.addSingletonGetter(silex.service.SilexTasks);
...
f=new silex.view.Menu(e,c,d),h=goog.dom.getElementByClass("silex-stage"),k=new silex.view.Stage(h,c,d),l=goog.dom.getElementByClass("silex-page-tool"),m=new silex.view.PageTool(l,c,d),n=goog.dom.getElementByClass("silex-htmleditor"),p=new silex.view.HTMLEditor(n,c,d),q=goog.dom.getElementByClass("silex-texteditor"),s=new silex.view.TextEditor(q,c,d),t=goog.dom.getElementByClass("silex-fileexplorer"),u=new silex.view.FileExplorer(t,c,d),v=goog.dom.getElementByClass("silex-settings-dialog"),x=new silex.view.SettingsDialog(v,
c,d),w=goog.dom.getElementByClass("silex-property-tool"),y=new silex.view.PropertyTool(w,c,d),z=goog.dom.getElementByClass("silex-workspace"),e=new silex.view.Workspace(z,e,h,l,w,n,q,t,v),c=new silex.types.Model(new silex.model.File(c,d),new silex.model.Head(c,d),new silex.model.Body(c,d),new silex.model.Element(c,d)),f=new silex.types.View(e,f,k,m,y,p,s,u,x),k=new silex.types.Controller(new silex.controller.MenuController(c,f),new silex.controller.StageController(c,f),new silex.controller.PageToolController(c,
f),new silex.controller.PropertyToolController(c,f),new silex.controller.SettingsDialogController(c,f),new silex.controller.HtmlEditorController(c,f),new silex.controller.TextEditorController(c,f));k.menuController.menuCallback("file.new");silex.Config.debug.debugMode&&silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(c,f,k)};goog.exportSymbol("silex.App",silex.App);
