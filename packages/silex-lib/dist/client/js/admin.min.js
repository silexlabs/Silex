...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};var silex={view:{}};silex.view.PageTool=function(a){this.element=a;this.initEvents()};silex.view.PageTool.prototype.initEvents=function(a){goog.events.listen(this.element,goog.events.EventType.CLICK,function(a){goog.dom.classes.has(a.target,"delete")?this.removePageAtIndex(this.getCellIndex(this.parentNode)):goog.dom.classes.has(a.target,"label")?this.renamePageAtIndex(this.getCellIndex(this.parentNode)):this.setSelectedIndex(this.getCellIndex(a.target),!0)},!1,this)};
silex.view.PageTool.prototype.refresh=function(){var a=silex.view.JQueryPageable.getPages(),b=goog.dom.getElementByClass("page-tool-container",this.element),c=goog.dom.getElementByClass("page-tool-template",this.element).innerHTML;b.innerHTML=silex.utils.dom.resolveTemplate(c,a)};silex.view.PageTool.prototype.removePageAtIndex=function(a){if(this.onStatus)this.onStatus({type:"delete",page:this.pages[a]});this.refresh()};
silex.view.PageTool.prototype.renamePageAtIndex=function(a){if(this.onStatus)this.onStatus({type:"rename",page:this.pages[a]});this.refresh()};silex.view.PageTool.prototype.setSelectedIndex=function(a,b){var c=goog.dom.getElementsByClass("page-container",this.element);goog.array.forEach(c,function(b){var c=this.getCellIndex(b);a===c?goog.dom.classes.add(b,"ui-selected"):goog.dom.classes.remove(b,"ui-selected")},this);if(b&&this.onStatus)this.onStatus({type:"changed",page:page})};
silex.view.PageTool.prototype.getCellIndex=function(a){for(var b=goog.dom.getElementsByClass("page-container",this.element),c=0;c<b.length&&b[c]!=a;)c++;c>=b.length&&(c=-1,console.error("Page not found for element ",a));return c};goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.debug={};goog.debug.Error=function(a){Error.captureStackTrace?Error.captureStackTrace(this,goog.debug.Error):this.stack=Error().stack||"";a&&(this.message=String(a))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.string={};goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
goog.math.Box.prototype.scale=function(a,b){var c=goog.isNumber(b)?b:a;this.left*=a;this.right*=a;this.top*=c;this.bottom*=c;return this};goog.userAgent={};goog.userAgent.ASSUME_IE=!1;goog.userAgent.ASSUME_GECKO=!1;goog.userAgent.ASSUME_WEBKIT=!1;goog.userAgent.ASSUME_MOBILE_WEBKIT=!1;goog.userAgent.ASSUME_OPERA=!1;goog.userAgent.ASSUME_ANY_VERSION=!1;goog.userAgent.BROWSER_KNOWN_=goog.userAgent.ASSUME_IE||goog.userAgent.ASSUME_GECKO||goog.userAgent.ASSUME_MOBILE_WEBKIT||goog.userAgent.ASSUME_WEBKIT||goog.userAgent.ASSUME_OPERA;
...
goog.style.getCssTranslation=function(a){var b;goog.userAgent.IE?b="-ms-transform":goog.userAgent.WEBKIT?b="-webkit-transform":goog.userAgent.OPERA?b="-o-transform":goog.userAgent.GECKO&&(b="-moz-transform");var c;b&&(c=goog.style.getStyle_(a,b));c||(c=goog.style.getStyle_(a,"transform"));return c?(a=c.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
goog.async.Delay.prototype.doAction_=function(){this.id_=0;this.listener_&&this.listener_.call(this.handler_)};silex.service={};silex.service.CloudStorage=function(){this.filePicker=cloudExplorer};silex.service.CloudStorage.getInstance=function(){silex.service.CloudStorage.instance||(silex.service.CloudStorage.instance=new silex.service.CloudStorage);return silex.service.CloudStorage.instance};
silex.service.CloudStorage.prototype.save=function(a,b,c,d){a={url:silex.Helper.getRelativePath(a.url,silex.Helper.BaseUrl)};this.filePicker.write(a,b,function(a){(new goog.async.Delay(function(){c&&c()},10)).start()},function(a){console.error(a);d&&(console.error(a),d(a))})};
silex.service.CloudStorage.prototype.load=function(a,b,c){a={url:silex.Helper.getRelativePath(a.url,silex.Helper.BaseUrl)};this.filePicker.read(a,function(a){(new goog.async.Delay(function(){b&&b(a)},10)).start()},function(a){console.error(a);c&&(console.error(a),c(a))})};
silex.service.CloudStorage.prototype.loadLocal=function(a,b,c){goog.net.XhrIo.send(a,function(a){a=a.target;var e=a.getResponse();if(a.isSuccess())(new goog.async.Delay(function(){b&&b(e)},10)).start();else{var f=a.getLastError();console.error(f,a,a.isSuccess(),a.getStatus(),a.headers.toString());c&&(console.error(FPError),c(f))}})};goog.events.KeyCodes={WIN_KEY_FF_LINUX:0,MAC_ENTER:3,BACKSPACE:8,TAB:9,NUM_CENTER:12,ENTER:13,SHIFT:16,CTRL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,FF_SEMICOLON:59,FF_EQUALS:61,FF_DASH:173,QUESTION_MARK:63,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,
...
goog.ui.KeyboardShortcutHandler.prototype.setAllowSpaceKeyOnButtons=function(a){this.allowSpaceKeyOnButtons_=a};goog.ui.KeyboardShortcutHandler.prototype.registerShortcut=function(a,b){goog.ui.KeyboardShortcutHandler.setShortcut_(this.shortcuts_,this.interpretStrokes_(1,arguments),a)};goog.ui.KeyboardShortcutHandler.prototype.unregisterShortcut=function(a){goog.ui.KeyboardShortcutHandler.setShortcut_(this.shortcuts_,this.interpretStrokes_(0,arguments),null)};
goog.ui.KeyboardShortcutHandler.prototype.isShortcutRegistered=function(a){return this.checkShortcut_(this.interpretStrokes_(0,arguments))};goog.ui.KeyboardShortcutHandler.prototype.interpretStrokes_=function(a,b){var c;if(goog.isString(b[a]))c=goog.ui.KeyboardShortcutHandler.parseStringShortcut(b[a]);else{var d=b,e=a;goog.isArray(b[a])&&(d=b[a],e=0);for(c=[];e<d.length;e+=2)c.push({keyCode:d[e],modifiers:d[e+1]})}return c};
...
goog.ui.KeyboardShortcutHandler.parseStringShortcut=function(a){a=a.replace(/[ +]*\+[ +]*/g,"+").replace(/[ ]+/g," ").toLowerCase();a=a.split(" ");for(var b=[],c,d=0;c=a[d];d++){c=c.split("+");for(var e,f=goog.ui.KeyboardShortcutHandler.Modifiers.NONE,g,h=0;g=c[h];h++){switch(g){case "shift":f|=goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT;continue;case "ctrl":f|=goog.ui.KeyboardShortcutHandler.Modifiers.CTRL;continue;case "alt":f|=goog.ui.KeyboardShortcutHandler.Modifiers.ALT;continue;case "meta":f|=
goog.ui.KeyboardShortcutHandler.Modifiers.META;continue}e=goog.ui.KeyboardShortcutHandler.getKeyCode(g);break}b.push({keyCode:e,modifiers:f})}return b};
goog.ui.KeyboardShortcutHandler.prototype.initializeKeyListener=function(a){this.keyTarget_=a;goog.events.listen(this.keyTarget_,goog.events.EventType.KEYDOWN,this.handleKeyDown_,!1,this);goog.userAgent.MAC&&(goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.8"))&&goog.events.listen(this.keyTarget_,goog.events.EventType.KEYUP,this.handleMacGeckoKeyUp_,!1,this);goog.userAgent.WINDOWS&&!goog.userAgent.GECKO&&(goog.events.listen(this.keyTarget_,goog.events.EventType.KEYPRESS,this.handleWindowsKeyPress_,
!1,this),goog.events.listen(this.keyTarget_,goog.events.EventType.KEYUP,this.handleWindowsKeyUp_,!1,this))};
goog.ui.KeyboardShortcutHandler.prototype.handleMacGeckoKeyUp_=function(a){if(a.keyCode==goog.events.KeyCodes.MAC_FF_META)this.metaKeyRecentlyReleased_=!0,goog.Timer.callOnce(function(){this.metaKeyRecentlyReleased_=!1},400,this);else{var b=a.metaKey||this.metaKeyRecentlyReleased_;a.keyCode!=goog.events.KeyCodes.C&&a.keyCode!=goog.events.KeyCodes.X&&a.keyCode!=goog.events.KeyCodes.V||!b||(a.metaKey=b,this.handleKeyDown_(a))}};
...
goog.events.unlisten(this.keyTarget_,goog.events.EventType.KEYUP,this.handleWindowsKeyUp_,!1,this));this.keyTarget_=null};goog.ui.KeyboardShortcutHandler.setShortcut_=function(a,b,c){var d=b.shift(),d=goog.ui.KeyboardShortcutHandler.makeKey_(d.keyCode,d.modifiers),e=a[d];if(e&&c&&(0==b.length||goog.isString(e)))throw Error("Keyboard shortcut conflicts with existing shortcut");b.length?(e||(e=a[d]={}),goog.ui.KeyboardShortcutHandler.setShortcut_(e,b,c)):a[d]=c};
...
goog.ui.KeyboardShortcutHandler.Modifiers.META:0)),c,d,e=goog.now();this.lastKeys_.strokes.length&&e-this.lastKeys_.time<=goog.ui.KeyboardShortcutHandler.MAX_KEY_SEQUENCE_DELAY?c=this.getShortcut_(this.lastKeys_.strokes):this.lastKeys_.strokes.length=0;c=c?c[b]:this.shortcuts_[b];c||(c=this.shortcuts_[b],this.lastKeys_.strokes=[]);c&&goog.isString(c)?d=c:c?(this.lastKeys_.strokes.push(b),this.lastKeys_.time=e,goog.userAgent.GECKO&&a.preventDefault()):this.lastKeys_.strokes.length=0;d&&(this.alwaysPreventDefault_&&
a.preventDefault(),this.alwaysStopPropagation_&&a.stopPropagation(),c=goog.ui.KeyboardShortcutHandler.EventType,b=a.target,e=new goog.ui.KeyboardShortcutEvent(c.SHORTCUT_TRIGGERED,d,b),e=this.dispatchEvent(e),d=new goog.ui.KeyboardShortcutEvent(c.SHORTCUT_PREFIX+d,d,b),(e&=this.dispatchEvent(d))||a.preventDefault(),this.lastKeys_.strokes.length=0)}};
goog.ui.KeyboardShortcutHandler.prototype.isValidShortcut_=function(a){var b=a.keyCode;if(b==goog.events.KeyCodes.SHIFT||b==goog.events.KeyCodes.CTRL||b==goog.events.KeyCodes.ALT)return!1;var c=a.target,d="TEXTAREA"==c.tagName||"INPUT"==c.tagName||"BUTTON"==c.tagName||"SELECT"==c.tagName,e=!d&&(c.isContentEditable||c.ownerDocument&&"on"==c.ownerDocument.designMode);return!d&&!e||this.globalKeys_[b]||this.allShortcutsAreGlobal_?!0:e?!1:this.modifierShortcutsAreGlobal_&&(a.altKey||a.ctrlKey||a.metaKey)?
!0:"INPUT"==c.tagName&&this.textInputs_[c.type]?b==goog.events.KeyCodes.ENTER:"INPUT"==c.tagName||"BUTTON"==c.tagName?this.allowSpaceKeyOnButtons_?!0:b!=goog.events.KeyCodes.SPACE:!1};goog.ui.KeyboardShortcutEvent=function(a,b,c){goog.events.Event.call(this,a,c);this.identifier=b};goog.inherits(goog.ui.KeyboardShortcutEvent,goog.events.Event);silex.view.FileExplorer=function(a){this.element=a;goog.style.setStyle(this.element,"display","none");(new goog.async.Delay(function(){this.init()},10,this)).start();a=new goog.ui.KeyboardShortcutHandler(document);a.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(a,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};silex.view.FileExplorer.CONTAINER_TYPE="modal";silex.view.FileExplorer.SERVICES=["DROPBOX","GOOGLE_DRIVE","EVERNOTE","FTP"];
silex.view.FileExplorer.prototype.init=function(){this.filePicker=silex.service.CloudStorage.getInstance().filePicker;goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
silex.view.FileExplorer.prototype.openDialog=function(a,b,c){var d;b&&(0===b[0].indexOf("image")?d=["jpg","jpeg","gif","png"]:0===b[0].indexOf("text/html")&&(d=["html","htm"]));var e=function(a){console.error(a);c&&c(a)},f=function(b){(new goog.async.Delay(function(){a&&a(b)},10,this)).start()};this.filePicker.pick(goog.bind(function(a){this.closeEditor();a.url=a.url.replace("https://","http://");a.url=silex.Helper.getAbsolutePath(a.url,silex.Helper.BaseUrl);if(d&&!1===silex.Helper.checkFileExt(a.url,
d)){var b=a.url.substring(a.url.lastIndexOf("/")+1);alertify.confirm("The file name "+b+" does not looks good to me, are you sure you want to select this file?",function(b){b?f(a):e({message:"Wrong file type."})})}else f(a)},this),e);this.openEditor()};
silex.view.FileExplorer.prototype.saveAsDialog=function(a,b,c){var d;b&&(0===b[0].indexOf("image")?d=["jpg","jpeg","gif","png"]:0===b[0].indexOf("text/html")&&(d=["html","htm"]));var e=function(a){console.error(a);c&&c(a)},f=function(b){(new goog.async.Delay(function(){a&&a(b)},10,this)).start()};this.filePicker.exportFile("http://google.com/",b,goog.bind(function(a){this.closeEditor();a.url=a.url.replace("https://","http://");a.url=silex.Helper.getAbsolutePath(a.url,silex.Helper.BaseUrl);if(d&&!1===
silex.Helper.checkFileExt(a.url,d)){var b=a.url.substring(a.url.lastIndexOf("/")+1);alertify.confirm("The file name "+b+" does not looks good to me, are you sure you want to select this file?",function(b){b?f(a):e({message:"Wrong file type."})})}else f(a)},this),e);this.openEditor()};
silex.view.FileExplorer.prototype.openEditor=function(){var a=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(a,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(a,goog.events.EventType.CLICK,this.closeEditor,!0,this)};
silex.view.FileExplorer.prototype.closeEditor=function(){var a=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(a,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(a,goog.events.EventType.CLICK,this.closeEditor,!0,this)};goog.dom.classlist={};goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST=!1;goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_=goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST||!!goog.global.DOMTokenList;goog.dom.classlist.get=goog.dom.classlist.NATIVE_DOM_TOKEN_LIST_?function(a){return a.classList}:function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classlist.set=function(a,b){a.className=b};
...
goog.ui.registry.defaultRenderers_={};goog.ui.registry.decoratorFunctions_={};goog.events.EventHandler=function(a){goog.Disposable.call(this);this.handler_=a;this.keys_={}};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(a,b,c,d){return this.listen_(a,b,c,d)};goog.events.EventHandler.prototype.listenWithScope=function(a,b,c,d,e){return this.listen_(a,b,c,d,e)};
...
goog.ui.MenuSeparatorRenderer.prototype.decorate=function(a,b){b.id&&a.setId(b.id);if("HR"==b.tagName){var c=b;b=this.createDom(a);goog.dom.insertSiblingBefore(b,c);goog.dom.removeNode(c)}else goog.dom.classlist.add(b,this.getCssClass());return b};goog.ui.MenuSeparatorRenderer.prototype.setContent=function(a,b){};goog.ui.MenuSeparatorRenderer.prototype.getCssClass=function(){return goog.ui.MenuSeparatorRenderer.CSS_CLASS};goog.ui.INLINE_BLOCK_CLASSNAME="goog-inline-block";goog.ui.ToolbarSeparatorRenderer=function(){goog.ui.MenuSeparatorRenderer.call(this)};goog.inherits(goog.ui.ToolbarSeparatorRenderer,goog.ui.MenuSeparatorRenderer);goog.addSingletonGetter(goog.ui.ToolbarSeparatorRenderer);goog.ui.ToolbarSeparatorRenderer.CSS_CLASS="goog-toolbar-separator";goog.ui.ToolbarSeparatorRenderer.prototype.createDom=function(a){return a.getDomHelper().createDom("div",this.getCssClass()+" "+goog.ui.INLINE_BLOCK_CLASSNAME,"\u00a0")};
goog.ui.ToolbarSeparatorRenderer.prototype.decorate=function(a,b){b=goog.ui.ToolbarSeparatorRenderer.superClass_.decorate.call(this,a,b);goog.dom.classlist.add(b,goog.ui.INLINE_BLOCK_CLASSNAME);return b};goog.ui.ToolbarSeparatorRenderer.prototype.getCssClass=function(){return goog.ui.ToolbarSeparatorRenderer.CSS_CLASS};goog.ui.decorate=function(a){var b=goog.ui.registry.getDecorator(a);b&&b.decorate(a);return b};goog.events.KeyHandler=function(a,b){goog.events.EventTarget.call(this);a&&this.attach(a,b)};goog.inherits(goog.events.KeyHandler,goog.events.EventTarget);goog.events.KeyHandler.prototype.element_=null;goog.events.KeyHandler.prototype.keyPressKey_=null;goog.events.KeyHandler.prototype.keyDownKey_=null;goog.events.KeyHandler.prototype.keyUpKey_=null;goog.events.KeyHandler.prototype.lastKey_=-1;goog.events.KeyHandler.prototype.keyCode_=-1;goog.events.KeyHandler.prototype.altKey_=!1;
...
!0):!1};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(a){var b=goog.style.isRightToLeft(a);return b&&goog.userAgent.GECKO?-a.scrollLeft:!b||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(a)?a.scrollLeft:a.scrollWidth-a.clientWidth-a.scrollLeft};
...
goog.ui.ModalPopup.prototype.getBackgroundIframe=function(){return this.bgIframeEl_};goog.ui.ModalPopup.prototype.getBackgroundElement=function(){return this.bgEl_};goog.ui.ModalPopup.prototype.createDom=function(){goog.ui.ModalPopup.superClass_.createDom.call(this);var a=this.getElement(),b=goog.string.trim(this.getCssClass()).split(" ");goog.dom.classlist.addAll(a,b);goog.dom.setFocusableTabIndex(a,!0);goog.style.setElementShown(a,!1);this.manageBackgroundDom_();this.createTabCatcher_()};
...
goog.ui.ModalPopup.prototype.decorateInternal=function(a){goog.ui.ModalPopup.superClass_.decorateInternal.call(this,a);a=goog.string.trim(this.getCssClass()).split(" ");goog.dom.classlist.addAll(this.getElement(),a);this.manageBackgroundDom_();this.createTabCatcher_();goog.style.setElementShown(this.getElement(),!1)};
...
goog.ui.Dialog.prototype.setDraggingEnabled_=function(a){var b=goog.string.trim(this.class_+"-title-draggable").split(" ");this.getElement()&&(a?goog.dom.classlist.addAll(this.titleEl_,b):goog.dom.classlist.removeAll(this.titleEl_,b));a&&!this.dragger_?(this.dragger_=this.createDragger(),goog.dom.classlist.addAll(this.titleEl_,b),goog.events.listen(this.dragger_,goog.fx.Dragger.EventType.START,this.setDraggerLimits_,!1,this)):!a&&this.dragger_&&(this.dragger_.dispose(),this.dragger_=null)};
...
goog.ui.editor.AbstractDialog.Builder.prototype.addClassName=function(a){goog.dom.classlist.add(this.wrappedDialog_.getDialogElement(),a);return this};goog.ui.editor.AbstractDialog.Builder.prototype.setContent=function(a){goog.dom.appendChild(this.wrappedDialog_.getContentElement(),a);return this};
goog.ui.editor.AbstractDialog.Builder.prototype.build=function(){this.buttonSet_.isEmpty()&&(this.addOkButton(),this.addCancelButton());this.wrappedDialog_.setButtonSet(this.buttonSet_);var a=this.buttonHandlers_;this.buttonHandlers_=null;this.wrappedDialog_.listen(goog.ui.Dialog.EventType.SELECT,function(b){if(a[b.key])return a[b.key](b)});this.wrappedDialog_.setModal(!0);var b=this.wrappedDialog_;this.wrappedDialog_=null;return b};goog.ui.editor.AbstractDialog.prototype.getOkButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.OK)};
goog.ui.editor.AbstractDialog.prototype.getCancelButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.CANCEL)};goog.ui.editor.AbstractDialog.prototype.getButtonElement=function(a){return this.dialogInternal_.getButtonSet().getButton(a)};goog.ui.editor.AbstractDialog.prototype.handleOk=function(a){return(a=this.createOkEvent(a))?this.dispatchEvent(a):!1};goog.ui.editor.AbstractDialog.prototype.handleCancel=function(){return this.dispatchEvent(goog.ui.editor.AbstractDialog.EventType.CANCEL)};
goog.ui.editor.AbstractDialog.prototype.disposeInternal=function(){this.dialogInternal_&&(this.hide(),this.dialogInternal_.dispose(),this.dialogInternal_=null);goog.ui.editor.AbstractDialog.superClass_.disposeInternal.call(this)};goog.ui.editor.AbstractDialog.prototype.handleAfterHide_=function(){this.dispatchEvent(goog.ui.editor.AbstractDialog.EventType.AFTER_HIDE)};goog.events.InputHandler=function(a){goog.events.EventTarget.call(this);this.element_=a;a=goog.userAgent.IE||goog.userAgent.WEBKIT&&!goog.userAgent.isVersionOrHigher("531")&&"TEXTAREA"==a.tagName;this.eventHandler_=new goog.events.EventHandler(this);this.eventHandler_.listen(this.element_,a?["keydown","paste","cut","drop","input"]:"input",this)};goog.inherits(goog.events.InputHandler,goog.events.EventTarget);goog.events.InputHandler.EventType={INPUT:"input"};
...
goog.dom.iter.AncestorIterator.prototype.next=function(){var a=this.node_;if(!a)throw goog.iter.StopIteration;this.node_=a.parentNode;return a};goog.editor.node={};
...
goog.dom.AbstractRange.prototype.setBrowserRangeObject=function(a){return!1};goog.dom.AbstractRange.prototype.getTextRanges=function(){for(var a=[],b=0,c=this.getTextRangeCount();b<c;b++)a.push(this.getTextRange(b));return a};goog.dom.AbstractRange.prototype.getContainerElement=function(){var a=this.getContainer();return a.nodeType==goog.dom.NodeType.ELEMENT?a:a.parentNode};goog.dom.AbstractRange.prototype.getAnchorNode=function(){return this.isReversed()?this.getEndNode():this.getStartNode()};
...
goog.dom.TextRangeIterator.prototype.clone=function(){var a=new goog.dom.TextRangeIterator(this.startNode_,this.startOffset_,this.endNode_,this.endOffset_,this.isReversed_);a.copyFrom(this);return a};goog.string.StringBuffer=function(a,b){null!=a&&this.append.apply(this,arguments)};goog.string.StringBuffer.prototype.buffer_="";goog.string.StringBuffer.prototype.set=function(a){this.buffer_=""+a};goog.string.StringBuffer.prototype.append=function(a,b,c){this.buffer_+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.buffer_+=arguments[d];return this};goog.string.StringBuffer.prototype.clear=function(){this.buffer_=""};goog.string.StringBuffer.prototype.getLength=function(){return this.buffer_.length};
goog.string.StringBuffer.prototype.toString=function(){return this.buffer_};goog.dom.browserrange={};goog.dom.browserrange.AbstractRange=function(){};goog.dom.browserrange.AbstractRange.prototype.getStartPosition=function(){goog.asserts.assert(this.range_.getClientRects,"Getting selection coordinates is not supported.");var a=this.range_.getClientRects();return a.length?new goog.math.Coordinate(a[0].left,a[0].top):null};
goog.dom.browserrange.AbstractRange.prototype.getEndPosition=function(){goog.asserts.assert(this.range_.getClientRects,"Getting selection coordinates is not supported.");var a=this.range_.getClientRects();return a.length?(a=goog.array.peek(a),new goog.math.Coordinate(a.right,a.bottom)):null};
goog.dom.browserrange.AbstractRange.prototype.containsRange=function(a,b){var c=b&&!a.isCollapsed(),d=a.getBrowserRange(),e=goog.dom.RangeEndpoint.START,f=goog.dom.RangeEndpoint.END;try{return c?0<=this.compareBrowserRangeEndpoints(d,f,e)&&0>=this.compareBrowserRangeEndpoints(d,e,f):0<=this.compareBrowserRangeEndpoints(d,f,f)&&0>=this.compareBrowserRangeEndpoints(d,e,e)}catch(g){if(!goog.userAgent.IE)throw g;return!1}};
...
(b=c.lastIndexOf("<"),a.append(b?c.substr(0,b):c))))},this);return a.toString()};goog.dom.browserrange.AbstractRange.prototype.__iterator__=function(a){return new goog.dom.TextRangeIterator(this.getStartNode(),this.getStartOffset(),this.getEndNode(),this.getEndOffset())};goog.dom.browserrange.W3cRange=function(a){this.range_=a};goog.inherits(goog.dom.browserrange.W3cRange,goog.dom.browserrange.AbstractRange);
...
goog.dom.browserrange.WebKitRange.prototype.selectInternal=function(a,b){a.removeAllRanges();b?a.setBaseAndExtent(this.getEndNode(),this.getEndOffset(),this.getStartNode(),this.getStartOffset()):a.setBaseAndExtent(this.getStartNode(),this.getStartOffset(),this.getEndNode(),this.getEndOffset())};goog.dom.browserrange.IeRange=function(a,b){this.range_=a;this.doc_=b};goog.inherits(goog.dom.browserrange.IeRange,goog.dom.browserrange.AbstractRange);goog.dom.browserrange.IeRange.logger_=goog.log.getLogger("goog.dom.browserrange.IeRange");
...
goog.dom.browserrange.IeRange.prototype.getEndpointNode_=function(a,b){var c=b||this.getContainer();if(!c||!c.firstChild)return c;for(var d=goog.dom.RangeEndpoint.START,e=goog.dom.RangeEndpoint.END,f=a==d,g=0,h=c.childNodes.length;g<h;g++){var k=f?g:h-g-1,l=c.childNodes[k],m;try{m=goog.dom.browserrange.createRangeFromNodeContents(l)}catch(n){continue}var p=m.getBrowserRange();if(this.isCollapsed())if(!goog.dom.browserrange.canContainRangeEndpoint(l)){if(0==this.compareBrowserRangeEndpoints(p,d,d)){this.startOffset_=
this.endOffset_=k;break}}else{if(m.containsRange(this))return this.getEndpointNode_(a,l)}else{if(this.containsRange(m)){if(!goog.dom.browserrange.canContainRangeEndpoint(l)){f?this.startOffset_=k:this.endOffset_=k+1;break}return this.getEndpointNode_(a,l)}if(0>this.compareBrowserRangeEndpoints(p,d,e)&&0<this.compareBrowserRangeEndpoints(p,e,d))return this.getEndpointNode_(a,l)}}return c};
...
goog.dom.browserrange.OperaRange.createFromNodes=function(a,b,c,d){return new goog.dom.browserrange.OperaRange(goog.dom.browserrange.W3cRange.getBrowserRangeForNodes(a,b,c,d))};goog.dom.browserrange.OperaRange.prototype.selectInternal=function(a,b){a.collapse(this.getStartNode(),this.getStartOffset());this.getEndNode()==this.getStartNode()&&this.getEndOffset()==this.getStartOffset()||a.extend(this.getEndNode(),this.getEndOffset());0==a.rangeCount&&a.addRange(this.range_)};goog.dom.browserrange.Error={NOT_IMPLEMENTED:"Not Implemented"};goog.dom.browserrange.createRange=function(a){return goog.userAgent.IE&&!goog.userAgent.isDocumentModeOrHigher(9)?new goog.dom.browserrange.IeRange(a,goog.dom.getOwnerDocument(a.parentElement())):goog.userAgent.WEBKIT?new goog.dom.browserrange.WebKitRange(a):goog.userAgent.GECKO?new goog.dom.browserrange.GeckoRange(a):goog.userAgent.OPERA?new goog.dom.browserrange.OperaRange(a):new goog.dom.browserrange.W3cRange(a)};
...
goog.dom.TextRange.prototype.clone=function(){var a=new goog.dom.TextRange;a.browserRangeWrapper_=this.browserRangeWrapper_;a.startNode_=this.startNode_;a.startOffset_=this.startOffset_;a.endNode_=this.endNode_;a.endOffset_=this.endOffset_;a.isReversed_=this.isReversed_;return a};goog.dom.TextRange.prototype.getType=function(){return goog.dom.RangeType.TEXT};goog.dom.TextRange.prototype.getBrowserRangeObject=function(){return this.getBrowserRangeWrapper_().getBrowserRange()};
...
goog.dom.TextRange.prototype.moveToNodes=function(a,b,c,d,e){this.startNode_=a;this.startOffset_=b;this.endNode_=c;this.endOffset_=d;this.isReversed_=e;this.browserRangeWrapper_=null};goog.dom.TextRange.prototype.isReversed=function(){return this.isReversed_};
goog.dom.TextRange.prototype.containsRange=function(a,b){var c=a.getType();return c==goog.dom.RangeType.TEXT?this.getBrowserRangeWrapper_().containsRange(a.getBrowserRangeWrapper_(),b):c==goog.dom.RangeType.CONTROL?(c=a.getElements(),(b?goog.array.some:goog.array.every)(c,function(a){return this.containsNode(a,b)},this)):!1};
...
c,">",a,"</",c,">")}return a};goog.dom.TextRange.prototype.__iterator__=function(a){return new goog.dom.TextRangeIterator(this.getStartNode(),this.getStartOffset(),this.getEndNode(),this.getEndOffset())};goog.dom.TextRange.prototype.select=function(){this.getBrowserRangeWrapper_().select(this.isReversed_)};goog.dom.TextRange.prototype.removeContents=function(){this.getBrowserRangeWrapper_().removeContents();this.clearCachedValues_()};
...
goog.dom.MultiRange.createFromTextRanges=function(a){var b=new goog.dom.MultiRange;b.ranges_=a;b.browserRanges_=goog.array.map(a,function(a){return a.getBrowserRangeObject()});return b};goog.dom.MultiRange.prototype.logger_=goog.log.getLogger("goog.dom.MultiRange");goog.dom.MultiRange.prototype.clearCachedValues_=function(){this.ranges_=[];this.container_=this.sortedRanges_=null};goog.dom.MultiRange.prototype.clone=function(){return goog.dom.MultiRange.createFromBrowserRanges(this.browserRanges_)};
...
goog.ui.TabBar.getOrientationFromLocation=function(a){return a==goog.ui.TabBar.Location.START||a==goog.ui.TabBar.Location.END?goog.ui.Container.Orientation.VERTICAL:goog.ui.Container.Orientation.HORIZONTAL};goog.ui.registry.setDecoratorByClassName(goog.ui.TabBarRenderer.CSS_CLASS,function(){return new goog.ui.TabBar});goog.ui.editor.TabPane=function(a,b){goog.ui.Component.call(this,a);this.eventHandler_=new goog.events.EventHandler(this);this.registerDisposable(this.eventHandler_);this.tabBar_=new goog.ui.TabBar(goog.ui.TabBar.Location.START,void 0,this.dom_);this.tabBar_.setFocusable(!1);this.tabContent_=this.dom_.createDom(goog.dom.TagName.DIV,{className:"goog-tab-content"});this.visibleContent_=this.selectedRadio_=null;if(b){var c=new goog.ui.Control(b,void 0,this.dom_);c.addClassName("tr-tabpane-caption");
c.setEnabled(!1);this.tabBar_.addChild(c,!0)}};goog.inherits(goog.ui.editor.TabPane,goog.ui.Component);goog.ui.editor.TabPane.prototype.getCurrentTabId=function(){return this.tabBar_.getSelectedTab().getId()};goog.ui.editor.TabPane.prototype.setSelectedTabId=function(a){this.tabBar_.setSelectedTab(this.tabBar_.getChild(a))};
goog.ui.editor.TabPane.prototype.addTab=function(a,b,c,d,e){d=this.dom_.createDom(goog.dom.TagName.INPUT,{name:d,type:"radio"});b=new goog.ui.Tab([d,this.dom_.createTextNode(b)],void 0,this.dom_);b.setId(a);b.setTooltip(c);this.tabBar_.addChild(b,!0);this.eventHandler_.listen(d,[goog.events.EventType.SELECT,goog.events.EventType.CLICK],goog.bind(this.tabBar_.setSelectedTab,this.tabBar_,b));e.id=a+"-tab";this.tabContent_.appendChild(e);goog.style.setElementShown(e,!1)};
goog.ui.editor.TabPane.prototype.enterDocument=function(){goog.ui.editor.TabPane.superClass_.enterDocument.call(this);var a=this.getElement();goog.dom.classlist.add(a,"tr-tabpane");this.addChild(this.tabBar_,!0);this.eventHandler_.listen(this.tabBar_,goog.ui.Component.EventType.SELECT,this.handleTabSelect_);a.appendChild(this.tabContent_);a.appendChild(this.dom_.createDom(goog.dom.TagName.DIV,{className:"goog-tab-bar-clear"}))};
goog.ui.editor.TabPane.prototype.handleTabSelect_=function(a){a=a.target;this.visibleContent_&&goog.style.setElementShown(this.visibleContent_,!1);this.visibleContent_=this.dom_.getElement(a.getId()+"-tab");goog.style.setElementShown(this.visibleContent_,!0);this.selectedRadio_&&(this.selectedRadio_.checked=!1);this.selectedRadio_=a.getElement().getElementsByTagName(goog.dom.TagName.INPUT)[0];this.selectedRadio_.checked=!0};goog.ui.FlatButtonRenderer=function(){goog.ui.ButtonRenderer.call(this)};goog.inherits(goog.ui.FlatButtonRenderer,goog.ui.ButtonRenderer);goog.addSingletonGetter(goog.ui.FlatButtonRenderer);goog.ui.FlatButtonRenderer.CSS_CLASS="goog-flat-button";
...
goog.ui.editor.messages.MSG_EMAIL_EXPLANATION=goog.getMsg("{$preb}Be careful.{$postb} Remember that any time you include an email address on a web page, nasty spammers can find it too.",{preb:"<b>",postb:"</b>"});goog.ui.editor.messages.MSG_OPEN_IN_NEW_WINDOW=goog.getMsg("Open this link in a new window");goog.ui.editor.messages.MSG_IMAGE_CAPTION=goog.getMsg("Image");goog.dom.selection={};goog.dom.selection.setStart=function(a,b){if(goog.dom.selection.useSelectionProperties_(a))a.selectionStart=b;else if(goog.userAgent.IE){var c=goog.dom.selection.getRangeIe_(a),d=c[0];d.inRange(c[1])&&(b=goog.dom.selection.canonicalizePositionIe_(a,b),d.collapse(!0),d.move("character",b),d.select())}};goog.dom.selection.getStart=function(a){return goog.dom.selection.getEndPoints_(a,!0)[0]};
...
goog.dom.selection.canonicalizePositionIe_=function(a,b){if("textarea"==a.type){var c=a.value.substring(0,b);b=goog.string.canonicalizeNewlines(c).length}return b};goog.dom.selection.useSelectionProperties_=function(a){try{return"number"==typeof a.selectionStart}catch(b){return!1}};goog.editor.focus={};goog.editor.focus.focusInputField=function(a){a.focus();goog.dom.selection.setCursorPosition(a,a.value.length)};goog.window={};goog.window.DEFAULT_POPUP_HEIGHT=500;goog.window.DEFAULT_POPUP_WIDTH=690;goog.window.DEFAULT_POPUP_TARGET="google_popup";
...
c+'">'),b.document.close()}else b=d.open(c,a,f);return b};goog.window.openBlank=function(a,b,c){a=a?goog.string.htmlEscape(a):"";return goog.window.open('javascript:"'+encodeURI(a)+'"',b,c)};goog.window.popup=function(a,b){b||(b={});b.target=b.target||a.target||goog.window.DEFAULT_POPUP_TARGET;b.width=b.width||goog.window.DEFAULT_POPUP_WIDTH;b.height=b.height||goog.window.DEFAULT_POPUP_HEIGHT;var c=goog.window.open(a,b);if(!c)return!0;c.focus();return!1};goog.ui.editor.LinkDialog=function(a,b){goog.ui.editor.AbstractDialog.call(this,a);this.targetLink_=b;this.eventHandler_=new goog.events.EventHandler(this)};goog.inherits(goog.ui.editor.LinkDialog,goog.ui.editor.AbstractDialog);goog.ui.editor.LinkDialog.EventType={BEFORE_TEST_LINK:"beforetestlink"};goog.ui.editor.LinkDialog.OkEvent=function(a,b,c,d){goog.events.Event.call(this,goog.ui.editor.AbstractDialog.EventType.OK);this.linkText=a;this.linkUrl=b;this.openInNewWindow=c;this.noFollow=d};
goog.inherits(goog.ui.editor.LinkDialog.OkEvent,goog.events.Event);goog.ui.editor.LinkDialog.BeforeTestLinkEvent=function(a){goog.events.Event.call(this,goog.ui.editor.LinkDialog.EventType.BEFORE_TEST_LINK);this.url=a};goog.inherits(goog.ui.editor.LinkDialog.BeforeTestLinkEvent,goog.events.Event);goog.ui.editor.LinkDialog.prototype.showOpenLinkInNewWindow_=!1;goog.ui.editor.LinkDialog.prototype.isOpenLinkInNewWindowChecked_=!1;goog.ui.editor.LinkDialog.prototype.showRelNoFollow_=!1;
goog.ui.editor.LinkDialog.prototype.setEmailWarning=function(a){this.emailWarning_=a};goog.ui.editor.LinkDialog.prototype.showOpenLinkInNewWindow=function(a){this.showOpenLinkInNewWindow_=!0;this.isOpenLinkInNewWindowChecked_=a};goog.ui.editor.LinkDialog.prototype.showRelNoFollow=function(){this.showRelNoFollow_=!0};
...
goog.ui.editor.LinkDialog.prototype.setAutogenFeatureEnabled=function(a){this.autogenFeatureEnabled_=a};goog.ui.editor.LinkDialog.hasNoFollow=function(a){return goog.ui.editor.LinkDialog.NO_FOLLOW_REGEX_.test(a)};goog.ui.editor.LinkDialog.removeNoFollow=function(a){return a.replace(goog.ui.editor.LinkDialog.NO_FOLLOW_REGEX_,"")};
...
goog.ui.editor.messages.MSG_EMAIL_ADDRESS,goog.ui.editor.messages.MSG_EMAIL_ADDRESS_TIP,goog.ui.editor.LinkDialog.BUTTON_GROUP_,this.buildTabEmailAddress_());this.tabPane_.render(a);this.eventHandler_.listen(this.tabPane_,goog.ui.Component.EventType.SELECT,this.onChangeTab_);this.showOpenLinkInNewWindow_&&a.appendChild(this.buildOpenInNewWindowDiv_());this.showRelNoFollow_&&a.appendChild(this.buildRelNoFollowDiv_());return a};
...
goog.ui.editor.LinkDialog.prototype.createOkEventFromWebTab_=function(){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT).value;if(goog.editor.Link.isLikelyEmailAddress(a))return this.createOkEventFromEmailTab_(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT);0>a.search(/:/)&&(a="http://"+goog.string.trimLeft(a));return this.createOkEventFromUrl_(a)};
...
goog.ui.editor.LinkDialog.prototype.onWebTestLink_=function(){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT).value;0>a.search(/:/)&&(a="http://"+goog.string.trimLeft(a));if(this.dispatchEvent(new goog.ui.editor.LinkDialog.BeforeTestLinkEvent(a))){var b=this.dom.getWindow(),c=goog.dom.getViewportSize(b),c={target:"_blank",width:Math.max(c.width-50,50),height:Math.max(c.height-50,50),toolbar:!0,scrollbars:!0,location:!0,statusbar:!1,menubar:!0,resizable:!0,noreferrer:this.stopReferrerLeaks_};
goog.window.open(a,c,b)}};goog.ui.editor.LinkDialog.prototype.onUrlOrEmailInputChange_=function(){this.autogenerateTextToDisplay_?this.setTextToDisplayFromAuto_():""==this.textToDisplayInput_.value&&this.setAutogenFlagFromCurInput_();this.syncOkButton_()};
goog.ui.editor.LinkDialog.prototype.onChangeTab_=function(a){a=this.dom.getElement(a.target.getId()+goog.ui.editor.LinkDialog.Id_.TAB_INPUT_SUFFIX);goog.editor.focus.focusInputField(a);a.style.width="";a.style.width=a.offsetWidth+"px";this.syncOkButton_();this.setTextToDisplayFromAuto_()};
goog.ui.editor.LinkDialog.prototype.setTextToDisplayFromAuto_=function(){if(this.autogenFeatureEnabled_&&this.autogenerateTextToDisplay_){var a=this.tabPane_.getCurrentTabId()+goog.ui.editor.LinkDialog.Id_.TAB_INPUT_SUFFIX;this.textToDisplayInput_.value=this.dom.getElement(a).value}};goog.ui.editor.LinkDialog.prototype.setAutogenFlag_=function(a){this.autogenerateTextToDisplay_=a};goog.ui.editor.LinkDialog.prototype.disableAutogenFlag_=function(a){this.setAutogenFlag_(!a);this.disableAutogen_=a};
...
goog.editor.Field.prototype.unregisterPlugin=function(a){var b=a.getTrogClassId();this.plugins_[b]||goog.log.error(this.logger,"Cannot unregister a plugin that isn't registered.");delete this.plugins_[b];for(var c in goog.editor.Plugin.OPCODE)a[goog.editor.Plugin.OPCODE[c]]&&goog.array.remove(this.indexedPlugins_[c],a);a.unregisterFieldObject(this)};goog.editor.Field.prototype.setInitialStyle=function(a){this.cssText=a};
...
this.usesIframe()){try{a=this.getEditableDomHelper().getWindow(),a.removeEventListener(goog.events.EventType.FOCUS,this.boundFocusListenerOpera_,!1),a.removeEventListener(goog.events.EventType.BLUR,this.boundBlurListenerOpera_,!1)}catch(c){}delete this.boundFocusListenerOpera_;delete this.boundBlurListenerOpera_}this.changeTimerGecko_&&this.changeTimerGecko_.stop();this.delayedChangeTimer_.stop()};
...
goog.editor.Field.cancelLinkClick_=function(a){goog.dom.getAncestorByTagNameAndClass(a.target,goog.dom.TagName.A)&&a.preventDefault()};goog.editor.Field.prototype.handleMouseDown_=function(a){goog.editor.Field.setActiveFieldId(this.id);if(goog.userAgent.IE){var b=a.target;b&&(b.tagName==goog.dom.TagName.A&&a.ctrlKey)&&this.originalDomHelper.getWindow().open(b.href)}this.waitingForMouseUp_=!0};goog.editor.Field.prototype.handleDragStart_=function(a){this.waitingForMouseUp_=!1};
goog.editor.Field.prototype.handleMouseUp_=function(a){if(!this.useWindowMouseUp_||this.waitingForMouseUp_)this.waitingForMouseUp_=!1,this.dispatchSelectionChangeEvent(a),goog.userAgent.IE&&(this.selectionChangeTarget_=a.target,this.selectionChangeTimer_.start())};
...
goog.editor.plugins.AbstractDialogPlugin.prototype.execCommandInternal=function(a,b){this.reuseDialog_||this.disposeDialog_();this.dialog_||(this.dialog_=this.createDialog(goog.dom.getDomHelper(this.getFieldObject().getAppWindow()),b));var c=this.getFieldObject().getRange();this.savedRange_=c&&goog.editor.range.saveUsingNormalizedCarets(c);goog.dom.Range.clearSelection(this.getFieldObject().getEditableDomHelper().getWindow());goog.events.listenOnce(this.dialog_,goog.ui.editor.AbstractDialog.EventType.AFTER_HIDE,
...
goog.editor.plugins.AbstractDialogPlugin.prototype.handleAfterHide=function(a){this.getFieldObject().setModalMode(!1);this.restoreOriginalSelection();this.reuseDialog_||this.disposeDialog_();this.dispatchEvent(goog.editor.plugins.AbstractDialogPlugin.EventType.CLOSED);this.getFieldObject().dispatchSelectionChangeEvent();this.getFieldObject().debounceEvent(goog.editor.Field.EventType.SELECTIONCHANGE)};
...
goog.editor.plugins.LinkDialogPlugin.prototype.createDialog=function(a,b){var c=new goog.ui.editor.LinkDialog(a,b);this.emailWarning_&&c.setEmailWarning(this.emailWarning_);this.showOpenLinkInNewWindow_&&c.showOpenLinkInNewWindow(this.isOpenLinkInNewWindowChecked_);this.showRelNoFollow_&&c.showRelNoFollow();c.setStopReferrerLeaks(this.stopReferrerLeaks_);this.eventHandler_.listen(c,goog.ui.editor.AbstractDialog.EventType.OK,this.handleOk).listen(c,goog.ui.editor.AbstractDialog.EventType.CANCEL,this.handleCancel_).listen(c,
goog.ui.editor.LinkDialog.EventType.BEFORE_TEST_LINK,this.handleBeforeTestLink);return c};goog.editor.plugins.LinkDialogPlugin.prototype.disposeInternal=function(){goog.editor.plugins.LinkDialogPlugin.superClass_.disposeInternal.call(this);this.eventHandler_.dispose()};
...
this.focusField_();return g};goog.editor.plugins.BasicTextFormatter.prototype.focusField_=function(){this.getFieldDomHelper().getWindow().focus()};
...
"x"),a.insertBefore(b,a.firstChild));return b};goog.editor.plugins.BasicTextFormatter.prototype.applyExecCommandGeckoFixes_=function(a){if(goog.userAgent.isVersionOrHigher("1.9")&&"formatblock"==a.toLowerCase()){a=this.getRange_();var b=a.getStartNode();if(a.isCollapsed()&&b&&b.tagName==goog.dom.TagName.BODY){var c=a.getStartOffset();(b=b.childNodes[c])&&b.tagName==goog.dom.TagName.BR&&(a=a.getBrowserRangeObject(),a.setStart(b,0),a.setEnd(b,0))}}};
...
goog.positioning.flipCornerHorizontal=function(a){return a^goog.positioning.CornerBit.RIGHT};goog.positioning.flipCornerVertical=function(a){return a^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(a){return a^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.ui.MenuRenderer=function(){goog.ui.ContainerRenderer.call(this)};goog.inherits(goog.ui.MenuRenderer,goog.ui.ContainerRenderer);goog.addSingletonGetter(goog.ui.MenuRenderer);goog.ui.MenuRenderer.CSS_CLASS="goog-menu";goog.ui.MenuRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.MENU};goog.ui.MenuRenderer.prototype.canDecorate=function(a){return"UL"==a.tagName||goog.ui.MenuRenderer.superClass_.canDecorate.call(this,a)};
...
goog.ui.MenuItem.prototype.setMnemonic=function(a){this.mnemonicKey_=a};goog.ui.MenuItem.prototype.getMnemonic=function(){return this.mnemonicKey_};goog.ui.registry.setDecoratorByClassName(goog.ui.MenuItemRenderer.CSS_CLASS,function(){return new goog.ui.MenuItem(null)});goog.ui.MenuHeaderRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.MenuHeaderRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.MenuHeaderRenderer);goog.ui.MenuHeaderRenderer.CSS_CLASS="goog-menuheader";goog.ui.MenuHeaderRenderer.prototype.getCssClass=function(){return goog.ui.MenuHeaderRenderer.CSS_CLASS};goog.ui.MenuHeader=function(a,b,c){goog.ui.Control.call(this,a,c||goog.ui.MenuHeaderRenderer.getInstance(),b);this.setSupportedState(goog.ui.Component.State.DISABLED,!1);this.setSupportedState(goog.ui.Component.State.HOVER,!1);this.setSupportedState(goog.ui.Component.State.ACTIVE,!1);this.setSupportedState(goog.ui.Component.State.FOCUSED,!1);this.setStateInternal(goog.ui.Component.State.DISABLED)};goog.inherits(goog.ui.MenuHeader,goog.ui.Control);
...
goog.ui.editor.DefaultToolbar.rtlButtonFactory_=function(a,b,c,d,e,f){var g=goog.ui.editor.ToolbarFactory.makeToggleButton(a,b,c,d,e,f);g.updateFromValue=function(a){a=!!a;goog.dom.classlist.enable(g.getParent().getElement(),"tr-rtl-mode",a);g.setChecked(a)};return g};goog.ui.editor.DefaultToolbar.undoRedoButtonFactory_=function(a,b,c,d,e,f){var g=goog.ui.editor.ToolbarFactory.makeButton(a,b,c,d,e,f);g.updateFromValue=function(a){g.setEnabled(a)};return g};
goog.ui.editor.DefaultToolbar.fontFaceFactory_=function(a,b,c,d,e,f){var g=goog.ui.editor.ToolbarFactory.makeSelectButton(a,b,c,d,e,f);goog.ui.editor.DefaultToolbar.addDefaultFonts(g);g.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FONT_NORMAL);goog.dom.classlist.add(g.getMenu().getContentElement(),"goog-menu-noaccel");g.updateFromValue=function(a){var b=null;a&&0<a.length&&(b=g.getMenu().getChild(goog.ui.editor.ToolbarFactory.getPrimaryFont(a)));a=g.getSelectedItem();b!=a&&g.setSelectedItem(b)};
return g};
goog.ui.editor.DefaultToolbar.fontSizeFactory_=function(a,b,c,d,e,f){var g=goog.ui.editor.ToolbarFactory.makeSelectButton(a,b,c,d,e,f);goog.ui.editor.DefaultToolbar.addDefaultFontSizes(g);g.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FONT_SIZE_NORMAL);goog.dom.classlist.add(g.getMenu().getContentElement(),"goog-menu-noaccel");g.updateFromValue=function(a){goog.isString(a)&&"px"==goog.style.getLengthUnits(a)&&(a=goog.ui.editor.ToolbarFactory.getLegacySizeFromPx(parseInt(a,10)));a=0<a?a:null;
a!=g.getValue()&&g.setValue(a)};return g};goog.ui.editor.DefaultToolbar.colorUpdateFromValue_=function(a,b){var c=b;try{if(goog.userAgent.IE)var d="000000"+c.toString(16),e=d.substr(d.length-6,6),c="#"+e.substring(4,6)+e.substring(2,4)+e.substring(0,2);c!=a.getValue()&&a.setValue(c)}catch(f){}};
...
goog.ui.editor.DefaultToolbar.formatBlockFactory_=function(a,b,c,d,e,f){var g=goog.ui.editor.ToolbarFactory.makeSelectButton(a,b,c,d,e,f);goog.ui.editor.DefaultToolbar.addDefaultFormatOptions(g);g.setDefaultCaption(goog.ui.editor.DefaultToolbar.MSG_FORMAT_NORMAL);goog.dom.classlist.add(g.getMenu().getContentElement(),"goog-menu-noaccel");g.updateFromValue=function(a){a=a&&0<a.length?a:null;a!=g.getValue()&&g.setValue(a)};return g};goog.ui.editor.DefaultToolbar.MSG_FORMAT_BLOCK_TITLE=goog.getMsg("Format");
...
(function(){for(var a=0,b;b=goog.ui.editor.DefaultToolbar.BUTTONS_[a];a++)goog.ui.editor.DefaultToolbar.buttons_[b.command]=b;delete goog.ui.editor.DefaultToolbar.BUTTONS_})();goog.text={};goog.text.LoremIpsum=function(){this.generateChains_(this.sample_);this.generateStatistics_(this.sample_);this.initializeDictionary_(this.dictionary_)};goog.text.LoremIpsum.DELIMITERS_SENTENCES_=[".","?","!"];goog.text.LoremIpsum.SENTENCE_SPLIT_REGEX_=/[\.\?\!]/;goog.text.LoremIpsum.DELIMITERS_WORDS_=[",",".","?","!"];goog.text.LoremIpsum.WORD_SPLIT_REGEX_=/\s/;
goog.text.LoremIpsum.prototype.generateChains_=function(a){a=goog.text.LoremIpsum.splitWords_(a);a=goog.array.map(a,goog.text.LoremIpsum.getWordInfo_);var b=[0,0],c=b.join("-"),d=new goog.structs.Map,e=[c],f={};goog.array.forEach(a,function(a){var h=d.get(c);h?h.push(a):(h=[a],d.set(c,h));goog.array.contains(goog.text.LoremIpsum.DELIMITERS_SENTENCES_,a[1])&&e.push(c);f[c]=b;b=[b[1],a[0]];c=b.join("-")});if(0<d.getCount())this.chains_=d,this.starts_=e,this.chainKeys_=f;else throw Error("Could not generate chains from sample text.");
};goog.text.LoremIpsum.prototype.generateStatistics_=function(a){this.generateSentenceStatistics_(a);this.generateParagraphStatistics_(a)};
goog.text.LoremIpsum.prototype.generateSentenceStatistics_=function(a){a=goog.array.filter(goog.text.LoremIpsum.splitSentences_(a),goog.text.LoremIpsum.isNotEmptyOrWhitepace_);a=goog.array.map(goog.array.map(a,goog.text.LoremIpsum.splitWords_),goog.text.LoremIpsum.arrayLength_);this.sentenceMean_=goog.math.average.apply(null,a);this.sentenceSigma_=goog.math.standardDeviation.apply(null,a)};
goog.text.LoremIpsum.prototype.generateParagraphStatistics_=function(a){a=goog.array.filter(goog.text.LoremIpsum.splitParagraphs_(a),goog.text.LoremIpsum.isNotEmptyOrWhitepace_);a=goog.array.map(goog.array.map(a,goog.text.LoremIpsum.splitSentences_),goog.text.LoremIpsum.arrayLength_);this.paragraphMean_=goog.math.average.apply(null,a);this.paragraphSigma_=goog.math.standardDeviation.apply(null,a)};
goog.text.LoremIpsum.prototype.initializeDictionary_=function(a){a=goog.text.LoremIpsum.splitWords_(a);var b=new goog.structs.Map;goog.array.forEach(a,function(a){var d=b.get(a.length);d||(d=new goog.structs.Set,b.set(a.length,d));d.add(a)});this.words_=b};goog.text.LoremIpsum.prototype.chooseRandomStart_=function(){var a=goog.text.LoremIpsum.randomChoice_(this.starts_);return this.chainKeys_[a]};
goog.text.LoremIpsum.prototype.generateSentence=function(a){if(0==this.chains_.getCount()||0==this.starts_.length)throw Error("No chains created");if(0==this.words_.getCount())throw Error("No dictionary");var b=goog.text.LoremIpsum.randomNormal_(this.sentenceMean_,this.sentenceSigma_),b=Math.max(Math.floor(b),1),c="";if(a){a=goog.text.LoremIpsum.splitWords_("lorem ipsum dolor sit amet, consecteteur adipiscing elit");a.length>b&&(a.length=b);var d=a[a.length-1],d=d.substring(d.length-1);goog.array.contains(goog.text.LoremIpsum.DELIMITERS_WORDS_,
d)&&(c=d)}else a=[];for(var d=[],e="";a.length<b;){this.chains_.containsKey(e)||(d=this.chooseRandomStart_(),e=d.join("-"));var c=goog.text.LoremIpsum.randomChoice_(this.chains_.get(e)),e=c[0],c=goog.array.contains(goog.text.LoremIpsum.DELIMITERS_SENTENCES_,c[1])?"":c[1],f=goog.text.LoremIpsum.chooseClosest(this.words_.getKeys(),e),f=goog.text.LoremIpsum.randomChoice_(this.words_.get(f).getValues());a.push(f+c);d=[d[1],e];e=d.join("-")}a=a.join(" ");a=a.slice(0,1).toUpperCase()+a.slice(1);a.substring(a.length-
1)==c&&(a=a.slice(0,a.length-1));return a+"."};goog.text.LoremIpsum.prototype.generateParagraph=function(a){for(var b=goog.text.LoremIpsum.randomNormal_(this.paragraphMean_,this.paragraphSigma_),b=Math.max(Math.floor(b),1),c=[];c.length<b;)a=this.generateSentence(a),c.push(a),a=!1;return c=c.join(" ")};goog.text.LoremIpsum.splitParagraphs_=function(a){return a.split("\n")};
goog.text.LoremIpsum.splitSentences_=function(a){return goog.array.filter(a.split(goog.text.LoremIpsum.SENTENCE_SPLIT_REGEX_),goog.text.LoremIpsum.isNotEmptyOrWhitepace_)};goog.text.LoremIpsum.splitWords_=function(a){return goog.array.filter(a.split(goog.text.LoremIpsum.WORD_SPLIT_REGEX_),goog.text.LoremIpsum.isNotEmptyOrWhitepace_)};goog.text.LoremIpsum.isNotEmptyOrWhitepace_=function(a){return 0<goog.string.trim(a).length};goog.text.LoremIpsum.arrayLength_=function(a){return a.length};
goog.text.LoremIpsum.chooseClosest=function(a,b){var c=a[0];goog.array.forEach(a,function(a){Math.abs(b-a)<Math.abs(b-c)&&(c=a)});return c};goog.text.LoremIpsum.getWordInfo_=function(a){var b;goog.array.some(goog.text.LoremIpsum.DELIMITERS_WORDS_,function(c){return goog.string.endsWith(a,c)?(b=[a.length-c.length,c],!0):!1});return b||[a.length,""]};goog.text.LoremIpsum.NV_MAGICCONST_=4*Math.exp(-0.5)/Math.sqrt(2);
goog.text.LoremIpsum.randomNormal_=function(a,b){for(;;){var c=Math.random(),d=1-Math.random(),c=goog.text.LoremIpsum.NV_MAGICCONST_*(c-0.5)/d;if(c*c/4<=-Math.log(d))break}return a+c*b};goog.text.LoremIpsum.randomChoice_=function(a){return a[goog.math.randomInt(a.length)]};goog.text.LoremIpsum.DICT_="a ac accumsan ad adipiscing aenean aliquam aliquet amet ante aptent arcu at auctor augue bibendum blandit class commodo condimentum congue consectetuer consequat conubia convallis cras cubilia cum curabitur curae cursus dapibus diam dictum dictumst dignissim dis dolor donec dui duis egestas eget eleifend elementum elit eni enim erat eros est et etiam eu euismod facilisi facilisis fames faucibus felis fermentum feugiat fringilla fusce gravida habitant habitasse hac hendrerit hymenaeos iaculis id imperdiet in inceptos integer interdum ipsum justo lacinia lacus laoreet lectus leo libero ligula litora lobortis lorem luctus maecenas magna magnis malesuada massa mattis mauris metus mi molestie mollis montes morbi mus nam nascetur natoque nec neque netus nibh nisi nisl non nonummy nostra nulla nullam nunc odio orci ornare parturient pede pellentesque penatibus per pharetra phasellus placerat platea porta porttitor posuere potenti praesent pretium primis proin pulvinar purus quam quis quisque rhoncus ridiculus risus rutrum sagittis sapien scelerisque sed sem semper senectus sit sociis sociosqu sodales sollicitudin suscipit suspendisse taciti tellus tempor tempus tincidunt torquent tortor tristique turpis ullamcorper ultrices ultricies urna ut varius ve vehicula vel velit venenatis vestibulum vitae vivamus viverra volutpat vulputate";
...
!goog.editor.node.isEditableContainer(k);){b=k.nodeName;if(b==goog.dom.TagName.TD||b==goog.dom.TagName.TR||b==goog.dom.TagName.TH)break;goog.dom.removeNode(k)}h.pasteHTML(a);(f=c.getElement(f))&&goog.dom.removeNode(f)}else if(goog.editor.BrowserFeature.HAS_W3C_RANGES){c.getDocument().execCommand("insertImage",!1,f);b=RegExp("<[^<]*"+f+"[^>]*>");k=this.getFieldObject().getRange().getContainerElement();k.nodeType==goog.dom.NodeType.TEXT&&(k=k.parentNode);for(;!b.test(k.innerHTML);)k=k.parentNode;if(goog.userAgent.GECKO)goog.editor.node.replaceInnerHtml(k,
k.innerHTML.replace(b,a));else{goog.editor.node.replaceInnerHtml(k,k.innerHTML.replace(b,g));for(k=f=c.getElement(f);(k=f.parentNode)&&goog.editor.node.isEmpty(k)&&!goog.editor.node.isEditableContainer(k);){b=k.nodeName;if(b==goog.dom.TagName.TD||b==goog.dom.TagName.TR||b==goog.dom.TagName.TH)break;goog.dom.insertSiblingAfter(f,k);goog.dom.removeNode(k)}goog.editor.node.replaceInnerHtml(k,k.innerHTML.replace(RegExp(g,"i"),a))}}a=c.getElement(d);c=c.getElement(e);goog.dom.Range.createFromNodes(a,0,
c,c.childNodes.length).select();goog.dom.removeNode(a);goog.dom.removeNode(c)};
goog.editor.plugins.RemoveFormatting.prototype.getHtmlText_=function(a){var b=this.getFieldDomHelper().createDom("div"),c=a.getBrowserRangeObject();if(goog.editor.BrowserFeature.HAS_W3C_RANGES)b.appendChild(c.cloneContents());else if(goog.editor.BrowserFeature.HAS_IE_RANGES){var d=a.getText(),d=d.replace(/\r\n/g,"\r"),e=d.length;a=e-goog.string.trimLeft(d).length;d=e-goog.string.trimRight(d).length;c.moveStart("character",a);c.moveEnd("character",-d);a=c.htmlText;"Formatted"==c.queryCommandValue("formatBlock")&&
...
1==a?this.openBubble_():2==a&&goog.dom.classlist.add(this.bubbleContainer_,"tr_multi_bubble");this.reposition();return f};goog.ui.editor.Bubble.prototype.removePanel=function(a){goog.dom.removeNode(this.panels_[a].element);delete this.panels_[a];a=goog.object.getCount(this.panels_);1>=a&&goog.dom.classlist.remove(this.bubbleContainer_,"tr_multi_bubble");0==a?this.closeBubble_():this.reposition()};
...
(c=this.positionAtAnchor_(a?goog.positioning.Corner.TOP_END:goog.positioning.Corner.TOP_START,goog.positioning.Corner.BOTTOM_START,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.FAIL_Y));c&goog.positioning.OverflowStatus.FAILED&&(c=this.positionAtAnchor_(a?goog.positioning.Corner.BOTTOM_END:goog.positioning.Corner.BOTTOM_START,goog.positioning.Corner.TOP_START,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.ADJUST_Y),c&goog.positioning.OverflowStatus.FAILED&&goog.log.warning(this.logger,
"reposition(): positionAtAnchor() failed with "+c))};goog.ui.editor.Bubble.prototype.positionAtAnchor_=function(a,b,c){var d=null,e;for(e in this.panels_){var f=this.panels_[e].targetElement;if(!d||goog.dom.contains(f,d))d=this.panels_[e].targetElement}return goog.positioning.positionAtAnchor(d,a,this.bubbleContainer_,b,null,goog.ui.editor.Bubble.MARGIN_BOX_,c)};
...
goog.editor.plugins.AbstractBubblePlugin.prototype.getSharedBubble_=function(){var a=this.bubbleParent_||this.getFieldObject().getAppWindow().document.body;this.dom_=goog.dom.getDomHelper(a);var b=goog.editor.plugins.AbstractBubblePlugin.bubbleMap_[this.getFieldObject().id];b||(b=(this.bubbleFactory_||goog.editor.plugins.AbstractBubblePlugin.globalBubbleFactory_).call(null,a,this.getFieldObject().getBaseZindex()),goog.editor.plugins.AbstractBubblePlugin.bubbleMap_[this.getFieldObject().id]=b);return b};
...
e.appendChild(g);goog.dom.appendChild(a,e)};goog.editor.plugins.LinkBubble.prototype.testLink=function(){goog.window.open(this.getTestLinkAction_(),{target:"_blank",noreferrer:this.stopReferrerLeaks_},this.getFieldObject().getAppWindow())};goog.editor.plugins.LinkBubble.prototype.isInvalidUrl=goog.functions.FALSE;
...
goog.editor.plugins.LinkBubble.prototype.deleteLink_=function(){this.getFieldObject().dispatchBeforeChange();var a=this.getTargetElement(),b=a.lastChild;goog.dom.flattenElement(a);goog.editor.range.placeCursorNextTo(b,!1);this.closeBubble();this.getFieldObject().dispatchChange();this.getFieldObject().focus()};
goog.editor.plugins.LinkBubble.prototype.onShow=function(){if(this.dom_.getElement(goog.editor.plugins.LinkBubble.LINK_DIV_ID_)){var a=this.dom_.getElement(goog.editor.plugins.LinkBubble.TEST_LINK_SPAN_ID_);if(a){var b=this.getTargetUrl();goog.style.setElementShown(a,!goog.editor.Link.isMailto(b))}for(a=0;a<this.extraActions_.length;a++){var b=this.extraActions_[a],c=this.dom_.getElement(b.spanId_);c&&goog.style.setElementShown(c,b.toShowFn_(this.getTargetUrl()))}}};
...
goog.editor.plugins.EnterHandler.prototype.deleteBrGecko=function(a){var b=this.getFieldObject().getRange();if(b.isCollapsed()){var c=b.getEndNode();if(c.nodeType==goog.dom.NodeType.ELEMENT&&(b=c.childNodes[b.getEndOffset()])&&b.tagName==goog.dom.TagName.BR){var d=goog.editor.node.getPreviousSibling(b),e=b.nextSibling;c.removeChild(b);a.preventDefault();e&&goog.editor.node.isBlockTag(e)&&(d&&d.tagName!=goog.dom.TagName.BR&&!goog.editor.node.isBlockTag(d)?goog.dom.Range.createCaret(d,goog.editor.node.getLength(d)).select():
(a=goog.editor.node.getLeftMostLeaf(e),goog.dom.Range.createCaret(a,0).select()))}}};
goog.editor.plugins.EnterHandler.prototype.handleKeyPress=function(a){if(goog.userAgent.GECKO&&this.getFieldObject().inModalMode())return!1;if(a.keyCode==goog.events.KeyCodes.BACKSPACE)this.handleBackspaceInternal(a,this.getFieldObject().getRange());else if(a.keyCode==goog.events.KeyCodes.ENTER)if(goog.userAgent.GECKO)a.shiftKey||this.handleEnterGecko_(a);else{this.getFieldObject().dispatchBeforeChange();var b=this.deleteCursorSelection_(),c=!!this.getFieldObject().execCommand(goog.editor.plugins.Blockquote.SPLIT_COMMAND,
b);c&&(a.preventDefault(),a.stopPropagation());this.releasePositionObject_(b);goog.userAgent.WEBKIT&&this.handleEnterWebkitInternal(a);this.processParagraphTagsInternal(a,c);this.getFieldObject().dispatchChange()}else goog.userAgent.GECKO&&a.keyCode==goog.events.KeyCodes.DELETE&&this.handleDeleteGecko(a);return!1};goog.editor.plugins.EnterHandler.prototype.handleKeyUp=function(a){if(goog.userAgent.GECKO&&this.getFieldObject().inModalMode())return!1;this.handleKeyUpInternal(a);return!1};
...
goog.editor.plugins.EnterHandler.prototype.ensureBlockIeOpera=function(a,b){for(var c=this.getFieldObject().getRange(),d=c.getContainer(),e=this.getFieldObject().getElement(),f;d&&d!=e;){var g=d.nodeName;if(g==a||goog.editor.plugins.EnterHandler.DO_NOT_ENSURE_BLOCK_NODES_[g]&&(!b||!goog.editor.plugins.EnterHandler.isBrElem(d))){if(goog.userAgent.OPERA&&f){g==a&&(f==d.lastChild&&goog.editor.node.isEmpty(f))&&(goog.dom.insertSiblingAfter(f,d),goog.dom.Range.createFromNodeContents(f).select());break}return}goog.userAgent.OPERA&&
(b&&g==goog.dom.TagName.P&&g!=a)&&(f=d);d=d.parentNode}if(goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher(9)){var h=!1,c=c.getBrowserRangeObject(),d=c.duplicate();d.moveEnd("character",1);d.text.length&&(h=d.parentElement(),d=d.duplicate(),d.collapse(!1),d=d.parentElement(),h=h!=d&&d!=c.parentElement())&&(c.move("character",-1),c.select())}this.getFieldObject().getEditableDomHelper().getDocument().execCommand("FormatBlock",!1,"<"+a+">");h&&(c.move("character",1),c.select())};
...
goog.editor.plugins.EnterHandler.prototype.deleteCursorSelectionW3C_=function(){var a=this.getFieldObject().getRange();if(!a.isCollapsed()){var b=!0;if(goog.userAgent.OPERA){var c=a.getStartNode(),d=a.getStartOffset();c==a.getEndNode()&&(c.lastChild&&c.lastChild.tagName==goog.dom.TagName.BR&&d==c.childNodes.length-1)&&(b=!1)}b&&goog.editor.plugins.EnterHandler.deleteW3cRange_(a)}return goog.editor.range.getDeepEndPoint(a,!0)};
...
!1),this.getFieldObject().dispatchSelectionChangeEvent()),a.preventDefault(),!0)};silex.view.TextEditor=function(a){this.element=a;this.initUI();this.closeEditor();a=new goog.ui.KeyboardShortcutHandler(document);a.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(a,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};
...
this.textField.registerPlugin(new goog.editor.plugins.HeaderFormatter);this.textField.registerPlugin(new goog.editor.plugins.LinkDialogPlugin);this.textField.registerPlugin(new goog.editor.plugins.LinkBubble);var a=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FONT_FACE),b=silex.Config.fonts,c;for(c in b)goog.ui.editor.ToolbarFactory.addFont(a,c,b[c].value);b=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FONT_SIZE);goog.ui.editor.ToolbarFactory.addFontSize(b,
"1","1");goog.ui.editor.ToolbarFactory.addFontSize(b,"2","2");goog.ui.editor.ToolbarFactory.addFontSize(b,"3","3");goog.ui.editor.ToolbarFactory.addFontSize(b,"4","4");goog.ui.editor.ToolbarFactory.addFontSize(b,"5","5");goog.ui.editor.ToolbarFactory.addFontSize(b,"6","6");goog.ui.editor.ToolbarFactory.addFontSize(b,"7","7");var a=goog.ui.editor.DefaultToolbar.makeToolbar([goog.editor.Command.BOLD,goog.editor.Command.ITALIC,goog.editor.Command.UNDERLINE,goog.editor.Command.FONT_COLOR,goog.editor.Command.BACKGROUND_COLOR,
a,b,goog.editor.Command.LINK,goog.editor.Command.UNDO,goog.editor.Command.REDO,goog.editor.Command.UNORDERED_LIST,goog.editor.Command.ORDERED_LIST,goog.editor.Command.INDENT,goog.editor.Command.OUTDENT,goog.editor.Command.JUSTIFY_LEFT,goog.editor.Command.JUSTIFY_CENTER,goog.editor.Command.JUSTIFY_RIGHT,goog.editor.Command.STRIKE_THROUGH,goog.editor.Command.REMOVE_FORMAT],goog.dom.getElementByClass("toolbar",this.element)),d=new goog.text.LoremIpsum,b=goog.ui.editor.ToolbarFactory.makeButton("loremIpsumBtn",
"insert lorem ipsum text","L");goog.events.listen(b,goog.ui.Component.EventType.ACTION,function(){var a=d.generateParagraph(!0),b=goog.dom.createElement("div");b.innerHTML=a;this.textField.getRange().replaceContentsWithNode(b)},!1,this);a.addChild(new goog.ui.ToolbarSeparator,!0);a.addChild(b,!0);new goog.ui.editor.ToolbarController(this.textField,a);goog.events.listen(this.textField,goog.editor.Field.EventType.DELAYEDCHANGE,function(){this.contentChanged()},!1,this);try{this.textField.makeEditable()}catch(e){console.error("error catched",
e)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);a=goog.dom.getElementByClass("dialogs-background");goog.events.listen(a,goog.events.EventType.CLICK,function(a){this.closeEditor()},!1,this)};
silex.view.TextEditor.prototype.openEditor=function(){silex.utils.JQueryEditable.getContainer();var a=getElementByClass(silex.model.Element.SELECTED_CLASS_NAME);this.textField.setHtml(!1,a);this.textField.focusAndPlaceCursorAtStart();a=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(a,"display","inherit");goog.style.setStyle(this.element,"display","inherit")};
silex.view.TextEditor.prototype.closeEditor=function(){var a=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(a,"display","none");goog.style.setStyle(this.element,"display","none")};silex.view.TextEditor.prototype.getData=function(){return this.textField.getCleanContents()};silex.view.TextEditor.prototype.contentChanged=function(){if(this.onStatus)this.onStatus({type:"changed",content:this.getData()})};silex.view.HTMLEditor=function(a,b){this.element=a;this.initUI();var c=new goog.ui.KeyboardShortcutHandler(document);c.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(c,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};
silex.view.HTMLEditor.prototype.initUI=function(){this.ace=ace.edit(goog.dom.getElementByClass("ace-editor",this.element));this.iAmSettingValue=!1;this.ace.getSession().setMode("ace/mode/html");this.ace.getSession().on("change",goog.bind(function(a){!1===this.iAmSettingValue&&(this.ace.getValue(),setTimeout(goog.bind(function(){this.contentChanged()},this),100))},this));goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},
!1,this)};silex.view.HTMLEditor.prototype.openEditor=function(a){var b=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(b,"display","inherit");goog.style.setStyle(this.element,"display","inherit");goog.events.listenOnce(b,goog.events.EventType.CLICK,function(a){this.closeEditor()},!1,this);this.iAmSettingValue=!0;this.ace.setValue(a);this.iAmSettingValue=!1;this.ace.resize()};
silex.view.HTMLEditor.prototype.closeEditor=function(){var a=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(a,"display","none");goog.style.setStyle(this.element,"display","none")};silex.view.HTMLEditor.prototype.getData=function(){return this.ace.getValue()};silex.view.HTMLEditor.prototype.contentChanged=function(){if(this.onStatus)this.onStatus({type:"changed",content:this.getData()})};silex.view.Workspace=function(a,b,c,d,e,f,g,h,k){this.element=a;this.menuElement=b;this.stageElement=c;this.pageToolElement=d;this.propertiesToolElement=e;this.htmlEditorElement=f;this.textEditorElement=g;this.fileExplorerElement=h;this.publishSettingsElement=k;this.viewport=new goog.dom.ViewportSizeMonitor;goog.events.listen(this.viewport,goog.events.EventType.RESIZE,function(a){this.invalidate()},!1,this);this.isDirty=!1;this.invalidate()};
silex.view.Workspace.prototype.invalidate=function(){!1===this.isDirty&&(this.isDirty=!0,this.redraw())};silex.view.Workspace.prototype.redraw=function(){!1===this.isDirty&&console.warn("Do not call redraw directly, use invalidate() instead");var a=this;setTimeout(function(){a.doRedraw()},400)};
silex.view.Workspace.prototype.doRedraw=function(){this.isDirty=!1;var a=this.viewport.getSize(),b=goog.style.getSize(this.pageToolElement),c=goog.style.getSize(this.propertiesToolElement),d=goog.style.getSize(this.menuElement);goog.style.setWidth(this.stageElement,a.width-b.width-c.width);b=a.height-d.height;goog.style.setHeight(this.pageToolElement,b);goog.style.setHeight(this.propertiesToolElement,b);goog.style.setHeight(this.stageElement,b);this.htmlEditorElement&&(c=goog.style.getSize(this.htmlEditorElement),
b=(a.width-c.width)/2,c=(a.height-c.height)/2,goog.style.setPosition(this.htmlEditorElement,b,c));this.textEditorElement&&(c=goog.style.getSize(this.textEditorElement),b=(a.width-c.width)/2,c=(a.height-c.height)/2,goog.style.setPosition(this.textEditorElement,b,c));this.fileExplorerElement&&(c=goog.style.getSize(this.fileExplorerElement),b=(a.width-c.width)/2,c=(a.height-c.height)/2,goog.style.setPosition(this.fileExplorerElement,b,c));this.publishSettingsElement&&(c=goog.style.getSize(this.publishSettingsElement),
b=(a.width-c.width)/2,c=(a.height-c.height)/2,goog.style.setPosition(this.publishSettingsElement,b,c));goog.dom.classes.has(document.body,"loading-pending")&&goog.dom.classes.remove(document.body,"loading-pending")};goog.ui.MenuBarRenderer=function(){goog.ui.ContainerRenderer.call(this)};goog.inherits(goog.ui.MenuBarRenderer,goog.ui.ContainerRenderer);goog.addSingletonGetter(goog.ui.MenuBarRenderer);goog.ui.MenuBarRenderer.CSS_CLASS="goog-menubar";goog.ui.MenuBarRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.MENUBAR};goog.ui.MenuBarRenderer.prototype.getCssClass=function(){return goog.ui.MenuBarRenderer.CSS_CLASS};goog.ui.MenuBarRenderer.prototype.getDefaultOrientation=function(){return goog.ui.Container.Orientation.HORIZONTAL};goog.ui.menuBar={};goog.ui.menuBar.create=function(a,b){return new goog.ui.Container(null,a?a:goog.ui.MenuBarRenderer.getInstance(),b)};silex.view.Menu=function(a){this.element=a;this.buildMenu(a)};
silex.view.Menu.prototype.buildMenu=function(a){this.menu=goog.ui.menuBar.create();var b=new goog.ui.KeyboardShortcutHandler(document),c=[];for(i in silex.Config.menu.names){var d=new goog.ui.Menu;goog.array.forEach(silex.Config.menu.options[i],function(a){var e;if(a){var f=a.id;e=new goog.ui.MenuItem(a.label);e.setId(f);e.addClassName(a.className);a.checkable&&e.setCheckable(!0);a.mnemonic&&e.setMnemonic(a.mnemonic);if(a.shortcut)for(var l in a.shortcut)b.registerShortcut(a.id,a.shortcut[l]),a.globalKey&&
c.push(a.globalKey)}else e=new goog.ui.MenuSeparator;d.addItem(e);a&&a.tooltip&&(f=goog.dom.createElement("span"),f.innerHTML=a.tooltip,f.className="goog-menuitem-accel",e.getElement().appendChild(f))},this);var e=silex.Config.menu.names[i],f=new goog.ui.MenuButton(e.label,d);f.addClassName(e.className);f.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);this.menu.addChild(f,!0)}b.setAlwaysPreventDefault(!1);b.setModifierShortcutsAreGlobal(!1);b.setGlobalKeys(c);goog.events.listen(b,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,
goog.bind(function(a){a.preventDefault();this.onMenuEvent(a.identifier)},this));e=new goog.events.KeyHandler(document);goog.events.listen(e,"key",goog.bind(function(a){a.keyCode===goog.events.KeyCodes.ENTER&&("INPUT"!==a.target.tagName&&a.target.tagName!==b.textInputs_[a.target.type])&&(a.preventDefault(),this.onMenuEvent("view.open.textEditor"))},this));this.menu.render(a);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,function(a){this.onClick(a)},!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),
goog.events.EventType.CLICK,function(a){this.onClick(a)},!1,this)};silex.view.Menu.prototype.onClick=function(a){if(this.onStatus&&a&&a.target)if(goog.dom.classes.has(a.target,"website-name"))this.onMenuEvent("title.changed");else this.onMenuEvent(a.target.getId())};silex.view.Menu.prototype.onMenuEvent=function(a){if(this.onStatus)this.onStatus({type:a})};silex.view.Menu.prototype.setWebsiteName=function(a){goog.dom.getElementByClass("website-name").innerHTML=a};
silex.view.Menu.prototype.getWebsiteName=function(){return goog.dom.getElementByClass("website-name").innerHTML};silex.service.Tracker=function(){ga||console.error("google analytcs not loaded")};silex.service.Tracker.SILEX_ACTIONS_CATEGORY="silex-event";silex.service.Tracker.prototype.trackAction=function(a,b,c,d){ga("send","event",a,b,c,d,!0)};silex.Controller=function(a){this.tracker=new silex.service.Tracker;this.tracker.trackAction("silex-event/controller","start",null,2);this.app=a;this.app.selection.setComponent(this.app.file.getStageComponent());this.app.menu.onStatus=goog.bind(this.app.menuCallback,this);this.app.stage.onStatus=goog.bind(this.app.stageCallback,this);this.app.pageTool.onStatus=goog.bind(this.app.pageToolCallback,this);this.app.propertiesTool.onStatus=goog.bind(this.app.propertiesToolCallback,this);this.app.publishSettings.onStatus=
goog.bind(this.app.publishSettingsCallback,this);this.app.htmlEditor.onStatus=goog.bind(this.app.htmlEditorCallback,this);this.app.textEditor.onStatus=goog.bind(this.app.textEditorCallback,this);if(!silex.Config.debug.debugMode||silex.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure?"}};
silex.Controller.prototype.menuCallback=function(a){this.tracker.trackAction("controller-events","request",a.type,0);switch(a.type){case "title.changed":alertify.prompt("What is the name of your website?",goog.bind(function(a,b){a&&this.app.file.setTitle(b)},this),this.app.menu.getWebsiteName());break;case "file.new":this.app.file.newFile();break;case "file.saveas":this.app.file.saveAs(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",
a.type,1)},this),goog.bind(function(b){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events","error",a.type,-1)},this));break;case "file.publish.settings":this.app.publishSettings.openDialog();this.app.workspace.invalidate();break;case "file.publish":this.app.file.getPublicationPath()?this.app.file.publish(goog.bind(function(b){b&&!1==b.success?(console.error("Error: I did not manage to publish the file. (1)"),this.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
(b.message||b.code||"")),this.tracker.trackAction("controller-events","error",a.type,-1)):(this.notifySuccess("I am about to publish your site. This may take several minutes."),this.tracker.trackAction("controller-events","success",a.type,1))},this),goog.bind(function(b){console.error("Error: I did not manage to publish the file. (2)",b);this.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
b);this.tracker.trackAction("controller-events","error",a.type,-1)},this)):alertify.alert('I do not know where to publish your site.             Select a folder in the settings pannel and do "publish" again.             <br /><br />Now I will open the publish settings.',goog.bind(function(){this.app.publishSettings.openDialog();this.app.workspace.invalidate()},this));break;case "file.save":this.app.file.getBlob()?this.app.file.save(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events",
"success",a.type,1)},this),goog.bind(function(b){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events","error",a.type,-1)},this)):this.app.file.saveAs(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",a.type,1)},this),goog.bind(function(b){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events",
"error",a.type,-1)},this));break;case "file.open":this.app.file.open(goog.bind(function(){this.notifySuccess(this.app.file.getTitle()+" opened.");this.app.selection.setComponent(this.app.file.getStageComponent());this.tracker.trackAction("controller-events","success",a.type,1)},this),goog.bind(function(b){this.notifyError("Error: I did not manage to open this file. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events","error",a.type,-1)},this));break;case "file.close":this.app.file.close();
this.app.selection.setComponent(null);break;case "view.file":this.app.file.view();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "tools.debug.activate":this.logger.getLevel()!==silex.Logger.ALL?this.logger.setLevel(silex.Logger.ALL):
this.logger.setLevel(silex.Logger.OFF);break;case "view.open.fileExplorer":this.app.fileExplorer.openDialog();this.app.workspace.invalidate();break;case "view.open.textEditor":this.editComponent();break;case "insert.page":this.createPage(goog.bind(function(){this.tracker.trackAction("controller-events","success",a.type,1)},this),goog.bind(function(){this.tracker.trackAction("controller-events","cancel",a.type,0)},this));break;case "insert.text":var b=this.app.file.getStageComponent().addText();this.app.selection.getPage().addComponent(b);
this.app.selection.setComponent(b);break;case "insert.html":b=this.app.file.getStageComponent().addHtml();this.app.selection.getPage().addComponent(b);this.app.selection.setComponent(b);break;case "insert.image":this.app.fileExplorer.openDialog(goog.bind(function(b){b=this.app.file.getStageComponent().addImage(b.url);this.app.selection.getPage().addComponent(b);this.app.selection.setComponent(b);this.tracker.trackAction("controller-events","success",a.type,1)},this),["image/*","text/plain"],goog.bind(function(b){this.notifyError("Error: I did not manage to load the image. <br /><br />"+
(b.message||""));this.tracker.trackAction("controller-events","error",a.type,-1)},this));this.app.workspace.invalidate();break;case "insert.container":b=this.app.file.getStageComponent().addContainer();this.app.selection.getPage().addComponent(b);this.app.selection.setComponent(b);break;case "edit.delete.selection":this.app.file.getStageComponent().remove(this.app.selection.getComponent());this.app.selection.setComponent(this.app.file.getStageComponent());break;case "edit.delete.page":this.removePage(this.app.selection.getPage());
break;case "edit.rename.page":this.renamePage(this.app.selection.getPage());break;case "help.about":window.open("http://www.silexlabs.org/silex/");break;case "help.aboutSilexLabs":window.open("http://www.silexlabs.org/silexlabs/");break;case "help.forums":window.open("http://graphicdesign.stackexchange.com/questions/tagged/silex");break;case "help.newsLetter":window.open("http://eepurl.com/F48q5");break;case "help.googlPlus":window.open("https://plus.google.com/communities/107373636457908189681");
break;case "help.twitter":window.open("http://twitter.com/silexlabs");break;case "help.facebook":window.open("http://www.facebook.com/silexlabs");break;case "help.forkMe":window.open("https://github.com/silexlabs/Silex")}};
silex.Controller.prototype.stageCallback=function(a){switch(a.type){case "select":var b=this.app.selection.getComponent();b&&b.setContext(silex.model.Component.CONTEXT_NORMAL);a.element?(this.app.selection.setComponent(new silex.model.Component(a.element,this.app.selection.getContext())),this.app.selection.getComponent().setContext(this.app.selection.getContext())):this.app.selection.setComponent(this.app.file.getStageComponent());break;case "change":this.app.selection.getComponent().setBoundingBox(this.app.selection.getComponent().getBoundingBox());
this.app.propertiesTool.redraw();break;case "newContainer":a=this.app.selection.getComponent();if(null!==a.getFirstPageableParent()){b=silex.model.Page.getPagesForElement(a.element);for(idx in b)b[idx].removeComponent(a);this.app.propertiesTool.redraw()}break;case "edit":this.editComponent()}};
silex.Controller.prototype.pageToolCallback=function(a){this.tracker.trackAction("controller-events","request",a.type,0);switch(a.type){case "changed":this.app.selection.setPage(a.page);a.page&&a.page.open();break;case "delete":this.removePage(a.page);break;case "rename":this.renamePage(a.page)}};silex.Controller.prototype.renamePage=function(a){this.getUserInputPageName(a.name,goog.bind(function(b){b&&a.rename(b);this.app.selection.getPage().open()},this))};
silex.Controller.prototype.removePage=function(a){alertify.confirm('I am about to delete the page "'+a.name+'", are you sure?',function(b){b&&a.detach()})};
silex.Controller.prototype.getUserInputPageName=function(a,b){alertify.prompt("Enter a name for your page!",function(a,d){if(a&&d&&0<d.length){d=d.replace(/\ /g,"-").replace(/\./g,"-").replace(/'/g,"-").replace(/"/g,"-").toLowerCase();var e=silex.model.Page.getPages(),f=null;goog.array.forEach(e,function(a){a.name===d&&(f=a)});f?f.open():b(d)}b(null)},a)};
silex.Controller.prototype.createPage=function(a,b){this.getUserInputPageName("My new page name",goog.bind(function(c){c?(c=new silex.model.Page(c,this.app.workspace,this.app.menu,this.app.stage,this.app.pageTool,this.app.propertiesTool,this.app.textEditor,this.app.fileExplorer),c.attach(),this.app.selection.setPage(c),c.open(),a&&a()):b&&b()},this))};
silex.Controller.prototype.publishSettingsCallback=function(a){switch(a.type){case "browsePublishPath":this.app.fileExplorer.openDialog(goog.bind(function(b){b=b.url.substring(b.url.indexOf("/api/v1.0/"),b.url.lastIndexOf("/"));b=b.replace("/exec/get","/exec/put");this.app.file.setPublicationPath(b);this.tracker.trackAction("controller-events","success",a.type,1)},this),null,goog.bind(function(b){this.notifyError("Error: I could not select the publish path. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events",
"error",a.type,-1)},this));break;case "change":this.app.file.setPublicationPath(a.data)}};
silex.Controller.prototype.propertiesToolCallback=function(a){switch(a.type){case "editHTML":this.editComponent();break;case "editText":this.editComponent();break;case "selectBgImage":this.app.fileExplorer.openDialog(goog.bind(function(b){this.app.propertiesTool.setBgImage(b.url);this.tracker.trackAction("controller-events","success",a.type,1)},this),["image/*","text/plain"],goog.bind(function(b){this.notifyError("Error: I could not load the image. <br /><br />"+(b.message||""));this.tracker.trackAction("controller-events",
"error",a.type,-1)},this));this.app.workspace.invalidate();break;case "selectImage":this.editComponent();break;case "contextChanged":this.app.selection.setContext(a.context);this.app.selection.getComponent().setContext(a.context);break;case "styleChanged":this.app.selection.getComponent().setStyle(a.style,a.context)}};silex.Controller.prototype.htmlEditorCallback=function(a){switch(a.type){case "changed":this.app.selection.getComponent().setHtml(a.content)}};
silex.Controller.prototype.textEditorCallback=function(a){switch(a.type){case "changed":this.app.selection.getComponent().setHtml(a.content),this.app.file.refreshFontList()}};
silex.Controller.prototype.editComponent=function(){var a=this.app.selection.getComponent();switch(a.type){case silex.model.Component.SUBTYPE_TEXT:this.app.textEditor.openEditor(a.getHtml());break;case silex.model.Component.SUBTYPE_HTML:this.app.htmlEditor.openEditor(a.getHtml());break;case silex.model.Component.SUBTYPE_IMAGE:this.app.fileExplorer.openDialog(goog.bind(function(a){this.app.propertiesTool.setImage(a.url)},this),["image/*","text/plain"],goog.bind(function(a){this.notifyError("Error: I did not manage to load the image. <br /><br />"+
(a.message||""))},this)),this.app.workspace.invalidate()}};silex.Controller.prototype.notifySuccess=function(a){console.info(a);alertify.success(a)};silex.Controller.prototype.notifyError=function(a){console.error(a);alertify.error(a)};silex.view.PublishSettings=function(a){this.element=a;this.publicationPath="";goog.style.setStyle(this.element,"display","none");a=new goog.ui.KeyboardShortcutHandler(document);a.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(a,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this));a=goog.dom.getElementByClass("close-btn",this.element);goog.events.listen(a,goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);a=goog.dom.getElementByClass("browse-btn",
this.element);goog.events.listen(a,goog.events.EventType.CLICK,function(){this.onStatus({type:"browsePublishPath"})},!1,this);var b=goog.dom.getElementByClass("input-publication-path");goog.events.listen(b,goog.ui.Component.EventType.CHANGE,function(){this.onStatus({type:"change",data:b.value})},!1,this)};silex.view.PublishSettings.prototype.redraw=function(){goog.dom.getElementByClass("input-publication-path").value=this.getPublicationPath()};
silex.view.PublishSettings.prototype.getPublicationPath=function(){var a=null;$('meta[name="publicationPath"]',this.headElement).each(function(){a=this.getAttribute("content")});return a};silex.view.PublishSettings.prototype.openDialog=function(a){this.onClose=a;a=goog.dom.getElementByClass("settings-background");goog.style.setStyle(a,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(a,goog.events.EventType.CLICK,this.closeEditor,!0,this);this.redraw()};
silex.view.PublishSettings.prototype.closeEditor=function(){if(this.onClose)this.onClose();var a=goog.dom.getElementByClass("settings-background");goog.style.setStyle(a,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(a,goog.events.EventType.CLICK,this.closeEditor,!0,this)};silex.model={};silex.model.File=function(){};silex.model.File.prototype.setPublicationPath=function(a){var b=!1;$('meta[name="publicationPath"]',this.headElement).each(function(){a&&""!==a?this.setAttribute("content",a):$(this).remove();b=!0});if(!b&&a&&""!==a){var c=goog.dom.createElement("meta");c.name="publicationPath";c.content=a;goog.dom.appendChild(this.headElement,c)}};
silex.model.File.prototype.getPublicationPath=function(){var a=null;$('meta[name="publicationPath"]',this.headElement).each(function(){a=this.getAttribute("content")});return a};silex.model.File.prototype.newFile=function(a,b){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,a,b)};silex.model.File.prototype.openFromUrl=function(a,b,c){silex.service.CloudStorage.getInstance().loadLocal(a,goog.bind(function(c){this.setUrl(a);this.setHtml(c);this.setBlob(null);b&&b()},this),c)};
silex.model.File.prototype.saveAs=function(a,b){this.fileExplorer.saveAsDialog(goog.bind(function(c){this.setUrl(c.url);this.setBlob(c);this.save(a,b)},this),["text/html","text/plain"],b);this.workspace.invalidate()};
silex.model.File.prototype.save=function(a,b){var c=this.getBlob();this.setBodyTag(this.getStageComponent().getHtml(c.url));this.setHeadTag(this.stage.getHead());this.setBodyStyle(this.stage.getBodyStyle());silex.service.CloudStorage.getInstance().save(c,this.getHtml(),function(){a&&a()},b)};
silex.model.File.prototype.open=function(a,b){this.fileExplorer.openDialog(goog.bind(function(c){silex.service.CloudStorage.getInstance().load(c,goog.bind(function(b){this.close();this.setUrl(c.url);this.setBlob(c);this.setHtml(b);a&&a()},this),b)},this),["text/html","text/plain"],b);this.workspace.invalidate()};
...
silex.model.File.prototype.refreshFontList=function(){var a=goog.dom.getElementsByTagNameAndClass("link");goog.array.forEach(a,function(a){-1!==a.getAttribute("href").indexOf("fonts")&&a.parentNode.removeChild(a)});var b=this.stage.headElement,a=goog.dom.getElementsByTagNameAndClass("link",null,b);goog.array.forEach(a,function(a){-1!==a.getAttribute("href").indexOf("fonts")&&a.parentNode.removeChild(a)});a=goog.dom.getElementsByTagNameAndClass("link",null,b);goog.array.forEach(a,function(a){-1!==
a.getAttribute("href").indexOf("fonts")&&a.parentNode.removeChild(a)});var c=this.getNeededFonts(),a=goog.dom.getElementsByTagNameAndClass("font",null,b);goog.array.forEach(a,function(a){null!==a.getAttribute("face")&&(c[a.getAttribute("face")]=!0)});var d=silex.Config.fonts,a=function(a){for(var b in d)if(d[b].value===a)return d[b];return null},e;for(e in c){var f=a(e);if(f&&void 0!==f.href){var g=goog.dom.createElement("link");g.setAttribute("href",f.href);g.setAttribute("rel","stylesheet");g.setAttribute("type",
"text/css");b.appendChild(g);g=goog.dom.createElement("link");g.setAttribute("href",f.href);g.setAttribute("rel","stylesheet");g.setAttribute("type","text/css");document.head.appendChild(g)}}};silex.model.File.prototype.getNeededFonts=function(){var a=[];this.getStageComponent().getHtml().replace(/<font[^"]*face="?([^"]*)"/g,function(b,c,d){a[c]=!0;return b});return a};silex.model.File.prototype.getStageComponent=function(){return new silex.model.Component(this.stage.bodyElement)};
silex.model.File.prototype.getBodyTag=function(){return this.bodyTag};silex.model.File.prototype.setBodyTag=function(a){this.bodyTag=a};silex.model.File.prototype.getHeadTag=function(){return this.headTag};silex.model.File.prototype.setHeadTag=function(a){this.headTag=a};silex.model.File.prototype.getUrl=function(){return this.url};silex.model.File.prototype.setUrl=function(a){this.url=a};silex.model.File.prototype.getBlob=function(){return this.blob};
silex.model.File.prototype.setBlob=function(a){(this.blob=a)?this.propertiesTool.setBaseUrl(a.url):this.propertiesTool.setBaseUrl(null)};silex.model.File.prototype.getBodyStyle=function(){return this.getStageComponent().relative2absolute(this.bodyStyle,this.getUrl())};silex.model.File.prototype.setBodyStyle=function(a){this.bodyStyle=this.getStageComponent().absolute2Relative(a,this.getUrl())};
silex.model.File.prototype.setHtml=function(a){for(var b=silex.model.Page.getPages();0<b.length;)b[0].detach();var b=a.toLowerCase(),c=b.indexOf("<head>");-1===c&&(c=b.indexOf("<head "));var d=b.indexOf("</head>"),e=b.indexOf("<body>");-1===e&&(e=b.indexOf("<body "));var f=b.indexOf("</body>");-1<c&&-1<d&&(c=b.indexOf(">",c),this.headTag=a.substring(c+1,d));-1<e&&-1<f&&(c=b.indexOf(">",e),this.bodyTag=a.substring(c+1,f));a=a.substring(e,f+1);b=a.indexOf('"');d=a.indexOf('"',b+1);this.bodyStyle=a.substring(b+
1,d);this.bodyStyle=this.getStageComponent().relative2absolute(this.bodyStyle,this.getUrl());this.getStageComponent().setHtml(this.bodyTag,this.getUrl());this.stage.setHead(this.headTag);this.stage.setBodyStyle(this.bodyStyle);a=this.stage.getPagesNamesFromDom();goog.array.forEach(a,function(a){a=new silex.model.Page(a,this.workspace,this.menu,this.stage,this.pageTool,this.propertiesTool,this.textEditor,this.fileExplorer);silex.model.Page.addPage(a)},this);b=silex.model.Page.getPages();this.pageTool.setPages(b);
this.propertiesTool.setPages(b);this.pageTool.setSelectedIndex(0);(a=this.getTitle())&&this.menu.setWebsiteName(a);this.setPublicationPath(this.getPublicationPath());this.refreshFontList();this.handleRetrocompatibility()};silex.model.File.prototype.getHtml=function(){var a=this.getBodyStyle(),b;b="<html>"+("<head>"+this.headTag+"</head>");b+='<body style="'+a+'">'+this.bodyTag+"</body>";return b+="</html>"};
silex.model.File.prototype.view=function(){this.getBlob()?window.open(this.getUrl()):alertify.confirm("The file has to be saved first. Save the file now?",goog.bind(function(a){a&&this.saveAs(goog.bind(function(){window.open(this.getUrl())},this))},this))};silex.model.File.prototype.getTitle=function(){var a=this.stage.headElement.getElementsByTagName("title");return a&&0<a.length?a[0].innerHTML:null};
silex.model.File.prototype.setTitle=function(a){var b=this.stage.headElement.getElementsByTagName("title");b&&0<b.length?b[0].innerHTML=a:(b=goog.dom.createElement("title"),b.innerHTML=a,this.stage.headElement.appendChild(b));this.menu.setWebsiteName(a)};
silex.model.File.prototype.handleRetrocompatibility=function(){var a=this;$('meta[name="page"]',this.stage.headElement).each(function(){var b=this.getAttribute("content"),b=new silex.model.Page(b,a.workspace,a.menu,a.stage,a.pageTool,a.propertiesTool,a.textEditor,a.fileExplorer);console.warn("retro compat in action",this,b);b.attach();$(this).remove()})};silex.model.File.prototype.setPublicationPath=function(a){""===a&&(a=null);this.publishSettings.setPublicationPath(a);this.stage.setPublicationPath(a)};
silex.model.File.prototype.getPublicationPath=function(){return this.stage.getPublicationPath()};silex.model.File.prototype.publish=function(a,b){this.getPublicationPath()?this.cleanup(goog.bind(function(c,d,e){silex.service.SilexTasks.getInstance().publish(this.getPublicationPath(),c,d,e,a,b)},this),goog.bind(function(a){console.error("publish cleanup error",a);b&&b(a)},this)):b&&b({message:"The publication path must be set before I can clean it up for you."})};
silex.model.File.prototype.cleanup=function(a,b){var c=this.getStageComponent().getHtml(),d=this.stage.getHead(),e=[],f=[];if(this.getBlob()){var g=this.getBlob().url,g=g.substring(0,g.lastIndexOf("/")+1),c=c.replace(/<img[^"]*src="?([^" ]*)"/g,function(a,b,c){c=silex.Helper.getAbsolutePath(b,g);var d=silex.Helper.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(d)||(d=d.replace("../","/"));var e="assets/"+c.substr(c.lastIndexOf("/")+1);f.push({url:c,destPath:e,srcPath:d});return a.replace(b,
e)}),c=c.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(a,b,c){return this.filterBgImage(g,f,a,b,c)},this)),d=d.replace(/href="?([^" ]*)"/g,function(a,b,c){var d=!1;c=silex.Helper.getAbsolutePath(b,g);var e=silex.Helper.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(e)?0!==c.indexOf("http://static.silex.me")&&(d=!0):e=e.replace("../","/");return d?a:(d="css/"+c.substr(c.lastIndexOf("/")+1),f.push({url:c,destPath:d,srcPath:e}),a.replace(b,d))}),d=d.replace(/src="?([^"]*)"/g,
function(a,b,c){var d=!1;c=silex.Helper.getAbsolutePath(b,g);var e=silex.Helper.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(e)?0!==c.indexOf("http://static.silex.me")&&(d=!0):e=e.replace("../","/");return d?a:(d="js/"+c.substr(c.lastIndexOf("/")+1),f.push({url:c,destPath:d,srcPath:e}),a.replace(b,d))}),h=goog.dom.createElement("div");h.innerHTML=c;c=goog.dom.createElement("div");c.innerHTML=d;$('meta[name="publicationPath"]',c).remove();d=goog.dom.getElementsByClass("editable-style",
h);goog.array.forEach(d,function(a){a=new silex.model.Component(a);var b=a.element.getAttribute("data-silex-href");b&&(a.element.setAttribute("href",b),a.element.removeAttribute("data-silex-href"),b=goog.dom.getOuterHtml(a.element),b="<a"+b.substring(4,b.length-6)+"</a>",b=goog.dom.htmlToDocumentFragment(b),goog.dom.insertSiblingBefore(b,a.element),goog.dom.removeNode(a.element),a.element=b)},this);var d=goog.dom.getElementsByClass("editable-style",h),k=0;goog.array.forEach(d,function(a){a=new silex.model.Component(a);
a.addClass("silex-"+a.type);var b="component-"+k++;a.addClass(b);var c=a.getCss(silex.model.Component.CONTEXT_NORMAL);e.push({classNames:["."+b],styles:c});a.hasStyle(silex.model.Component.CONTEXT_HOVER)&&(c=a.getCss(silex.model.Component.CONTEXT_HOVER),e.push({classNames:["."+b+":hover"],styles:c}));a.hasStyle(silex.model.Component.CONTEXT_PRESSED)&&(c=a.getCss(silex.model.Component.CONTEXT_PRESSED),e.push({classNames:["."+b+":pressed"],styles:c}));a.removeClass("editable-style");a.element.removeAttribute("data-silex-type");
a.element.removeAttribute("data-silex-sub-type");a.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_NORMAL);a.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_HOVER);a.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_PRESSED);a.element.removeAttribute("style")},this);d=this.stage.getBodyStyle();d=d.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(a,b,c){return this.filterBgImage(g,f,a,b,c)},this));e.push({classNames:["body"],styles:silex.Helper.stringToStyle(d)});
var l="";goog.array.forEach(e,function(a){var b="";goog.array.forEach(a.classNames,function(a){""!=b&&(b+=", ");b+=a},this);b+="{\n\t"+silex.Helper.styleToString(a.styles)+"\n}";l+="\n"+b},this);l.replace("; ",";\n\t");c="<html>"+('<head><link href="css/styles.css" rel="stylesheet">'+c.innerHTML+"</head>");c+="<body>"+h.innerHTML+"</body>";c+="</html>";a(c,l,f)}else b&&b({message:"The file must be saved before I can clean it up for you."})};
silex.model.File.prototype.filterBgImage=function(a,b,c,d,e){a=silex.Helper.getAbsolutePath(e,a);c=silex.Helper.getRelativePath(a,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(c)||(c=c.replace("../","/"));d="assets/"+a.substr(a.lastIndexOf("/")+1);e="url('../"+d+"')";b.push({url:a,destPath:d,srcPath:c});return e};goog.events.MouseWheelHandler=function(a,b){goog.events.EventTarget.call(this);this.element_=a;var c=goog.dom.isElement(this.element_)?this.element_:this.element_?this.element_.body:null;this.isRtl_=!!c&&goog.style.isRightToLeft(c);this.listenKey_=goog.events.listen(this.element_,goog.userAgent.GECKO?"DOMMouseScroll":"mousewheel",this,b)};goog.inherits(goog.events.MouseWheelHandler,goog.events.EventTarget);goog.events.MouseWheelHandler.EventType={MOUSEWHEEL:"mousewheel"};
...
goog.events.MouseWheelHandler.prototype.disposeInternal=function(){goog.events.MouseWheelHandler.superClass_.disposeInternal.call(this);goog.events.unlistenByKey(this.listenKey_);this.listenKey_=null};goog.events.MouseWheelEvent=function(a,b,c,d){goog.events.BrowserEvent.call(this,b);this.type=goog.events.MouseWheelHandler.EventType.MOUSEWHEEL;this.detail=a;this.deltaX=c;this.deltaY=d};goog.inherits(goog.events.MouseWheelEvent,goog.events.BrowserEvent);silex.view.Stage=function(a){this.element=a;this.initEvents()};
silex.view.Stage.prototype.initEvents=function(){goog.events.listen(this.element,"mousedown",function(a){if(this.onStatus)this.onStatus({type:"select",element:a.target});this.isDragging=!0},!1,this);goog.events.listen(document.body,"mouseup",function(a){if(this.isDragging){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1}},!1,this);goog.events.listen(this.element,"dragstop",function(a){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1},!1,this);goog.events.listen(this.element,
"resize",function(a){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1},!1,this);goog.events.listen(this.element,"newContainer",function(a){if(this.onStatus)this.onStatus({type:"newContainer"})},!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(a){if(this.onStatus)this.onStatus({type:"edit"})},!1,this);var a=new goog.events.MouseWheelHandler(this.element);goog.events.listen(a,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,function(a){0>a.deltaX&&
0>=this.element.scrollLeft&&a.preventDefault()},!1,this)};silex.App=function(){"silex"===window.location.href.slice(-5)&&(window.location.href+="/");window.location.hash="";var a=goog.dom.getElementByClass("silex-menu");this.menu=new silex.view.Menu(a);var b=goog.dom.getElementByClass("silex-stage");this.stage=new silex.view.Stage(b);var c=goog.dom.getElementByClass("silex-pagetool");this.pageTool=new silex.view.PageTool(c);var d=goog.dom.getElementByClass("silex-htmleditor");this.htmlEditor=new silex.view.HTMLEditor(d);var e=goog.dom.getElementByClass("silex-texteditor");
this.textEditor=new silex.view.TextEditor(e);var f=goog.dom.getElementByClass("silex-fileexplorer");this.fileExplorer=new silex.view.FileExplorer(f);var g=goog.dom.getElementByClass("silex-publishsettings");this.publishSettings=new silex.view.PublishSettings(g);var h=goog.dom.getElementByClass("silex-propertiestool"),k=goog.dom.getElementByClass("silex-workspace");this.workspace=new silex.view.Workspace(k,a,b,c,h,d,e,f,g);this.file=new silex.model.File;this.controller=new silex.Controller(this);file.newFile(function(){silex.Config.debug.debugMode&&
silex.Config.debug.doAfterReady&&silex.Config.debug.doAfterReady(this)})};goog.exportSymbol("silex.boot",silex.boot);
