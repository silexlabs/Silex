...
"error",c.type,-1)},this));this.workspace.invalidate();break;case "selectImage":this.editComponent();break;case "contextChanged":this.selection.setContext(c.context);this.selection.getComponent().setContext(c.context);break;case "styleChanged":this.selection.getComponent().setStyle(c.style,c.context)}};silex.Controller.prototype.htmlEditorCallback=function(c){switch(c.type){case "changed":this.selection.getComponent().setHtml(c.content)}};silex.Controller.prototype.textEditorCallback=function(c){switch(c.type){case "changed":this.selection.getComponent().setHtml(c.content)}};
...
goog.editor.Field.EventType.DELAYEDCHANGE,function(){this.contentChanged()},!1,this);try{this.textField.makeEditable()}catch(e){console.error("error catched",e)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
...
silex.model.File.prototype.close=function(){this.blob=this.url=null;this.bodyTag=this.headTag="";this.setHtml("");this.stage.setBody("");this.stage.setHead("");this.stage.setBodyStyle("");this.workspace.invalidate()};silex.model.File.prototype.getStageComponent=function(){return new silex.model.Component(this.stage.bodyElement)};silex.model.File.prototype.getBodyTag=function(){return this.bodyTag};silex.model.File.prototype.setBodyTag=function(c){this.bodyTag=c};
silex.model.File.prototype.getHeadTag=function(){return this.headTag};silex.model.File.prototype.setHeadTag=function(c){this.headTag=c};silex.model.File.prototype.getUrl=function(){return this.url};silex.model.File.prototype.setUrl=function(c){this.url=c};silex.model.File.prototype.getBlob=function(){return this.blob};silex.model.File.prototype.setBlob=function(c){(this.blob=c)?this.propertiesTool.setBaseUrl(c.url):this.propertiesTool.setBaseUrl(null)};silex.model.File.prototype.getBodyStyle=function(){return this.bodyStyle};
silex.model.File.prototype.setBodyStyle=function(c){this.bodyStyle=c};
