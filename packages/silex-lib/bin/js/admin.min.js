...
silex.model.Component.SUBTYPE_IMAGE){if(c=goog.dom.getElementByClass("image-url-button",d))e=new goog.ui.CustomButton,e.decorate(c),goog.events.listen(c,goog.events.EventType.CLICK,this.selectImage,!1);var f=goog.dom.getElementByClass("image-url-input",d);f&&goog.events.listen(f,"change",function(c){this.component&&!this.isRedraw&&this.component.type===silex.model.Component.SUBTYPE_IMAGE&&this.setImage(f.value)},!1,this)}goog.dom.classes.has(this.component.element,"editable-style")?(d=this.component.getBoundingBox(),
...
silex.view.PublishSettings.prototype.openDialog=function(c){this.openEditor(c);this.redraw()};silex.view.PublishSettings.prototype.openEditor=function(c){this.onClose=c;c=goog.dom.getElementByClass("settings-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};
...
silex.model.Component.prototype.setStyle=function(c,d){c||(c={});d||(d=this.context);var e="";goog.object.forEach(c,function(c,d,f){c&&("none"===c?c=null:e+=goog.string.toSelectorCase(d)+": "+c+"; ",f=c.replace(/\'/g,""),this.element.style[d]!==f&&goog.style.setStyle(this.element,d,c))},this);if(d===silex.model.Component.CONTEXT_NORMAL)var f=this.getBoundingBox(),e=e+("top: "+f.top+"; "),e=e+("left: "+f.left+"; "),e=e+("width: "+f.width+"; "),e=e+("height: "+f.height+"; "),e=e+("bottom: "+f.bottom+
"; "),e=e+("right: "+f.right+"; "),e=e+("z-index: "+f.zIndex+"; "),e=e+"position: absolute; ";""!==e?this.element.getAttribute("data-style-"+d)!==e&&this.element.setAttribute("data-style-"+d,e):this.element.removeAttribute("data-style-"+d)};
...
silex.model.File.prototype.save=function(c,d){var e=this.getBlob();this.setBodyTag(this.getStageComponent().getHtml(e.url));this.setHeadTag(this.stage.getHead());var f=this.getStageComponent().absolute2Relative(this.stage.getBodyStyle(),e.url);this.setBodyStyle(f);silex.service.CloudStorage.getInstance().save(e,this.getHtml(),function(){c&&c()},d)};
...
silex.model.File.prototype.refreshFontList=function(){var c=goog.dom.getElementsByTagNameAndClass("link");goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});var c=goog.dom.getElementsByClass("editable-style"),d={};goog.array.forEach(c,function(c){c=new silex.model.Component(c);c=[c.getStyle(silex.model.Component.CONTEXT_NORMAL),c.getStyle(silex.model.Component.CONTEXT_HOVER),c.getStyle(silex.model.Component.CONTEXT_PRESSED)];goog.array.forEach(c,
function(c){void 0!==c.fontFamily&&(d[c.fontFamily]=!0)})});c=goog.dom.getElementsByTagNameAndClass("font");goog.array.forEach(c,function(c){null!==c.getAttribute("face")&&(d[c.getAttribute("face")]=!0)});var e=silex.model.Config.fonts,c=document.head,f=function(c){for(var d in e)if(e[d].value===c)return e[d];return null},h;for(h in d){var k=f(h);if(k&&void 0!==k.href){var l=goog.dom.createElement("link");l.setAttribute("href",k.href);l.setAttribute("rel","stylesheet");l.setAttribute("type","text/css");
c.appendChild(l)}}};silex.model.File.prototype.getStageComponent=function(){return new silex.model.Component(this.stage.bodyElement)};silex.model.File.prototype.getBodyTag=function(){return this.bodyTag};silex.model.File.prototype.setBodyTag=function(c){this.bodyTag=c};silex.model.File.prototype.getHeadTag=function(){return this.headTag};silex.model.File.prototype.setHeadTag=function(c){this.headTag=c};silex.model.File.prototype.getUrl=function(){return this.url};
...
this.propertiesTool.setPages(d);this.pageTool.setSelectedIndex(0);(c=this.getTitle())&&this.menu.setWebsiteName(c);this.setPublicationPath(this.getPublicationPath());this.handleRetrocompatibility()};silex.model.File.prototype.getHtml=function(){var c=silex.Helper.stringToStyle(this.getBodyStyle()),c=silex.Helper.styleToString(c),d;d="<html>"+("<head>"+this.headTag+"</head>");d+='<body style="'+c+'">'+this.bodyTag+"</body>";return d+="</html>"};
...
h)}),e=e.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(c,d,e){console.log("filter",arguments);return this.filterBgImage(l,k,c,d,e)},this)),f=f.replace(/href="?([^" ]*)"/g,function(c,d,e){e=silex.Helper.getAbsolutePath(d,l);var f=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="css/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,h)}),f=f.replace(/src="?([^"]*)"/g,function(c,d,e){var f=!1;
e=silex.Helper.getAbsolutePath(d,l);var h=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="js/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),m=goog.dom.createElement("div");m.innerHTML=e;e=goog.dom.createElement("div");e.innerHTML=f;$('meta[name="publicationPath"]',e).remove();f=goog.dom.getElementsByClass("editable-style",m);goog.array.forEach(f,
function(c){c=new silex.model.Component(c);var d=c.element.getAttribute("data-silex-href");d&&(c.element.setAttribute("href",d),c.element.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c.element),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,c.element),goog.dom.removeNode(c.element),c.element=d)},this);var f=goog.dom.getElementsByClass("editable-style",m),n=0;goog.array.forEach(f,function(c){c=new silex.model.Component(c);c.addClass("silex-"+
c.type);var d="component-"+n++;c.addClass(d);var e=c.getCss(silex.model.Component.CONTEXT_NORMAL);h.push({classNames:["."+d],styles:e});c.hasStyle(silex.model.Component.CONTEXT_HOVER)&&(e=c.getCss(silex.model.Component.CONTEXT_HOVER),h.push({classNames:["."+d+":hover"],styles:e}));c.hasStyle(silex.model.Component.CONTEXT_PRESSED)&&(e=c.getCss(silex.model.Component.CONTEXT_PRESSED),h.push({classNames:["."+d+":pressed"],styles:e}));c.removeClass("editable-style");c.element.removeAttribute("data-silex-type");
