...
silex.service.CloudStorage.prototype.loadLocal=function(c,d,e){goog.net.XhrIo.send(c,function(c){c=c.target;var h=c.getResponse();if(c.isSuccess())(new goog.async.Delay(function(){d&&d(h)},10)).start();else{var k=c.getLastError();console.error(k,c,c.isSuccess(),c.getStatus(),c.headers.toString());e&&(console.error(FPError),e(k))}})};silex.boot=function(){var c=goog.dom.getElementByClass("silex-menu"),d=new silex.view.Menu(c,function(){var c=goog.dom.getElementByClass("silex-stage"),f=new silex.view.Stage(c,function(){var c=goog.dom.getElementByClass("silex-pagetool"),e=new silex.view.PageTool(c,function(){var c=goog.dom.getElementByClass("silex-propertiestool"),h=new silex.view.PropertiesTool(c,function(){var c=goog.dom.getElementByClass("silex-htmleditor"),l=new silex.view.HTMLEditor(c,function(){var c=goog.dom.getElementByClass("silex-texteditor"),
n=new silex.view.TextEditor(c,function(){var c=goog.dom.getElementByClass("silex-fileexplorer"),q=new silex.view.FileExplorer(c,function(){var c=goog.dom.getElementByClass("silex-publishsettings"),t=new silex.view.PublishSettings(c,function(){var c=goog.dom.getElementByClass("silex-workspace"),c=new silex.view.Workspace(c,d,f,e,h,l,n,q,t),u=new silex.model.File(c,d,f,e,h,l,n,q,t),w=new silex.model.Selection(c,d,f,e,h,l,n,q,t),x=new silex.Controller(c,d,f,e,h,l,n,q,t,u,w);u.newFile(function(){var c=
{url:"../api/v1.0/www/exec/get/temp.html"};silex.service.CloudStorage.getInstance().load(c,goog.bind(function(d){u.close();u.setUrl("../api/v1.0/www/exec/get/temp.html");u.setBlob(c);u.setHtml(d);x.menuCallback({type:"file.publish"})},this))})})})})})})})})})};goog.exportSymbol("silex.boot",silex.boot);
