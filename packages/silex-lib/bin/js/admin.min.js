...
default:return!1}};goog.events.KeyCodes.normalizeGeckoKeyCode=function(c){switch(c){case goog.events.KeyCodes.FF_EQUALS:return goog.events.KeyCodes.EQUALS;case goog.events.KeyCodes.FF_SEMICOLON:return goog.events.KeyCodes.SEMICOLON;case goog.events.KeyCodes.MAC_FF_META:return goog.events.KeyCodes.META;case goog.events.KeyCodes.WIN_KEY_FF_LINUX:return goog.events.KeyCodes.WIN_KEY;default:return c}};goog.debug={};goog.debug.Error=function(c){Error.captureStackTrace?Error.captureStackTrace(this,goog.debug.Error):this.stack=Error().stack||"";c&&(this.message=String(c))};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.asserts={};goog.asserts.ENABLE_ASSERTS=goog.DEBUG;goog.asserts.AssertionError=function(c,d){d.unshift(c);goog.debug.Error.call(this,goog.string.subs.apply(null,d));d.shift();this.messagePattern=c};goog.inherits(goog.asserts.AssertionError,goog.debug.Error);goog.asserts.AssertionError.prototype.name="AssertionError";goog.asserts.doAssertFailure_=function(c,d,e,f){var h="Assertion failed";if(e)var h=h+(": "+e),k=f;else c&&(h+=": "+c,k=d);throw new goog.asserts.AssertionError(""+h,k||[]);};
...
goog.positioning.flipCornerHorizontal=function(c){return c^goog.positioning.CornerBit.RIGHT};goog.positioning.flipCornerVertical=function(c){return c^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(c){return c^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.events.EventType={CLICK:"click",DBLCLICK:"dblclick",MOUSEDOWN:"mousedown",MOUSEUP:"mouseup",MOUSEOVER:"mouseover",MOUSEOUT:"mouseout",MOUSEMOVE:"mousemove",SELECTSTART:"selectstart",KEYPRESS:"keypress",KEYDOWN:"keydown",KEYUP:"keyup",BLUR:"blur",FOCUS:"focus",DEACTIVATE:"deactivate",FOCUSIN:goog.userAgent.IE?"focusin":"DOMFocusIn",FOCUSOUT:goog.userAgent.IE?"focusout":"DOMFocusOut",CHANGE:"change",SELECT:"select",SUBMIT:"submit",INPUT:"input",PROPERTYCHANGE:"propertychange",DRAGSTART:"dragstart",
...
RESPONSIVE:"responsive",SIZECHANGED:"sizechanged",UNRESPONSIVE:"unresponsive"};goog.a11y={};goog.a11y.aria={};
...
goog.events.wrapListener_=function(c){goog.asserts.assert(c,"Listener can not be null.");if(goog.isFunction(c))return c;goog.asserts.assert(c.handleEvent,"An object listener must have handleEvent method.");return c[goog.events.LISTENER_WRAPPER_PROP_]||(c[goog.events.LISTENER_WRAPPER_PROP_]=function(d){return c.handleEvent(d)})};goog.debug.entryPointRegistry.register(function(c){goog.events.handleBrowserEvent_=c(goog.events.handleBrowserEvent_)});goog.events.ListenerMap=function(c){this.src=c;this.listeners={};this.typeCount_=0};goog.events.ListenerMap.prototype.getTypeCount=function(){return this.typeCount_};goog.events.ListenerMap.prototype.getListenerCount=function(){var c=0,d;for(d in this.listeners)c+=this.listeners[d].length;return c};
...
goog.userAgent.product.SAFARI=goog.userAgent.product.PRODUCT_KNOWN_?goog.userAgent.product.ASSUME_SAFARI:goog.userAgent.product.detectedSafari_;goog.ui.registry={};goog.ui.registry.getDefaultRenderer=function(c){for(var d;c;){d=goog.getUid(c);if(d=goog.ui.registry.defaultRenderers_[d])break;c=c.superClass_?c.superClass_.constructor:null}return d?goog.isFunction(d.getInstance)?d.getInstance():new d:null};
