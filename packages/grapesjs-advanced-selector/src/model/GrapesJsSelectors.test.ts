...
describe('getSelectors', () => {
  ...
  test('component without selector should return the classes (getClasses)', () => {
    ...
    expect(result.mainSelector.selectors).toContainEqual({ type: SimpleSelectorType.CLASS, value: 'class-one', active: false })
    expect(result.mainSelector.selectors).toContainEqual({ type: SimpleSelectorType.CLASS, value: 'class-two', active: false })
