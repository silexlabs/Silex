 ...
 */
export function setCaret(el, _a) {
...
export function allowDrop(_a) {
    ...
    return !allParents.find(function (p) { return allChildren.find(function (c) { return getSymbolId(c) === getSymbolId(p); }); });
}
