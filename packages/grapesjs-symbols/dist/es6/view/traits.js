...
export default function (editor, options) {
    ...
    function unlink(component) {
        confirmDialog({
            ...
            primaryLabel: 'Unlink',
            cbk: function () {
                editor.runCommand(cmdUnlink, { component: component });
            },
            lsKey: 'unlink-symbol',
        });
    }
    ...
    editor.TraitManager.addType('symbol-trait', {
        ...
        createInput: function (_a) {
            ...
            Object.values(SymbolEvents).forEach(function (event) { return editor.on(event, function () { return updateUi(el); }); });
            // Initial ui update
            updateUi(el);
