...
var Symbol_1 = __importStar(require("./Symbol"));
var Symbols = /** @class */ (function (_super) {
    ...
    Symbols.prototype.onDrag = function (_a) {
        var target = _a.target, parent = _a.parent;
        if ((parent === null || parent === void 0 ? void 0 : parent.get('droppable')) && !(0, utils_1.allowDrop)({ target: target, parent: parent })) {
            // Prevent drop
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.updating)
                            return [2 /*return*/];
                        inst = (0, utils_1.closestInstance)(parent);
                        if (!inst) return [3 /*break*/, 4];
                        symbolId = (0, Symbol_1.getSymbolId)(inst);
    ...
    Symbols.prototype.onUpdateAttributes = function (c) {
        ...
        if (inst) {
            var symbolId = (0, Symbol_1.getSymbolId)(inst);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.updating)
                            return [2 /*return*/];
                        inst = (0, utils_1.closestInstance)(c);
                        if (!inst) return [3 /*break*/, 3];
                        symbolId = (0, Symbol_1.getSymbolId)(inst);
                        s_2 = this.get(symbolId);
                        if (!s_2) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, utils_1.wait)()]; // Needed for undo to work
                    case 1:
...
Symbols.prototype.model = Symbol_1.default;
