...
let StepsSelectorItem = class StepsSelectorItem extends LitElement {
    ...
    render() {
      ...
      <header part="header">
        ...
        <popin-form hidden ${ref(this.valuesPopin)} @click=${(e) => this.selectValue(e)}>
        ...
        ${this.noInfo ? '' : html `
          ...
          <popin-form hidden ${ref(this.helpTextPopin)}>
        ...
        <div class="buttons">
          ...
          <popin-form hidden no-auto-close ${ref(this.optionsPopin)} @submit=${(e) => this.selectOptions(e)} @reset=${() => this.cancelOptions()}>
