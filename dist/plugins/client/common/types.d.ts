...
export type ApiWebsiteForkQuery = {
    connectorId?: ConnectorId;
};
export type ApiWebsiteForkBody = {
    gitlabUrl: string;
};
export type ApiWebsiteForkResponse = {
    websiteId: WebsiteId;
    message: string;
};
...
export declare const EMPTY_PAGES: Page[];
export declare const EMPTY_WEBSITE: WebsiteData;
