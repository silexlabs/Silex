 ...
 */
export function selectBody(editor) {
 ...
 */
export function isTextOrInputField(element) {
    if (element.getAttribute('type') === 'submit')
        return false;
    const isInput = element.tagName === 'INPUT';
    const isOtherFormElement = ['TEXTAREA', 'OPTION', 'OPTGROUP', 'SELECT', 'BUTTON'].includes(element.tagName);
