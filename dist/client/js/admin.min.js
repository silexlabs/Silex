...
silex.utils.RetroCompat.process=function(c,d){var e=this;$("[data-style-normal]",c).each(function(){this.setAttribute("style",this.getAttribute("data-style-normal"));this.removeAttribute("data-style-normal")});$('meta[name="page"]',d).each(function(){var c=this.getAttribute("content"),c=new silex.model.Page(c,e.workspace,e.menu,e.stage,e.pageTool,e.propertyTool,e.textEditor,e.fileExplorer);console.warn("retro compat in action",this,c);c.attach();$(this).remove()})};silex.utils.Notification=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Notification.ERROR_ICON="assets/notifications/error.png";silex.utils.Notification.SUCCESS_ICON="assets/notifications/success.png";silex.utils.Notification.INFO_ICON="assets/notifications/info.png";silex.utils.Notification.useNative=function(){return window.webkitNotifications&&0===window.webkitNotifications.checkPermission()};
...
silex.controller.MenuController.prototype.menuCallback=function(c){console.log(arguments);switch(c){case "title.changed":this.promptTitle();break;case "file.close":case "file.new":this.newFile();break;case "file.saveas":this.save(null,goog.bind(function(){this.tracker.trackAction("controller-events","success",c,1)},this));break;case "file.rename":this.promptTitle();break;case "file.publish.settings":this.view.settingsDialog.openDialog();this.view.workspace.invalidate();break;case "file.publish":this.publish();
break;case "file.save":this.save(this.model.file.getUrl());break;case "file.open":this.openFile();break;case "view.file":this.preview();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "view.open.fileExplorer":this.view.fileExplorer.openDialog();
this.view.workspace.invalidate();break;case "view.open.cssEditor":this.openCssEditor();break;case "view.open.editor":this.editElement();break;case "insert.page":this.createPage();break;case "insert.text":this.addElement(silex.model.Element.TYPE_TEXT);break;case "insert.html":this.addElement(silex.model.Element.TYPE_HTML);break;case "insert.image":this.browseAndAddImage(silex.model.Element.TYPE_IMAGE);break;case "insert.container":this.addElement(silex.model.Element.TYPE_CONTAINER);break;case "edit.delete.selection":this.removeElement();
...
"1","1");goog.ui.editor.ToolbarFactory.addFontSize(d,"2","2");goog.ui.editor.ToolbarFactory.addFontSize(d,"3","3");goog.ui.editor.ToolbarFactory.addFontSize(d,"4","4");goog.ui.editor.ToolbarFactory.addFontSize(d,"5","5");goog.ui.editor.ToolbarFactory.addFontSize(d,"6","6");goog.ui.editor.ToolbarFactory.addFontSize(d,"7","7");e=goog.ui.editor.DefaultToolbar.makeBuiltInToolbarButton(goog.editor.Command.FORMAT_BLOCK);for(console.log(e.getItemCount());0<e.getItemCount();)e.removeItemAt(0);goog.ui.editor.ToolbarFactory.addFormatOption(e,
"Normal text","P");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Title","HEADER");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Subtitle","DIV");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 1","H1");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 2","H2");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Heading 3","H3");goog.ui.editor.ToolbarFactory.addFormatOption(e,"Quote","BLOCKQUOTE");c=[e,c,d,goog.editor.Command.BOLD,goog.editor.Command.ITALIC,goog.editor.Command.UNDERLINE,
goog.editor.Command.FONT_COLOR,goog.editor.Command.BACKGROUND_COLOR,goog.editor.Command.LINK,goog.editor.Command.UNDO,goog.editor.Command.REDO,goog.editor.Command.UNORDERED_LIST,goog.editor.Command.ORDERED_LIST,goog.editor.Command.INDENT,goog.editor.Command.OUTDENT,goog.editor.Command.JUSTIFY_LEFT,goog.editor.Command.JUSTIFY_CENTER,goog.editor.Command.JUSTIFY_RIGHT,goog.editor.Command.STRIKE_THROUGH,goog.editor.Command.REMOVE_FORMAT];console.log(c);var c=goog.ui.editor.DefaultToolbar.makeToolbar(c,
goog.dom.getElementByClass("toolbar",this.element)),f=new goog.text.LoremIpsum,d=goog.ui.editor.ToolbarFactory.makeButton("loremIpsumBtn","insert lorem ipsum text","L");goog.events.listen(d,goog.ui.Component.EventType.ACTION,function(){var c=f.generateParagraph(!0),d=goog.dom.createElement("div");d.innerHTML=c;this.textField.getRange().replaceContentsWithNode(d)},!1,this);c.addChild(new goog.ui.ToolbarSeparator,!0);c.addChild(d,!0);new goog.ui.editor.ToolbarController(this.textField,c);goog.events.listen(this.textField,
...
silex.model.File.prototype.getHtml=function(){var c=this.bodyElement.getAttribute("style")||"",d;d="<html>"+("<head>"+this.headElement.innerHTML+"</head>");d+='<body style="'+c+'">'+this.bodyElement.innerHTML+"</body>";d+="</html>";console.log("getHtml",d,this.headElement);return d};silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
