...
silex.model.Config.menu={names:[{label:"File",className:"menu-item-file"},{label:"Edit",className:"menu-item-edit"},{label:"View",className:"menu-item-view"},{label:"Insert",className:"menu-item-insert"},{label:"Tools",className:"menu-item-tools"},{label:"Help",className:"menu-item-help"}],options:[[{label:"New File",id:"file.new",className:"menu-item-file-new",shortcut:[[goog.events.KeyCodes.N,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"n",mnemonic:goog.events.KeyCodes.N,
accelerator:"n"},{label:"Open File...",id:"file.open",className:"menu-item-file-open",shortcut:[[goog.events.KeyCodes.O,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"o",mnemonic:goog.events.KeyCodes.O,accelerator:"o"},{label:"Save File",id:"file.save",className:"menu-item-file-save",shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"s",mnemonic:goog.events.KeyCodes.S,accelerator:"s"},{label:"Save As...",id:"file.saveas",
className:"menu-item-file-saveas",shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META+goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT]],tooltip:ctrlKeyDisplay+"\u21e7S"},null,{label:"Publish",id:"file.publish",className:"menu-item-file-publish",shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.META]],tooltip:ctrlKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"},{label:"Settings...",id:"file.publish.settings",className:"menu-item-file-publish-settings"},
null,{label:"Close File",id:"file.close",className:"menu-item-file-close",shortcut:[[goog.events.KeyCodes.W,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"w",mnemonic:goog.events.KeyCodes.W,accelerator:"w"}],[{label:"Delete selection",id:"edit.delete.selection",className:"menu-item-edit-delete-selection",shortcut:[[goog.events.KeyCodes.DELETE],[goog.events.KeyCodes.BACKSPACE]],tooltip:"suppr",mnemonic:goog.events.KeyCodes.R,accelerator:"r"},null,{label:"Rename page",id:"edit.rename.page",
className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],[{label:"View in new window",id:"view.file",className:"menu-item-view-file",shortcut:[[goog.events.KeyCodes.V,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"Open text editor",id:"view.open.textEditor",className:"menu-item-view-open-textEditor",shortcut:[[goog.events.KeyCodes.ENTER]],tooltip:"\u21b5"},
{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",shortcut:[[goog.events.KeyCodes.T,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"T",mnemonic:goog.events.KeyCodes.T,accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+
"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",shortcut:[[goog.events.KeyCodes.C,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"C",mnemonic:goog.events.KeyCodes.C,accelerator:"c"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html",shortcut:[[goog.events.KeyCodes.H,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"H",mnemonic:goog.events.KeyCodes.H,
accelerator:"h"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},
{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Questions and answers",id:"help.forums",className:"menu-item-help-forums"},{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",className:"menu-item-help-forkMe"}]]};
...
silex.view.Menu.prototype.buildMenu=function(c){this.menu=goog.ui.menuBar.create();var d=new goog.ui.KeyboardShortcutHandler(document);d.setAlwaysPreventDefault(!1);goog.events.listen(d,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(function(c){console.log("key",c.target,c.target.tagName);c.keyCode===goog.events.KeyCodes.ENTER&&"INPUT"===c.target.tagName||d.textInputs_[c.target.type]?console.log("stop",c.target.tagName,c.target.type):(c.preventDefault(),this.onMenuEvent(c.identifier))},
this));for(i in silex.model.Config.menu.names){var e=new goog.ui.Menu;goog.array.forEach(silex.model.Config.menu.options[i],function(c){var f;if(c){var h=c.id;f=new goog.ui.MenuItem(c.label);f.setId(h);f.addClassName(c.className);c.checkable&&f.setCheckable(!0);c.mnemonic&&f.setMnemonic(c.mnemonic);if(c.shortcut)for(var n in c.shortcut)d.registerShortcut(c.id,c.shortcut[n])}else f=new goog.ui.MenuSeparator;e.addItem(f);c&&c.tooltip&&(h=goog.dom.createElement("span"),h.innerHTML=c.tooltip,h.className=
"goog-menuitem-accel",f.getElement().appendChild(h))},this);var f=silex.model.Config.menu.names[i],h=new goog.ui.MenuButton(f.label,e);h.addClassName(f.className);h.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);this.menu.addChild(h,!0)}this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,function(c){this.onClick(c)},!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),goog.events.EventType.CLICK,function(c){this.onClick(c)},!1,this)};
