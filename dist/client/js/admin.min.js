...
goog.ui.MenuButton.prototype.attachPopupListeners_=function(c){var d=this.getHandler(),e=c?d.listen:d.unlisten;e.call(d,this.getDomHelper().getDocument(),goog.events.EventType.MOUSEDOWN,this.handleDocumentMouseDown,!0);this.isFocusablePopupMenu()&&e.call(d,this.menu_,goog.ui.Component.EventType.BLUR,this.handleMenuBlur);e.call(d,this.timer_,goog.Timer.TICK,this.onTick_);c?this.timer_.start():this.timer_.stop()};goog.ui.registry.setDecoratorByClassName(goog.ui.MenuButtonRenderer.CSS_CLASS,function(){return new goog.ui.MenuButton(null)});goog.events.KeyNames={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"caps-lock",27:"esc",32:"space",33:"pg-up",34:"pg-down",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"delete",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",59:"semicolon",61:"equals",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",
...
"s",mnemonic:goog.events.KeyCodes.S,accelerator:"s"},{label:"Save As...",id:"file.saveas",className:"menu-item-file-saveas",globalKey:goog.events.KeyCodes.S,shortcut:[[goog.events.KeyCodes.S,goog.ui.KeyboardShortcutHandler.Modifiers.META+goog.ui.KeyboardShortcutHandler.Modifiers.SHIFT]],tooltip:ctrlKeyDisplay+"\u21e7S"},null,{label:"Publish",id:"file.publish",className:"menu-item-file-publish",globalKey:goog.events.KeyCodes.P,shortcut:[[goog.events.KeyCodes.P,goog.ui.KeyboardShortcutHandler.Modifiers.META]],
...
tooltip:altKeyDisplay+"V",mnemonic:goog.events.KeyCodes.V,accelerator:"v"},null,{label:"Open text editor",id:"view.open.textEditor",className:"menu-item-view-open-textEditor",tooltip:"\u21b5"},{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",globalKey:goog.events.KeyCodes.T,shortcut:[[goog.events.KeyCodes.T,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+
"T",mnemonic:goog.events.KeyCodes.T,accelerator:"t"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",globalKey:goog.events.KeyCodes.I,shortcut:[[goog.events.KeyCodes.I,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],tooltip:altKeyDisplay+"I",mnemonic:goog.events.KeyCodes.I,accelerator:"i"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",globalKey:goog.events.KeyCodes.C,shortcut:[[goog.events.KeyCodes.C,goog.ui.KeyboardShortcutHandler.Modifiers.ALT]],
...
tooltip:altKeyDisplay+"P",mnemonic:goog.events.KeyCodes.P,accelerator:"p"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Questions and answers",id:"help.forums",
className:"menu-item-help-forums"},{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",id:"help.forkMe",className:"menu-item-help-forkMe"}]]};
silex.model.Config.fonts={"Roboto Condensed":{href:"http://fonts.googleapis.com/css?family=Roboto+Condensed:300italic,400italic,700italic,400,300,700",value:"Roboto Condensed"},Roboto:{href:"http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic",value:"Roboto"},"Days One":{href:"http://fonts.googleapis.com/css?family=Days+One",value:"Days One"},Sintony:{href:"http://fonts.googleapis.com/css?family=Sintony:400,700",value:"Sintony"},
...
value:"Bree Serif"},"Arial Black":{value:"Arial Black, Gadget, sans-serif"},Impact:{value:"Impact, Charcoal, sans-serif"},"Lucida Console":{value:"Lucida Console, Monaco, monospace"},"Lucida Sans":{value:"Lucida Sans Unicode, Lucida Grande, sans-serif"},Palatino:{value:"Palatino Linotype, Book Antiqua, Palatino, serif"},Tahoma:{value:"Tahoma, Geneva, sans-serif"}};goog.ui.MenuBarRenderer=function(){goog.ui.ContainerRenderer.call(this)};goog.inherits(goog.ui.MenuBarRenderer,goog.ui.ContainerRenderer);goog.addSingletonGetter(goog.ui.MenuBarRenderer);goog.ui.MenuBarRenderer.CSS_CLASS="goog-menubar";goog.ui.MenuBarRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.MENUBAR};goog.ui.MenuBarRenderer.prototype.getCssClass=function(){return goog.ui.MenuBarRenderer.CSS_CLASS};goog.ui.MenuBarRenderer.prototype.getDefaultOrientation=function(){return goog.ui.Container.Orientation.HORIZONTAL};goog.ui.menuBar={};goog.ui.menuBar.create=function(c,d){return new goog.ui.Container(null,c?c:goog.ui.MenuBarRenderer.getInstance(),d)};silex.view={};silex.view.Menu=function(c,d){this.element=c;silex.Helper.loadTemplateFile("templates/menu.html",c,function(){this.buildMenu(c);d&&d()},this)};
silex.view.Menu.prototype.buildMenu=function(c){this.menu=goog.ui.menuBar.create();var d=new goog.ui.KeyboardShortcutHandler(document),e=[];for(i in silex.model.Config.menu.names){var f=new goog.ui.Menu;goog.array.forEach(silex.model.Config.menu.options[i],function(c){var h;if(c){var k=c.id;h=new goog.ui.MenuItem(c.label);h.setId(k);h.addClassName(c.className);c.checkable&&h.setCheckable(!0);c.mnemonic&&h.setMnemonic(c.mnemonic);if(c.shortcut)for(var p in c.shortcut)d.registerShortcut(c.id,c.shortcut[p]),
c.globalKey&&e.push(c.globalKey)}else h=new goog.ui.MenuSeparator;f.addItem(h);c&&c.tooltip&&(k=goog.dom.createElement("span"),k.innerHTML=c.tooltip,k.className="goog-menuitem-accel",h.getElement().appendChild(k))},this);var h=silex.model.Config.menu.names[i],k=new goog.ui.MenuButton(h.label,f);k.addClassName(h.className);k.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);this.menu.addChild(k,!0)}d.setAlwaysPreventDefault(!1);d.setModifierShortcutsAreGlobal(!1);d.setGlobalKeys(e);goog.events.listen(d,
goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(function(c){c.preventDefault();this.onMenuEvent(c.identifier)},this));h=new goog.events.KeyHandler(document);goog.events.listen(h,"key",goog.bind(function(c){c.keyCode===goog.events.KeyCodes.ENTER&&("INPUT"!==c.target.tagName&&c.target.tagName!==d.textInputs_[c.target.type])&&(c.preventDefault(),this.onMenuEvent("view.open.textEditor"))},this));this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,
function(c){this.onClick(c)},!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),goog.events.EventType.CLICK,function(c){this.onClick(c)},!1,this)};silex.view.Menu.prototype.onClick=function(c){if(this.onStatus&&c&&c.target)if(goog.dom.classes.has(c.target,"website-name"))this.onMenuEvent("title.changed");else this.onMenuEvent(c.target.getId())};silex.view.Menu.prototype.onMenuEvent=function(c){if(this.onStatus)this.onStatus({type:c})};
silex.view.Menu.prototype.setWebsiteName=function(c){goog.dom.getElementByClass("website-name").innerHTML=c};silex.view.Menu.prototype.getWebsiteName=function(){return goog.dom.getElementByClass("website-name").innerHTML};silex.view.propertiesTool={};silex.view.propertiesTool.PropertyPane=function(c,d,e,f,h){this.element=c;this.propertyChanged=d;this.editText=f;this.editHTML=e;this.selectImage=h;this.buildUi()};
...
silex.view.propertiesTool.PropertyPane.prototype.lock=function(){this.hasLockedParent()?alert("unlock the parent in order to lock / unlock this component."):this.component.setLocked(!0)};silex.view.propertiesTool.PropertyPane.prototype.unlock=function(){this.hasLockedParent()?alert("unlock the parent in order to lock / unlock this component."):this.component.setLocked(!1)};
silex.view.propertiesTool.PropertyPane.prototype.onPositionChanged=function(){if(this.component&&!this.isRedraw&&goog.dom.classes.has(this.component.element,"editable-style")){var c={};this.leftInput.value&&""!==this.leftInput.value&&(c.left=this.leftInput.value+"px");this.widthInput.value&&""!==this.widthInput.value&&(c.width=this.widthInput.value+"px");this.bottomInput.value&&""!==this.bottomInput.value&&(c.bottom=this.bottomInput.value+"px");this.topInput.value&&""!==this.topInput.value&&(c.top=
this.topInput.value+"px");this.heightInput.value&&""!==this.heightInput.value&&(c.height=this.heightInput.value+"px");this.rightInput.value&&""!==this.rightInput.value&&(c.right=this.rightInput.value+"px");this.zIndexInput.value&&""!==this.zIndexInput.value&&(c.zIndex=this.zIndexInput.value);this.component.setBoundingBox(c)}this.redraw()};silex.view.propertiesTool.PropertyPane.prototype.setComponent=function(c){this.component=c;this.redraw()};
silex.view.propertiesTool.PropertyPane.prototype.getBaseUrl=function(){return this.baseUrl};silex.view.propertiesTool.PropertyPane.prototype.setBaseUrl=function(c){this.baseUrl=c;this.redraw()};silex.view.propertiesTool.PropertyPane.prototype.setImage=function(c){this.baseUrl?this.component.setImageSrc(silex.Helper.getAbsolutePath(c,this.baseUrl)):this.component.setImageSrc(c);this.redraw()};
...
{htmlEditor:this.component.type===silex.model.Component.SUBTYPE_HTML,textEditor:this.component.type===silex.model.Component.SUBTYPE_TEXT,imageUrl:c});if(c=goog.dom.getElementByClass("html-editor-button",d))e=new goog.ui.CustomButton,e.decorate(c),goog.events.listen(c,goog.events.EventType.CLICK,this.editHTML,!1);if(c=goog.dom.getElementByClass("text-editor-button",d))e=new goog.ui.CustomButton,e.decorate(c),goog.events.listen(c,goog.events.EventType.CLICK,this.editText,!1);if(this.component.type===
silex.model.Component.SUBTYPE_IMAGE){if(c=goog.dom.getElementByClass("image-url-button",d))e=new goog.ui.CustomButton,e.decorate(c),goog.events.listen(c,goog.events.EventType.CLICK,this.selectImage,!1);var f=goog.dom.getElementByClass("image-url-input",d);f&&goog.events.listen(f,"change",function(){this.component&&!this.isRedraw&&this.component.type===silex.model.Component.SUBTYPE_IMAGE&&this.setImage(f.value)},!1,this)}goog.dom.classes.has(this.component.element,"editable-style")?(d=this.component.getBoundingBox(),
this.leftInput.value=void 0!==d.left?d.left.substr(0,d.left.indexOf("px")):"",this.widthInput.value=void 0!==d.width?d.width.substr(0,d.width.indexOf("px")):"",this.bottomInput.value=void 0!==d.bottom?d.bottom.substr(0,d.bottom.indexOf("px")):"",this.topInput.value=void 0!==d.top?d.top.substr(0,d.top.indexOf("px")):"",this.heightInput.value=void 0!==d.height?d.height.substr(0,d.height.indexOf("px")):"",this.rightInput.value=void 0!==d.right?d.right.substr(0,d.right.indexOf("px")):"",this.zIndexInput.value=
void 0!==d.zIndex?d.zIndex:""):(this.leftInput.value="",this.widthInput.value="",this.bottomInput.value="",this.topInput.value="",this.heightInput.value="",this.rightInput.value="",this.zIndexInput.value="")}else d&&(d.innerHTML="");this.isRedraw=!1}};silex.service={};silex.service.Tracker=function(){ga||console.error("google analytcs not loaded")};silex.service.Tracker.SILEX_ACTIONS_CATEGORY="silex-event";silex.service.Tracker.prototype.trackAction=function(c,d,e,f){ga("send","event",c,d,e,f,!0)};goog.events.MouseWheelHandler=function(c,d){goog.events.EventTarget.call(this);this.element_=c;var e=goog.dom.isElement(this.element_)?this.element_:this.element_?this.element_.body:null;this.isRtl_=!!e&&goog.style.isRightToLeft(e);this.listenKey_=goog.events.listen(this.element_,goog.userAgent.GECKO?"DOMMouseScroll":"mousewheel",this,d)};goog.inherits(goog.events.MouseWheelHandler,goog.events.EventTarget);goog.events.MouseWheelHandler.EventType={MOUSEWHEEL:"mousewheel"};
...
goog.events.MouseWheelHandler.prototype.disposeInternal=function(){goog.events.MouseWheelHandler.superClass_.disposeInternal.call(this);goog.events.unlistenByKey(this.listenKey_);this.listenKey_=null};goog.events.MouseWheelEvent=function(c,d,e,f){goog.events.BrowserEvent.call(this,d);this.type=goog.events.MouseWheelHandler.EventType.MOUSEWHEEL;this.detail=c;this.deltaX=e;this.deltaY=f};goog.inherits(goog.events.MouseWheelEvent,goog.events.BrowserEvent);silex.view.Stage=function(c,d){this.element=c;this.headElement=goog.dom.createElement("div");silex.Helper.loadTemplateFile("templates/stage.html",c,function(){this.bodyElement=goog.dom.getElementByClass("silex-stage-body",this.element);d&&d();$(this.bodyElement).pageable({useDeeplink:!1});$(this.bodyElement).editable({isContainer:!0,isResizable:!1,isDroppable:!0,isDraggable:!1})},this);goog.events.listen(this.element,"mousedown",function(c){if(this.onStatus)this.onStatus({type:"select",element:c.target});
this.isDragging=!0},!1,this);goog.events.listen(document.body,"mouseup",function(c){if(this.isDragging){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1}},!1,this);goog.events.listen(this.element,"dragstop",function(c){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1},!1,this);goog.events.listen(this.element,"resize",function(c){if(this.onStatus)this.onStatus({type:"change"});this.isDragging=!1},!1,this);goog.events.listen(this.element,"newContainer",function(c){if(this.onStatus)this.onStatus({type:"newContainer"})},
!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(c){if(this.onStatus)this.onStatus({type:"edit"})},!1,this);handleMouseWheel=goog.bind(function(c){0>c.deltaX&&0>=this.element.scrollLeft&&c.preventDefault()},this);var e=new goog.events.MouseWheelHandler(this.element);goog.events.listen(e,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,handleMouseWheel);goog.events.listen(window,"unload",function(c){goog.events.unlisten(e,goog.events.MouseWheelHandler.EventType.MOUSEWHEEL,
handleMouseWheel)})};silex.view.Stage.prototype.getPagesNamesFromDom=function(){var c=[];$('a[data-silex-type="page"]',this.bodyElement).each(function(){c.push(this.getAttribute("id"))});return c};
silex.view.Stage.prototype.removePage=function(c){$('a[data-silex-type="page"]',this.bodyElement).each(function(){this.getAttribute("id")===c.name&&$(this).remove()});$('*[data-silex-href="#'+c.name+'"]').each(function(){this.removeAttribute("data-silex-href")});$("."+c.name).each(function(){$(this).removeClass(c.name);0>=silex.model.Page.getPagesForElement(this).length&&$(this).removeClass(silex.model.Page.PAGE_CLASS)})};
silex.view.Stage.prototype.addPage=function(c){var d=goog.dom.createElement("a");d.setAttribute("id",c.name);d.setAttribute("data-silex-type",silex.model.Component.TYPE_PAGE);d.innerHTML=c.name;goog.dom.appendChild(this.bodyElement,d)};
silex.view.Stage.prototype.renamePage=function(c,d){$('a[data-silex-type="page"]',this.bodyElement).each(function(){this.getAttribute("id")===c.name&&this.setAttribute("id",d)});$('*[data-silex-href="#'+c.name+'"]').each(function(){this.setAttribute("data-silex-href","#"+d)});$("."+c.name).each(function(){$(this).removeClass(c.name);$(this).addClass(d)})};silex.view.Stage.prototype.openPage=function(c){$(this.bodyElement).pageable({currentPage:c.name})};
silex.view.Stage.prototype.setPublicationPath=function(c){var d=!1;$('meta[name="publicationPath"]',this.headElement).each(function(){c&&""!==c?this.setAttribute("content",c):$(this).remove();d=!0});if(!d&&c&&""!==c){var e=goog.dom.createElement("meta");e.name="publicationPath";e.content=c;goog.dom.appendChild(this.headElement,e)}};
silex.view.Stage.prototype.getPublicationPath=function(){var c=null;$('meta[name="publicationPath"]',this.headElement).each(function(){c=this.getAttribute("content")});return c};silex.view.Stage.prototype.setBody=function(c){""!==c&&console.warn("warning: you are supposed to use stageComponent.setHtml");this.bodyElement.innerHTML=c};silex.view.Stage.prototype.getBody=function(){return this.bodyElement.innerHTML};silex.view.Stage.prototype.setHead=function(c){this.headElement.innerHTML=c};
silex.view.Stage.prototype.getHead=function(){return this.headElement.innerHTML};silex.view.Stage.prototype.setBodyStyle=function(c){this.bodyElement.setAttribute("data-style-normal",c);this.bodyElement.setAttribute("style",c)};silex.view.Stage.prototype.getBodyStyle=function(){return this.bodyElement.getAttribute("data-style-normal")};silex.view.PublishSettings=function(c,d){this.element=c;this.publicationPath="";goog.style.setStyle(this.element,"display","none");var e=new goog.ui.KeyboardShortcutHandler(document);e.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(e,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this));silex.Helper.loadTemplateFile("templates/publishsettings.html",c,function(){var c=goog.dom.getElementByClass("close-btn",this.element);goog.events.listen(c,
goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);c=goog.dom.getElementByClass("browse-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.onStatus({type:"browsePublishPath"})},!1,this);var e=goog.dom.getElementByClass("input-publication-path");goog.events.listen(e,goog.ui.Component.EventType.CHANGE,function(){this.onStatus({type:"change",data:e.value})},!1,this);d&&d()},this)};
silex.view.PublishSettings.prototype.setPublicationPath=function(c){this.publicationPath=c;this.redraw()};silex.view.PublishSettings.prototype.redraw=function(){goog.dom.getElementByClass("input-publication-path").value=this.publicationPath};
silex.view.PublishSettings.prototype.openDialog=function(c){this.onClose=c;c=goog.dom.getElementByClass("settings-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(c,goog.events.EventType.CLICK,this.closeEditor,!0,this);this.redraw()};
silex.view.PublishSettings.prototype.closeEditor=function(){if(this.onClose)this.onClose();var c=goog.dom.getElementByClass("settings-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};silex.Controller=function(c,d,e,f,h,k,l,m,n,p,q){this.tracker=new silex.service.Tracker;this.tracker.trackAction("silex-event/controller","start",null,2);this.workspace=c;this.menu=d;this.stage=e;this.pageTool=f;this.propertiesTool=h;this.textEditor=l;this.htmlEditor=k;this.fileExplorer=m;this.publishSettings=n;this.file=p;this.selection=q;this.selection.setComponent(this.file.getStageComponent());this.menu.onStatus=goog.bind(this.menuCallback,this);this.stage.onStatus=goog.bind(this.stageCallback,
this);this.pageTool.onStatus=goog.bind(this.pageToolCallback,this);this.propertiesTool.onStatus=goog.bind(this.propertiesToolCallback,this);this.publishSettings.onStatus=goog.bind(this.publishSettingsCallback,this);this.htmlEditor.onStatus=goog.bind(this.htmlEditorCallback,this);this.textEditor.onStatus=goog.bind(this.textEditorCallback,this);if(!silex.model.Config.debug.debugMode||silex.model.Config.debug.preventQuit)window.onbeforeunload=function(){return"Are you sure?"}};
silex.Controller.prototype.menuCallback=function(c){this.tracker.trackAction("controller-events","request",c.type,0);switch(c.type){case "title.changed":alertify.prompt("What is the name of your website?",goog.bind(function(c,d){c&&this.file.setTitle(d)},this),this.menu.getWebsiteName());break;case "file.new":this.file.newFile();break;case "file.saveas":this.file.saveAs(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",c.type,1)},
this),goog.bind(function(d){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));break;case "file.publish.settings":this.publishSettings.openDialog();this.workspace.invalidate();break;case "file.publish":this.file.getPublicationPath()?this.file.publish(goog.bind(function(d){d&&!1==d.success?(console.error("Error: I did not manage to publish the file. (1)"),this.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
(d.message||d.code||"")),this.tracker.trackAction("controller-events","error",c.type,-1)):(this.notifySuccess("I am about to publish your site. This may take several minutes."),this.tracker.trackAction("controller-events","success",c.type,1))},this),goog.bind(function(d){console.error("Error: I did not manage to publish the file. (2)",d);this.notifyError("I did not manage to publish the file. You may want to check the publication settings and your internet connection. <br /><br />Error message: "+
d);this.tracker.trackAction("controller-events","error",c.type,-1)},this)):alertify.alert('I do not know where to publish your site.             Select a folder in the settings pannel and do "publish" again.             <br /><br />Now I will open the publish settings.',goog.bind(function(){this.publishSettings.openDialog();this.workspace.invalidate()},this));break;case "file.save":this.file.getBlob()?this.file.save(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events",
"success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this)):this.file.saveAs(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events",
"error",c.type,-1)},this));break;case "file.open":this.file.open(goog.bind(function(){this.notifySuccess(this.file.getTitle()+" opened.");this.selection.setComponent(this.file.getStageComponent());this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to open this file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));break;case "file.close":this.file.close();this.selection.setComponent(null);
...
break;case "view.open.fileExplorer":this.fileExplorer.openDialog();this.workspace.invalidate();break;case "view.open.textEditor":this.editComponent();break;case "insert.page":this.createPage(goog.bind(function(){this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(){this.tracker.trackAction("controller-events","cancel",c.type,0)},this));break;case "insert.text":var d=this.file.getStageComponent().addText();this.selection.getPage().addComponent(d);this.selection.setComponent(d);
break;case "insert.html":d=this.file.getStageComponent().addHtml();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "insert.image":this.fileExplorer.openDialog(goog.bind(function(d){d=this.file.getStageComponent().addImage(d.url);this.selection.getPage().addComponent(d);this.selection.setComponent(d);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],goog.bind(function(d){this.notifyError("Error: I did not manage to load the image. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));this.workspace.invalidate();break;case "insert.container":d=this.file.getStageComponent().addContainer();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "edit.delete.selection":this.file.getStageComponent().remove(this.selection.getComponent());this.selection.setComponent(this.file.getStageComponent());break;case "edit.delete.page":this.removePage(this.selection.getPage());break;
case "edit.rename.page":this.renamePage(this.selection.getPage());break;case "help.about":window.open("http://www.silexlabs.org/silex/");break;case "help.aboutSilexLabs":window.open("http://www.silexlabs.org/silexlabs/");break;case "help.forums":window.open("http://graphicdesign.stackexchange.com/questions/tagged/silex");break;case "help.newsLetter":window.open("http://eepurl.com/F48q5");break;case "help.googlPlus":window.open("https://plus.google.com/communities/107373636457908189681");break;case "help.twitter":window.open("http://twitter.com/silexlabs");
break;case "help.facebook":window.open("http://www.facebook.com/silexlabs");break;case "help.forkMe":window.open("https://github.com/silexlabs/Silex")}};
silex.Controller.prototype.stageCallback=function(c){switch(c.type){case "select":var d=this.selection.getComponent();d&&d.setContext(silex.model.Component.CONTEXT_NORMAL);c.element?(this.selection.setComponent(new silex.model.Component(c.element,this.selection.getContext())),this.selection.getComponent().setContext(this.selection.getContext())):this.selection.setComponent(this.file.getStageComponent());break;case "change":this.selection.getComponent().setBoundingBox(this.selection.getComponent().getBoundingBox());
this.propertiesTool.redraw();break;case "newContainer":c=this.selection.getComponent();if(null!==c.getFirstPageableParent()){d=silex.model.Page.getPagesForElement(c.element);for(idx in d)d[idx].removeComponent(c);this.propertiesTool.redraw()}break;case "edit":this.editComponent()}};
silex.Controller.prototype.pageToolCallback=function(c){this.tracker.trackAction("controller-events","request",c.type,0);switch(c.type){case "changed":this.selection.setPage(c.page);c.page&&c.page.open();break;case "delete":this.removePage(c.page);break;case "rename":this.renamePage(c.page)}};silex.Controller.prototype.renamePage=function(c){this.getUserInputPageName(c.name,goog.bind(function(d){d&&c.rename(d);this.selection.getPage().open()},this))};
silex.Controller.prototype.removePage=function(c){alertify.confirm('I am about to delete the page "'+c.name+'", are you sure?',function(d){d&&c.detach()})};
silex.Controller.prototype.getUserInputPageName=function(c,d){alertify.prompt("Enter a name for your page!",function(c,f){if(c&&f&&0<f.length){f=f.replace(/\ /g,"-").replace(/\./g,"-").replace(/'/g,"-").replace(/"/g,"-").toLowerCase();var h=silex.model.Page.getPages(),k=null;goog.array.forEach(h,function(c){c.name===f&&(k=c)});k?k.open():d(f)}d(null)},c)};
silex.Controller.prototype.createPage=function(c,d){this.getUserInputPageName("My new page name",goog.bind(function(e){e?(e=new silex.model.Page(e,this.workspace,this.menu,this.stage,this.pageTool,this.propertiesTool,this.textEditor,this.fileExplorer),e.attach(),this.selection.setPage(e),e.open(),c&&c()):d&&d()},this))};
silex.Controller.prototype.publishSettingsCallback=function(c){switch(c.type){case "browsePublishPath":this.fileExplorer.openDialog(goog.bind(function(d){d=d.url.substring(d.url.indexOf("/api/v1.0/"),d.url.lastIndexOf("/"));d=d.replace("/exec/get","/exec/put");this.file.setPublicationPath(d);this.tracker.trackAction("controller-events","success",c.type,1)},this),null,goog.bind(function(d){this.notifyError("Error: I could not select the publish path. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events",
"error",c.type,-1)},this));break;case "change":this.file.setPublicationPath(c.data)}};
silex.Controller.prototype.propertiesToolCallback=function(c){switch(c.type){case "editHTML":this.editComponent();break;case "editText":this.editComponent();break;case "selectBgImage":this.fileExplorer.openDialog(goog.bind(function(d){this.propertiesTool.setBgImage(d.url);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],goog.bind(function(d){this.notifyError("Error: I could not load the image. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events",
"error",c.type,-1)},this));this.workspace.invalidate();break;case "selectImage":this.editComponent();break;case "contextChanged":this.selection.setContext(c.context);this.selection.getComponent().setContext(c.context);break;case "styleChanged":this.selection.getComponent().setStyle(c.style,c.context)}};silex.Controller.prototype.htmlEditorCallback=function(c){switch(c.type){case "changed":this.selection.getComponent().setHtml(c.content)}};
silex.Controller.prototype.textEditorCallback=function(c){switch(c.type){case "changed":this.selection.getComponent().setHtml(c.content),this.file.refreshFontList()}};
silex.Controller.prototype.editComponent=function(){var c=this.selection.getComponent();switch(c.type){case silex.model.Component.SUBTYPE_TEXT:this.textEditor.openEditor(c.getHtml());break;case silex.model.Component.SUBTYPE_HTML:this.htmlEditor.openEditor(c.getHtml());break;case silex.model.Component.SUBTYPE_IMAGE:this.fileExplorer.openDialog(goog.bind(function(c){this.propertiesTool.setImage(c.url)},this),["image/*","text/plain"],goog.bind(function(c){this.notifyError("Error: I did not manage to load the image. <br /><br />"+
(c.message||""))},this)),this.workspace.invalidate()}};silex.Controller.prototype.notifySuccess=function(c){console.info(c);alertify.success(c)};silex.Controller.prototype.notifyError=function(c){console.error(c);alertify.error(c)};goog.async={};goog.async.Delay=function(c,d,e){goog.Disposable.call(this);this.listener_=c;this.interval_=d||0;this.handler_=e;this.callback_=goog.bind(this.doAction_,this)};goog.inherits(goog.async.Delay,goog.Disposable);goog.Delay=goog.async.Delay;goog.async.Delay.prototype.id_=0;goog.async.Delay.prototype.disposeInternal=function(){goog.async.Delay.superClass_.disposeInternal.call(this);this.stop();delete this.listener_;delete this.handler_};
...
goog.async.Delay.prototype.doAction_=function(){this.id_=0;this.listener_&&this.listener_.call(this.handler_)};silex.view.FileExplorer=function(c,d){var e=this;this.element=c;goog.style.setStyle(this.element,"display","none");d&&(new goog.async.Delay(function(){d();e.init()},10)).start();goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);var f=new goog.ui.KeyboardShortcutHandler(document);f.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(f,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,
goog.bind(this.closeEditor,this))};silex.view.FileExplorer.CONTAINER_TYPE="modal";silex.view.FileExplorer.SERVICES=["DROPBOX","GOOGLE_DRIVE","EVERNOTE","FTP"];silex.view.FileExplorer.prototype.init=function(){this.filePicker=silex.service.CloudStorage.getInstance().filePicker};
silex.view.FileExplorer.prototype.openDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d)},10,this)).start()};this.filePicker.pick(goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");c.url=silex.Helper.getAbsolutePath(c.url,silex.Helper.BaseUrl);if(f&&!1===silex.Helper.checkFileExt(c.url,
f)){var d=c.url.substring(c.url.lastIndexOf("/")+1);alertify.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};
silex.view.FileExplorer.prototype.saveAsDialog=function(c,d,e){var f;d&&(0===d[0].indexOf("image")?f=["jpg","jpeg","gif","png"]:0===d[0].indexOf("text/html")&&(f=["html","htm"]));var h=function(c){console.error(c);e&&e(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d)},10,this)).start()};this.filePicker.exportFile("http://google.com/",d,goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");c.url=silex.Helper.getAbsolutePath(c.url,silex.Helper.BaseUrl);if(f&&!1===
silex.Helper.checkFileExt(c.url,f)){var d=c.url.substring(c.url.lastIndexOf("/")+1);alertify.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};
...
silex.view.FileExplorer.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none");goog.events.unlisten(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};silex.model.Component=function(c,d){this.isEditable=!1;this.element=this.getFirstEditableParent(c);this.type=silex.model.Component.getType(this.element);d||(d=silex.model.Component.CONTEXT_NORMAL);this.setContext(d)};silex.model.Component.CONTEXT_NORMAL="normal";silex.model.Component.CONTEXT_HOVER="hover";silex.model.Component.CONTEXT_PRESSED="pressed";silex.model.Component.TYPE_CONTAINER="container";silex.model.Component.TYPE_PAGE="page";silex.model.Component.TYPE_ELEMENT="element";
silex.model.Component.SUBTYPE_IMAGE="image";silex.model.Component.SUBTYPE_TEXT="text";silex.model.Component.SUBTYPE_HTML="html";silex.model.Component.getType=function(c){var d=c.getAttribute("data-silex-type");c=c.getAttribute("data-silex-sub-type");switch(d){case silex.model.Component.TYPE_CONTAINER:return d;case silex.model.Component.TYPE_ELEMENT:return c}throw"Could not determine the type of this element.";};
silex.model.Component.prototype.getFirstPageableParent=function(){for(var c=this.element.parentNode;c&&!goog.dom.classes.has(c,silex.model.Page.PAGE_CLASS);)c=c.parentNode;return c};silex.model.Component.prototype.getBackgroundElement=function(){var c=goog.dom.getElementsByClass("background",this.element);return 0<c.length?c[0]:this.element};silex.model.Component.prototype.getContext=function(){return this.context};
silex.model.Component.prototype.setContext=function(c){this.context=c;this.setStyle(this.getStyle(c),c)};silex.model.Component.prototype.getCss=function(c){c||(c=this.context);(c=this.element.getAttribute("data-style-"+c))||(c="");c=silex.Helper.stringToStyle(c);var d={};goog.object.forEach(c,function(c,f,h){c&&""!==c&&(d[f]=c)},this);return d};silex.model.Component.prototype.hasStyle=function(c){c||(c=this.context);return this.element.getAttribute("data-style-"+c)?!0:!1};
silex.model.Component.prototype.getStyle=function(c){c=this.getCss(c);c.top=void 0;c.left=void 0;c.width=void 0;c.height=void 0;c.bottom=void 0;c.right=void 0;c.zIndex=void 0;c.position=void 0;var d={};goog.object.forEach(c,function(c,f,h){c&&""!==c&&(d[f]=c)},this);return d};
silex.model.Component.prototype.setStyle=function(c,d){c||(c={});d||(d=this.context);var e="";goog.object.forEach(c,function(c,d,f){c&&("none"===c&&(c=null),c?(e+=goog.string.toSelectorCase(d)+": "+c+"; ",f=c.replace(/\'/g,""),this.element.style[d]!==f&&goog.style.setStyle(this.element,d,c)):goog.style.setStyle(this.element,d,null))},this);if(d===silex.model.Component.CONTEXT_NORMAL)var f=this.getBoundingBox(),e=e+("top: "+f.top+"; "),e=e+("left: "+f.left+"; "),e=e+("width: "+f.width+"; "),e=e+("height: "+
f.height+"; "),e=e+("bottom: "+f.bottom+"; "),e=e+("right: "+f.right+"; "),e=e+("z-index: "+f.zIndex+"; "),e=e+"position: absolute; ";""!==e?this.element.getAttribute("data-style-"+d)!==e&&this.element.setAttribute("data-style-"+d,e):this.element.removeAttribute("data-style-"+d)};
silex.model.Component.prototype.getBoundingBox=function(){return{top:goog.style.getStyle(this.element,"top"),left:goog.style.getStyle(this.element,"left"),width:goog.style.getStyle(this.element,"width"),height:goog.style.getStyle(this.element,"height"),bottom:goog.style.getStyle(this.element,"bottom"),right:goog.style.getStyle(this.element,"right"),zIndex:goog.style.getStyle(this.element,"zIndex")}};
...
"height",null);c.bottom?goog.style.setStyle(this.element,"bottom",c.bottom):goog.style.setStyle(this.element,"bottom",null);c.right?goog.style.setStyle(this.element,"right",c.right):goog.style.setStyle(this.element,"right",null);c.zIndex?goog.style.setStyle(this.element,"zIndex",c.zIndex):goog.style.setStyle(this.element,"zIndex",null);var d=this.getCss(silex.model.Component.CONTEXT_NORMAL);d.top=c.top;d.left=c.left;d.width=c.width;d.height=c.height;d.bottom=c.bottom;d.right=c.right;d.zIndex=c.zIndex;
c=silex.Helper.styleToString(d);this.element.setAttribute("data-style-"+silex.model.Component.CONTEXT_NORMAL,c)};silex.model.Component.prototype.getImageSrc=function(){if(this.type===silex.model.Component.SUBTYPE_IMAGE){var c=goog.dom.getElementsByTagNameAndClass("img",null,this.element)[0];if(c)return c.getAttribute("src");console.error("The image element inside the component could not be found. Canot get the source.")}else console.error("The component is not an image, canot get the source.");return""};
silex.model.Component.prototype.setImageSrc=function(c){if(this.type===silex.model.Component.SUBTYPE_IMAGE){var d=goog.dom.getElementsByTagNameAndClass("img",null,this.element)[0];if(d)return d.setAttribute("src",c);console.error("The image element inside the component could not be found. Canot set the source.")}else console.error("The component is not an image, canot set the source.")};
silex.model.Component.prototype.getHtml=function(c){this.applyStateToAllComponents("normal");this.setEditable(!1);var d=this.element.cloneNode(!0);this.setEditable(!0);var e="";if(this.type==silex.model.Component.SUBTYPE_HTML){if(d=goog.dom.getFirstElementChild(d))e=d.innerHTML}else e=d.innerHTML;c&&(c=silex.Helper.getAbsolutePath(c,silex.Helper.BaseUrl),e=this.absolute2Relative(e,c));return e};
silex.model.Component.prototype.setHtml=function(c,d){this.setEditable(!1);d?(d=silex.Helper.getAbsolutePath(d,silex.Helper.BaseUrl),c=this.relative2absolute(c,d)):console.warn("setHtml without base url, the URLs could not be converted to absolute");if(this.type==silex.model.Component.SUBTYPE_HTML){var e=goog.dom.getFirstElementChild(this.element);e&&(e.innerHTML=c)}else this.element.innerHTML=c;this.setEditable(!0)};
silex.model.Component.prototype.getFirstEditableParent=function(c){for(var d=c;d&&d.getAttribute&&!this.getEditable(d);)d=d.parentNode;return d&&d.getAttribute&&this.getEditable(d)?d:c};silex.model.Component.prototype.getLocked=function(c){c||(c=this.element);return $(c).hasClass("locked-style")};
silex.model.Component.prototype.setLocked=function(c,d){d||(d=this.element);c?$(d).hasClass("locked-style")||$(d).addClass("locked-style"):$(d).hasClass("locked-style")&&$(d).removeClass("locked-style");this.setEditable(!c,d)};silex.model.Component.prototype.getEditable=function(c){c||(c=this.element);return $(c).hasClass("editable-style")};
silex.model.Component.prototype.setEditable=function(c,d){d||(d=this.element);if(c){if($('.editable-style[data-silex-type="container"]',d).each(function(){$(this).hasClass("locked-style")||$(this).editable({isContainer:!0})}),$('.editable-style[data-silex-type="element"]',d).editable(),this.getEditable(d)){if($(this).hasClass("locked-style"))return;d.getAttribute("data-silex-type")===silex.model.Component.TYPE_CONTAINER?$(d).editable({isContainer:!0}):$(d).editable()}}else $('[data-silex-type="container"]',
d).editable("destroy"),$('[data-silex-type="element"]',d).editable("destroy"),this.getEditable(d)&&$(d).editable("destroy"),$(d).find(".silex-selected").removeClass("silex-selected"),$(d).find(".ui-resizable").removeClass("ui-resizable"),$(d).find(".ui-draggable").removeClass("ui-draggable"),$(d).find(".ui-droppable").removeClass("ui-droppable"),$(d).find("[aria-disabled]").removeAttr("aria-disabled"),$(d).find(".ui-resizable-handle").remove();this.isEditable=c};
silex.model.Component.prototype.absolute2Relative=function(c,d){c=c.replace(/src="?([^" ]*)" /g,function(c,f,h){return c.replace(f,silex.Helper.getRelativePath(f,d))});return c=c.replace(/url\((['"])(.+?)\1\)/g,function(c,f,h){return"url('"+silex.Helper.getRelativePath(h,d)+"')"})};
silex.model.Component.prototype.relative2absolute=function(c,d){c=c.replace(/src="?([^" ]*)" /g,function(c,f,h){return c.replace(f,silex.Helper.getAbsolutePath(f,d))});return c=c.replace(/url\((['"])(.+?)\1\)/g,function(c,f,h){return"url('"+silex.Helper.getAbsolutePath(h,d)+"')"})};silex.model.Component.prototype.applyStateToAllComponents=function(c){$("[data-style-normal]").each(function(){var d=this.getAttribute("data-style-"+c);null!==d?this.setAttribute("style",d):this.setAttribute("style",this.getAttribute("data-style-normal"))})};
silex.model.Component.prototype.addContainer=function(){if(this.type!==silex.model.Component.TYPE_CONTAINER)throw"Canot create a child component for this component because it is not of type "+silex.model.Component.TYPE_CONTAINER;var c=goog.dom.createElement("div");c.className="editable-style";c.setAttribute("data-silex-type",silex.model.Component.TYPE_CONTAINER);var d=this.getBackgroundElement();goog.dom.appendChild(d,c);this.setEditable(!0,c);var c=new silex.model.Component(c),d={},e=this.element.parentNode;
d.left=100+e.scrollLeft+"px";d.top=100+e.scrollTop+"px";d.height="100px";d.width="100px";c.setBoundingBox(d);c.setStyle({backgroundColor:"rgba(255, 255, 255, 1)"},silex.model.Component.CONTEXT_NORMAL);return c};
...
c);this.setEditable(!0,c);var c=new silex.model.Component(c),d={},e=this.element.parentNode;d.left=100+e.scrollLeft+"px";d.top=100+e.scrollTop+"px";d.height="100px";d.width="100px";c.setBoundingBox(d);c.setStyle({backgroundColor:"rgba(255, 255, 255, 1)"},silex.model.Component.CONTEXT_NORMAL);return c};
silex.model.Component.prototype.addHtml=function(){if(this.type!==silex.model.Component.TYPE_CONTAINER)throw"Canot create a child component for this component because it is not of type "+silex.model.Component.TYPE_CONTAINER;var c=goog.dom.createElement("div");c.className="editable-style";c.setAttribute("data-silex-type",silex.model.Component.TYPE_ELEMENT);c.setAttribute("data-silex-sub-type",silex.model.Component.SUBTYPE_HTML);var d=goog.dom.createElement("div");d.className="html-content";d.innerHTML=
"<p>New HTML box</p>";goog.style.setStyle(d,"width","100%");goog.style.setStyle(d,"height","100%");var e=this.getBackgroundElement();goog.dom.appendChild(e,c);goog.dom.appendChild(c,d);this.setEditable(!0,c);c=new silex.model.Component(c);d={};e=this.element.parentNode;d.left=100+e.scrollLeft+"px";d.top=100+e.scrollTop+"px";d.height="100px";d.width="100px";c.setBoundingBox(d);c.setStyle({backgroundColor:"rgba(255, 255, 255, 1)"},silex.model.Component.CONTEXT_NORMAL);return c};
silex.model.Component.prototype.addImage=function(c){if(this.type!==silex.model.Component.TYPE_CONTAINER)throw"Canot create a child component for this component because it is not of type "+silex.model.Component.TYPE_CONTAINER;c||console.error("No URL provided for the image component");var d=goog.dom.createElement("div");d.className="editable-style";d.setAttribute("data-silex-type",silex.model.Component.TYPE_ELEMENT);d.setAttribute("data-silex-sub-type",silex.model.Component.SUBTYPE_IMAGE);var e=goog.dom.createElement("img");
goog.style.setStyle(e,"width","100%");goog.style.setStyle(e,"height","100%");var f=this.getBackgroundElement();goog.dom.appendChild(f,d);goog.dom.appendChild(d,e);var h=new silex.model.Component(d),k={},f=this.element.parentNode;k.left=100+f.scrollLeft+"px";k.top=100+f.scrollTop+"px";h.setBoundingBox(k);e.setAttribute("src",c);e.onload=function(c){k.width=e.offsetWidth+"px";k.height=e.offsetHeight+"px";h.setBoundingBox(k);h.setEditable(!0,d)};return h};
...
silex.model.Component.prototype.setSelected=function(c){c?goog.dom.classes.add(this.element,"silex-selected"):goog.dom.classes.remove(this.element,"silex-selected")};silex.model.Component.prototype.getSelected=function(){return goog.dom.classes.has(this.element,"silex-selected")};silex.model.Component.prototype.addClass=function(c){goog.dom.classes.add(this.element,c)};silex.model.Component.prototype.removeClass=function(c){goog.dom.classes.remove(this.element,c)};
silex.model.Component.prototype.getClasses=function(){return goog.dom.classes.get(this.element)};silex.model.Component.prototype.getClasses=function(c){return goog.dom.classes.set(this.element,c)};silex.model.Component.prototype.hasClass=function(c){return goog.dom.classes.has(this.element,c)};goog.uri={};goog.uri.utils={};goog.uri.utils.CharCode_={AMPERSAND:38,EQUAL:61,HASH:35,QUESTION:63};goog.uri.utils.buildFromEncodedParts=function(c,d,e,f,h,k,l){var m="";c&&(m+=c+":");e&&(m+="//",d&&(m+=d+"@"),m+=e,f&&(m+=":"+f));h&&(m+=h);k&&(m+="?"+k);l&&(m+="#"+l);return m};goog.uri.utils.splitRe_=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
...
goog.net.XhrIo.prototype.formatMsg_=function(c){return c+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(c){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=c(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});silex.Helper=function(){};silex.Helper.BaseUrl=window.location.href.substr(0,window.location.href.lastIndexOf("/")+1);silex.Helper.loadTemplateFile=function(c,d,e,f){goog.net.XhrIo.send(c,function(c){c=c.target.getResponse();d.innerHTML=c;e&&e.call(f)})};silex.Helper.resolveTemplate=function(c,d,e){d=Handlebars.compile(d);c.innerHTML=d(e)};silex.Helper.isAbsoluteUrl=function(c){return 0===c.indexOf("http")};
silex.Helper.getRelativePath=function(c,d){if(0!==d.indexOf("http")||0!==c.indexOf("http"))return console.warn("Warning: the URL is not absolute ",c,d),c;var e=c.split("/"),f=d.split("/"),h=e[e.length-1];e.pop();f.pop();e.shift();e.shift();f.shift();f.shift();if(f[0]!==e[0])return console.warn("Warning: the URL is not on the same domain as the base url ",c,d),c;for(;0<f.length&&0<e.length&&f[0]===e[0];)f.shift(),e.shift();for(var k="",l=0;l<f.length;l++)k+="../";0<e.length&&(k+=e.join("/")+"/");return k+
h};silex.Helper.getAbsolutePath=function(c,d){return goog.Uri.resolve(d,c).toString()};silex.Helper.styleToString=function(c){var d="";goog.object.forEach(c,function(c,f,h){c&&(d+=goog.string.toSelectorCase(f)+": "+c+"; ")});return d};silex.Helper.stringToStyle=function(c){return goog.style.parseStyleAttribute(c)};
...
null!==this.style.backgroundImage&&"none"!==this.style.backgroundImage&&""!==this.style.backgroundImage?this.bgClearBgImage.setEnabled(!0):this.bgClearBgImage.setEnabled(!1);this.bgClearBgImage.setEnabled(!0);if(this.style.backgroundAttachement)switch(this.style.backgroundAttachement){case "scroll":this.attachementComboBox.setSelectedIndex(0);break;case "fixed":this.attachementComboBox.setSelectedIndex(1);break;case "local":this.attachementComboBox.setSelectedIndex(2)}else this.attachementComboBox.setSelectedIndex(0);
if(this.style.backgroundPosition){var c=this.style.backgroundPosition.split(" "),d=c[1];switch(c[0]){case "top":this.vPositionComboBox.setSelectedIndex(0);break;case "center":this.vPositionComboBox.setSelectedIndex(1);break;case "bottom":this.vPositionComboBox.setSelectedIndex(2)}switch(d){case "left":this.hPositionComboBox.setSelectedIndex(0);break;case "center":this.hPositionComboBox.setSelectedIndex(1);break;case "right":this.hPositionComboBox.setSelectedIndex(2)}}else this.vPositionComboBox.setSelectedIndex(0),
this.hPositionComboBox.setSelectedIndex(0);if(this.style.backgroundRepeat)switch(this.style.backgroundRepeat){case "repeat":this.repeatComboBox.setSelectedIndex(0);break;case "repeat-x":this.repeatComboBox.setSelectedIndex(1);break;case "repeat-y":this.repeatComboBox.setSelectedIndex(2);break;case "no-repeat":this.repeatComboBox.setSelectedIndex(3);break;case "inherit":this.repeatComboBox.setSelectedIndex(4)}else this.repeatComboBox.setSelectedIndex(0);this.isRedraw=!1}};
silex.view.propertiesTool.BgPane.prototype.onColorChanged=function(){var c=silex.Helper.hexToRgba(this.hsvPalette.getColorRgbaHex());this.style||(this.style={});this.style.backgroundColor=c;this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.onBgColorButton=function(){!1===this.getColorPaletteVisibility()?(this.hsvPalette.setColorRgbaHex(silex.Helper.rgbaToHex(this.style.backgroundColor)),this.setColorPaletteVisibility(!0)):this.setColorPaletteVisibility(!1)};
silex.view.propertiesTool.BgPane.prototype.onTransparentChanged=function(){if(!1===this.transparentBgCheckbox.getChecked()){var c=silex.Helper.hexToRgba(this.hsvPalette.getColorRgbaHex());c||(c="rgba(255, 255, 255, 1)");this.style.backgroundColor=c}else this.style.backgroundColor="transparent";this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.onSelectImageButton=function(){this.selectImage()};
silex.view.propertiesTool.BgPane.prototype.setBgImage=function(c){this.style.backgroundImage="url('"+c+"')";this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.setBgImageAttachement=function(c){this.style.backgroundAttachment=c;this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.setBgImagePosition=function(c){this.style.backgroundPosition=c;this.styleChanged(this.style);this.redraw()};
silex.view.propertiesTool.BgPane.prototype.setBgImageRepeat=function(c){this.style.backgroundRepeat=c;this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.onClearImageButton=function(){this.style.backgroundImage="none";this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.getColorPaletteVisibility=function(){return"hidden"!==goog.style.getStyle(this.hsvPalette.getElement(),"visibility")};
...
silex.view.propertiesTool.GeneralStylePane.prototype.redraw=function(){this.style&&!this.isRedraw&&(this.isRedraw=!0,this.opacityInput.value=this.style.opacity?this.style.opacity:"",this.isRedraw=!1)};silex.view.propertiesTool.GeneralStylePane.prototype.onInputChanged=function(c){this.style&&!this.isRedraw&&(this.style.opacity=this.opacityInput.value&&""!==this.opacityInput.value?this.opacityInput.value:"none",this.styleChanged(this.style),this.redraw())};silex.service.SilexTasks=function(){};silex.service.SilexTasks.getInstance=function(){silex.service.SilexTasks.instance||(silex.service.SilexTasks.instance=new silex.service.SilexTasks);return silex.service.SilexTasks.instance};
...
silex.view.propertiesTool.BorderPane.prototype.onResetBorder=function(){this.borderWidthInput.value="";this.onBorderChanged()};silex.view.propertiesTool.BorderPane.prototype.toggleColorPaletteVisibility=function(){this.setColorPaletteVisibility(!this.getColorPaletteVisibility())};silex.view.propertiesTool.BorderPane.prototype.getColorPaletteVisibility=function(){return"hidden"!==goog.style.getStyle(this.hsvPalette.getElement(),"visibility")};
silex.view.propertiesTool.BorderPane.prototype.setColorPaletteVisibility=function(c){c?this.getColorPaletteVisibility()||(goog.style.setStyle(this.hsvPalette.getElement(),"visibility",null),goog.style.setStyle(this.hsvPalette.getElement(),"position",null)):this.getColorPaletteVisibility()&&(goog.style.setStyle(this.hsvPalette.getElement(),"visibility","hidden"),goog.style.setStyle(this.hsvPalette.getElement(),"position","absolute"))};silex.view.PageTool=function(c,d){this.element=c;this.pages=[];this.selectedIndex=-1;silex.Helper.loadTemplateFile("templates/pagetool.html",c,function(){goog.events.listen(this.element,goog.events.EventType.CLICK,function(c){this.selectionChanged(this.pages[this.getCellIndex(c.target.parentNode)],!0)},!1,this);d&&d()},this)};
silex.view.PageTool.prototype.setPages=function(c){this.pages=c;var d=goog.dom.getElementByClass("page-tool-container",this.element),e=goog.dom.getElementByClass("page-tool-template",this.element).innerHTML;silex.Helper.resolveTemplate(d,e,{pages:c});var f=this;$(this.element).find(".page-tool-container .page-container .page-preview .delete").click(function(c){c.stopPropagation();f.removePageAtIndex(f.getCellIndex(this.parentNode.parentNode))});$(this.element).find(".page-tool-container .page-container .page-preview .label").click(function(c){c.stopPropagation();
f.renamePageAtIndex(f.getCellIndex(this.parentNode.parentNode))})};silex.view.PageTool.prototype.removePageAtIndex=function(c){if(this.onStatus)this.onStatus({type:"delete",page:this.pages[c]})};silex.view.PageTool.prototype.renamePageAtIndex=function(c){if(this.onStatus)this.onStatus({type:"rename",page:this.pages[c]})};silex.view.PageTool.prototype.selectionChanged=function(c){if(this.onStatus)this.onStatus({type:"changed",page:c})};
...
silex.view.PageTool.prototype.getCellIndex=function(c){var d=silex.model.Page.getPageByName(c.getAttribute("data-page-name"));if(d)return silex.model.Page.getPageIndex(d);console.error("Page not found for element ",c,silex.model.Page.pages);return-1};silex.view.PageTool.prototype.setSelectedIndex=function(c,d){this.selectedIndex=c;var e=0;$(".page-container",this.element).each(function(){c===e?$(this).addClass("ui-selected"):$(this).removeClass("ui-selected");e++});!1!==d&&this.selectionChanged(this.getSelectedItem())};goog.ui.ToolbarSeparatorRenderer=function(){goog.ui.MenuSeparatorRenderer.call(this)};goog.inherits(goog.ui.ToolbarSeparatorRenderer,goog.ui.MenuSeparatorRenderer);goog.addSingletonGetter(goog.ui.ToolbarSeparatorRenderer);goog.ui.ToolbarSeparatorRenderer.CSS_CLASS="goog-toolbar-separator";goog.ui.ToolbarSeparatorRenderer.prototype.createDom=function(c){return c.getDomHelper().createDom("div",this.getCssClass()+" "+goog.ui.INLINE_BLOCK_CLASSNAME,"\u00a0")};
...
!1),this.getFieldObject().dispatchSelectionChangeEvent()),c.preventDefault(),!0)};silex.view.TextEditor=function(c,d){this.element=c;silex.Helper.loadTemplateFile("templates/texteditor.html",c,function(){this.initUI();this.closeEditor();d&&d()},this);var e=new goog.ui.KeyboardShortcutHandler(document);e.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(e,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};
...
h)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
silex.view.TextEditor.prototype.openEditor=function(c){this.textField.setHtml(!1,c);this.textField.focusAndPlaceCursorAtStart();c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","inherit");goog.events.listenOnce(c,goog.events.EventType.CLICK,function(c){this.closeEditor()},!1,this)};
silex.view.TextEditor.prototype.closeEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","none");goog.style.setStyle(this.element,"display","none")};silex.view.TextEditor.prototype.getData=function(){return this.textField.getCleanContents()};silex.view.TextEditor.prototype.contentChanged=function(){if(this.onStatus)this.onStatus({type:"changed",content:this.getData()})};silex.service.CloudStorage=function(){this.filePicker=cloudExplorer};silex.service.CloudStorage.getInstance=function(){silex.service.CloudStorage.instance||(silex.service.CloudStorage.instance=new silex.service.CloudStorage);return silex.service.CloudStorage.instance};
silex.service.CloudStorage.prototype.save=function(c,d,e,f){c={url:silex.Helper.getRelativePath(c.url,silex.Helper.BaseUrl)};this.filePicker.write(c,d,function(c){(new goog.async.Delay(function(){e&&e()},10)).start()},function(c){console.error(c);f&&(console.error(c),f(c))})};
silex.service.CloudStorage.prototype.load=function(c,d,e){c={url:silex.Helper.getRelativePath(c.url,silex.Helper.BaseUrl)};this.filePicker.read(c,function(c){(new goog.async.Delay(function(){d&&d(c)},10)).start()},function(c){console.error(c);e&&(console.error(c),e(c))})};
silex.service.CloudStorage.prototype.loadLocal=function(c,d,e){goog.net.XhrIo.send(c,function(c){c=c.target;var h=c.getResponse();if(c.isSuccess())(new goog.async.Delay(function(){d&&d(h)},10)).start();else{var k=c.getLastError();console.error(k,c,c.isSuccess(),c.getStatus(),c.headers.toString());e&&(console.error(FPError),e(k))}})};silex.view.HTMLEditor=function(c,d){this.element=c;silex.Helper.loadTemplateFile("templates/htmleditor.html",c,function(){this.initUI();d&&d()},this);var e=new goog.ui.KeyboardShortcutHandler(document);e.registerShortcut("esc",goog.events.KeyCodes.ESC);goog.events.listen(e,goog.ui.KeyboardShortcutHandler.EventType.SHORTCUT_TRIGGERED,goog.bind(this.closeEditor,this))};
...
silex.view.Workspace.prototype.doRedraw=function(){this.isDirty=!1;var c=this.viewport.getSize(),d=goog.style.getSize(this.pageTool.element),e=goog.style.getSize(this.propertiesTool.element),f=goog.style.getSize(this.menu.element);goog.style.setWidth(this.stage.element,c.width-d.width-e.width);d=c.height-f.height;goog.style.setHeight(this.pageTool.element,d);goog.style.setHeight(this.propertiesTool.element,d);goog.style.setHeight(this.stage.element,d);this.htmlEditor.element&&(e=goog.style.getSize(this.htmlEditor.element),
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.htmlEditor.element,d,e));this.textEditor.element&&(e=goog.style.getSize(this.textEditor.element),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.textEditor.element,d,e));this.fileExplorer.element&&(e=goog.style.getSize(this.fileExplorer.element),d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.fileExplorer.element,d,e));this.publishSettings.element&&(e=goog.style.getSize(this.publishSettings.element),
d=(c.width-e.width)/2,e=(c.height-e.height)/2,goog.style.setPosition(this.publishSettings.element,d,e));goog.dom.classes.has(document.body,"loading-pending")&&goog.dom.classes.remove(document.body,"loading-pending")};silex.view.PropertiesTool=function(c,d){this.element=c;this.context=silex.model.Component.CONTEXT_NORMAL;silex.Helper.loadTemplateFile("templates/propertiestool.html",c,function(){this.buildTabs();this.buildPanes();d&&d()},this)};silex.view.PropertiesTool.TAB_TITLE_NORMAL="Normal";silex.view.PropertiesTool.TAB_TITLE_HOVER="Hover";silex.view.PropertiesTool.TAB_TITLE_PRESSED="Pressed";
...
silex.view.PropertiesTool.prototype.buildPanes=function(){this.bgPane=new silex.view.propertiesTool.BgPane(goog.dom.getElementByClass("background-editor",this.element),goog.bind(this.styleChanged,this),goog.bind(this.selectBgImage,this));this.borderPane=new silex.view.propertiesTool.BorderPane(goog.dom.getElementByClass("border-editor",this.element),goog.bind(this.styleChanged,this));this.propertyPane=new silex.view.propertiesTool.PropertyPane(goog.dom.getElementByClass("property-editor",this.element),
goog.bind(this.propertyChanged,this),goog.bind(this.editHTML,this),goog.bind(this.editText,this),goog.bind(this.selectImage,this));this.pagePane=new silex.view.propertiesTool.PagePane(goog.dom.getElementByClass("page-editor",this.element),goog.bind(this.propertyChanged,this));this.generalStylePane=new silex.view.propertiesTool.GeneralStylePane(goog.dom.getElementByClass("general-editor",this.element),goog.bind(this.styleChanged,this))};silex.view.PropertiesTool.prototype.selectBgImage=function(){if(this.onStatus)this.onStatus({type:"selectBgImage"})};
silex.view.PropertiesTool.prototype.setBgImage=function(c){this.bgPane.setBgImage(c)};silex.view.PropertiesTool.prototype.selectImage=function(){if(this.onStatus)this.onStatus({type:"selectImage"})};silex.view.PropertiesTool.prototype.setImage=function(c){this.propertyPane.setImage(c)};silex.view.PropertiesTool.prototype.editHTML=function(){if(this.onStatus)this.onStatus({type:"editHTML"})};silex.view.PropertiesTool.prototype.editText=function(){if(this.onStatus)this.onStatus({type:"editText"})};
silex.view.PropertiesTool.prototype.styleChanged=function(c){if(this.onStatus)this.onStatus({type:"styleChanged",style:c,context:this.context})};silex.view.PropertiesTool.prototype.propertyChanged=function(){if(this.onStatus)this.onStatus({type:"propertiesChanged",context:this.context})};
silex.view.PropertiesTool.prototype.setComponent=function(c){this.component=c;this.propertyPane.setComponent(c);this.pagePane.setComponent(c);c=this.component.getStyle()||{};this.borderPane.setStyle(c);this.bgPane.setStyle(c);this.generalStylePane.setStyle(c)};silex.view.PropertiesTool.prototype.redraw=function(){this.borderPane.redraw();this.propertyPane.redraw();this.pagePane.redraw();this.generalStylePane.redraw();this.bgPane.redraw()};silex.view.PropertiesTool.prototype.getBaseUrl=function(){return this.propertyPane.getBaseUrl()};
silex.view.PropertiesTool.prototype.setBaseUrl=function(c){this.propertyPane.setBaseUrl(c)};silex.view.PropertiesTool.prototype.setPages=function(c){this.pagePane.setPages(c)};silex.model.File=function(c,d,e,f,h,k,l,m,n){this.workspace=c;this.menu=d;this.stage=e;this.pageTool=f;this.propertiesTool=h;this.htmlEditor=k;this.textEditor=l;this.fileExplorer=m;this.publishSettings=n};silex.model.File.CREATION_TEMPLATE="creation-template.html";silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
silex.model.File.prototype.openFromUrl=function(c,d,e){silex.service.CloudStorage.getInstance().loadLocal(c,goog.bind(function(e){this.setUrl(c);this.setHtml(e);this.setBlob(null);d&&d()},this),e)};silex.model.File.prototype.saveAs=function(c,d){this.fileExplorer.saveAsDialog(goog.bind(function(e){this.setUrl(e.url);this.setBlob(e);this.save(c,d)},this),["text/html","text/plain"],d);this.workspace.invalidate()};
silex.model.File.prototype.save=function(c,d){var e=this.getBlob();this.setBodyTag(this.getStageComponent().getHtml(e.url));this.setHeadTag(this.stage.getHead());this.setBodyStyle(this.stage.getBodyStyle());silex.service.CloudStorage.getInstance().save(e,this.getHtml(),function(){c&&c()},d)};
silex.model.File.prototype.open=function(c,d){this.fileExplorer.openDialog(goog.bind(function(e){silex.service.CloudStorage.getInstance().load(e,goog.bind(function(d){this.close();this.setUrl(e.url);this.setBlob(e);this.setHtml(d);c&&c()},this),d)},this),["text/html","text/plain"],d);this.workspace.invalidate()};
silex.model.File.prototype.close=function(){this.blob=this.url=null;this.bodyTag=this.headTag="";this.setHtml("");this.stage.setBody("");this.stage.setHead("");this.stage.setBodyStyle("");this.workspace.invalidate()};
silex.model.File.prototype.refreshFontList=function(){var c=goog.dom.getElementsByTagNameAndClass("link");goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});var d=this.stage.headElement,c=goog.dom.getElementsByTagNameAndClass("link",null,d);goog.array.forEach(c,function(c){-1!==c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});c=goog.dom.getElementsByTagNameAndClass("link",null,d);goog.array.forEach(c,function(c){-1!==
c.getAttribute("href").indexOf("fonts")&&c.parentNode.removeChild(c)});var e=this.getNeededFonts(),c=goog.dom.getElementsByTagNameAndClass("font",null,d);goog.array.forEach(c,function(c){null!==c.getAttribute("face")&&(e[c.getAttribute("face")]=!0)});var f=silex.model.Config.fonts,c=function(c){for(var d in f)if(f[d].value===c)return f[d];return null},h;for(h in e){var k=c(h);if(k&&void 0!==k.href){var l=goog.dom.createElement("link");l.setAttribute("href",k.href);l.setAttribute("rel","stylesheet");
l.setAttribute("type","text/css");d.appendChild(l);l=goog.dom.createElement("link");l.setAttribute("href",k.href);l.setAttribute("rel","stylesheet");l.setAttribute("type","text/css");document.head.appendChild(l)}}};silex.model.File.prototype.getNeededFonts=function(){var c=[];this.getStageComponent().getHtml().replace(/<font[^"]*face="?([^"]*)"/g,function(d,e,f){c[e]=!0;return d});return c};silex.model.File.prototype.getStageComponent=function(){return new silex.model.Component(this.stage.bodyElement)};
silex.model.File.prototype.getBodyTag=function(){return this.bodyTag};silex.model.File.prototype.setBodyTag=function(c){this.bodyTag=c};silex.model.File.prototype.getHeadTag=function(){return this.headTag};silex.model.File.prototype.setHeadTag=function(c){this.headTag=c};silex.model.File.prototype.getUrl=function(){return this.url};silex.model.File.prototype.setUrl=function(c){this.url=c};silex.model.File.prototype.getBlob=function(){return this.blob};
silex.model.File.prototype.setBlob=function(c){(this.blob=c)?this.propertiesTool.setBaseUrl(c.url):this.propertiesTool.setBaseUrl(null)};silex.model.File.prototype.getBodyStyle=function(){return this.getStageComponent().relative2absolute(this.bodyStyle,this.getUrl())};silex.model.File.prototype.setBodyStyle=function(c){this.bodyStyle=this.getStageComponent().absolute2Relative(c,this.getUrl())};
...
1,f);this.bodyStyle=this.getStageComponent().relative2absolute(this.bodyStyle,this.getUrl());this.getStageComponent().setHtml(this.bodyTag,this.getUrl());this.stage.setHead(this.headTag);this.stage.setBodyStyle(this.bodyStyle);c=this.stage.getPagesNamesFromDom();goog.array.forEach(c,function(c){c=new silex.model.Page(c,this.workspace,this.menu,this.stage,this.pageTool,this.propertiesTool,this.textEditor,this.fileExplorer);silex.model.Page.addPage(c)},this);d=silex.model.Page.getPages();this.pageTool.setPages(d);
this.propertiesTool.setPages(d);this.pageTool.setSelectedIndex(0);(c=this.getTitle())&&this.menu.setWebsiteName(c);this.setPublicationPath(this.getPublicationPath());this.refreshFontList();this.handleRetrocompatibility()};silex.model.File.prototype.getHtml=function(){var c=this.getBodyStyle(),d;d="<html>"+("<head>"+this.headTag+"</head>");d+='<body style="'+c+'">'+this.bodyTag+"</body>";return d+="</html>"};
silex.model.File.prototype.view=function(){this.getBlob()?window.open(this.getUrl()):alertify.confirm("The file has to be saved first. Save the file now?",goog.bind(function(c){c&&this.saveAs(goog.bind(function(){window.open(this.getUrl())},this))},this))};silex.model.File.prototype.getTitle=function(){var c=this.stage.headElement.getElementsByTagName("title");return c&&0<c.length?c[0].innerHTML:null};
silex.model.File.prototype.setTitle=function(c){var d=this.stage.headElement.getElementsByTagName("title");d&&0<d.length?d[0].innerHTML=c:(d=goog.dom.createElement("title"),d.innerHTML=c,this.stage.headElement.appendChild(d));this.menu.setWebsiteName(c)};
silex.model.File.prototype.handleRetrocompatibility=function(){var c=this;$('meta[name="page"]',this.stage.headElement).each(function(){var d=this.getAttribute("content"),d=new silex.model.Page(d,c.workspace,c.menu,c.stage,c.pageTool,c.propertiesTool,c.textEditor,c.fileExplorer);console.warn("retro compat in action",this,d);d.attach();$(this).remove()})};silex.model.File.prototype.setPublicationPath=function(c){""===c&&(c=null);this.publishSettings.setPublicationPath(c);this.stage.setPublicationPath(c)};
silex.model.File.prototype.getPublicationPath=function(){return this.stage.getPublicationPath()};silex.model.File.prototype.publish=function(c,d){this.getPublicationPath()?this.cleanup(goog.bind(function(e,f,h){silex.service.SilexTasks.getInstance().publish(this.getPublicationPath(),e,f,h,c,d)},this),goog.bind(function(c){console.error("publish cleanup error",c);d&&d(c)},this)):d&&d({message:"The publication path must be set before I can clean it up for you."})};
silex.model.File.prototype.cleanup=function(c,d){var e=this.getStageComponent().getHtml(),f=this.stage.getHead(),h=[],k=[];if(this.getBlob()){var l=this.getBlob().url,l=l.substring(0,l.lastIndexOf("/")+1),e=e.replace(/<img[^"]*src="?([^" ]*)"/g,function(c,d,e){e=silex.Helper.getAbsolutePath(d,l);var f=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="assets/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,
h)}),e=e.replace(/url\((['"])(.+?)\1\)/g,goog.bind(function(c,d,e){return this.filterBgImage(l,k,c,d,e)},this)),f=f.replace(/href="?([^" ]*)"/g,function(c,d,e){var f=!1;e=silex.Helper.getAbsolutePath(d,l);var h=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(h)?0!==e.indexOf("http://static.silex.me")&&(f=!0):h=h.replace("../","/");return f?c:(f="css/"+e.substr(e.lastIndexOf("/")+1),k.push({url:e,destPath:f,srcPath:h}),c.replace(d,f))}),f=f.replace(/src="?([^"]*)"/g,
...
silex.view.propertiesTool.PagePane.prototype.onLinkChanged=function(){if("none"===this.linkDropdown.value)this.component.removeLink(),this.redraw();else if("custom"===this.linkDropdown.value){this.linkInputTextField.setValue("");var c=goog.dom.getElementByClass("link-input-text",this.element);goog.style.setStyle(c,"display","inherit")}else this.component.setLink("#"+this.linkDropdown.value),this.redraw();this.pageChanged()};
silex.view.propertiesTool.PagePane.prototype.onLinkTextChanged=function(){console.log("xxx");this.component.setLink(this.linkInputTextField.getValue());this.pageChanged()};
...
silex.view.propertiesTool.PagePane.prototype.checkPage=function(c,d){d.isChecked()?c.addComponent(this.component):c.removeComponent(this.component);this.pageChanged();this.redraw()};silex.view.propertiesTool.PagePane.prototype.unCheckAll=function(){goog.array.forEach(this.pages,function(c){c.removeComponent(this.component)},this);this.pageChanged();this.redraw()};silex.boot=function(){var c=goog.dom.getElementByClass("silex-menu"),d=new silex.view.Menu(c,function(){var c=goog.dom.getElementByClass("silex-stage"),f=new silex.view.Stage(c,function(){var c=goog.dom.getElementByClass("silex-pagetool"),e=new silex.view.PageTool(c,function(){var c=goog.dom.getElementByClass("silex-propertiestool"),h=new silex.view.PropertiesTool(c,function(){var c=goog.dom.getElementByClass("silex-htmleditor"),l=new silex.view.HTMLEditor(c,function(){var c=goog.dom.getElementByClass("silex-texteditor"),
n=new silex.view.TextEditor(c,function(){var c=goog.dom.getElementByClass("silex-fileexplorer"),q=new silex.view.FileExplorer(c,function(){var c=goog.dom.getElementByClass("silex-publishsettings"),t=new silex.view.PublishSettings(c,function(){var c=goog.dom.getElementByClass("silex-workspace"),u=new silex.view.Workspace(c,d,f,e,h,l,n,q,t),v=new silex.model.File(u,d,f,e,h,l,n,q,t),w=new silex.model.Selection(u,d,f,e,h,l,n,q,t),y=new silex.Controller(u,d,f,e,h,l,n,q,t,v,w);v.newFile(function(){silex.model.Config.debug.debugMode&&
silex.model.Config.debug.doAfterReady&&silex.model.Config.debug.doAfterReady(y,u,d,f,e,h,l,n,q,t,v,w)})})})})})})})})})};goog.exportSymbol("silex.boot",silex.boot);
