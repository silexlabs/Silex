...
!1,this);goog.events.listen(this.element,goog.events.EventType.DBLCLICK,function(c){if(this.onStatus)this.onStatus({type:"edit"})},!1,this)};silex.view.Stage.prototype.getPagesNamesFromDom=function(){var c=[];$('a[data-silex-type="page"]',this.bodyElement).each(function(){c.push(this.getAttribute("id"))});return c};
...
silex.view.propertiesTool.PagePane.prototype.buildUi=function(){this.linkDropdown=goog.dom.getElementByClass("link-combo-box",this.element);this.linkDropdown.onchange=goog.bind(this.onLinkChanged,this);var c=goog.dom.getElementByClass("link-input-text",this.element);this.linkInputTextField=new goog.ui.LabelInput;this.linkInputTextField.decorate(c);goog.style.setStyle(c,"display","none");goog.events.listen(c,goog.ui.Component.EventType.CHANGE,this.onLinkTextChanged,!1,this)};
silex.view.propertiesTool.PagePane.prototype.setComponent=function(c){this.component=c;this.redraw()};
...
silex.view.propertiesTool.PagePane.prototype.onLinkChanged=function(){if("none"===this.linkDropdown.value)this.component.removeLink();else if("custom"===this.linkDropdown.value){var c=this.linkInputTextField.getValue();0===c.indexOf("#")&&(c="");""===c&&(c="http://www.silex.me/");this.component.setLink(c)}else this.component.setLink("#"+this.linkDropdown.value);this.pageChanged();this.redraw()};
silex.view.propertiesTool.PagePane.prototype.onLinkTextChanged=function(){this.component.setLink(this.linkInputTextField.getValue());this.pageChanged()};
...
c.substr(1):(this.linkInputTextField.setValue(c),this.linkDropdown.value="custom"):this.linkDropdown.value="none";c=goog.dom.getElementByClass("link-input-text",this.element);"custom"===this.linkDropdown.value?goog.style.setStyle(c,"display","inherit"):goog.style.setStyle(c,"display","none");this.isRedraw=!1}};silex.view.propertiesTool.PagePane.prototype.checkPage=function(c,d){d.isChecked()?c.addComponent(this.component):c.removeComponent(this.component);this.pageChanged();this.redraw()};
silex.view.propertiesTool.PagePane.prototype.unCheckAll=function(){goog.array.forEach(this.pages,function(c){c.removeComponent(this.component)},this);this.pageChanged();this.redraw()};silex.boot=function(){var c=goog.dom.getElementByClass("silex-menu"),d=new silex.view.Menu(c,function(){var c=goog.dom.getElementByClass("silex-stage"),f=new silex.view.Stage(c,function(){var c=goog.dom.getElementByClass("silex-pagetool"),e=new silex.view.PageTool(c,function(){var c=goog.dom.getElementByClass("silex-propertiestool"),h=new silex.view.PropertiesTool(c,function(){var c=goog.dom.getElementByClass("silex-htmleditor"),l=new silex.view.HTMLEditor(c,function(){var c=goog.dom.getElementByClass("silex-texteditor"),
