...
silex.model.Element.prototype.createElement=function(c){var d;switch(c){case silex.model.Element.TYPE_CONTAINER:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_CONTAINER);break;case silex.model.Element.TYPE_TEXT:d=goog.dom.createElement("div");d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_TEXT);d.innerHTML="<p>New text box</p>";break;case silex.model.Element.TYPE_HTML:d=goog.dom.createElement("div");d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME;
d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_HTML);var e=goog.dom.createElement("div");e.innerHTML="<p>New HTML box</p>";goog.style.setStyle(e,"width","100%");goog.style.setStyle(e,"height","100%");goog.dom.appendChild(d,e);goog.dom.classes.add(e,silex.model.Element.ELEMENT_CONTENT_CLASS_NAME);break;case silex.model.Element.TYPE_IMAGE:d=goog.dom.createElement("div"),d.className=silex.utils.EditablePlugin.EDITABLE_CLASS_NAME,d.setAttribute(silex.model.Element.TYPE_ATTR,silex.model.Element.TYPE_IMAGE)}goog.dom.classes.add(d,
silex.utils.EditablePlugin.EDITABLE_CLASS_NAME);silex.utils.EditablePlugin.setEditable(d,!0);e=goog.dom.getElementByClass("background",this.bodyElement);e||(e=this.bodyElement);goog.style.setStyle(d,{height:"100px",width:"100px",top:100+this.bodyElement.scrollTop+"px",left:100+this.bodyElement.scrollLeft+"px",backgroundColor:"rgba(255, 255, 255, 1)",position:"absolute"});goog.dom.classes.add(d,c+"-element");goog.dom.appendChild(e,d);return d};
silex.model.Element.prototype.setSelected=function(c,d){d?(this.resetSelection(),goog.dom.classes.add(c,silex.model.Element.SELECTED_CLASS_NAME)):goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)};silex.model.Element.prototype.resetSelection=function(){var c=goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement);goog.array.forEach(c,function(c){goog.dom.classes.remove(c,silex.model.Element.SELECTED_CLASS_NAME)},this)};
silex.model.Element.prototype.getSelected=function(c){return goog.dom.classes.has(c,silex.model.Element.SELECTED_CLASS_NAME)};silex.view={};silex.view.ViewBase=function(c,d,e){this.element=c;this.bodyElement=d;this.headElement=e};silex.view.ViewBase.prototype.getSelection=function(){var c=goog.dom.getElementsByClass(silex.model.Element.SELECTED_CLASS_NAME,this.bodyElement);return c&&0!==c.length?c:[this.bodyElement]};silex.view.Menu=function(c,d,e){silex.view.ViewBase.call(this,c,d,e);this.buildMenu(c)};goog.inherits(silex.view.Menu,silex.view.ViewBase);silex.view.Menu.prototype.redraw=function(){var c=null;$("title",this.headElement).each(function(){c=this.innerHTML});this.setWebsiteName(c)};
