...
$("[href]",c).each(function(){var c=this.getAttribute("href");0===c.indexOf("#")&&0!==c.indexOf("#!")&&this.setAttribute("href",c.substr(2))});$("[data-silex-type]",c).each(function(){$(this).addClass(this.getAttribute("data-silex-type")+"-element");console.log("add class",this.getAttribute("data-silex-type"))});$("[src]",d).each(function(){var c=this.getAttribute("src");this.setAttribute("src",c.replace("http://static.silex.me/2.0","http://static.silex.me/2.1"))});$("[href]",d).each(function(){var c=
this.getAttribute("href");this.setAttribute("href",c.replace("http://static.silex.me/2.0","http://static.silex.me/2.1"))})};silex.utils.Notification=function(){throw"this is a static class and it canot be instanciated";};silex.utils.Notification.ERROR_ICON="assets/notifications/error.png";silex.utils.Notification.SUCCESS_ICON="assets/notifications/success.png";silex.utils.Notification.INFO_ICON="assets/notifications/info.png";silex.utils.Notification.useNative=function(){return window.webkitNotifications&&0===window.webkitNotifications.checkPermission()};
...
silex.controller.ControllerBase.prototype.renamePage=function(c){c||(c=silex.utils.PageablePlugin.getCurrentPageName());this.getUserInputPageName(silex.utils.PageablePlugin.getDisplayName(c),goog.bind(function(d,e){e&&(silex.utils.PageablePlugin.renamePage(c,d,e),this.openPage(d))},this))};
...
silex.controller.ControllerBase.prototype.createPage=function(c,d){this.tracker.trackAction("controller-events","request","insert.page",0);this.getUserInputPageName("Your new page name",goog.bind(function(e,f){e?(silex.utils.PageablePlugin.createPage(e,f),this.openPage(e),c&&c(),this.tracker.trackAction("controller-events","success","insert.page",1)):(d&&d(),this.tracker.trackAction("controller-events","cancel","insert.page",0))},this))};
...
e&&e(c)},this))},this),{mimetype:"text/html"})};silex.controller.ControllerBase.prototype.fileOperationSuccess=function(c,d){var e=silex.utils.PageablePlugin.getPages();silex.utils.PageablePlugin.setCurrentPage(e[0]);d&&(this.view.pageTool.redraw(),this.view.propertyTool.redraw(),this.view.menu.redraw(),this.refreshFonts());c&&silex.utils.Notification.notifySuccess(c);this.model.head.updateBrowserStyle();this.view.textEditor.redraw()};
...
(d.message||""));this.tracker.trackAction("controller-events","error",c,-1)},this));this.view.workspace.invalidate();break;case "selectImage":this.editElement();break;case "styleChanged":var f=this.view.stage.getSelection()[0];f&&d?(this.model.element.setStyle(f,d,e),this.view.propertyTool.redraw()):console.error("can not set style ",d," on element ",f);break;case "propertyChanged":console.error("not implemented");break;case "addToPage":silex.utils.PageablePlugin.addToPage(this.view.stage.getSelection()[0],
...
silex.model.File.prototype.setHtml=function(c){var d,e=c.toLowerCase(),f=e.indexOf("<head>");-1===f&&(f=e.indexOf("<head "));var h=e.indexOf("</head>"),k=e.indexOf("<body>");-1===k&&(k=e.indexOf("<body "));var l=e.indexOf("</body>");-1<f&&-1<h&&(f=e.indexOf(">",f),d=c.substring(f+1,h));-1<k&&-1<l&&(f=e.indexOf(">",k),c.substring(f+1,l));c=c.substring(k,l+7);this.bodyElement.innerHTML=c;this.headElement.innerHTML=d;silex.utils.EditablePlugin.setEditable(this.bodyElement,!0,!0)};
silex.model.File.prototype.getHtml=function(){var c=this.bodyElement.getAttribute("style")||"",d;d="<html>"+("<head>"+this.headElement.innerHTML+"</head>");d+='<body style="'+c+'">'+this.bodyElement.innerHTML+"</body>";return d+="</html>"};silex.model.File.prototype.newFile=function(c,d){this.openFromUrl(silex.model.File.CREATION_TEMPLATE,c,d)};
