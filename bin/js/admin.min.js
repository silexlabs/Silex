...
silex.model.File.prototype.cleanup=function(c,d){var e=this.getStageComponent().getHtml(),f=this.stage.getHead(),h=[],k=[];if(this.getBlob()){var l=this.getBlob().url,l=l.substring(0,l.lastIndexOf("/")+1),e=e.replace(/src="?([^" ]*)" /g,function(c,d,e){e=silex.Helper.getAbsolutePath(d,l);var f=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="assets/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,
h)}),e=e.replace(/url\((['"])(.+?)\1\)/g,function(c,d,e){c=silex.Helper.getAbsolutePath(e,l);d=silex.Helper.getRelativePath(c,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(d)||(d=d.replace("../","/"));e="assets/"+c.substr(c.lastIndexOf("/")+1);var f="url('../"+e+"')";k.push({url:c,destPath:e,srcPath:d});return f}),f=f.replace(/href="?([^" ]*)"/g,function(c,d,e){e=silex.Helper.getAbsolutePath(d,l);var f=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../",
...
e;e=goog.dom.createElement("div");e.innerHTML=f;$('meta[name="publicationPath"]',e).remove();f=goog.dom.getElementsByClass("editable-style",m);goog.array.forEach(f,function(c){c=new silex.model.Component(c);var d=c.element.getAttribute("data-silex-href");d&&(c.element.setAttribute("href",d),c.element.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c.element),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,c.element),goog.dom.removeNode(c.element),
c.element=d)},this);var f=goog.dom.getElementsByClass("editable-style",m),n=0;goog.array.forEach(f,function(c){c=new silex.model.Component(c);c.addClass("silex-"+c.type);var d="component-"+n++;c.addClass(d);var e=c.getCss(silex.model.Component.CONTEXT_NORMAL);h.push({classNames:["."+d],styles:e});c.hasStyle(silex.model.Component.CONTEXT_HOVER)&&(e=c.getCss(silex.model.Component.CONTEXT_HOVER),h.push({classNames:["."+d+":hover"],styles:e}));c.hasStyle(silex.model.Component.CONTEXT_PRESSED)&&(e=c.getCss(silex.model.Component.CONTEXT_PRESSED),
h.push({classNames:["."+d+":pressed"],styles:e}));c.removeClass("editable-style");c.element.removeAttribute("data-silex-type");c.element.removeAttribute("data-silex-sub-type");c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_NORMAL);c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_HOVER);c.element.removeAttribute("data-style-"+silex.model.Component.CONTEXT_PRESSED);c.element.removeAttribute("style")},this);f=this.stage.getBodyStyle();h.push({classNames:["body"],
styles:silex.Helper.stringToStyle(f)});var p="";goog.array.forEach(h,function(c){var d="";goog.array.forEach(c.classNames,function(c){""!=d&&(d+=", ");d+=c},this);d+="{\n\t"+silex.Helper.styleToString(c.styles)+"\n}";p+="\n"+d},this);p.replace("; ",";\n\t");e="<html>"+('<head><link href="css/styles.css" rel="stylesheet">'+e.innerHTML+"</head>");e+="<body>"+m.innerHTML+"</body>";e+="</html>";c(e,p,k)}else d&&d({message:"The file must be saved before I can clean it up for you."})};silex.view.propertiesTool.PagePane=function(c,d){this.element=c;this.pageCheckboxes=[];this.pageChanged=d;this.buildUi()};
