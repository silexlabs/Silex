...
silex.view.Menu.prototype.buildMenu=function(c){this.menu=goog.ui.menuBar.create();var d=[{label:"File",className:"menu-item-file"},{label:"Edit",className:"menu-item-edit"},{label:"View",className:"menu-item-view"},{label:"Insert",className:"menu-item-insert"},{label:"Tools",className:"menu-item-tools"},{label:"Help",className:"menu-item-help"}],e=[[{label:"New File",id:"file.new",className:"menu-item-file-new"},{label:"Open File...",id:"file.open",className:"menu-item-file-open"},{label:"Save File",
id:"file.save",className:"menu-item-file-save"},{label:"Save As...",id:"file.saveas",className:"menu-item-file-saveas"},null,{label:"Publish",id:"file.publish",className:"menu-item-file-publish"},{label:"Settings...",id:"file.publish.settings",className:"menu-item-file-publish-settings"},null,{label:"Close File",id:"file.close",className:"menu-item-file-close"}],[{label:"Delete selection",id:"edit.delete.selection",className:"menu-item-edit-delete-selection"},null,{label:"Rename page",id:"edit.rename.page",
className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],[{label:"View in new window",id:"view.file",className:"menu-item-view-file"},null,{label:"Open text editor",id:"view.open.textEditor",className:"menu-item-view-open-textEditor"},{label:"Open file browser",id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text"},{label:"Image...",id:"insert.image",
className:"menu-item-insert-image"},{label:"Container",id:"insert.container",className:"menu-item-insert-container"},null,{label:"HTML box",id:"insert.html",className:"menu-item-insert-html"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",
className:"menu-item-help-aboutSilexLabs"},{label:"Silex Labs news by email",id:"help.newsLetter",className:"menu-item-help-newsLetter"},null,{label:"Questions and answers",id:"help.forums",className:"menu-item-help-forums"},{label:"Talk with us on twitter",id:"help.twitter",className:"menu-item-help-twitter"},{label:"Talk with us on Google+",id:"help.googlPlus",className:"menu-item-help-googlPlus"},{label:"Talk with us on Facebook",id:"help.facebook",className:"menu-item-help-facebook"},null,{label:"Fork me on github!",
id:"help.forkMe",className:"menu-item-help-forkMe"}]];for(i in d){var f=new goog.ui.Menu;goog.array.forEach(e[i],function(c){var d;if(c){var e=c.id,h=c.className;d=new goog.ui.MenuItem(c.label);d.setId(e);d.addClassName(h);c.checkable&&d.setCheckable(!0)}else d=new goog.ui.MenuSeparator;d.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);f.addItem(d)});var h=new goog.ui.MenuButton(d[i].label,f);h.addClassName(d[i].className);h.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);
this.menu.addChild(h,!0)}this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,function(c){this.onMenuEvent(c)},!1,this);goog.events.listen(goog.dom.getElementByClass("website-name"),goog.events.EventType.CLICK,function(c){this.onMenuEvent(c)},!1,this)};silex.view.Menu.prototype.onMenuEvent=function(c){if(this.onStatus&&c&&c.target)if(goog.dom.classes.has(c.target,"website-name")){if(this.onStatus)this.onStatus({type:"title.changed"})}else this.onStatus({type:c.target.getId()})};
...
case goog.editor.plugins.BasicTextFormatter.COMMAND.INDENT:case goog.editor.plugins.BasicTextFormatter.COMMAND.OUTDENT:case goog.editor.plugins.BasicTextFormatter.COMMAND.HORIZONTAL_RULE:return!1;case goog.editor.plugins.BasicTextFormatter.COMMAND.FONT_SIZE:case goog.editor.plugins.BasicTextFormatter.COMMAND.FONT_FACE:case goog.editor.plugins.BasicTextFormatter.COMMAND.FONT_COLOR:case goog.editor.plugins.BasicTextFormatter.COMMAND.BACKGROUND_COLOR:return console.log("Use HAS_STYLE_WITH_CSS",goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS+
" xxx"),this.queryCommandValueInternal_(this.getDocument_(),c,goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS&&goog.userAgent.GECKO);case goog.editor.plugins.BasicTextFormatter.COMMAND.UNDERLINE:case goog.editor.plugins.BasicTextFormatter.COMMAND.BOLD:case goog.editor.plugins.BasicTextFormatter.COMMAND.ITALIC:console.log("Use HAS_STYLE_WITH_CSS",goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS+" xxx"),d=goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS&&goog.userAgent.GECKO;default:return this.queryCommandStateInternal_(this.getDocument_(),
c,d)}};goog.editor.plugins.BasicTextFormatter.prototype.prepareContentsHtml=function(c){goog.editor.BrowserFeature.COLLAPSES_EMPTY_NODES&&c.match(/^\s*<script/i)&&(c="&nbsp;"+c);goog.editor.BrowserFeature.CONVERT_TO_B_AND_I_TAGS&&(c=c.replace(/<(\/?)strong([^\w])/gi,"<$1b$2"),c=c.replace(/<(\/?)em([^\w])/gi,"<$1i$2"));return c};
...
goog.editor.BrowserFeature.DOESNT_OVERRIDE_FONT_SIZE_IN_STYLE_ATTR&&"fontsize"==c.toLowerCase()&&this.removeFontSizeFromStyleAttrs_();e=this.getDocument_();console.log("Use HAS_STYLE_WITH_CSS",goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS+" xxx");f&&goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS&&(e.execCommand("styleWithCSS",!1,!0),goog.userAgent.OPERA&&this.invalidateInlineCss_());e.execCommand(c,!1,d);f&&goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS&&e.execCommand("styleWithCSS",!1,!1);goog.userAgent.WEBKIT&&
(!goog.userAgent.isVersionOrHigher("526")&&"formatblock"==c.toLowerCase()&&d&&/^[<]?h\d[>]?$/i.test(d))&&this.cleanUpSafariHeadings_();/insert(un)?orderedlist/i.test(c)&&(goog.userAgent.WEBKIT&&!goog.userAgent.isVersionOrHigher(534)&&this.fixSafariLists_(),goog.userAgent.IE&&(this.fixIELists_(),l&&goog.dom.removeNode(l)));k&&goog.dom.removeNode(k);h&&this.getFieldObject().execCommand(h)};
