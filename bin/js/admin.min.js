...
goog.ui.MenuButton.prototype.attachPopupListeners_=function(c){var d=this.getHandler(),e=c?d.listen:d.unlisten;e.call(d,this.getDomHelper().getDocument(),goog.events.EventType.MOUSEDOWN,this.handleDocumentMouseDown,!0);this.isFocusablePopupMenu()&&e.call(d,this.menu_,goog.ui.Component.EventType.BLUR,this.handleMenuBlur);e.call(d,this.timer_,goog.Timer.TICK,this.onTick_);c?this.timer_.start():this.timer_.stop()};goog.ui.registry.setDecoratorByClassName(goog.ui.MenuButtonRenderer.CSS_CLASS,function(){return new goog.ui.MenuButton(null)});silex.model.Config={};function getAllCombinations(c,d){return["ctrl+"+d,"alt+"+d,"command+"+d,"ctrl+shift+"+d,"alt+shift+"+d,"command+shift+"+d,"ctrl+"+c+" ctrl+"+d,"alt+"+c+" alt+"+d,"command+"+c+" command+"+d,"ctrl+shift+"+c+" ctrl+shift+"+d,"alt+shift+"+c+" alt+shift+"+d,"command+shift+"+c+" command+shift+"+d]}
silex.model.Config.menu={names:[{label:"File",className:"menu-item-file",shortcut:["mod+shift+f"],tooltip:"ctrl+\u21ea+f"},{label:"Edit",className:"menu-item-edit",shortcut:["mod+shift+e"],tooltip:"ctrl+\u21ea+e"},{label:"View",className:"menu-item-view",shortcut:["mod+shift+v"],tooltip:"ctrl+\u21ea+v"},{label:"Insert",className:"menu-item-insert",shortcut:["mod+shift+i"],tooltip:"ctrl+\u21ea+i"},{label:"Tools",className:"menu-item-tools",shortcut:["mod+shift+t"],tooltip:"ctrl+\u21ea+t"},{label:"Help",
className:"menu-item-help",shortcut:["mod+shift+h"],tooltip:"ctrl+\u21ea+h"}],options:[[{label:"New File",id:"file.new",className:"menu-item-file-new",shortcut:getAllCombinations("f","n"),tooltip:"ctrl+fn"},{label:"Open File...",id:"file.open",className:"menu-item-file-open",shortcut:getAllCombinations("f","o"),tooltip:"ctrl+fo"},{label:"Save File",id:"file.save",className:"menu-item-file-save",shortcut:getAllCombinations("f","s"),tooltip:"ctrl+fs"},{label:"Save As...",id:"file.saveas",className:"menu-item-file-saveas",
shortcut:getAllCombinations("f","s"),tooltip:"ctrl+\u21ea+fs"},null,{label:"Publish",id:"file.publish",className:"menu-item-file-publish",shortcut:getAllCombinations("f","p"),tooltip:"ctrl+\u21ea+fp"},{label:"Settings...",id:"file.publish.settings",className:"menu-item-file-publish-settings"},null,{label:"Close File",id:"file.close",className:"menu-item-file-close",shortcut:getAllCombinations("f","w"),tooltip:"ctrl+fw"}],[{label:"Delete selection",id:"edit.delete.selection",className:"menu-item-edit-delete-selection",
shortcut:["del","backspace"],tooltip:"suppr"},null,{label:"Rename page",id:"edit.rename.page",className:"menu-item-edit-rename-page"},{label:"Delete page",id:"edit.delete.page",className:"menu-item-edit-delete-page"}],[{label:"View in new window",id:"view.file",className:"menu-item-view-file",shortcut:getAllCombinations("v","n"),tooltip:"ctrl+\u21ea+vn"},null,{label:"Open text editor",id:"view.open.textEditor",className:"menu-item-view-open-textEditor",shortcut:["enter"],tooltip:"\u21b5"},{label:"Open file browser",
id:"view.open.fileExplorer",className:"menu-item-view-open-fileExplorer"}],[{label:"Text box",id:"insert.text",className:"menu-item-insert-text",shortcut:getAllCombinations("i","t"),tooltip:"ctrl+\u21ea+it"},{label:"Image...",id:"insert.image",className:"menu-item-insert-image",shortcut:getAllCombinations("i","i"),tooltip:"ctrl+\u21ea+ii"},{label:"Container",id:"insert.container",className:"menu-item-insert-container",shortcut:getAllCombinations("i","c"),tooltip:"ctrl+\u21ea+ic"},null,{label:"HTML box",
id:"insert.html",className:"menu-item-insert-html",shortcut:getAllCombinations("i","h"),tooltip:"ctrl+\u21ea+ih"},null,{label:"New page",id:"insert.page",className:"menu-item-insert-page",shortcut:getAllCombinations("i","n"),tooltip:"ctrl+\u21ea+in"}],[{label:"Apollo mode",id:"tools.advanced.activate",className:"menu-item-tools-advanced.activate",checkable:!0}],[{label:"About Silex",id:"help.about",className:"menu-item-help-about"},{label:"About Silex Labs",id:"help.aboutSilexLabs",className:"menu-item-help-aboutSilexLabs"},
...
goog.ui.PopupBase.prototype.shouldDebounce_=function(){return goog.now()-this.lastShowTime_<goog.ui.PopupBase.DEBOUNCE_DELAY_MS};goog.ui.PopupBase.prototype.disposeInternal=function(){goog.ui.PopupBase.superClass_.disposeInternal.call(this);this.handler_.dispose();goog.dispose(this.showTransition_);goog.dispose(this.hideTransition_);delete this.element_;delete this.handler_};goog.positioning.ViewportPosition=function(c,d){this.coordinate=c instanceof goog.math.Coordinate?c:new goog.math.Coordinate(c,d)};goog.inherits(goog.positioning.ViewportPosition,goog.positioning.AbstractPosition);goog.positioning.ViewportPosition.prototype.reposition=function(c,d,e,f){goog.positioning.positionAtAnchor(goog.style.getClientViewportElement(c),goog.positioning.Corner.TOP_LEFT,c,d,this.coordinate,e,null,f)};goog.positioning.ClientPosition=function(c,d){this.coordinate=c instanceof goog.math.Coordinate?c:new goog.math.Coordinate(c,d)};goog.inherits(goog.positioning.ClientPosition,goog.positioning.AbstractPosition);
goog.positioning.ClientPosition.prototype.reposition=function(c,d,e,f){goog.asserts.assert(c);var h=goog.style.getViewportPageOffset(goog.dom.getOwnerDocument(c)),k=this.coordinate.x+h.x,h=this.coordinate.y+h.y,l=goog.positioning.getOffsetParentPageOffset(c),k=k-l.x,h=h-l.y;goog.positioning.positionAtCoordinate(new goog.math.Coordinate(k,h),c,d,e,null,null,f)};goog.positioning.ViewportClientPosition=function(c,d){goog.positioning.ClientPosition.call(this,c,d)};goog.inherits(goog.positioning.ViewportClientPosition,goog.positioning.ClientPosition);goog.positioning.ViewportClientPosition.prototype.lastResortOverflow_=0;goog.positioning.ViewportClientPosition.prototype.setLastResortOverflow=function(c){this.lastResortOverflow_=c};
goog.positioning.ViewportClientPosition.prototype.reposition=function(c,d,e,f){var h=goog.style.getClientViewportElement(c),h=goog.style.getVisibleRectForElement(h),k=goog.dom.getDomHelper(c).getDocumentScrollElement(),k=new goog.math.Coordinate(this.coordinate.x+k.scrollLeft,this.coordinate.y+k.scrollTop),l=goog.positioning.Overflow.FAIL_X|goog.positioning.Overflow.FAIL_Y,m=d,n=goog.positioning.positionAtCoordinate(k,c,m,e,h,l,f);if(0!=(n&goog.positioning.OverflowStatus.FAILED)){if(n&goog.positioning.OverflowStatus.FAILED_LEFT||
n&goog.positioning.OverflowStatus.FAILED_RIGHT)m=goog.positioning.flipCornerHorizontal(m);if(n&goog.positioning.OverflowStatus.FAILED_TOP||n&goog.positioning.OverflowStatus.FAILED_BOTTOM)m=goog.positioning.flipCornerVertical(m);n=goog.positioning.positionAtCoordinate(k,c,m,e,h,l,f);0!=(n&goog.positioning.OverflowStatus.FAILED)&&goog.positioning.positionAtCoordinate(k,c,d,e,h,this.lastResortOverflow_,f)}};goog.positioning.AbsolutePosition=function(c,d){this.coordinate=c instanceof goog.math.Coordinate?c:new goog.math.Coordinate(c,d)};goog.inherits(goog.positioning.AbsolutePosition,goog.positioning.AbstractPosition);goog.positioning.AbsolutePosition.prototype.reposition=function(c,d,e,f){goog.positioning.positionAtCoordinate(this.coordinate,c,d,e,null,null,f)};goog.ui.Popup=function(c,d){this.popupCorner_=goog.positioning.Corner.TOP_START;this.position_=d||void 0;goog.ui.PopupBase.call(this,c)};goog.inherits(goog.ui.Popup,goog.ui.PopupBase);goog.ui.Popup.Corner=goog.positioning.Corner;goog.ui.Popup.Overflow=goog.positioning.Overflow;goog.ui.Popup.prototype.getPinnedCorner=function(){return this.popupCorner_};goog.ui.Popup.prototype.setPinnedCorner=function(c){this.popupCorner_=c;this.isVisible()&&this.reposition()};
goog.ui.Popup.prototype.getPosition=function(){return this.position_||null};goog.ui.Popup.prototype.setPosition=function(c){this.position_=c||void 0;this.isVisible()&&this.reposition()};goog.ui.Popup.prototype.getMargin=function(){return this.margin_||null};goog.ui.Popup.prototype.setMargin=function(c,d,e,f){this.margin_=null==c||c instanceof goog.math.Box?c:new goog.math.Box(c,d,e,f);this.isVisible()&&this.reposition()};
goog.ui.Popup.prototype.reposition=function(){if(this.position_){var c=!this.isVisible()&&this.getType()!=goog.ui.PopupBase.Type.MOVE_OFFSCREEN,d=this.getElement();c&&(d.style.visibility="hidden",goog.style.setElementShown(d,!0));this.position_.reposition(d,this.popupCorner_,this.margin_);c&&goog.style.setElementShown(d,!1)}};goog.ui.Popup.AnchoredPosition=goog.positioning.AnchoredPosition;goog.ui.Popup.AnchoredViewPortPosition=goog.positioning.AnchoredViewportPosition;
goog.ui.Popup.AbsolutePosition=goog.positioning.AbsolutePosition;goog.ui.Popup.ViewPortPosition=goog.positioning.ViewportPosition;goog.ui.Popup.ClientPosition=goog.positioning.ClientPosition;goog.ui.Popup.ViewPortClientPosition=goog.positioning.ViewportClientPosition;goog.structs={};goog.structs.Collection=function(){};goog.structs.getCount=function(c){return"function"==typeof c.getCount?c.getCount():goog.isArrayLike(c)||goog.isString(c)?c.length:goog.object.getCount(c)};goog.structs.getValues=function(c){if("function"==typeof c.getValues)return c.getValues();if(goog.isString(c))return c.split("");if(goog.isArrayLike(c)){for(var d=[],e=c.length,f=0;f<e;f++)d.push(c[f]);return d}return goog.object.getValues(c)};
...
goog.structs.Set.prototype.equals=function(c){return this.getCount()==goog.structs.getCount(c)&&this.isSubsetOf(c)};goog.structs.Set.prototype.isSubsetOf=function(c){var d=goog.structs.getCount(c);if(this.getCount()>d)return!1;!(c instanceof goog.structs.Set)&&5<d&&(c=new goog.structs.Set(c));return goog.structs.every(this,function(d){return goog.structs.contains(c,d)})};goog.structs.Set.prototype.__iterator__=function(c){return this.map_.__iterator__(!1)};goog.ui.Tooltip=function(c,d,e){this.dom_=e||(c?goog.dom.getDomHelper(goog.dom.getElement(c)):goog.dom.getDomHelper());goog.ui.Popup.call(this,this.dom_.createDom("div",{style:"position:absolute;display:none;"}));this.cursorPosition=new goog.math.Coordinate(1,1);this.elements_=new goog.structs.Set;c&&this.attach(c);null!=d&&this.setText(d)};goog.inherits(goog.ui.Tooltip,goog.ui.Popup);goog.ui.Tooltip.activeInstances_=[];goog.ui.Tooltip.prototype.activeEl_=null;
...
goog.ui.Tooltip.prototype.attach=function(c){c=goog.dom.getElement(c);this.elements_.add(c);goog.events.listen(c,goog.events.EventType.MOUSEOVER,this.handleMouseOver,!1,this);goog.events.listen(c,goog.events.EventType.MOUSEOUT,this.handleMouseOutAndBlur,!1,this);goog.events.listen(c,goog.events.EventType.MOUSEMOVE,this.handleMouseMove,!1,this);goog.events.listen(c,goog.events.EventType.FOCUS,this.handleFocus,!1,this);goog.events.listen(c,goog.events.EventType.BLUR,this.handleMouseOutAndBlur,!1,this)};
goog.ui.Tooltip.prototype.detach=function(c){if(c)c=goog.dom.getElement(c),this.detachElement_(c),this.elements_.remove(c);else{for(var d=this.elements_.getValues(),e=0;c=d[e];e++)this.detachElement_(c);this.elements_.clear()}};
goog.ui.Tooltip.prototype.detachElement_=function(c){goog.events.unlisten(c,goog.events.EventType.MOUSEOVER,this.handleMouseOver,!1,this);goog.events.unlisten(c,goog.events.EventType.MOUSEOUT,this.handleMouseOutAndBlur,!1,this);goog.events.unlisten(c,goog.events.EventType.MOUSEMOVE,this.handleMouseMove,!1,this);goog.events.unlisten(c,goog.events.EventType.FOCUS,this.handleFocus,!1,this);goog.events.unlisten(c,goog.events.EventType.BLUR,this.handleMouseOutAndBlur,!1,this)};
goog.ui.Tooltip.prototype.setShowDelayMs=function(c){this.showDelayMs_=c};goog.ui.Tooltip.prototype.getShowDelayMs=function(){return this.showDelayMs_};goog.ui.Tooltip.prototype.setHideDelayMs=function(c){this.hideDelayMs_=c};goog.ui.Tooltip.prototype.getHideDelayMs=function(){return this.hideDelayMs_};goog.ui.Tooltip.prototype.setText=function(c){goog.dom.setTextContent(this.getElement(),c)};goog.ui.Tooltip.prototype.setHtml=function(c){this.getElement().innerHTML=c};
goog.ui.Tooltip.prototype.setElement=function(c){var d=this.getElement();d&&goog.dom.removeNode(d);goog.ui.Tooltip.superClass_.setElement.call(this,c);c&&(d=this.dom_.getDocument().body,d.insertBefore(c,d.lastChild))};goog.ui.Tooltip.prototype.getText=function(){return goog.dom.getTextContent(this.getElement())};goog.ui.Tooltip.prototype.getHtml=function(){return this.getElement().innerHTML};
goog.ui.Tooltip.prototype.getState=function(){return this.showTimer?this.isVisible()?goog.ui.Tooltip.State.UPDATING:goog.ui.Tooltip.State.WAITING_TO_SHOW:this.hideTimer?goog.ui.Tooltip.State.WAITING_TO_HIDE:this.isVisible()?goog.ui.Tooltip.State.SHOWING:goog.ui.Tooltip.State.INACTIVE};goog.ui.Tooltip.prototype.setRequireInteraction=function(c){this.requireInteraction_=c};
goog.ui.Tooltip.prototype.isCoordinateInTooltip=function(c){if(!this.isVisible())return!1;var d=goog.style.getPageOffset(this.getElement()),e=goog.style.getSize(this.getElement());return d.x<=c.x&&c.x<=d.x+e.width&&d.y<=c.y&&c.y<=d.y+e.height};
goog.ui.Tooltip.prototype.onBeforeShow=function(){if(!goog.ui.PopupBase.prototype.onBeforeShow.call(this))return!1;if(this.anchor)for(var c,d=0;c=goog.ui.Tooltip.activeInstances_[d];d++)goog.dom.contains(c.getElement(),this.anchor)||c.setVisible(!1);goog.array.insert(goog.ui.Tooltip.activeInstances_,this);c=this.getElement();c.className=this.className;this.clearHideTimer();goog.events.listen(c,goog.events.EventType.MOUSEOVER,this.handleTooltipMouseOver,!1,this);goog.events.listen(c,goog.events.EventType.MOUSEOUT,
this.handleTooltipMouseOut,!1,this);this.clearShowTimer();return!0};
goog.ui.Tooltip.prototype.onHide_=function(){goog.array.remove(goog.ui.Tooltip.activeInstances_,this);for(var c=this.getElement(),d,e=0;d=goog.ui.Tooltip.activeInstances_[e];e++)d.anchor&&goog.dom.contains(c,d.anchor)&&d.setVisible(!1);this.parentTooltip_&&this.parentTooltip_.startHideTimer();goog.events.unlisten(c,goog.events.EventType.MOUSEOVER,this.handleTooltipMouseOver,!1,this);goog.events.unlisten(c,goog.events.EventType.MOUSEOUT,this.handleTooltipMouseOut,!1,this);this.anchor=void 0;this.getState()==
goog.ui.Tooltip.State.INACTIVE&&(this.seenInteraction_=!1);goog.ui.PopupBase.prototype.onHide_.call(this)};goog.ui.Tooltip.prototype.maybeShow=function(c,d){this.anchor==c&&this.elements_.contains(this.anchor)&&(this.seenInteraction_||!this.requireInteraction_?(this.setVisible(!1),this.isVisible()||this.positionAndShow_(c,d)):this.anchor=void 0);this.showTimer=void 0};goog.ui.Tooltip.prototype.getElements=function(){return this.elements_};goog.ui.Tooltip.prototype.getActiveElement=function(){return this.activeEl_};
goog.ui.Tooltip.prototype.setActiveElement=function(c){this.activeEl_=c};goog.ui.Tooltip.prototype.showForElement=function(c,d){this.attach(c);this.activeEl_=c;this.positionAndShow_(c,d)};goog.ui.Tooltip.prototype.positionAndShow_=function(c,d){this.anchor=c;this.setPosition(d||this.getPositioningStrategy(goog.ui.Tooltip.Activation.CURSOR));this.setVisible(!0)};
goog.ui.Tooltip.prototype.maybeHide=function(c){this.hideTimer=void 0;c==this.anchor&&(null!=this.activeEl_&&(this.activeEl_==this.getElement()||this.elements_.contains(this.activeEl_))||this.hasActiveChild()||this.setVisible(!1))};goog.ui.Tooltip.prototype.hasActiveChild=function(){return!(!this.childTooltip_||!this.childTooltip_.activeEl_)};
goog.ui.Tooltip.prototype.saveCursorPosition_=function(c){var d=this.dom_.getDocumentScroll();this.cursorPosition.x=c.clientX+d.x;this.cursorPosition.y=c.clientY+d.y};goog.ui.Tooltip.prototype.handleMouseOver=function(c){var d=this.getAnchorFromElement(c.target);this.activeEl_=d;this.clearHideTimer();d!=this.anchor&&(this.anchor=d,this.startShowTimer(d),this.checkForParentTooltip_(),this.saveCursorPosition_(c))};
goog.ui.Tooltip.prototype.getAnchorFromElement=function(c){try{for(;c&&!this.elements_.contains(c);)c=c.parentNode;return c}catch(d){return null}};goog.ui.Tooltip.prototype.handleMouseMove=function(c){this.saveCursorPosition_(c);this.seenInteraction_=!0};
goog.ui.Tooltip.prototype.handleFocus=function(c){this.activeEl_=c=this.getAnchorFromElement(c.target);this.seenInteraction_=!0;if(this.anchor!=c){this.anchor=c;var d=this.getPositioningStrategy(goog.ui.Tooltip.Activation.FOCUS);this.clearHideTimer();this.startShowTimer(c,d);this.checkForParentTooltip_()}};goog.ui.Tooltip.prototype.getPositioningStrategy=function(c){return c==goog.ui.Tooltip.Activation.CURSOR?(c=this.cursorPosition.clone(),new goog.ui.Tooltip.CursorTooltipPosition(c)):new goog.ui.Tooltip.ElementTooltipPosition(this.activeEl_)};
goog.ui.Tooltip.prototype.checkForParentTooltip_=function(){if(this.anchor)for(var c,d=0;c=goog.ui.Tooltip.activeInstances_[d];d++)goog.dom.contains(c.getElement(),this.anchor)&&(c.childTooltip_=this,this.parentTooltip_=c)};
goog.ui.Tooltip.prototype.handleMouseOutAndBlur=function(c){var d=this.getAnchorFromElement(c.target),e=this.getAnchorFromElement(c.relatedTarget);d!=e&&(d==this.activeEl_&&(this.activeEl_=null),this.clearShowTimer(),this.seenInteraction_=!1,!this.isVisible()||c.relatedTarget&&goog.dom.contains(this.getElement(),c.relatedTarget)?this.anchor=void 0:this.startHideTimer())};
goog.ui.Tooltip.prototype.handleTooltipMouseOver=function(c){c=this.getElement();this.activeEl_!=c&&(this.clearHideTimer(),this.activeEl_=c)};goog.ui.Tooltip.prototype.handleTooltipMouseOut=function(c){var d=this.getElement();this.activeEl_!=d||c.relatedTarget&&goog.dom.contains(d,c.relatedTarget)||(this.activeEl_=null,this.startHideTimer())};goog.ui.Tooltip.prototype.startShowTimer=function(c,d){this.showTimer||(this.showTimer=goog.Timer.callOnce(goog.bind(this.maybeShow,this,c,d),this.showDelayMs_))};
...
goog.ui.Tooltip.prototype.disposeInternal=function(){this.setVisible(!1);this.clearShowTimer();this.detach();this.getElement()&&goog.dom.removeNode(this.getElement());this.activeEl_=null;delete this.dom_;goog.ui.Tooltip.superClass_.disposeInternal.call(this)};goog.ui.Tooltip.CursorTooltipPosition=function(c,d){goog.positioning.ViewportPosition.call(this,c,d)};goog.inherits(goog.ui.Tooltip.CursorTooltipPosition,goog.positioning.ViewportPosition);
goog.ui.Tooltip.CursorTooltipPosition.prototype.reposition=function(c,d,e){d=goog.style.getClientViewportElement(c);d=goog.style.getVisibleRectForElement(d);e=e?new goog.math.Box(e.top+10,e.right,e.bottom,e.left+10):new goog.math.Box(10,0,0,10);goog.positioning.positionAtCoordinate(this.coordinate,c,goog.positioning.Corner.TOP_START,e,d,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.FAIL_Y)&goog.positioning.OverflowStatus.FAILED&&goog.positioning.positionAtCoordinate(this.coordinate,
c,goog.positioning.Corner.TOP_START,e,d,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.ADJUST_Y)};goog.ui.Tooltip.ElementTooltipPosition=function(c){goog.positioning.AnchoredPosition.call(this,c,goog.positioning.Corner.BOTTOM_RIGHT)};goog.inherits(goog.ui.Tooltip.ElementTooltipPosition,goog.positioning.AnchoredPosition);
goog.ui.Tooltip.ElementTooltipPosition.prototype.reposition=function(c,d,e){var f=new goog.math.Coordinate(10,0);goog.positioning.positionAtAnchor(this.element,this.corner,c,d,f,e,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.FAIL_Y)&goog.positioning.OverflowStatus.FAILED&&goog.positioning.positionAtAnchor(this.element,goog.positioning.Corner.TOP_RIGHT,c,goog.positioning.Corner.BOTTOM_LEFT,f,e,goog.positioning.Overflow.ADJUST_X|goog.positioning.Overflow.ADJUST_Y)};silex.view={};silex.view.Menu=function(c,d){this.element=c;silex.Helper.loadTemplateFile("templates/menu.html",c,function(){this.buildMenu(c);d&&d()},this)};
silex.view.Menu.prototype.buildMenu=function(c){this.menu=goog.ui.menuBar.create();for(i in silex.model.Config.menu.names){var d=new goog.ui.Menu;goog.array.forEach(silex.model.Config.menu.options[i],function(c){var e;if(c){var f=c.id,m=c.className;e=new goog.ui.MenuItem(c.label);e.setId(f);e.addClassName(m);c.checkable&&e.setCheckable(!0);c.shortcut&&Mousetrap.bind(c.shortcut,goog.bind(function(d,e){console.log("shortcut",c,e);d.preventDefault();this.onMenuEvent(c.id)},this))}else e=new goog.ui.MenuSeparator;
e.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);d.addItem(e);c&&c.tooltip&&(f=goog.dom.createElement("small"),f.innerHTML=c.tooltip,f.className="shortcut-display",e.getElement().appendChild(f),new goog.ui.Tooltip(e.getElement(),c.tooltip))},this);var e=silex.model.Config.menu.names[i],f=new goog.ui.MenuButton(e.label,d);f.addClassName(e.className);f.setDispatchTransitionEvents(goog.ui.Component.State.ALL,!0);this.menu.addChild(f,!0)}this.menu.render(c);goog.events.listen(this.menu,goog.ui.Component.EventType.ACTION,
...
silex.view.Stage.prototype.getHead=function(){return this.headElement.innerHTML};silex.view.Stage.prototype.setBodyStyle=function(c){this.bodyElement.setAttribute("data-style-normal",c);this.bodyElement.setAttribute("style",c)};silex.view.Stage.prototype.getBodyStyle=function(){return this.bodyElement.getAttribute("data-style-normal")};silex.view.PublishSettings=function(c,d){this.element=c;this.publicationPath="";goog.style.setStyle(this.element,"display","none");silex.Helper.loadTemplateFile("templates/publishsettings.html",c,function(){var c=goog.dom.getElementByClass("close-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this);c=goog.dom.getElementByClass("browse-btn",this.element);goog.events.listen(c,goog.events.EventType.CLICK,function(){this.onStatus({type:"browsePublishPath"})},
!1,this);var f=goog.dom.getElementByClass("input-publication-path");goog.events.listen(f,goog.ui.Component.EventType.CHANGE,function(){this.onStatus({type:"change",data:f.value})},!1,this);d&&d()},this)};silex.view.PublishSettings.prototype.setPublicationPath=function(c){this.publicationPath=c;this.redraw()};silex.view.PublishSettings.prototype.redraw=function(){goog.dom.getElementByClass("input-publication-path").value=this.publicationPath};
...
d);this.tracker.trackAction("controller-events","error",c.type,-1)},this)):(this.publishSettings.openDialog(),this.workspace.invalidate());break;case "file.save":this.file.getBlob()?this.file.save(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,
-1)},this)):this.file.saveAs(goog.bind(function(){this.notifySuccess("Your file is saved.");this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to save the file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));break;case "file.open":this.file.open(goog.bind(function(){this.notifySuccess(this.file.getTitle()+" opened.");this.selection.setComponent(this.file.getStageComponent());
this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(d){this.notifyError("Error: I did not manage to open this file. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));break;case "file.close":this.file.close();this.selection.setComponent(null);break;case "view.file":this.file.view();break;case "tools.advanced.activate":goog.dom.classes.has(document.body,"advanced-mode-on")?(goog.dom.classes.remove(document.body,
"advanced-mode-on"),goog.dom.classes.add(document.body,"advanced-mode-off")):(goog.dom.classes.add(document.body,"advanced-mode-on"),goog.dom.classes.remove(document.body,"advanced-mode-off"));break;case "tools.debug.activate":this.logger.getLevel()!==silex.Logger.ALL?this.logger.setLevel(silex.Logger.ALL):this.logger.setLevel(silex.Logger.OFF);break;case "view.open.fileExplorer":this.fileExplorer.openDialog();this.workspace.invalidate();break;case "view.open.textEditor":this.editComponent();break;
case "insert.page":this.createPage(goog.bind(function(){this.tracker.trackAction("controller-events","success",c.type,1)},this),goog.bind(function(){this.tracker.trackAction("controller-events","cancel",c.type,0)},this));break;case "insert.text":var d=this.file.getStageComponent().addText();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "insert.html":d=this.file.getStageComponent().addHtml();this.selection.getPage().addComponent(d);this.selection.setComponent(d);
break;case "insert.image":this.fileExplorer.openDialog(goog.bind(function(d){d=this.file.getStageComponent().addImage(d.url);this.selection.getPage().addComponent(d);this.selection.setComponent(d);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],["jpg","gif","png"],goog.bind(function(d){this.notifyError("Error: I did not manage to load the image. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));this.workspace.invalidate();
break;case "insert.container":d=this.file.getStageComponent().addContainer();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "edit.delete.selection":this.file.getStageComponent().remove(this.selection.getComponent());this.selection.setComponent(this.file.getStageComponent());break;case "edit.delete.page":this.removePage(this.selection.getPage());break;case "edit.rename.page":this.renamePage(this.selection.getPage());break;case "help.about":window.open("http://www.silexlabs.org/silex/");
break;case "help.aboutSilexLabs":window.open("http://www.silexlabs.org/silexlabs/");break;case "help.forums":window.open("http://graphicdesign.stackexchange.com/questions/tagged/silex");break;case "help.newsLetter":window.open("http://eepurl.com/F48q5");break;case "help.googlPlus":window.open("https://plus.google.com/communities/107373636457908189681");break;case "help.twitter":window.open("http://twitter.com/silexlabs");break;case "help.facebook":window.open("http://www.facebook.com/silexlabs");
break;case "help.forkMe":window.open("https://github.com/silexlabs/Silex")}};
silex.Controller.prototype.stageCallback=function(c){switch(c.type){case "select":var d=this.selection.getComponent();d&&d.setContext(silex.model.Component.CONTEXT_NORMAL);c.element?(this.selection.setComponent(new silex.model.Component(c.element,this.selection.getContext())),this.selection.getComponent().setContext(this.selection.getContext())):this.selection.setComponent(this.file.getStageComponent());break;case "change":this.selection.getComponent().setBoundingBox(this.selection.getComponent().getBoundingBox());this.propertiesTool.redraw();
break;case "newContainer":c=this.selection.getComponent();if(null!==c.getFirstPageableParent()){d=silex.model.Page.getPagesForElement(c.element);for(idx in d)d[idx].removeComponent(c);this.propertiesTool.redraw()}break;case "edit":this.editComponent()}};
...
silex.Controller.prototype.publishSettingsCallback=function(c){switch(c.type){case "browsePublishPath":this.fileExplorer.openDialog(goog.bind(function(d){d=d.url.substring(d.url.indexOf("/api/v1.0/"),d.url.lastIndexOf("/"));d=d.replace("/exec/get","/exec/put");this.file.setPublicationPath(d);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],["jpg","gif","png"],goog.bind(function(d){this.notifyError("Error: I could not select the publish path. <br /><br />"+
(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));break;case "change":this.file.setPublicationPath(c.data)}};
silex.Controller.prototype.propertiesToolCallback=function(c){switch(c.type){case "editHTML":this.editComponent();break;case "editText":this.editComponent();break;case "selectBgImage":this.fileExplorer.openDialog(goog.bind(function(d){this.propertiesTool.setBgImage(d.url);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],["jpg","gif","png"],goog.bind(function(d){this.notifyError("Error: I could not load the image. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events",
...
silex.view.FileExplorer.prototype.init=function(){this.filePicker=silex.service.CloudStorage.getInstance().filePicker};
silex.view.FileExplorer.prototype.openDialog=function(c,d,e,f){d||(d=["image/*","text/plain"]);var h=function(c){console.error(c);f&&f(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d)},10,this)).start()};this.filePicker.pick(goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");c.url=silex.Helper.getAbsolutePath(c.url,silex.Helper.BaseUrl);if(e&&!1===silex.Helper.checkFileExt(c.url,e)){var d=c.url.substring(c.url.lastIndexOf("/")+1);alertify.confirm("The file name "+
d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};
silex.view.FileExplorer.prototype.saveAsDialog=function(c,d,e,f){d||(d={mimetype:"text/html"});var h=function(c){console.error(c);f&&f(c)},k=function(d){(new goog.async.Delay(function(){c&&c(d)},10,this)).start()};this.filePicker.exportFile("http://google.com/",d,goog.bind(function(c){this.closeEditor();c.url=c.url.replace("https://","http://");c.url=silex.Helper.getAbsolutePath(c.url,silex.Helper.BaseUrl);if(e&&!1===silex.Helper.checkFileExt(c.url,e)){var d=c.url.substring(c.url.lastIndexOf("/")+
1);alertify.confirm("The file name "+d+" does not looks good to me, are you sure you want to select this file?",function(d){d?k(c):h({message:"Wrong file type."})})}else k(c)},this),h);this.openEditor()};silex.view.FileExplorer.prototype.openEditor=function(){var c=goog.dom.getElementByClass("dialogs-background");goog.style.setStyle(c,"display","inherit");goog.style.setStyle(this.element,"display","");goog.events.listen(c,goog.events.EventType.CLICK,this.closeEditor,!0,this)};
...
goog.style.setStyle(e,"width","100%");goog.style.setStyle(e,"height","100%");var f=this.getBackgroundElement();goog.dom.appendChild(f,d);goog.dom.appendChild(d,e);var h=new silex.model.Component(d),k={left:"100px",top:"100px"};h.setBoundingBox(k);e.setAttribute("src",c);e.onload=function(c){k.width=e.offsetWidth+"px";k.height=e.offsetHeight+"px";h.setBoundingBox(k);h.setEditable(!0,d)};return h};
...
!1),this.getFieldObject().dispatchSelectionChangeEvent()),c.preventDefault(),!0)};silex.view.TextEditor=function(c,d){this.element=c;silex.Helper.loadTemplateFile("templates/texteditor.html",c,function(){this.initUI();this.closeEditor();d&&d()},this)};
...
c,d,goog.editor.Command.LINK,goog.editor.Command.UNDO,goog.editor.Command.REDO,goog.editor.Command.UNORDERED_LIST,goog.editor.Command.ORDERED_LIST,goog.editor.Command.INDENT,goog.editor.Command.OUTDENT,goog.editor.Command.JUSTIFY_LEFT,goog.editor.Command.JUSTIFY_CENTER,goog.editor.Command.JUSTIFY_RIGHT,goog.editor.Command.SUBSCRIPT,goog.editor.Command.SUPERSCRIPT,goog.editor.Command.STRIKE_THROUGH,goog.editor.Command.REMOVE_FORMAT],goog.dom.getElementByClass("toolbar",this.element));new goog.ui.editor.ToolbarController(this.textField,
c);goog.events.listen(this.textField,goog.editor.Field.EventType.DELAYEDCHANGE,function(){this.contentChanged()},!1,this);try{this.textField.makeEditable()}catch(f){console.error("error catched",f)}goog.events.listen(goog.dom.getElementByClass("close-btn",this.element),goog.events.EventType.CLICK,function(){this.closeEditor()},!1,this)};
...
silex.model.File.prototype.open=function(c,d){this.fileExplorer.openDialog(goog.bind(function(e){silex.service.CloudStorage.getInstance().load(e,goog.bind(function(d){this.close();this.setUrl(e.url);this.setBlob(e);this.setHtml(d);c&&c()},this),d)},this),["text/html","text/plain"],["html","htm"],d);this.workspace.invalidate()};
