...
case "insert.page":this.createPage(function(){this.tracker.trackAction("controller-events","success",c.type,1)},function(){this.tracker.trackAction("controller-events","cancel",c.type,0)});break;case "insert.text":var d=this.file.getStageComponent().addText();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "insert.html":d=this.file.getStageComponent().addHtml();this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "insert.image":this.fileExplorer.openDialog(goog.bind(function(d){d=
this.file.getStageComponent().addImage(d.url);this.selection.getPage().addComponent(d);this.selection.setComponent(d);this.tracker.trackAction("controller-events","success",c.type,1)},this),["image/*","text/plain"],["jpg","gif","png"],goog.bind(function(d){this.notifyError("Error: I did not manage to load the image. <br /><br />"+(d.message||""));this.tracker.trackAction("controller-events","error",c.type,-1)},this));this.workspace.invalidate();break;case "insert.container":d=this.file.getStageComponent().addContainer();
this.selection.getPage().addComponent(d);this.selection.setComponent(d);break;case "edit.delete.selection":this.file.getStageComponent().remove(this.selection.getComponent());this.selection.setComponent(this.file.getStageComponent());break;case "edit.delete.page":this.removePage(this.selection.getPage());break;case "edit.rename.page":this.renamePage(this.selection.getPage());break;case "help.about":window.open("http://www.silexlabs.org/silex/");break;case "help.aboutSilexLabs":window.open("http://www.silexlabs.org/silexlabs/");
break;case "help.forums":window.open("http://graphicdesign.stackexchange.com/questions/tagged/silex");break;case "help.newsLetter":window.open("http://eepurl.com/F48q5");break;case "help.googlPlus":window.open("https://plus.google.com/communities/107373636457908189681");break;case "help.twitter":window.open("http://twitter.com/silexlabs");break;case "help.facebook":window.open("http://www.facebook.com/silexlabs");break;case "help.forkMe":window.open("https://github.com/silexlabs/Silex")}};
