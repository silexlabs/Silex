...
silex.model.Component.prototype.setStyle=function(c,d){c||(c={});d||(d=this.context);var e="";goog.object.forEach(c,function(c,d,f){c&&("none"===c?c=null:e+=goog.string.toSelectorCase(d)+": "+c+"; ",goog.style.setStyle(this.element,d,c))},this);if(d===silex.model.Component.CONTEXT_NORMAL)var f=this.getBoundingBox(),e=e+("top: "+f.top+"; "),e=e+("left: "+f.left+"; "),e=e+("width: "+f.width+"; "),e=e+("height: "+f.height+"; "),e=e+("bottom: "+f.bottom+"; "),e=e+("right: "+f.right+"; "),e=e+("z-index: "+
f.zIndex+"; "),e=e+"position: absolute; ";""!==e?this.element.setAttribute("data-style-"+d,e):this.element.removeAttribute("data-style-"+d)};
...
silex.view.propertiesTool.BgPane.prototype.onColorChanged=function(c){c=silex.Helper.hexToRgba(this.hsvPalette.getColorRgbaHex());this.style||(this.style={});this.style.backgroundColor=c;this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.onBgColorButton=function(c){!1===this.getColorPaletteVisibility()?(this.hsvPalette.setColorRgbaHex(silex.Helper.rgbaToHex(this.style.backgroundColor)),this.setColorPaletteVisibility(!0)):this.setColorPaletteVisibility(!1)};
silex.view.propertiesTool.BgPane.prototype.onTransparentChanged=function(c){!1===this.transparentBgCheckbox.getChecked()?((c=silex.Helper.hexToRgba(this.hsvPalette.getColorRgbaHex()))||(c="rgba(255, 255, 255, 1)"),this.style.backgroundColor=c):this.style.backgroundColor="transparent";this.styleChanged(this.style);this.redraw()};silex.view.propertiesTool.BgPane.prototype.onSelectImageButton=function(c){this.selectImage()};
