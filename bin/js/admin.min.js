...
var p="";goog.array.forEach(h,function(c){var d="";goog.array.forEach(c.classNames,function(c){""!=d&&(d+=", ");d+=c},this);d+="{\n\t"+silex.Helper.styleToString(c.styles)+"\n}";p+="\n"+d},this);p.replace("; ",";\n\t");e="<html>"+('<head><link href="css/styles.css" rel="stylesheet">'+e.innerHTML+"</head>");e+="<body>"+m.innerHTML+"</body>";e+="</html>";console.info("files to publish",k);c(e,p,k)}else d&&d({message:"The file must be saved before I can clean it up for you."})};
