...
"/"));var h="css/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,h)}),f=f.replace(/src="?([^"]*)"/g,function(c,d,e){e=silex.Helper.getAbsolutePath(d,l);var f=silex.Helper.getRelativePath(e,silex.Helper.BaseUrl);silex.Helper.isAbsoluteUrl(f)||(f=f.replace("../","/"));var h="js/"+e.substr(e.lastIndexOf("/")+1);k.push({url:e,destPath:h,srcPath:f});return c.replace(d,h)}),m=goog.dom.createElement("div");m.innerHTML=e;e=goog.dom.createElement("div");e.innerHTML=
f;$('meta[name="publicationPath"]',e).remove();f=goog.dom.getElementsByClass("editable-style",m);goog.array.forEach(f,function(c){c=new silex.model.Component(c);var d=c.element.getAttribute("data-silex-href");d&&(c.element.setAttribute("href",d),c.element.removeAttribute("data-silex-href"),d=goog.dom.getOuterHtml(c.element),d="<a"+d.substring(4,d.length-6)+"</a>",d=goog.dom.htmlToDocumentFragment(d),goog.dom.insertSiblingBefore(d,c.element),goog.dom.removeNode(c.element),c.element=d)},this);var f=
goog.dom.getElementsByClass("editable-style",m),n=0;goog.array.forEach(f,function(c){c=new silex.model.Component(c);c.addClass("silex-"+c.type);var d="component-"+n++;c.addClass(d);var e=c.getCss(silex.model.Component.CONTEXT_NORMAL);h.push({classNames:["."+d],styles:e});c.hasStyle(silex.model.Component.CONTEXT_HOVER)&&(e=c.getCss(silex.model.Component.CONTEXT_HOVER),h.push({classNames:["."+d+":hover"],styles:e}));c.hasStyle(silex.model.Component.CONTEXT_PRESSED)&&(e=c.getCss(silex.model.Component.CONTEXT_PRESSED),
